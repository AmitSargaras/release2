...
public class GuaranteesIndRestRequestDTO {
	...
	public String getGuarantersPan() {
		return guarantersPan;
	}
	public void setGuarantersPan(String guarantersPan) {
		this.guarantersPan = guarantersPan;
	}
