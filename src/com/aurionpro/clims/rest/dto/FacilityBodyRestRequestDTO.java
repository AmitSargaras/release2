...
public class FacilityBodyRestRequestDTO  {
	
	private String facilityCategoryId; //E
	private String facilityTypeId;//E
	private String facilityName;
	private String climsFacilityId;//E
	private String mainFacilityId;//E
	private String syndicateLoan;
	private String dpRequired;
	private String isDpCalulated;
	private String relationshipManager;
	private String isReleased;
	private String bankingArrangement;
	private String clauseAsPerPolicy;
	private String grade;//E
	private String secured;//E
	private String currency;//E
	private String isAdhoc;
	private String isAdhocToSanction;
	private String adhocLimit;
	private String subLimitFlag;//E
	private String facilityNameGuar;
	private String guaranteeFlag;//E
	private String partyName;
	private String LiabilityId;
	private String sanctionedAmount;//E
	private String releasableAmount;
	private String released;
	private String camId;//E
	private String subFacilityName;
	private String event;
	private String facilityUpadteFlag;
	private List<SecurityDetailRestRequestDTO> securityList;
	//private List<FacilitySCODDetailRestRequestDTO> scodList;
	private List<FacilityLineDetailRestRequestDTO> lineList;
	private List<CoBorrowerDetailsRestRequestDTO> borrowerList;
	

	
	private String isScod;
	...
	public String getDpRequired() {
		return dpRequired;
	}
	public void setDpRequired(String dpRequired) {
		this.dpRequired = dpRequired;
	}
	public String getIsDpCalulated() {
		return isDpCalulated;
	}
	public void setIsDpCalulated(String isDpCalulated) {
		this.isDpCalulated = isDpCalulated;
	}
	...
	public String getIsAdhocToSanction() {
		return isAdhocToSanction;
	}
	public void setIsAdhocToSanction(String isAdhocToSanction) {
		this.isAdhocToSanction = isAdhocToSanction;
	}
	...
	public String getFacilityNameGuar() {
		return facilityNameGuar;
	}
	public void setFacilityNameGuar(String facilityNameGuar) {
		this.facilityNameGuar = facilityNameGuar;
	}
	...
	public List<SecurityDetailRestRequestDTO> getSecurityList() {
		return securityList;
	}
	public void setSecurityList(List<SecurityDetailRestRequestDTO> securityList) {
		this.securityList = securityList;
	}
	/*public List<FacilitySCODDetailRestRequestDTO> getScodList() {
		return scodList;
	}
	public void setScodList(List<FacilitySCODDetailRestRequestDTO> scodList) {
		this.scodList = scodList;
	}*/
	public List<CoBorrowerDetailsRestRequestDTO> getBorrowerList() {
		return borrowerList;
	}
	public void setBorrowerList(List<CoBorrowerDetailsRestRequestDTO> borrowerList) {
		this.borrowerList = borrowerList;
	}
	
	public List<FacilityLineDetailRestRequestDTO> getLineList() {
		return lineList;
	}
	public void setLineList(List<FacilityLineDetailRestRequestDTO> lineList) {
	...
	public String getFacilityUpadteFlag() {
		return facilityUpadteFlag;
	}
	public void setFacilityUpadteFlag(String facilityUpadteFlag) {
		this.facilityUpadteFlag = facilityUpadteFlag;
	}
	public String getIsScod() {
		return isScod;
	}
	public void setIsScod(String isScod) {
		this.isScod = isScod;
	}
	...
	public String getTenorVal() {
		return tenorVal;
	}
	public void setTenorVal(String tenorVal) {
		this.tenorVal = tenorVal;
	}
