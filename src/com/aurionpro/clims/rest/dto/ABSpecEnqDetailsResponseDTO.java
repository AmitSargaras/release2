...
public class ABSpecEnqDetailsResponseDTO extends CollateralEnqiryDetailsResponseDTO {
	...
	public String getPhysicalInspectionFreqCode() {
		return physicalInspectionFreqCode;
	}

	public void setPhysicalInspectionFreqCode(String physicalInspectionFreqCode) {
		this.physicalInspectionFreqCode = physicalInspectionFreqCode;
	}

	public String getGoodStatusCode() {
		return goodStatusCode;
	}

	public void setGoodStatusCode(String goodStatusCode) {
		this.goodStatusCode = goodStatusCode;
	}

	public String getEnvRiskyStatusCode() {
		return envRiskyStatusCode;
	}

	public void setEnvRiskyStatusCode(String envRiskyStatusCode) {
		this.envRiskyStatusCode = envRiskyStatusCode;
	}
