...
public class EncryptUtil {
	...
	public static void main(String args[]) {
		...
		DefaultLogger.debug("Encryption Provider is ", "" + PropertyManager.getValue("rest.encryption.provider"));
		...
		if (args[0].equals("e")) {
			...
			CryptoManager sec = new CryptoManager("Hex", PropertyManager.getValue("rest.encryption.provider"));
			...
			String fileName=(args[1].equals("p"))?"encrypted.dbuid.file" : "encrypted.dbpwd.file";
			writeFile(PropertyManager.getValue(fileName),result);
