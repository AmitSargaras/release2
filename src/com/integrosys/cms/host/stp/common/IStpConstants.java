 ...
 */
public interface IStpConstants {
	...
	public static final String STP_MASTER_TRANS_ENTITY_NAME = "stpMasterTrx";

	// entity name for OBStpTrans
	public static final String STP_TRANS_ENTITY_NAME = "stpTrx";

	// entity name for OBStpTransHistory
	public static final String STP_TRANS_HISTORY_ENTITY_NAME = "stpTrxHistory";

	// entity name for OBStpTransError
	public static final String STP_TRANS_ERROR_ENTITY_NAME = "stpTrxError";

	// sequence for STP_TRANS TRX_UID
	public static final String SEQUENCE_STP_TRANS_UID = "STP_TRANS_UID_SEQ";

	// sequence for STP MBASE HDRNUM
	public static final String SEQUENCE_STP_TRANS_REF = "STP_TRANS_REF_SEQ";
	...
	public static final String STP_TRX_VALUE = "obStpMasterTrans";
	...
	public static final String STP_TRX_UID_PREFIX = "CMS";

	// Stp send/resend indicator
	public static final String STP_TRX_SEND_IND = "S";

	public static final String STP_TRX_RESEND_IND = "R";

	// Stp date and time format
	public static final String STP_DATE_PATTERN = "stp.date.pattern";

	public static final String STP_SHORT_DATE_PATTERN = "stp.short.date.pattern";

	public static final String STP_TIME_PATTERN = "stp.time.pattern";

	// Stp asynchronous poller properties config
	public static final String STP_ASYNC_POLLER_ENABLED = "stp.async.poller.enabled";

	public static final String STP_ASYNC_POLLER_INTERVAL = "stp.async.poller.interval";

	public static final String STP_ASYNC_TASK_INTERVAL = "stp.async.task.interval";

	// Additional property in Chain context
	public static final String FIELD_VAL_MAP = "FIELD_VAL_MAP";

	public static final String STP_TRANS_MAP = "STP_TRANS_MAP";
	...
	public static final String STP_SKT_HDR_NUMBER_RECORD = "stp.number.record.return";

	public static final String STP_DSP_TIMEOUT_CODE = ".DSP0003";

	public static final String STP_DFT_CURR = "stp.default.currency";

	public static final String STP_SWITCH_MODE = "stp.inquiry.enabled";

	// KLYong: Application resources properties
	public static final String ERR_STP_INQUIRY = "error.stp.inquiry";

	public static final String ERR_STP_PACKVALUE = "error.stp.packvalue";

	public static final String ERR_STP_REQUIRED_FIELD = "error.stp.required.field";

	public static final String APPLICATION_TYPE = "CC";

	// Collateral master default valuer code
	public static final String DEFAULT_VALUER = "stp.default.valuer.code";

	// Islamic STP Loan Type
	public static final String STP_ISLAMIC_LOAN_TYPE_MASTER = "1";

	public static final String STP_ISLAMIC_LOAN_TYPE_BBA = "2";
	
	public static final String STP_ISLAMIC_LOAN_TYPE_CORPORATE = "3";

    public static final String STP_CORRELATION_ID_SEQ = "CMS_CORRELATION_ID_SEQ";
}
