...
/**
 * Facility islamic rental renewal create and update Stp message
 *
 * @author Andy Wong
 * @since Sep 29, 2009
 */
public class StpFacIslamicRentalRenewCreationCmd extends AbstractStpCommand {
//    private final Logger logger = LoggerFactory.getLogger(getClass());
    ...
    public boolean execute(Map ctx) throws Exception {
        ...
        if (limitProfile.getApplicationType().equals(ICMSConstant.APPLICATION_TYPE_CO)
            ...
            OBFacilityIslamicRentalRenewal rentalRenewal = obFacilityMaster.getFacilityIslamicRentalRenewal();
            fieldValMap.put("LIJRAT", StpCommandUtil.convertPercentToDecimalPoint(rentalRenewal.getRenewalRate()));
            fieldValMap.put("LIJPVI", StpCommandUtil.convertPercentToDecimalPoint(rentalRenewal.getPrimeVariance()));

            //put the OB into an array of object
            ArrayList aObject = new ArrayList();
            aObject.add(limit);
            aObject.add(rentalRenewal);
