...
import com.integrosys.cms.host.eai.DataAccessJdbcException;
...
public abstract class DataAccessExceptionUtils {
	 ...
	 * {@link SQLException#getNextException()} will be accumulated and printed
	 * to the log as well.
	 * <p>
	 ...
	 */
	public static EAIMessageException handleDataAccessException(DataAccessException ex) {
		...
		return new EAIProcessFailedException("failed to access persistent framework", ex);
	}
	 ...
	 * {@link SQLException#getNextException()}, then print out the message of
