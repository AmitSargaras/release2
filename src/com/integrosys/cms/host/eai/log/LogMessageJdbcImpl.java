 ...
 */
public class LogMessageJdbcImpl extends JdbcDaoSupport implements ILogMessageJdbc {
...
//	private static final String GET_SEQ_SQL = "VALUES nextval FOR CMS_MQ_MSG_LOG_SEQ";
	...
	public void persistEAILogMessage(EAIMessageLog logMessage) {
		String query = "INSERT INTO cms_eai_message_log "
				+ "(log_id, message_ref_num, message_type, message_id, publish_type, publish_date, source, "
				+ "received_msg_path, response_msg_path, response_msg_id, response_code, response_desc, "
		...
		argList.add(logMessage.getReceivedMessagePath());
