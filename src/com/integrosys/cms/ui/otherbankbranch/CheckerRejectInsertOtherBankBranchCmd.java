...
public class CheckerRejectInsertOtherBankBranchCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectInsertOtherBankBranchCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		 HashMap returnMap = new HashMap();
	        ...
	        try {
	            ...
	            IOtherBankBranchTrxValue trxValueOut = getOtherBranchProxyManager().checkerRejectInsertOtherBankBranch(ctx, trxValueIn);
