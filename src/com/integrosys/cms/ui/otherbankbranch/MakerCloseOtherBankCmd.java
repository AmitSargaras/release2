...
public class MakerCloseOtherBankCmd extends AbstractCommand implements ICommonEventConstant {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IOtherBankTrxValue trxValueOut = getOtherBankProxyManager().makerCloseRejectedOtherBank(ctx, trxValueIn);
