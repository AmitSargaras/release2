...
public class MakerInsertCloseOtherBankCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerInsertCloseOtherBankCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IOtherBankTrxValue trxValueOut = getOtherBankProxyManager().makerInsertCloseRejectedOtherBank(ctx, trxValueIn); 
