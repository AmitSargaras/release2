 ...
 * 
 */
public class CheckerRejectEditOtherBranchCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectEditOtherBranchCmd() {
	}
		 ...
		 HashMap returnMap = new HashMap();
	        ...
	        try {
	            ...
	            if(remarks == null || remarks.equals("")){
	            	...
	            	resultMap.put("IOtherBankBranchTrxValue", trxValueIn);
	            	...
	            	IOtherBankBranchTrxValue trxValueOut = getOtherBranchProxyManager().checkerRejectOtherBranch(ctx, trxValueIn);
