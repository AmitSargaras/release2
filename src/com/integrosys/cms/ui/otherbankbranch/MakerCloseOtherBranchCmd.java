 ...
 * Command for maker to close the rejected Other Bank Branch trx value
 */

public class MakerCloseOtherBranchCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerCloseOtherBranchCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IOtherBankBranchTrxValue trxValueOut = getOtherBranchProxyManager().makerCloseRejectedOtherBranch(ctx, trxValueIn);
