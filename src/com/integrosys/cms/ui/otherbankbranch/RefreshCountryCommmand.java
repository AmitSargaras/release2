...
public class RefreshCountryCommmand extends AbstractCommand{
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	        	...
	        	if( event.equals("refresh_region_id")){	        		
	        		...
	        		IOtherBankBranchTrxValue trxValue =(OBOtherBankBranchTrxValue) (map.get("IOtherBankBranchTrxValue"));
