 ...
 * Command for maker to close the rejected Other Bank trx value
 */

public class MakerDraftCloseOtherBankCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerDraftCloseOtherBankCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IOtherBankTrxValue trxValueOut = getOtherBankProxyManager().makerCloseDraftOtherBank(ctx, trxValueIn);
