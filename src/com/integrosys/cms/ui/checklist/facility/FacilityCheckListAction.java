 ...
 */
public class FacilityCheckListAction extends CommonAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if ("list".equals(event)) {
			...
			objArray[0] = getCommandByName("ListFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("disable_facility_col_task".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("DisableFacilityColTaskCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("maintain".equals(event) || "view".equals(event) || "delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("MaintainFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("AddFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("remove_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("RemoveFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("SubmitFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("submit_delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("SubmitDeleteFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("process".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ReadStagingFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("approve_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ApproveFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("reject_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("RejectFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("update".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("UpdateFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("update_delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("UpdateDeleteFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("CloseFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("CopyFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("link".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("LinkFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("replace".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ReplaceFacilityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return FacilityCheckListFormValidator.validateInput((FacilityCheckListForm) aForm, locale);
	}
	...
	public IPage getNextPage(String event, HashMap resultMap, HashMap exceptionMap) {
		...
		if ((resultMap.get("no_facility_name") != null) && ((String) resultMap.get("no_facility_name")).equals("true")) {
			aPage.setPageReference("no_facility_name");
			return aPage;
		}
	...
	private String getReference(String event) {
		...
		if ("list".equals(event)) {
			...
			forwardName = "disable_facility_task";
		}
