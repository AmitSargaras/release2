 ...
 */
public class MaintainCAMCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public MaintainCAMCheckListCommand() {
	}
...
//				}
				...
				int count=dao.getPendingStageChecklistCount("CAM",limitProfileID);
				if(count>0){
				resultMap.put("wip", "wip");
				}
