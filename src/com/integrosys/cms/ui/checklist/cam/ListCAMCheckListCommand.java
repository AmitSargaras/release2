 ...
 */
public class ListCAMCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public ListCAMCheckListCommand() {
	}
...
//				{ "innerOuterBcaObList", "java.util.HashMap", REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        String isViewFlag = (String) map.get("isViewFlag");
          ...
          try {
        	//  CheckListDAOFactory.getCheckListDAO().getBulkCAMCheckListByCategoryAndProfileID("CAM",limitProfileID);
        	  ...
        	  resultMap.put("camCheckList", camCheckList);
