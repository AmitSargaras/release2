 ...
 */
public class SubmitCAMCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public SubmitCAMCheckListCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		checkList.setCamDate(limitProfile.getApprovalDate());
		checkList.setCamNumber(limitProfile.getBCAReference());
		checkList.setCamType(limitProfile.getCamType());
		checkList.setIsLatest("Y");
