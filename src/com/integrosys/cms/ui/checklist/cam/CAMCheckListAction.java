 ...
 */
public class CAMCheckListAction extends CommonAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if ("list".equals(event)) {
			...
			objArray[0] = getCommandByName("ListCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("disable_cam_col_task".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("DisableCAMColTaskCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("maintain".equals(event) || "view".equals(event) || "delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("MaintainCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("AddCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("remove_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("RemoveCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("SubmitCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("submit_delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("SubmitDeleteCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("process".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ReadStagingCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("approve_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ApproveCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("reject_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("RejectCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("update".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("UpdateCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("update_delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("UpdateDeleteCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("CloseCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("CopyCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("link".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("LinkCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("replace".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ReplaceCAMCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return CAMCheckListFormValidator.validateInput((CAMCheckListForm) aForm, locale);
	}
	...
	private String getReference(String event) {
		...
		}else if ("reject_checklist_item_error".equals(event)) {
			forwardName = "after_process";
		}
