 ...
 */
public class SecurityCheckListAction extends CommonAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if ("list".equals(event)) {
			...
			objArray[0] = getCommandByName("ListSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("disable_security_col_task".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("DisableSecurityColTaskCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("maintain".equals(event) || "view".equals(event) || "delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("MaintainSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("AddSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("remove_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("RemoveSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("SubmitSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("submit_delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("SubmitDeleteSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("process".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ReadStagingSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("approve_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ApproveSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("reject_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("RejectSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("update".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("UpdateSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("update_delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("UpdateDeleteSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("CloseSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("CopySecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("link".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("LinkSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("replace".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ReplaceSecurityCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return SecurityCheckListFormValidator.validateInput((SecurityCheckListForm) aForm, locale);
	}
	...
	private String getReference(String event) {
		...
		if ("list".equals(event)) {
			...
			forwardName = "disable_security_task";
		}
