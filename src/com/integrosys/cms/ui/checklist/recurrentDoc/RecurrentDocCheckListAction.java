 ...
 */
public class RecurrentDocCheckListAction extends CommonAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if ("list".equals(event)) {
			...
			objArray[0] = getCommandByName("ListRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("disable_other_col_task".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("DisableRecurrentDocColTaskCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("maintain".equals(event) || "view".equals(event) || "delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("MaintainRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("AddRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("remove_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("RemoveRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("SubmitRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("submit_delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("SubmitDeleteRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("process".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ReadStagingRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("approve_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ApproveRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("reject_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("RejectRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("update".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("UpdateRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("update_delete".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("UpdateDeleteRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("CloseRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("CopyRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("link".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("LinkRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
		else if ("replace".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = getCommandByName("ReplaceRecurrentDocCheckListCommand");
			objArray[1] = getCommandByName("FrameFlagSetterCommand");
		}
			...
			objArray = new ICommand[1];
			objArray[0] = getCommandByName("FrameFlagSetterCommand");
		}else if ("show_recurrent_master".equals(event)) {
			objArray = new ICommand[1];
			objArray[0] = new com.integrosys.cms.ui.checklist.recurrentDoc.ShowRecurrentMasterItemCommand();
		}else if ("add_recurrent".equals(event)) {
			objArray = new ICommand[1];
			objArray[0] = new AddRecurrentCommand();
		}
		return (objArray);
	}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return RecurrentDocCheckListFormValidator.validateInput((RecurrentDocCheckListForm) aForm, locale);
	}
	...
	private String getReference(String event) {
		...
		if ("list".equals(event)) {
			...
			forwardName = "disable_other_task";
				...
				|| "replace".equals(event) || "back".equals(event) || "remove_error".equals(event)|| "add_recurrent".equals(event)) {
			...
			forwardName = "show_recurrent_master";
		}
