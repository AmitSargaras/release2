 ...
 */
public class ListRecurrentDocCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public ListRecurrentDocCheckListCommand() {
	}
...
//				{ "innerOuterBcaObList", "java.util.HashMap", REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        String isViewFlag = (String) map.get("isViewFlag");
          ...
          try {
        	  CheckListSearchResult otherCheckList= this.checklistProxyManager.getCAMCheckListByCategoryAndProfileID("REC",limitProfileID);
