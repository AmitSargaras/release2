 ...
 * @since $Date: 2006/10/10 08:14:37 $ Tag: $Name: $
 */
public class SubmitDeleteRecurrentDocCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public SubmitDeleteRecurrentDocCheckListCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			throw new CommandProcessingException("failed to submit delete checklist workflow", ex);
		}
