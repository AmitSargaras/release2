 ...
 */
public class CheckerUpdateCCReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CheckerUpdateCCReceiptCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			checkListTrxVal = proxy.checkerUpdateCheckListReceipt(ctx, checkListTrxVal);
