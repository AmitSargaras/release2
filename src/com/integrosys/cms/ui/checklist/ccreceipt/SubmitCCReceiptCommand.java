 ...
 */
public class SubmitCCReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public SubmitCCReceiptCommand() {
	}
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] {
				...
				// SERVICE_SCOPE},
				// {"hLegalFirm", "java.lang.String", REQUEST_SCOPE},
				// {"makerStatus", "java.lang.String", REQUEST_SCOPE}, // cms -
				// 1487
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICheckList checkList = (ICheckList) map.get("checkListObj");
