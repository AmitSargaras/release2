 ...
 */
public class CheckerViewCCReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CheckerViewCCReceiptCommand() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "actualShareCheckList", "java.util.List", REQUEST_SCOPE },
				{ "stagingShareCheckList", "java.util.List", REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			resultMap.put("actualShareCheckList", getShareCheckList(actual));
	...
	private List getShareCheckList(ICheckListItem iCheckListItem) {
		...
		DefaultLogger
				.debug(this, ">>>>>>>>> iCheckListItem   CheckListItemRef " + iCheckListItem.getCheckListItemRef());
