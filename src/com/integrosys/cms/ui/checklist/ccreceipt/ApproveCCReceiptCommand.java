 ...
 */
public class ApproveCCReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ApproveCCReceiptCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// this.updateShareCheeckListStatus(checkListTrxVal); //not
			// necessary - just leave the status empty
