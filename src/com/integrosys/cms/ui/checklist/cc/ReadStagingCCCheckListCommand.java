 ...
 */
public class ReadStagingCCCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public ReadStagingCCCheckListCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			throw new CommandProcessingException("failed to get checklist by transaction id [" + custTypeTrxID + "]",
					ex);
		}
