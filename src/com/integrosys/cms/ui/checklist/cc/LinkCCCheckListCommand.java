 ...
 */
public class LinkCCCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public LinkCCCheckListCommand() {
	}
	 ...
	 * results back into the HashMap. Here, the in-memory checklists are updated
	 * to reflect the linkage status.
	 * 
