 ...
 */
public class RemoveCCCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RemoveCCCheckListCommand() {
	}
	...
	private void mapCheckListItem(HashMap map) { // same as
		// SubmitCCCheckListCommand.java
