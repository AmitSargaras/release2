 ...
 */
public class ReplaceCCCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public ReplaceCCCheckListCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		ICheckListItem replaceCheckListItem = null;

		try {
			replaceCheckListItem = this.checklistProxyManager.getCheckListItem(replaceItemRef);
		}
		catch (CheckListException ex) {
			throw new CommandProcessingException("failed to get checklist item, reference number [" + replaceItemRef
					+ "]", ex);
		}
