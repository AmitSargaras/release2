 ...
 */
public class RejectCCCheckListCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public RejectCCCheckListCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			throw new CommandProcessingException("failed to reject checklist workflow", ex);
		}
