...
import com.integrosys.cms.ui.checklist.CheckListForm;
...
public class RetriveImageCommand extends AbstractCommand {
	...
	/*	String tCheckListID = (String) map.get("checkListID");
		...
		String secName = (String) map.get("secName");
		String collateralID = (String) map.get("collateralID");
		String collateralRef = (String) map.get("collateralRef");
	...
	/*	result.put("checkListID", tCheckListID);
		result.put("limitBkgLoc", limitBkgLoc);
		result.put("secType", secType);
		result.put("secSubType", secSubType);
		result.put("secName", secName);
		result.put("collateralID", collateralID);
		result.put("collateralRef", collateralRef);
		result.put("limitProfileID", limitProfileID);
         result.put("legalID", legalID);
         result.put("legalConstitution", legalConstitution);*/
