...
import com.integrosys.cms.ui.checklist.facilityreceipt.RetriveImageTagUntagFacRecCommand;
 ...
 */
public class SecurityReceiptAction extends CommonAction {
    ...
    public static final String EVENT_RETRIEVE_IMAGE_GALLARY_SEC_DOC = "retrieveImageGallarySecurityDoc";
	public static final String EVENT_RETRIEVE_INDVDL_IMAGE_SEC_DOC = "retrieveIndividualImageSecurityDoc";
	public final static String SEARCH_SECURITY_DOC = "search_security_doc";
	public final static String CHECKER_SEARCH_SECURITY_DOC = "checker_search_security_doc";
	...
	public final static String EVENT_RETRIEVE_IMAGE_GALLERY_CHK_OTHER = "retrieve_image_gallery_chk_other";
	public final static String EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_OTHER = "retrieve_individual_image_chk_other";
	public final static String EVENT_PREPARE_TAG_UNTAG_IMAGE_FROM_RETRIEVE = "prepare_retrieve_tag_untag_image";
	
	public final static String EVENT_RETRIEVE_IMAGE_GALLERY_CHK_SECURITY = "retrieve_image_gallery_chk_security";
	public final static String EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK = "retrieve_individual_image_chk";
	public final static String EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_SECURITY = "retrieve_individual_image_chk_security";
	public static final String EVENT_RETRIEVE_IMAGE_GALLARY_SECURITY = "retrieveImageGallarySecurityDoc";
	public static final String EVENT_RETRIEVE_INDVDL_IMAGE_SECURITY = "retrieveIndividualImageSecurityDoc";
	public static final String EVENT_RETRIEVE_MIG_IMAGE_GALLARY_SECURITY = "retrieveMigImageGallarySECURITYDoc";
	public static final String EVENT_RETRIEVE_MIG_INDVDL_IMAGE_SECURITY = "retrieveMigIndividualImageSECURITYDoc";
	
	public final static String EVENT_PREPARE_TAG_UNTAG_IMAGE_VIEW = "prepare_tag_untag_image_view";
	public final static String EVENT_RETRIEVE_IMAGE_GALLERY_CHK_SECURITY_CHECKER_VIEW = "retrieve_image_gallery_chk_security_checker_view";
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_REFRESH_SHARE_CHECKLIST.equals(event)) {
			...
			objArray = new ICommand[3];
			objArray[0] = new ListSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
		else if ("cust_list".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new ListFilteredSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
		else if ("prepare_update".equals(event) || "view".equals(event)||SEARCH_SECURITY_DOC.equals(event)
				||CHECKER_SEARCH_SECURITY_DOC.equals(event)||"checker_search_security_doc".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new PrepareUpdateSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
			...
			objArray = new ICommand[2];
			objArray[0] = new SaveSecurityReceiptCommand(); 
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[2];
//			objArray[0] = new CreateImageTagAddSecReceiptCommand();
			objArray[0] = new SubmitSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("submiting".equals(event)) {
			objArray = new ICommand[2];
//			objArray[0] = new EditImageTagSecReceiptCommand();
			objArray[0] = new SubmitSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
				...
				||"search_security_doc_checker".equals(event)||"search_security_doc_checker_close".equals(event)
				||"search_security_doc_checker_process".equals(event)||"search_security_doc_maker_close".equals(event)) { // OFFICE
			objArray = new ICommand[3];
//			objArray[0] = new CheckerReadImageTagSecReceiptCmd();
			objArray[0] = new ReadStagingSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
		else if ("edit_staging_checklist_item".equals(event)) {
			objArray = new ICommand[3];
//			objArray[0] = new MakerPreapreResubmitImageTagSecReceiptCmd();
			objArray[0] = new ReadStagingSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
			...
			objArray = new ICommand[2];
			objArray[0] = new RefreshSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("close".equals(event)) {
			objArray = new ICommand[2];
//			objArray[0] = new MakerCloseImageTagSecReceiptCmd();
			objArray[0] = new CloseSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("cancel".equals(event)) {
			objArray = new ICommand[2];
//			objArray[0] = new MakerCloseImageTagSecReceiptCmd();
			objArray[0] = new CancelSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("approve_checklist_item".equals(event)) {
			objArray = new ICommand[2];
//			objArray[0] = new CheckerApproveCreateImageTagSecReceiptCmd();
			objArray[0] = new ApproveSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("reject_checklist_item".equals(event)) {
			objArray = new ICommand[2];
//			objArray[0] = new CheckerRejectEditImageTagSecReceiptCmd();
			objArray[0] = new RejectSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		// Begin of OFFICE
		else if ("forward_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ForwardSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		// End of OFFICE
			...
			objArray = new ICommand[3];
			objArray[0] = new CheckerViewSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
		else if ("view_receipt".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new ViewSecurityReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
            ...
            objArray[1] = new FrameFlagSetterCommand();
        }else if("view_image_page".equals(event)||"view_image_page_to_track".equals(event)||"view_image_page_to_do".equals(event)
        		||"view_image_page_to_do_process".equals(event)) {
            objArray = new ICommand[1];
...
//            objArray[1] = new FrameFlagSetterCommand();
        ...
        else if (event.equals(EVENT_RETRIEVE_IMAGE_GALLARY_SEC_DOC) || event.equals(EVENT_RETRIEVE_INDVDL_IMAGE_SEC_DOC)) {
			objArray = new ICommand[1];
			objArray[0] = new RetriveImageCommand();
		}
        /*else if (event.equals("retrieveImageTagUntagSecReceipt") || event.equals("retrieveIndImageTagUntagSecReceiptPath") ) {
			objArray = new ICommand[1];
			objArray[0] = new RetriveImageTagUntagSecRecCommand();
		}*/
        ...
        objArray[2] = new MapChecklistCommand();
		objArray[3] = new FrameFlagSetterCommand();
//		objArray[4] = new SecurityReceiptImageTagUntagCommand();
    }else if("securityreceipt_image_tag_untag_submit".equals(event)) {
    	objArray = new ICommand[4];
		objArray[0] = new PrepareCommand();
		objArray[1] = new ReadCheckListItemCommand();
        objArray[2] = new MapChecklistCommand();
...
//		objArray[4] = new SecurityReceiptImageTagUntagCommand();
	...
	else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_SECURITY.equals(event) || EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_SECURITY.equals(event) || EVENT_RETRIEVE_IMAGE_GALLERY_CHK_SECURITY_CHECKER_VIEW.equals(event)) {
		objArray = new ICommand[2];
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return SecurityReceiptFormValidator.validateInput((SecurityReceiptForm) aForm, locale);
		// return
	...
	private String getReference(String event) {
		...
		if ("prepare_update".equals(event) || "save_remind".equals(event) || "undo".equals(event)
                ...
                || EVENT_PREPARE.equals(event) || EVENT_EXPRESS_COMPLETION.equals(event)||SEARCH_SECURITY_DOC.equals(event)
                ||"version".equals(event)||"conform_inactive".equals(event)
                || "save_discrepancy".equals(event)|| "NOT_APPLICABLE".equals(event)) {                                           // priya
																							// -
																							// added
																							// save_update_renewal
																							// for
		...
		if("edit_staging_checklist_item".equals(event)||"search_security_doc_checker_process".equals(event)){
		...
		if ("process".equals(event) || "refresh_comment".equals(event) || "chk_view_return".equals(event)
				||"search_security_doc_checker".equals(event)) { // OFFICE
																												// Comment
		...
		if ("cancel_checklist_item".equals(event) || "close_checklist_item".equals(event) || "to_track".equals(event)
				|| "track_refresh_comment".equals(event)||"search_security_doc_checker_close".equals(event)
				||"search_security_doc_maker_close".equals(event)) {// OFFICE
		...
		if ("view".equals(event) || "view_return".equals(event)||CHECKER_SEARCH_SECURITY_DOC.equals(event)
				||"checker_search_security_doc".equals(event)||"view_return_to_track".equals(event)) {
		...
		if ("reject_checklist_item_error".equals(event)) {
			...
			forwardName = "downloadImage";
		 ...
		 else if (EVENT_RETRIEVE_INDVDL_IMAGE_SEC_DOC.equals(event)) {
				forwardName = "imagePath";
			} else if (EVENT_RETRIEVE_IMAGE_GALLARY_SEC_DOC.equals(event) ) {
				forwardName = "image_gallary";
			}else if ("retrieveImageTagUntagSecReceipt".equals(event) || "retrieveIndImageTagUntagSecReceiptPath".equals(event) ) {
				forwardName = "image_gallary_sec_receipt_imgtaguntag";
				...
				//forwardName = "after_securityreceipt_image_tag_untag_submit";
				forwardName = "after_RECEIVE";
			...
			else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_SECURITY.equals(event)) {
				forwardName = EVENT_RETRIEVE_IMAGE_GALLERY_CHK_SECURITY;
			}
			else if (EVENT_RETRIEVE_INDVDL_IMAGE_SECURITY.equals(event) || EVENT_RETRIEVE_MIG_INDVDL_IMAGE_SECURITY.equals(event) ||
					EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_SECURITY.equals(event)) {
			forwardName = "imagePath";
			
		} else if (EVENT_RETRIEVE_IMAGE_GALLARY_SECURITY.equals(event) || EVENT_RETRIEVE_MIG_IMAGE_GALLARY_SECURITY.equals(event)) {
			forwardName = "image_gallary";
		}
		else if(EVENT_PREPARE_TAG_UNTAG_IMAGE.equals(event) || EVENT_PREPARE_TAG_UNTAG_IMAGE_FROM_RETRIEVE.equals(event)) {
			forwardName = EVENT_PREPARE_TAG_UNTAG_IMAGE;
		...
		else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_SECURITY_CHECKER_VIEW.equals(event)) {
			forwardName = EVENT_RETRIEVE_IMAGE_GALLERY_CHK_SECURITY_CHECKER_VIEW;
		}
