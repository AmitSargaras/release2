 ...
 */
public class CheckerViewSecurityReceiptCommand extends AbstractCommand implements ICommonEventConstant, ITagUntagImageConstant {
	/**
	 * Default Constructor
	 */
	public CheckerViewSecurityReceiptCommand() {
	}
