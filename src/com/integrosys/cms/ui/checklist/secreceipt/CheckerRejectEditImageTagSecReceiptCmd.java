 ...
 * 
 */
public class CheckerRejectEditImageTagSecReceiptCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectEditImageTagSecReceiptCmd() {
	}
...
//	            String event = (String) map.get("event");
				...
				if(trxds1.equals(trxhistId)) {
					...
					System.out.println("CheckerRejectEditImageSecReceiptcmd => statusOfTrxImage=>"+statusOfTrxImage+" instance=>"+instance+" trxIdofimagetag=>"+trxhistId);
				}else {
