 ...
 */
public class CheckerReadImageTagSecReceiptCmd extends AbstractCommand implements
	 ...
	 * Default Constructor
	 */
	public CheckerReadImageTagSecReceiptCmd() {
	}
...
//				imageCode = String.valueOf((Long.valueOf(custTypeTrxID) - 1));
			...
			if(imageCode!=null){
				System.out.println("CheckerReadImageTagSecReceiptCmd.java  imageCode=>"+imageCode);
...
//				throw (new ImageTagException("Image Code is null "));
	...
	private String getTrxIdforImageTag(String trxIdOfSecReceipt) {
		...
		String sql = "SELECT CUR_TRX_HISTORY_ID FROM TRANSACTION WHERE TRANSACTION_ID = '"+trxIdOfSecReceipt+"'";
