 ...
 */
public class ListSecurityReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ListSecurityReceiptCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// proxy.getCollateralCheckListSummaryList(theOBTrxContext,
			// limitProfileID);
			...
			// DefaultLogger.debug(this, "Summary size" + colChkLst.length);
