 ...
 */
public class ApproveAnnexureCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			checkListTrxVal = getRecurrentProxyManager().checkerApproveCheckListAnnexure(ctx, checkListTrxVal);
		}
