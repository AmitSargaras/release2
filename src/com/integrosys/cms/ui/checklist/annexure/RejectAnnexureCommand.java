 ...
 */
public class RejectAnnexureCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		if(remark == null || remark.equals("")){
        	...
        	resultMap.put("IRecurrentCheckListTrxValue", trxValue);
		...
		try {
			checkListTrxVal = getRecurrentProxyManager().checkerRejectAnnexureCheckList(ctx, checkListTrxVal);
		}
