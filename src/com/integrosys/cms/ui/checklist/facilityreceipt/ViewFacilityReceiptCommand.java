 ...
 */
public class ViewFacilityReceiptCommand extends AbstractCommand implements ICommonEventConstant,ITagUntagImageConstant {
	/**
	 * Default Constructor
	 */
	public ViewFacilityReceiptCommand() {
	}
