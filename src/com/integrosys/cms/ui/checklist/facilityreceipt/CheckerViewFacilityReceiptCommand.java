 ...
 */
public class CheckerViewFacilityReceiptCommand extends AbstractCommand implements ICommonEventConstant, ITagUntagImageConstant {
	/**
	 * Default Constructor
	 */
	public CheckerViewFacilityReceiptCommand() {
	}
