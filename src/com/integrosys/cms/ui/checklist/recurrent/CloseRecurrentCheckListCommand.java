 ...
 * @since $Date: 2005/09/07 10:58:41 $ Tag: $Name: $
 */
public class CloseRecurrentCheckListCommand extends AbstractCommand {
	 ...
	 * Default Constructor
	 */
	public CloseRecurrentCheckListCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			checkListTrxVal = getRecurrentProxyManager().makerCloseCheckListTrx(ctx, checkListTrxVal);
