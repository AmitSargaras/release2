 ...
 * @since $Date: 2005/09/07 11:06:12 $ Tag: $Name: $
 */
public class RejectRecurrentCheckListCommand extends AbstractCommand {
	 ...
	 * Default Constructor
	 */
	public RejectRecurrentCheckListCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			checkListTrxVal = getRecurrentProxyManager().checkerRejectCheckList(ctx, checkListTrxVal);
