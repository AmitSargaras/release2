 ...
 * @since $Date: 2005/09/07 10:57:20 $ Tag: $Name: $
 */
public class ApproveRecurrentCheckListCommand extends AbstractCommand {
	 ...
	 * Default Constructor
	 */
	public ApproveRecurrentCheckListCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			checkListTrxVal = getRecurrentProxyManager().checkerApproveCheckList(ctx, checkListTrxVal);
