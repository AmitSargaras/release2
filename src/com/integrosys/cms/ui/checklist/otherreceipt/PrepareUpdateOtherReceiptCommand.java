...
import static com.integrosys.cms.app.common.constant.ICMSConstant.LONG_INVALID_VALUE;
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if(checkListID != com.integrosys.cms.app.common.constant.ICMSConstant.LONG_INVALID_VALUE){
				...
				if(StringUtils.isNotBlank(checkListTrxVal.getStagingReferenceID())) {
					Long stagingChecklistId = Long.valueOf(checkListTrxVal.getStagingReferenceID());
					if(stagingChecklistId.longValue() != LONG_INVALID_VALUE)
						collateralTypeMap = checklistJdbc.getChecklistItemsCollateralType(stagingChecklistId);
				}
			}
