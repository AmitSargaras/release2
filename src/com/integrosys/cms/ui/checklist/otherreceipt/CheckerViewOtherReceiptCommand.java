 ...
 */
public class CheckerViewOtherReceiptCommand extends AbstractCommand implements ICommonEventConstant, ITagUntagImageConstant {
	/**
	 * Default Constructor
	 */
	public CheckerViewOtherReceiptCommand() {
	}
