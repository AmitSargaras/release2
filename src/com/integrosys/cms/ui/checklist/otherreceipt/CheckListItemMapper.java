...
public class CheckListItemMapper extends AbstractCommonMapper {
	...
	public Object mapFormToOB(CommonForm cForm, HashMap map) throws MapperException {
		...
		OtherReceiptForm aForm = (OtherReceiptForm) cForm;
...
//				temp.setItemStatus(aForm.getDocumentStatus());
		...
		if (OtherReceiptAction.EVENT_REFRESH_SHARE_CHECKLIST.equals(event)) {
...
//			}
		...
		if (obj != null) {
			...
			if(tempOb.getTenureType()!=null)
				...
				if(!tempOb.getDocAmt().equals(""))
					aForm.setDocAmt(UIUtil.formatWithCommaAndDecimalNew(String.valueOf(tempOb.getDocAmt())));
				
				if(tempOb.getHdfcAmt()!=null)
				if(!tempOb.getHdfcAmt().equals(""))
					aForm.setHdfcAmt(UIUtil.formatWithCommaAndDecimalNew(String.valueOf(tempOb.getHdfcAmt())));
	...
	private IShareDoc[] getIShareDocFormToOB(OtherReceiptForm aForm) {
