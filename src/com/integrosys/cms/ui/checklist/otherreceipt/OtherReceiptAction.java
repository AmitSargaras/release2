 ...
 */
public class OtherReceiptAction extends CommonAction {
    ...
    public static final String EVENT_RETRIEVE_IMAGE_GALLARY_OTHER = "retrieveImageGallaryOtherDoc";
	public static final String EVENT_RETRIEVE_INDVDL_IMAGE_OTHER = "retrieveIndividualImageOtherDoc";
	
	public static final String EVENT_RETRIEVE_MIG_IMAGE_GALLARY_OTHER = "retrieveMigImageGallaryOtherDoc";
	public static final String EVENT_RETRIEVE_MIG_INDVDL_IMAGE_OTHER = "retrieveMigIndividualImageOtherDoc";
	public final static String SEARCH_OTHER_DOC = "search_other_doc";
	public final static String CHECKER_SEARCH_OTHER_DOC = "checker_search_other_doc";
	...
	public final static String EVENT_RETRIEVE_IMAGE_GALLERY_CHK_OTHER_CHECKER_VIEW = "retrieve_image_gallery_chk_other_checker_view";
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_REFRESH_SHARE_CHECKLIST.equals(event)) {
			...
			objArray[0] = new ListOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("cust_list".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ListFilteredOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("prepare_update".equals(event) || "view".equals(event)||SEARCH_OTHER_DOC.equals(event)
				||CHECKER_SEARCH_OTHER_DOC.equals(event)||"checker_search_other_doc".equals(event)) {
			objArray = new ICommand[3];
			...
			objArray[2] = new PrepareCommand();
                ...
                || "DISCREPANCY".equals(event)) {        // bernard
																								// -
																								// added
																								// ALLOW_RELODGE
																								// ,
			...
			objArray = new ICommand[2];
			objArray[0] = new SaveOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new SubmitOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
				...
				||"search_other_doc_checker".equals(event)||"search_other_doc_checker_close".equals(event)
				||"search_other_doc_checker_process".equals(event)||"search_other_doc_maker_close".equals(event)) { // OFFICE
			objArray = new ICommand[3];
			...
			objArray = new ICommand[2];
			objArray[0] = new RefreshOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("close".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new CloseOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
			...
			objArray = new ICommand[2];
			objArray[0] = new ApproveOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("reject_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new RejectOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		// Begin of OFFICE
		else if ("forward_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ForwardOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		// End of OFFICE
			...
			objArray[0] = new FrameFlagSetterCommand();             
				...
				|| "refresh_share_checklist_prepare".equals(event)|| "save_discrepancy_prepare".equals(event) || EVENT_PREPARE_TAG_UNTAG_IMAGE_ERROR.equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new PrepareCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
			...
			objArray = new ICommand[3];
			objArray[0] = new PrepareCommand();
			objArray[1] = new CheckerViewOtherReceiptCommand();
			objArray[2] = new FrameFlagSetterCommand();
		}
		else if ("view_receipt".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new ViewOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
...
//            objArray[1] = new FrameFlagSetterCommand();
		  ...
		  else if (event.equals(EVENT_RETRIEVE_IMAGE_GALLARY_OTHER) || event.equals(EVENT_RETRIEVE_INDVDL_IMAGE_OTHER) ) {
				objArray = new ICommand[1];
				objArray[0] = new RetriveImageCommand();
			}
		  else if ( event.equals(EVENT_RETRIEVE_MIG_IMAGE_GALLARY_OTHER) || event.equals(EVENT_RETRIEVE_MIG_INDVDL_IMAGE_OTHER) ) {
				objArray = new ICommand[1];
				objArray[0] = new RetriveMigImageCommand();
		...
		else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_OTHER.equals(event) || EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_OTHER.equals(event) || EVENT_RETRIEVE_IMAGE_GALLERY_CHK_OTHER_CHECKER_VIEW.equals(event)) {
			objArray = new ICommand[2];
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return OtherReceiptFormValidator.validateInput((OtherReceiptForm) aForm, locale);
		// return
	...
	protected boolean isValidationRequired(String event) {
		...
		if ("save_remind".equals(event) || "save_receive".equals(event) || "save_waiver_req".equals(event)
                ...
                ||  "save_discrepancy".equals(event) || EVENT_PREPARE_TAG_UNTAG_IMAGE.equals(event)) {
	...
	private String getReference(String event) {
		...
		if ("prepare_update".equals(event) || "save_remind".equals(event) || "undo".equals(event)
				...
				|| "save_update_narration".equals(event) || "save_update_renewal".equals(event)
				|| "save_temp_uplift".equals(event) || "save_perm_uplift".equals(event) || "save_delete".equals(event)
				|| "view_ok".equals(event) || "edit".equals(event)|| "maker_refresh_comment".equals(event) || "save_relodge".equals(event) || "save_redeem".equals(event)
                || EVENT_PREPARE.equals(event) || EVENT_EXPRESS_COMPLETION.equals(event)||SEARCH_OTHER_DOC.equals(event)
                ||"version".equals(event)||"conform_inactive".equals(event)
                || "save_discrepancy".equals(event)) {                                           // priya
																							// -
																							// added
																							// save_update_renewal
																							// for
		...
		if("edit_staging_checklist_item".equals(event)||"search_other_doc_checker_process".equals(event)){
		...
		if ("process".equals(event) || "refresh_comment".equals(event) || "chk_view_return".equals(event)
				||"search_other_doc_checker".equals(event)) { // OFFICE
																												// Comment
		...
		if ("cancel_checklist_item".equals(event) || "close_checklist_item".equals(event) || "to_track".equals(event)
				|| "track_refresh_comment".equals(event)||"search_other_doc_checker_close".equals(event)
				||"search_other_doc_maker_close".equals(event)) {// OFFICE
		...
		if ("view".equals(event) || "view_return".equals(event)||CHECKER_SEARCH_OTHER_DOC.equals(event)
				||"checker_search_other_doc".equals(event)||"view_return_to_track".equals(event)) {
		...
		if ("retrieveImage".equals(event)) {
		 ...
		 if (EVENT_RETRIEVE_INDVDL_IMAGE_OTHER.equals(event)  || EVENT_RETRIEVE_MIG_INDVDL_IMAGE_OTHER.equals(event) ||
				 EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_OTHER.equals(event)) {
			forwardName = "imagePath";
			
		} 
		 if (EVENT_RETRIEVE_IMAGE_GALLARY_OTHER.equals(event) ||  EVENT_RETRIEVE_MIG_IMAGE_GALLARY_OTHER.equals(event)) {
		...
		else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_OTHER.equals(event)) {
			forwardName = EVENT_RETRIEVE_IMAGE_GALLERY_CHK_OTHER;
		}
		...
		else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_OTHER_CHECKER_VIEW.equals(event)) {
			forwardName = EVENT_RETRIEVE_IMAGE_GALLERY_CHK_OTHER_CHECKER_VIEW;
		}
