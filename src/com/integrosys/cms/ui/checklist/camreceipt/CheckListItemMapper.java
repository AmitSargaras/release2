...
public class CheckListItemMapper extends AbstractCommonMapper {
	...
	public Object mapFormToOB(CommonForm cForm, HashMap map) throws MapperException {
		...
		CAMReceiptForm aForm = (CAMReceiptForm) cForm;
		...
		DefaultLogger.debug(this, ">>>>>>>>>>>.............. STATUS " + aForm.getItemStatus());
...
//				temp.setItemStatus(aForm.getDocumentStatus());
		...
		if (CAMReceiptAction.EVENT_REFRESH_SHARE_CHECKLIST.equals(event)) {
		...
		if ("save_receive".equals(event) || aForm.getAwaiting().equals("true") || CAMReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE.equals(event)) {
...
//			}
	...
	public CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap map) throws MapperException {
		...
		if (obj != null) {
			...
			aForm.setItemStatus(tempOb.getItemStatus());																				// cr
																							// 36
	...
	private IShareDoc[] getIShareDocFormToOB(CAMReceiptForm aForm) {
