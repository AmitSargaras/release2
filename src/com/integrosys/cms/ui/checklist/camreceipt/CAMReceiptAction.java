 ...
 */
public class CAMReceiptAction extends CommonAction {
    ...
    public final static String EVENT_EXPRESS_COMPLETION = "express_complete";
     public final static String EVENT_SEARCH_CAM_NO = "search_cam_no";
    public static final String EVENT_RETRIEVE_IMAGE_GALLARY_CAM = "retrieveImageGallaryCAMDoc";
	public static final String EVENT_RETRIEVE_INDVDL_IMAGE_CAM = "retrieveIndividualImageCAMDoc";
	   ...
	   public static final String EVENT_RETRIEVE_MIG_IMAGE_GALLARY_CAM = "retrieveMigImageGallaryCAMDoc";
		...
		public final static String SEARCH_CAM_DOC = "search_cam_doc";
		...
		public final static String EVENT_RETRIEVE_IMAGE_GALLERY_CHK_CAM = "retrieve_image_gallery_chk_cam";
		public final static String EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK = "retrieve_individual_image_chk";
		public final static String EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_CAM = "retrieve_individual_image_chk_cam";
		...
		public final static String EVENT_RETRIEVE_IMAGE_GALLERY_CHK_CAM_CHECKER_VIEW = "retrieve_image_gallery_chk_cam_checker_view";
		public final static String EVENT_PREPARE_TAG_UNTAG_IMAGE_FROM_RETRIEVE_VIEW = "prepare_retrieve_tag_untag_image_view";
		public final static String EVENT_RETRIEVE_IMAGE_GALLERY_CHK = "retrieve_image_gallery_chk";
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_REFRESH_SHARE_CHECKLIST.equals(event)) {
		...
		else if ("list".equals(event)||EVENT_SEARCH_CAM_NO.equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ListCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("cust_list".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ListFilteredCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("prepare_update".equals(event) || "view".equals(event)||"view2".equals(event)
				||SEARCH_CAM_DOC.equals(event)||"checker_search_cam_doc".equals(event)||"view_back".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new PrepareUpdateCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
                ...
                || "VIEW_PENDING_RELODGE".equals(event)
                ||"prepare_inactive".equals(event)) {        // bernard
																								// -
																								// added
																								// ALLOW_RELODGE
																								// ,
			...
			objArray = new ICommand[2];
			objArray[0] = new SaveCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new SubmitCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
				...
				||"search_cam_doc_checker".equals(event)||"search_cam_doc_checker_close".equals(event)||"search_cam_doc_checker_process".equals(event)
				||"search_cam_doc_maker_close".equals(event)||"search_cam_doc_view".equals(event)) { // OFFICE
			objArray = new ICommand[3];
			objArray[0] = new ReadStagingCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
		else if ("refresh_comment".equals(event) || "chk_view_return".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new RefreshCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("close".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new CloseCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("cancel".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new CancelCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("approve_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ApproveCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("reject_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new RejectCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		// Begin of OFFICE
		else if ("forward_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ForwardCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		// End of OFFICE
			...
			objArray[0] = new FrameFlagSetterCommand();            
				...
				|| "refresh_share_checklist_prepare".equals(event) || EVENT_PREPARE_TAG_UNTAG_IMAGE_ERROR.equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new PrepareCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
			...
			objArray = new ICommand[3];
			objArray[0] = new PrepareCommand();
			objArray[1] = new CheckerViewCAMReceiptCommand();
			objArray[2] = new FrameFlagSetterCommand();
		}
		else if ("view_receipt".equals(event)||"view_receipt_img".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new ViewCAMReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
            ...
            objArray[1] = new FrameFlagSetterCommand();
        		...
        		||"view_image_page_to_do_process".equals(event)||"view_image_page2".equals(event)) {
            objArray = new ICommand[1];
...
//            objArray[1] = new FrameFlagSetterCommand();
        ...
        else if (event.equals(EVENT_RETRIEVE_MIG_IMAGE_GALLARY_CAM) || event.equals(EVENT_RETRIEVE_MIG_INDVDL_IMAGE_CAM)) {
			objArray = new ICommand[1];
...
//            objArray[1] = new FrameFlagSetterCommand();
			...
			objArray = new ICommand[3];
			objArray[0] = new VersionCAMReceiptCommand();
	...
	else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_CAM.equals(event) || EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_CAM.equals(event) || EVENT_RETRIEVE_IMAGE_GALLERY_CHK_CAM_CHECKER_VIEW.equals(event)) {
		objArray = new ICommand[2];
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return CAMReceiptFormValidator.validateInput((CAMReceiptForm) aForm, locale);
		// return
	...
	private String getReference(String event) {
		...
		if ("list".equals(event)||EVENT_SEARCH_CAM_NO.equals(event)) {
		...
		if ("prepare_update".equals(event) || "save_remind".equals(event) || "undo".equals(event)
                ...
                || EVENT_PREPARE.equals(event) || EVENT_EXPRESS_COMPLETION.equals(event)||SEARCH_CAM_DOC.equals(event)
                ||"conform_inactive".equals(event)||"version".equals(event)) {                                           // priya
																							// -
																							// added
																							// save_update_renewal
																							// for
		...
		if("edit_staging_checklist_item".equals(event)||"search_cam_doc_checker_process".equals(event)){
		...
		if ("process".equals(event) || "refresh_comment".equals(event) || "chk_view_return".equals(event)
				||"search_cam_doc_checker".equals(event)) { // OFFICE
																												// Comment
		...
		if ("cancel_checklist_item".equals(event) || "close_checklist_item".equals(event) || "to_track".equals(event)
				|| "track_refresh_comment".equals(event)||"search_cam_doc_checker_close".equals(event)||"search_cam_doc_maker_close".equals(event)) {// OFFICE
		...
		if ("view".equals(event) || "view_return".equals(event)||"checker_search_cam_doc".equals(event)||"view_return_to_track".equals(event)
				||"view_back".equals(event)||"view2".equals(event)) {
			forwardName = "after_view";
		}
		if("search_cam_doc_view".equals(event)){
			forwardName = "search_view";
		}
		...
		if ("view_image_page".equals(event)||"view_image_page2".equals(event)) {
		...
		if ("reject_checklist_item_error".equals(event)) {
			...
			forwardName = "downloadImage";
					...
					EVENT_RETRIEVE_INDIVIDUAL_IMAGE_CHK_CAM.equals(event)) {
			forwardName = "imagePath";
		...
		else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_CAM.equals(event)) {
			forwardName = EVENT_RETRIEVE_IMAGE_GALLERY_CHK_CAM;
		}
		...
		else if(EVENT_RETRIEVE_IMAGE_GALLERY_CHK_CAM_CHECKER_VIEW.equals(event)) {
			forwardName = EVENT_RETRIEVE_IMAGE_GALLERY_CHK_CAM_CHECKER_VIEW;
		}
