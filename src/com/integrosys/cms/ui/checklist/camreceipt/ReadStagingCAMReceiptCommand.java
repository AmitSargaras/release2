 ...
 */
public class ReadStagingCAMReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ReadStagingCAMReceiptCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if ("close_checklist_item".equals(event)||"search_cam_doc_checker_close".equals(event)) {
