 ...
 */
public class PrepareUpdateCAMReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public PrepareUpdateCAMReceiptCommand() {
	}
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] { { "checkListID", "java.lang.String", REQUEST_SCOPE },
				...
				{ "isLatest", "java.lang.String", REQUEST_SCOPE },		
		});
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "checkList", "com.integrosys.cms.app.checklist.bus.ICheckList", SERVICE_SCOPE },
				...
				{ "checkListID", "java.lang.String", SERVICE_SCOPE },
				{ "session.camNo", "java.lang.String", SERVICE_SCOPE },
				...
				{ "isLatest", "java.lang.String", SERVICE_SCOPE },		
		});
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if(null == tCheckListID || "".equalsIgnoreCase(tCheckListID) || "null".equalsIgnoreCase(tCheckListID)){
			...
			String isLatest = (String) map.get("isLatest");
			resultMap.put("isLatest", isLatest);
			ICheckList checkList = null;
			/*if(null!=map.get("session.checkList")){
				try {
					checkList=(ICheckList)com.integrosys.cms.app.common.util.CommonUtil.deepClone((ICheckList) map.get("session.checkList"));
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
...
//			ICheckListTrxValue checkListTrxVal = proxy.getCheckList(checkListID);
			...
			if ((ICMSConstant.HAS_PENDING_CHECKLIST_TRX == wip) && (event != null) && event.equals("prepare_update")) {
                ...
                resultMap.put("session.checkListID", checkListID+"");
