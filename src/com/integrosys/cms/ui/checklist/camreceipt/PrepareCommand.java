...
public class PrepareCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "actionPartyLabels", "java.util.Collection", REQUEST_SCOPE },
				...
				{ "rocChargeList", List.class.getName() , SERVICE_SCOPE },
				{"event", "java.lang.String", REQUEST_SCOPE}
		});
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, "Inside doExecute() AND EVENT IS "+event);
				...
				resultMap.put("rocChargeList", getYesNoDDL());
	...
	/*This method will return currency list*/
	...
	private List getYesNoDDL() {
		List<LabelValueBean> lbValList = new ArrayList<LabelValueBean>();
		lbValList.add(new LabelValueBean("Yes", ICMSConstant.YES));
		lbValList.add(new LabelValueBean("No",ICMSConstant.NO));
		return lbValList;
	}
