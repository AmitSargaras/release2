...
import com.integrosys.cms.ui.checklist.LADreceipt.RetriveImageCommand;
import com.integrosys.cms.ui.checklist.camreceipt.DownloadImageCommand;
import com.integrosys.cms.ui.genlad.ViewImageDocCommand;
import com.integrosys.cms.ui.genlad.ViewLADCommand;
 ...
 */
public class LADReceiptAction extends CommonAction {
    ...
    public static final String EVENT_RETRIEVE_IMAGE_GALLARY_LAD = "retrieveImageGallaryLADDoc";
    public static final String REJECT_RETRIEVE_IMAGE_GALLARY_LAD = "rejectImageGallaryLADDoc";
    public static final String CHECKER_RETRIEVE_IMAGE_GALLARY_LAD = "chkImageGallaryLADDoc";
	public static final String EVENT_RETRIEVE_INDVDL_IMAGE_LAD = "retrieveIndividualImageLADDoc";
	 public static final String EVENT_CLOSE_IMAGE_GALLARY_LAD = "closeImageGallaryLADDoc";
	 public static final String EVENT_RETRIEVE_LAD_IMAGE = "retrieveLADDocImage";
	 public static final String TO_TRACK_IMAGE_LAD = "toTrackImageLADDoc";
	 public static final String CHK_RETRIEVE_IMAGE_LAD = "chkretrieveImageLADDoc";
	 public static final String MAKER_PROCESS_IMAGE_LAD = "makerProcessImageLADDoc";
	 public static final String MAKER_CLOSE_IMAGE_LAD = "makerretrieveImageLADDoc";
	 public static final String CHK_VIEW_REJECT_IMG = "chk_view_reject_img";
	 public static final String CHK_VIEW_APPROVE_IMG = "chk_view_approve_img";
	 public static final String CHK_VIEW_PROCESS_IMG = "chk_view_process_image";
	 public static final String MKR_VIEW_TOTRACK_IMG = "mkr_view_totrack_img";
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_REFRESH_SHARE_CHECKLIST.equals(event)) {
			...
			objArray[0] = new ListLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("cust_list".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ListFilteredLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}else if (event.equals("downloadImage")) {
			objArray = new ICommand[1];
			objArray[0] = new DownloadImageCommand();
			...
			objArray = new ICommand[3];
			objArray[0] = new PrepareUpdateLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			...
			objArray = new ICommand[2];
			objArray[0] = new SaveLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new SubmitLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
				...
				||"return_process".equals(event)||"maker_return_process".equals(event)||"maker_return_todo_process".equals(event)
				||"maker_return_to_track".equals(event)||"checker_return_to_track".equals(event)
				||"return_close_draft".equals(event)||"return_process_draft".equals(event)) { // OFFICE
			objArray = new ICommand[3];
			objArray[0] = new ReadStagingLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
		else if ("refresh_comment".equals(event) || "chk_view_return".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new RefreshLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("close".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new CloseLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("cancel".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new CancelOtherReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("approve_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ApproveLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("reject_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new RejectLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		// Begin of OFFICE
		else if ("forward_checklist_item".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ForwardLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		// End of OFFICE
			...
			objArray = new ICommand[3];
			objArray[0] = new PrepareCommand();
			objArray[1] = new CheckerViewLADReceiptCommand();
			objArray[2] = new FrameFlagSetterCommand();
		}
		else if ("view_receipt".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new ViewLADReceiptCommand();
			objArray[1] = new FrameFlagSetterCommand();
			objArray[2] = new PrepareCommand();
		}
        ...
        else if("view_image_page".equals(event)||"checker_view_attach_image".equals(event)||"view_process_image_page".equals(event)
        		||"maker_totrack_view_image".equals(event)||"checker_totrack_view_image".equals(event)||"close_draft_view_image".equals(event)
        		||"process_draft_view_image".equals(event)||"draft_lad_img".equals(event)||"draft_lad_process_img".equals(event)) {
            objArray = new ICommand[1];
...
//            objArray[1] = new FrameFlagSetterCommand();
        ...
        else if (event.equals(EVENT_RETRIEVE_IMAGE_GALLARY_LAD) || event.equals(EVENT_RETRIEVE_INDVDL_IMAGE_LAD)
        		|| event.equals(CHECKER_RETRIEVE_IMAGE_GALLARY_LAD)||event.equals(REJECT_RETRIEVE_IMAGE_GALLARY_LAD)
        		||event.equals(EVENT_CLOSE_IMAGE_GALLARY_LAD)|| event.equals(EVENT_RETRIEVE_LAD_IMAGE)
        		||event.equals(TO_TRACK_IMAGE_LAD)||event.equals(CHK_RETRIEVE_IMAGE_LAD)||event.equals(CHK_VIEW_APPROVE_IMG)
        		||event.equals(MAKER_PROCESS_IMAGE_LAD)||event.equals(MAKER_CLOSE_IMAGE_LAD)||event.equals(CHK_VIEW_REJECT_IMG)
        		||event.equals("closeToTrackImage")||event.equals("mkr_view_draft_close")||event.equals("mkr_view_draft_process")) {
			objArray = new ICommand[1];
			objArray[0] = new RetriveImageCommand();
		}
        else if ("prepare_view_lad".equals(event)||"prepare_view_lad_view".equals(event)||"prepare_checker_view_lad".equals(event)
        		||"prepare_view_process_lad".equals(event)||"prepare_totrack_view_lad".equals(event)||"checker_totrack_view_lad".equals(event)
        		||"draft_close_view_lad".equals(event)||"draft_process_view__lad".equals(event)||"return_checker_view_lad".equals(event)
        		||"return_totrack_view_lad".equals(event)||"prepare_view_process_lad_image".equals(event)
        		||"return_draft_process_view__lad".equals(event)||"return_draft_close_view_lad".equals(event)
        		||"prepare_totrack_view_lad_return".equals(event)||"prepare_view_lad_doc".equals(event)
        		||"prepare_view_process_lad_doc".equals(event)) {
			objArray = new ICommand[1];
			objArray[0] =new ViewLADCommand();
		}else if ("print_image".equals(event) || "view_image".equals(event)) {
			objArray = new ICommand[1];
			objArray[0] = new ImageTagResultPrintCommand();
		}else if ("view_attach_image".equals(event)||"view_attach_image_process".equals(event)||"view_attach_image_reject".equals(event)
				||"view_attach_lad_image".equals(event)||"view_close_image_draft".equals(event)||"view_process_image_draft".equals(event)
				||"view_attach_lad_process_image".equals(event)||"view_attach_image_close".equals(event)||"mkr_view_totrack_img".equals(event)) {
			objArray = new ICommand[1];
			objArray[0] = new ViewImageDocCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return LADReceiptFormValidator.validateInput((LADReceiptForm) aForm, locale);
		// return
	...
	private String getReference(String event) {
		...
		if ("prepare_update".equals(event) || "save_remind".equals(event) || "undo".equals(event)
                ...
                || EVENT_PREPARE.equals(event) || EVENT_EXPRESS_COMPLETION.equals(event)||"return_process_draft".equals(event)) {                                           // priya
		...
		if ("process".equals(event) || "refresh_comment".equals(event) || "chk_view_return".equals(event)
				||"return_process".equals(event)) { // OFFICE
																												// Comment
		...
		if ("cancel_checklist_item".equals(event) || "close_checklist_item".equals(event) || "to_track".equals(event)
				|| "track_refresh_comment".equals(event)||"maker_return_process".equals(event)||"maker_return_to_track".equals(event)
				||"checker_return_to_track".equals(event)||"return_close_draft".equals(event)) {// OFFICE
			forwardName = "after_close_checklist_item";
		}
		if ("maker_return_todo_process".equals(event)) {
			forwardName = "maker_return_todo_process";
		}
		...
		if ("view_process_image_page".equals(event)) {
			forwardName = "view_process_image_page";
		}
		...
		if ("prepare_view_lad".equals(event)||"prepare_view_lad_doc".equals(event)) {
			forwardName = "prepare_view_lad";
		}if ("prepare_view_process_lad".equals(event)||"prepare_view_process_lad_image".equals(event)||"prepare_view_process_lad_doc".equals(event)) {
			forwardName = "prepare_view_process_lad";
		}
		if ("prepare_totrack_view_lad".equals(event)||"checker_totrack_view_lad".equals(event)||"return_totrack_view_lad".equals(event)
				||"prepare_totrack_view_lad_return".equals(event)) {
			forwardName = "prepare_totrack_view_lad";
		}if ("draft_close_view_lad".equals(event)||"draft_process_view__lad".equals(event)||"return_draft_close_view_lad".equals(event)
				||"return_draft_process_view__lad".equals(event)) {
			forwardName = "draft_close_view_lad";
		}
		if ("view_attach_image".equals(event)) {
			forwardName = "view_attach_image";
		}if ("view_attach_image_process".equals(event)||"view_attach_image_reject".equals(event)||"view_attach_image_close".equals(event)) {
			forwardName = "view_attach_image_process";
		}if ("view_attach_image_reject".equals(event)) {
			forwardName = "view_attach_image_reject";
		}if ("mkr_view_totrack_img".equals(event)) {
			forwardName = "mkr_view_totrack_img";
		}
		if("prepare_checker_view_lad".equals(event)||"return_checker_view_lad".equals(event)){
			forwardName = "prepare_checker_view_lad";
		}if("checker_view_attach_image".equals(event)){
			forwardName = "checker_view_attach_image";
		}if("maker_totrack_view_image".equals(event)||"checker_totrack_view_image".equals(event)){
			forwardName = "maker_totrack_view_image";
		}if("close_draft_view_image".equals(event)||"process_draft_view_image".equals(event)){
			forwardName = "close_draft_view_image";
		}if("view_attach_lad_image".equals(event)){
			forwardName = "view_attach_lad_image";
		}if("view_close_image_draft".equals(event)||"view_process_image_draft".equals(event)){
			forwardName = "view_close_image_draft";
		}if("view_attach_lad_process_image".equals(event)){
			forwardName = "view_attach_lad_process_image";
		}if("draft_lad_img".equals(event)||"draft_lad_process_img".equals(event)){
			forwardName = "draft_lad_img";
		}
		if ("prepare_view_lad_view".equals(event)) {
			forwardName = "prepare_view_lad_view";
		}else if ("downloadImage".equals(event)) {
			forwardName = "downloadImage";
		}
		else if (EVENT_RETRIEVE_INDVDL_IMAGE_LAD.equals(event)) {
			forwardName = "imagePath";
		} else if (EVENT_RETRIEVE_IMAGE_GALLARY_LAD.equals(event) ) {
			forwardName = "image_gallary";
		}else if (CHK_VIEW_REJECT_IMG.equals(event) ) {
			forwardName = "chk_view_reject_img";
		}else if (CHK_VIEW_APPROVE_IMG.equals(event) ) {
			forwardName = "chk_view_approve_img";
		}
		else if ("mkr_view_draft_close".equals(event) ) {
			forwardName = "mkr_view_draft_close";
		}else if ("mkr_view_draft_process".equals(event) ) {
			forwardName = "mkr_view_draft_process";
		}
		else if (CHECKER_RETRIEVE_IMAGE_GALLARY_LAD.equals(event) ) {
			forwardName = "chk_image_gallary";
		}else if (REJECT_RETRIEVE_IMAGE_GALLARY_LAD.equals(event) ) {
			forwardName = "reject_image_gallary";
		}else if (EVENT_CLOSE_IMAGE_GALLARY_LAD.equals(event)||"closeToTrackImage".equals(event) ) {
			forwardName = "close_image_gallary";
		}else if (EVENT_RETRIEVE_LAD_IMAGE.equals(event) ) {
			forwardName = "lad_image_gallary";
		}else if (TO_TRACK_IMAGE_LAD.equals(event) ) {
			forwardName = "to_track_lad_image_gallary";
		}else if (CHK_RETRIEVE_IMAGE_LAD.equals(event) ) {
			forwardName = "approve_lad_image_gallary";
		}else if (MAKER_PROCESS_IMAGE_LAD.equals(event) ) {
			forwardName = "process_lad_image_gallary";
		}else if (MAKER_CLOSE_IMAGE_LAD.equals(event) ) {
			forwardName = "close_lad_image_gallary";
		}
