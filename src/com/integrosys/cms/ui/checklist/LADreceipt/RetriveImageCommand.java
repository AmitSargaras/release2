	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		imagePath="C:\\Documents and Settings\\All Users\\Documents\\My Pictures\\Sample Pictures"+"\\"+imageName;
			...
			try {
				...
				params[1] = imageName;
				params[2] = status;
				ContentManagerFactory managerFactory=(ContentManagerFactory)BeanHouse.get("contentManagerFactory");
				//imagePath=(String)managerFactory.getContentManagerService().retrieveDocument(params);
				
				if(null == img.getHCPStatus() || img.getHCPStatus().equals("N")) {
					imagePath=(String)managerFactory.getContentManagerService().retrieveDocument(params);
					}else {
						System.out.println("inSide HTC..........");
						imagePath=(String)managerFactory.getContentManagerService().get(img.getHCPFileName(),String.valueOf(img.getStatus()));
