 ...
 * @since $Date: 2005/09/07 11:07:43 $ Tag: $Name: $
 */
public class SaveRecurrentReceiptCommand extends AbstractCommand {
	 ...
	 * Default Constructor
	 */
	public SaveRecurrentReceiptCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		// DefaultLogger.debug(this, "Selected Items to remind" +
		// reminderIndex);
		...
		try {
			checkListTrxVal = getRecurrentProxyManager().makerSaveCheckListReceipt(ctx, checkListTrxVal, recChkLst);
		}
		catch (RecurrentException ex) {
			throw new CommandProcessingException("failed to save checklist receipt workflow", ex);
		}
