 ...
 */
public class CheckerViewRecurrentDocReceiptCommand extends AbstractCommand implements ICommonEventConstant, ITagUntagImageConstant {
	/**
	 * Default Constructor
	 */
	public CheckerViewRecurrentDocReceiptCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			String taggedFileNames = CheckListHelper.getTagUntaggedFileNameList(imageIdUnTaggedStatusMap, staging.getCheckListItemImageDetail(), true);
			String unTaggedFileNames = CheckListHelper.getTagUntaggedFileNameList(imageIdUnTaggedStatusMap, staging.getCheckListItemImageDetail(), false);
