 ...
 */
public class ViewRecurrentDocReceiptCommand extends AbstractCommand implements ICommonEventConstant, ITagUntagImageConstant {
	/**
	 * Default Constructor
	 */
	public ViewRecurrentDocReceiptCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (checkListTrxVal != null && checkListTrxVal.getCheckList() != null) {
