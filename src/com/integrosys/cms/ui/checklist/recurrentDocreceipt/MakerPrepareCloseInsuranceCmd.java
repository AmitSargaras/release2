...
public class MakerPrepareCloseInsuranceCmd extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try{
			...
			throw new InsuranceCGException("ERROR-- MakerPrepareCloseInsuranceCmd.doExecute");
