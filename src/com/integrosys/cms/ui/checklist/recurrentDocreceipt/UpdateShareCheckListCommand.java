				...
				for (int i = 0; i < jspIShareDoc.length; i++) {
					...
					if (!recExist) {
						...
						if (!recExist) {
							...
							if (!(currEvent.equals(RecurrentDocReceiptAction.EVENT_REFRESH_SHARE_CHECKLIST) || currEvent
									.equals(RecurrentDocReceiptAction.EVENT_REFRESH_SHARE_CHECKLIST + "_prepare"))) {
