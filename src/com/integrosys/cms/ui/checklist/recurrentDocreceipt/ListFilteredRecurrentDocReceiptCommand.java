 ...
 */
public class ListFilteredRecurrentDocReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ListFilteredRecurrentDocReceiptCommand() {
	}
