 ...
 */
public class ListRecurrentDocReceiptCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ListRecurrentDocReceiptCommand() {
	}
...
//				{ "colChkLst", "java.util.List", REQUEST_SCOPE },
				{ "recurrentDocCheckList", "com.integrosys.cms.app.checklist.bus.CheckListSearchResult", REQUEST_SCOPE },
...
//				{ "innerOuterBcaObList", "java.util.HashMap", REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        String isViewFlag = (String) map.get("isViewFlag");
          ...
          try {
        	  CheckListSearchResult recurrentDocCheckList= checklistProxyManager.getCAMCheckListByCategoryAndProfileID("REC",limitProfileID);
        	  
        	  resultMap.put("recurrentDocCheckList", recurrentDocCheckList);
        	  CheckListDAO checkListDAO = new CheckListDAO();
        	  migCheckList= checkListDAO.getMigratedCheckListItem(String.valueOf(limitProfileID), "Recurrent");
