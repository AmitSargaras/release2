...
public class CheckListItemMapper extends AbstractCommonMapper {
	...
	public Object mapFormToOB(CommonForm cForm, HashMap map) throws MapperException {
		...
		if("save_relodge".equals(event)){
			...
			temp.setDocJust(aForm.getDocJustification());
			DefaultLogger.debug(this, ">>>>>>>>>>>go to event: " + event);
		}

		if (RecurrentDocReceiptAction.EVENT_REFRESH_SHARE_CHECKLIST.equals(event)) {
		...
		if ("save_receive".equals(event) || aForm.getAwaiting().equals("true") ||
				RecurrentDocReceiptAction.EVENT_PREPARE_TAG_UNTAG_IMAGE_RECEIVE.equals(event)) {
...
//			}
	...
	public CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap map) throws MapperException {
		...
		if (obj != null) {
			...
			aForm.setDocJustification(tempOb.getDocJust());
	...
	private IShareDoc[] getIShareDocFormToOB(RecurrentDocReceiptForm aForm) {
