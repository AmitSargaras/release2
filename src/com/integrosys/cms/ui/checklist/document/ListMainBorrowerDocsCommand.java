 ...
 */
public class ListMainBorrowerDocsCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ListMainBorrowerDocsCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			criteria.setSubCategory(ICMSConstant.CHECKLIST_MAIN_BORROWER);
