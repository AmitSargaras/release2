 ...
 */
public class ListCoBorrowerDocsCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ListCoBorrowerDocsCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			criteria.setSubCategory(ICMSConstant.CHECKLIST_CO_BORROWER);
