...
public class CheckerRejectEditLeiDateValidationCmd  extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectEditLeiDateValidationCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		if(remarks == null||remarks.trim().equals("")){
			...
			try {
			    ...
			    ILeiDateValidationTrxValue trxValueOut = getLeiDateValidationProxy().checkerRejectLeiDateValidation(ctx, trxValueIn);
