...
/**
 * Purpose : This command disable the  selected Director Master 
 *
...
public class MakerDisableDirectorMasterCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerDisableDirectorMasterCmd() {
	}
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if (event.equals("maker_disable_directorMaster")) {
						trxValueOut = getDirectorMasterProxy().makerDisableDirectorMaster(ctx, trxValueIn, directorMaster);
					} 
				else {
