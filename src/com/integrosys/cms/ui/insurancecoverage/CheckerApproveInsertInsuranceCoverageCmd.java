...
public class CheckerApproveInsertInsuranceCoverageCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerApproveInsertInsuranceCoverageCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			IInsuranceCoverageTrxValue trxValueOut = getInsuranceCoverageProxyManager().checkerApproveInsertInsuranceCoverage(ctx, trxValueIn);
			
			//--------------getList--------------------
			String tempTrxValue = trxValueOut.getCurrentTrxHistoryID();
	        
	        
			List listId = getInsuranceCoverageProxyManager().getFileMasterList(trxValueOut.getTransactionID());
			...
			for (int i = 0; i < listId.size(); i++) {
				OBFileMapperMaster mapList = (OBFileMapperMaster) listId.get(i);
    			 ...
    			 IInsuranceCoverage refInsuranceCoverage = getInsuranceCoverageProxyManager().insertActualInsuranceCoverage(regStage);
    			 
    			 trxValue = getInsuranceCoverageProxyManager().checkerCreateInsuranceCoverage(ctx, refInsuranceCoverage, regStage);
