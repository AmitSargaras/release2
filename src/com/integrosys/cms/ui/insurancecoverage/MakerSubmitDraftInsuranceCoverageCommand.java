...
/**
 * This command submits the Insurance Coverage saved in draft 
 * 
 * $Author: Dattatray Thorat
 * 
 * @version $Revision: 1.2 $
 */
public class MakerSubmitDraftInsuranceCoverageCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerSubmitDraftInsuranceCoverageCommand() {
	}
	        ...
	        try {
				...
				IInsuranceCoverageTrxValue trxValueOut = new OBInsuranceCoverageTrxValue();
					...
					if(event.equals("maker_confirm_resubmit_draft")){
						trxValueOut = getInsuranceCoverageProxyManager().makerUpdateCreateInsuranceCoverage(ctx, trxValueIn, relationshipMgr);
					}else {
