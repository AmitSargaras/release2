...
public class MakerInsertCloseInsuranceCoverageCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerInsertCloseInsuranceCoverageCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IInsuranceCoverageTrxValue trxValueOut = getInsuranceCoverageProxyManager().makerInsertCloseRejectedInsuranceCoverage(ctx, trxValueIn);
