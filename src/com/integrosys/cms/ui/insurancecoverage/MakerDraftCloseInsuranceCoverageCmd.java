...
public class MakerDraftCloseInsuranceCoverageCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerDraftCloseInsuranceCoverageCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IInsuranceCoverageTrxValue trxValueOut = getInsuranceCoverageProxyManager().makerCloseDraftInsuranceCoverage(ctx, trxValueIn);
