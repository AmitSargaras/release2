 ...
 * 
 */
public class CheckerRejectInsertInsuranceCoverageCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectInsertInsuranceCoverageCmd() {
	}
		 ...
		 HashMap returnMap = new HashMap();
	        ...
	        try {
	            ...
	            if(remarks == null || remarks.equals("")){
	            	...
	            	IInsuranceCoverageTrxValue trxValueOut = getInsuranceCoverageProxyManager().checkerRejectInsertInsuranceCoverage(ctx, trxValueIn);
