...
/**
 * This command Prepares the Insurance Coverage before deleting
 * $Author: Dattatray Thorat
 * @version $Revision: 1.0 $
 */
public class PrepareDeleteInsuranceCoverageCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public PrepareDeleteInsuranceCoverageCommand() {
	}
	...
	public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	        	...
	        	IInsuranceCoverageTrxValue insuranceCoverageTrxValue = null;
	        	IInsuranceCoverage insuranceCoverage = new OBInsuranceCoverage();
	        	
	        	insuranceCoverageTrxValue = getInsuranceCoverageProxyManager().getInsuranceCoverageTrxValue(Long.parseLong(id));
