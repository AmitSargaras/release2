...
public class BankingArrangementFacExclusionAction extends CommonAction implements IPin{
	...
	protected ICommand[] getCommandChain(String event) {
		...
		if(event.equals(EVENT_MAKER_LIST)
		...
		}else if(event.equals(EVENT_REFRESH_FACILITY_NAME)){
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("RefreshFacNameCommand");
			...
			objArray[1] = (ICommand) getNameCommandMap().get("RefreshFacNameCommand");
			...
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("PaginationCommand");
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return BankingArrangementFacExclusionValidator.validateInput((BankingArrangementFacExclusionForm) aForm, locale);
	}
