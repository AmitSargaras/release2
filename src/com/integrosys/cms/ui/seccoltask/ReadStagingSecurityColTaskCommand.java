 ...
 */
public class ReadStagingSecurityColTaskCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ReadStagingSecurityColTaskCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICollateralTaskTrxValue colTrxVal = proxy.getCollateralTaskByTrxID(trxID);
			resultMap.put("originEvent", map.get("event"));
			resultMap.put("colTask", colTrxVal.getStagingCollateralTask());
