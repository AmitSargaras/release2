 ...
 * @since $Date: 2006/04/13 07:55:25 $ Tag: $Name: $
 */
public class MakerRejectSecurityColTaskCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public MakerRejectSecurityColTaskCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (colTrxVal != null) {
				...
				colTrxVal = proxy.makerRejectCollaborationTask(ctx, colTrxVal, sTask);
			}
