 ...
 */
package com.integrosys.cms.ui.partycamupload.proxy;
...
import com.integrosys.cms.ui.partycamupload.bus.IPartyCamUploadBusManager;
 ...
 * 
 */
public class PartyCamUploadProxyManagerImpl implements IPartyCamUploadProxyManager {
/*	private IPartyCamUploadBusManager partyCamUploadBusManager;

	public IPartyCamErrorLog insertPartyCamfile(ArrayList resultList,String fileName,String uploadId,IPartyCamErrDetLog[] obPartyCamErrDetLog) throws HolidayException,
			TrxParameterException, TransactionException {
		try {
			return getPartyCamUploadBusManager().insertPartyCamUpload(resultList,fileName,uploadId,obPartyCamErrDetLog);
		} catch (Exception e) {
			
			e.printStackTrace();
			throw new PartyCamUploadException("ERROR-- Due to null State object cannot update.");
		}
	}

	public IPartyCamUploadBusManager getPartyCamUploadBusManager() {
		return partyCamUploadBusManager;
	}

	public void setPartyCamUploadBusManager(IPartyCamUploadBusManager partyCamUploadBusManager) {
		this.partyCamUploadBusManager = partyCamUploadBusManager;
	}
*/
	...
	throws FileUploadException,TrxParameterException, TransactionException {
      ...
      //  trxValue.setTransactionSubType(anFile.getFileType());
	...
	private IFileUploadTrxValue formulateTrxValue(ITrxContext anITrxContext, IFileUploadTrxValue anFile) {
		...
		anFile.setTransactionType(ICMSConstant.PARTYCAM_UPLOAD);
        return anFile;
    }
	...
	private IFileUploadTrxValue operate(IFileUploadTrxValue anFileTrxValue, OBCMSTrxParameter anOBCMSTrxParameter) throws FileUploadException,TrxParameterException,TransactionException {
	 ...
	 public IFileUploadTrxValue getFielUploadByTrxID(String aTrxID)throws FileUploadException, TransactionException,
		CommandProcessingException {
		 ...
		 trxValue.setTransactionType(ICMSConstant.PARTYCAM_UPLOAD);
		 OBCMSTrxParameter param = new OBCMSTrxParameter();
