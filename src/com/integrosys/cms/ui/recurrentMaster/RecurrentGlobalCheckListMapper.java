...
public class RecurrentGlobalCheckListMapper extends DocumentationGlobalCheckListMapper {
	...
	public Object mapFormToOB(CommonForm cForm, HashMap map) throws MapperException {
        ...
        RecurrentGlobalForm aForm = (RecurrentGlobalForm) cForm;
        ...
        if (!((aForm.getItemID() != null) && !aForm.getItemID().trim().equals(""))) {
            ...
            temp.setItemType(ICMSConstant.DOC_TYPE_RECURRENT_MASTER);
...
//		temp.setLoanApplicationType(appendApp);
	...
	public CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap map) throws MapperException {
		...
		RecurrentGlobalForm aForm = (RecurrentGlobalForm) super.mapOBToForm(cForm, obj, map);
		if (obj != null) {
