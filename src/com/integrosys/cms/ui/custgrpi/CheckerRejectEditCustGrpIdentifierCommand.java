...
public class CheckerRejectEditCustGrpIdentifierCommand extends AbstractCommand implements ICommonEventConstant {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            proxy.checkerRejectUpdateCustGrpIdentifier(trxContext, trxVal);
