...
/**
 * Describe this class.
 * Purpose: for checker2 to Reject the transaction
...
public class Checker2RejectEditCustGrpIdentifierCommand extends AbstractCommand implements ICommonEventConstant {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            proxy.checker2RejectUpdateCustGrpIdentifier(trxContext, trxVal);
