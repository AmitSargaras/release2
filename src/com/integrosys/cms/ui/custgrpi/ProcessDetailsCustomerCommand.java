...
public class ProcessDetailsCustomerCommand extends AbstractCommand implements ICommonEventConstant {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            String sub_profile_id = (String) map.get("sub_profile_id");  // It is actually lmt_profile_id
            if (sub_profile_id != null) {
                String sub_profile_id1 = null;
                //sub_profile_id1= proxy.searchCustomer(Long.parseLong(sub_profile_id));
                DefaultLogger.debug(this,"sub_profile_id1 = " + sub_profile_id1);
