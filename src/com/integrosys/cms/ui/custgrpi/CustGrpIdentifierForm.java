...
public class CustGrpIdentifierForm extends TrxContextForm implements java.io.Serializable {
    ...
    // for used in delete the sub limit item
    ...
    // Andy Wong, 27 June 2008: customization for ABG req
    private String isBGELInd;
    private String groupAccountMgrCode = "";
    public IGroupOtrLimit[] groupOtrLimit;
    // for used in delete the other limit item
    private String[] deleteOtrLmt;

    public String[] getDeleteOtrLmt() {
        return deleteOtrLmt;
    }

    public void setDeleteOtrLmt(String[] deleteOtrLmt) {
        this.deleteOtrLmt = deleteOtrLmt;
    }

    public String getIsBGELInd() {
        return isBGELInd;
    }

    public void setIsBGELInd(String BGELInd) {
        isBGELInd = BGELInd;
    }
    ...
    public String[][] getMapper() {
        ...
        String[][] input = {
                ...
                {CustGroupUIHelper.form_custGrpIdentifierObj, "com.integrosys.cms.ui.custgrpi.CustGrpIdentifierMapper"},
                {CustGroupUIHelper.form_CustGrpIdentifierSearchObj, "com.integrosys.cms.ui.custgrpi.CustGrpIdentifierSearchMapper"},
//                {CustGroupUIHelper.form_CustGrpIdentifierSearchListObj, "com.integrosys.cms.ui.custgrpi.CustGrpIdentifierSearchListMapper" },
                {CustGroupUIHelper.form_groupResult, "com.integrosys.cms.ui.custgrpi.CustGrpIdentifierSearchListMapper"},
