 ...
 * @since $Date: 2005/01/28 10:27:06 $ Tag: $Name: $
 */
public class TotalGenerateCCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public TotalGenerateCCCCommand() {
	}
