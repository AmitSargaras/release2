 ...
 */
public class ViewReturnGenerateCCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ViewReturnGenerateCCCCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		ICCCertificateCustomerDetail custDetail = (ICCCertificateCustomerDetail) map.get("custDetail");
