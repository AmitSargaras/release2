 ...
 */
public class RejectGenerateCCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectGenerateCCCCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			 ...
			 * ().getCountryCode()); } else { ILimitProfile limit =
			...
			certTrxVal = proxy.checkerRejectGenerateCCC(ctx, certTrxVal);
