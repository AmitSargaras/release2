...
public class MakerCloseValuationAmountAndRatingCmd extends AbstractCommand implements ICommonEventConstant{
	 ...
	 * Default Constructor
	 */
	public MakerCloseValuationAmountAndRatingCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if( event.equals("maker_confirm_close") ){
				trxValueOut = getValuationAmountAndRatingProxy().makerCloseRejectedValuationAmountAndRating(ctx, trxValueIn);
				resultMap.put("request.ITrxValue", trxValueOut);
			}
			else if(event.equals("maker_confirm_draft_close")){
            	 trxValueOut = getValuationAmountAndRatingProxy().makerCloseDraftValuationAmountAndRating(ctx, trxValueIn);
            	 resultMap.put("request.ITrxValue", trxValueOut);
            }
