...
public interface IStockdetailsUploadProxyManager {
	...
	public IFileUploadTrxValue getFileUploadByTrxID(String aTrxID)
			throws FileUploadException, TransactionException,	CommandProcessingException;
	public IFileUploadTrxValue checkerApproveFileUpload(ITrxContext anITrxContext, IFileUploadTrxValue anFileTrxVal) 
			throws FileUploadException, TrxParameterException,TransactionException;
	public IFileUploadTrxValue checkerRejectFileUpload(ITrxContext anITrxContext,IFileUploadTrxValue anFileTrxVal) 
			throws FileUploadException, TrxParameterException, TransactionException;
