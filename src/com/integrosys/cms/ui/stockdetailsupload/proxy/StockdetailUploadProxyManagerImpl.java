package com.integrosys.cms.ui.stockdetailsupload.proxy;
...
public class StockdetailUploadProxyManagerImpl implements IStockdetailsUploadProxyManager {
	...
	public void setStagingfileUploadBusManager(IFileUploadBusManager stagingfileUploadBusManager) {
	...
	public void setStagingfileUploadFileMapperIdBusManager(IFileUploadBusManager stagingfileUploadFileMapperIdBusManager) {
	...
	public void setFileUploadFileMapperIdBusManager(IFileUploadBusManager fileUploadFileMapperIdBusManager) {
	...
	public IFileUploadTrxValue makerCreateFile(ITrxContext anITrxContext,IFileUpload anFile)
			...
			private IFileUploadTrxValue formulateTrxValue(ITrxContext anITrxContext, IFileUploadTrxValue anFile) {
				...
				anFile.setTransactionType(ICMSConstant.STOCK_DETAILS_UPLOAD);
		        return anFile;
		    }
			...
			public IFileUploadTrxValue getFileUploadByTrxID(String aTrxID)throws FileUploadException, TransactionException,
				CommandProcessingException {
				 ...
				 trxValue.setTransactionType(ICMSConstant.STOCK_DETAILS_UPLOAD);
				 OBCMSTrxParameter param = new OBCMSTrxParameter();
