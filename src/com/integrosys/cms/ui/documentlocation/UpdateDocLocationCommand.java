 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/documentlocation/UpdateDocLocationCommand.java,v 1.7 2005/10/24 08:12:17 hshii Exp $
 */
...
public class UpdateDocLocationCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICCDocumentLocation docLocation = (ICCDocumentLocation) map.get("docLocationObj");
			IDocumentLocationProxyManager proxyManager = DocumentLocationProxyManagerFactory.getProxyManager();

			if (docLocTrxValue.getStatus().equals(ICMSConstant.STATE_REJECTED)) {
				docLocTrxValue = proxyManager.makerEditRejectedDocumentLocation(theOBTrxContext, docLocTrxValue,
						docLocation);
			}
			else {
				docLocTrxValue = proxyManager.makerUpdateDocumentLocation(theOBTrxContext, docLocTrxValue, docLocation);
			}
