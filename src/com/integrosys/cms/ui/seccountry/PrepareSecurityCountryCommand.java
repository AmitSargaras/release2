 ...
 * @since $Date: 2006/09/13 11:11:34 $ Tag: $Name: $
 */
public class PrepareSecurityCountryCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public PrepareSecurityCountryCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
            ...
            //resultMap.put("frameRequired", "true");// used to apply frames
            resultMap.put("frame", null);   //reset the frame indicator -> this is used to determine the main frame container that will be called
