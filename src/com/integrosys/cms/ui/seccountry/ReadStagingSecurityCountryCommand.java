 ...
 * @since $Date: 2003/08/04 06:04:30 $ Tag: $Name: $
 */
public class ReadStagingSecurityCountryCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ReadStagingSecurityCountryCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			String subType = itemTrxVal.getStagingTemplate().getCollateralSubType();
