 ...
 */
public class MakerCreateSystemBankBranchCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerCreateSystemBankBranchCmd() {
	}
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			boolean validRBICode=false;
				...
				trxValueOut = getSystemBankBranchProxy().makerCreateSystemBankBranch(ctx,systemBankBranch);
