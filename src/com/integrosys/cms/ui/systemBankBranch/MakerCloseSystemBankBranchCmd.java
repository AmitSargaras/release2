...
public class MakerCloseSystemBankBranchCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerCloseSystemBankBranchCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            ISystemBankBranchTrxValue trxValueOut = getSystemBankBranchProxy().makerCloseRejectedSystemBankBranch(ctx, trxValueIn);
            resultMap.put("request.ITrxValue", trxValueOut);
            }
