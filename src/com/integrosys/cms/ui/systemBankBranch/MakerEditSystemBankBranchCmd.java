...
* Command for edit System Bank Branch
 */
public class MakerEditSystemBankBranchCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerEditSystemBankBranchCmd() {
	}
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if(trxValueIn.getFromState().equals("PENDING_PERFECTION")){
					trxValueOut = getSystemBankBranchProxy().makerUpdateSaveCreateSystemBankBranch(ctx, trxValueIn, systemBankBranch);
					...
					if(!(systemBankBranch.getIsHub().equalsIgnoreCase(trxValueIn.getSystemBankBranch().getIsHub()))){
						...
						trxValueOut = getSystemBankBranchProxy().makerUpdateSystemBankBranch(ctx, trxValueIn, systemBankBranch);
						resultMap.put("request.ITrxValue", trxValueOut);
