 ...
 */
public class EditCCCountryTemplateCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public EditCCCountryTemplateCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			String index1 = (String) map.get("index");
			if(index1!=null){
				if(index1.length()!=0){
