 ...
 * @since $Date: 2003/08/16 04:31:17 $ Tag: $Name: $
 */
public class RemoveItemCCCountryCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RemoveItemCCCountryCommand() {
	}
