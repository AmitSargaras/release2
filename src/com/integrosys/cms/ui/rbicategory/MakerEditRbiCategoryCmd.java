...
*/
public class MakerEditRbiCategoryCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerEditRbiCategoryCmd() {
	}
	 ...
	 */
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				OBRbiCategory rbiCategoryObj = (OBRbiCategory) map.get("rbiCategoryObj");
				...
				if(event.equals("maker_save_create")){
					trxValueOut = getRbiCategoryProxy().makerUpdateSaveCreateRbiCategory(ctx, trxValueIn, rbiCategoryObj);
				}
				
				
				
					if ((event.equals("maker_edit_rbi_category"))||event.equals("maker_delete_rbi_category")||event.equals("maker_save_update")) {
						trxValueOut = getRbiCategoryProxy().makerUpdateRbiCategory(ctx, trxValueIn, rbiCategoryObj);
					} else {
						// event is  maker_confirm_resubmit_edit
						String remarks = (String) map.get("remarks");
						ctx.setRemarks(remarks);
						trxValueOut = getRbiCategoryProxy().makerEditRejectedRbiCategory(ctx, trxValueIn, rbiCategoryObj);
					} 
