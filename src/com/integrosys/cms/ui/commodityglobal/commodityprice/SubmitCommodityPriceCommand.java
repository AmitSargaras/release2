 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/commodityprice/SubmitCommodityPriceCommand.java,v 1.4 2006/03/03 01:39:10 hmbao Exp $
 */
...
public class SubmitCommodityPriceCommand extends AbstractCommand implements ICMSUIConstant, CMDTProfConstants {
	public String[][] getParameterDescriptor() {
		return (new String[][] {
				{ "commPriceTrxValue", "com.integrosys.cms.app.commodity.main.trx.price.ICommodityPriceTrxValue",
						SERVICE_SCOPE },
				{ "theOBTrxContext", "com.integrosys.cms.app.transaction.OBTrxContext", FORM_SCOPE },
				{ "commodityPriceObj", CN_COLLECTION, FORM_SCOPE }, { AN_RIC_TYPE, CN_STRING, REQUEST_SCOPE } });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			if ((commPriceList == null) || (commPriceList.length == 0)) {
				...
				trxValue = proxy.makerUpdateCommodityPrice(ctx, trxValue, commPriceList, ricType);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
