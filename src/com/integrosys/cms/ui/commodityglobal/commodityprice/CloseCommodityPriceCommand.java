 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/commodityprice/CloseCommodityPriceCommand.java,v 1.3 2004/06/17 06:32:06 hshii Exp $
 */
...
public class CloseCommodityPriceCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			trxValue = proxy.makerCloseCommodityPrice(ctx, trxValue);
		}
		catch (Exception e) {
			e.printStackTrace();
