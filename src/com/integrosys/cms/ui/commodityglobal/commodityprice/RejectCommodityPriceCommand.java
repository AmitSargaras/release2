 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/commodityprice/RejectCommodityPriceCommand.java,v 1.4 2006/03/03 01:39:10 hmbao Exp $
 */
...
public class RejectCommodityPriceCommand extends AbstractCommand implements ICMSUIConstant, CMDTProfConstants {
	public String[][] getParameterDescriptor() {
		return (new String[][] {
				{ "commPriceTrxValue", "com.integrosys.cms.app.commodity.main.trx.price.ICommodityPriceTrxValue",
						SERVICE_SCOPE }, { AN_RIC_TYPE, CN_STRING, REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			trxValue = proxy.checkerRejectUpdateCommodityPrice(ctx, trxValue, ricType);
		}
		catch (Exception e) {
			e.printStackTrace();
