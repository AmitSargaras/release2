 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/commodityuom/list/UpdateCommodityUOMListCommand.java,v 1.2 2004/08/13 11:05:59 hshii Exp $
 */
 ...
 * @since $Date: 2004/08/13 11:05:59 $ Tag: $Name: $
 */
public class UpdateCommodityUOMListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			if ((trxValue.getStagingUnitofMeasure() == null) || (trxValue.getStagingUnitofMeasure().length == 0)) {
				exceptionMap.put("commodityUOMList", new ActionMessage("error.commodityuom.empty"));
			}
			else {
				trxValue = proxy.makerSaveUnitofMeasure(ctx, trxValue, trxValue.getStagingUnitofMeasure());
			}
		}
		catch (Exception e) {
			e.printStackTrace();
