 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/commodityuom/list/RejectCommodityUOMListCommand.java,v 1.3 2004/06/17 06:32:06 hshii Exp $
 */
...
public class RejectCommodityUOMListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			trxValue = proxy.checkerRejectUpdateUnitofMeasure(ctx, trxValue);
		}
		catch (Exception e) {
			e.printStackTrace();
