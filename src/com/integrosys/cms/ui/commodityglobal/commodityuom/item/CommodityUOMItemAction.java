 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/commodityuom/item/CommodityUOMItemAction.java,v 1.2 2004/06/04 05:11:44 hltan Exp $
 */
...
public class CommodityUOMItemAction extends CommodityUOMAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (event.equals(EVENT_PREPARE_ADD) || event.equals(EVENT_PREPARE_NOOP)) {
			...
			objArray[0] = new PrepareCommodityUOMItemCommand();
		}
		else if (event.equals(EVENT_PREPARE)) {
			objArray = new ICommand[2];
			objArray[0] = new ReadCommodityUOMItemCommand();
			objArray[1] = new PrepareCommodityUOMItemCommand();
		}
		else if (event.equals(EVENT_UPDATE)) {
			objArray = new ICommand[1];
			objArray[0] = new UpdateCommodityUOMItemCommand();
		}
		else if (event.equals(EVENT_ADD)) {
			objArray = new ICommand[1];
			objArray[0] = new AddCommodityUOMItemCommand();
		}
		return objArray;
	}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return CommodityUOMItemValidator.validateInput((CommodityUOMItemForm) aForm, locale);
	}
