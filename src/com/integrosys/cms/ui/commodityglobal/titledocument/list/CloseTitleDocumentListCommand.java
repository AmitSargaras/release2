 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/titledocument/list/CloseTitleDocumentListCommand.java,v 1.4 2005/01/10 10:28:52 hshii Exp $
 */
 ...
 * @since $Date: 2005/01/10 10:28:52 $ Tag: $Name: $
 */

public class CloseTitleDocumentListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			if (trxValue.getTitleDocument() == null) {
				trxValue = proxy.makerCloseCreateTitleDocument(ctx, trxValue);
			}
			else {
				trxValue = proxy.makerCloseUpdateTitleDocument(ctx, trxValue);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
