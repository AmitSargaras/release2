 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/titledocument/list/SubmitTitleDocumentListCommand.java,v 1.4 2004/06/23 07:40:25 hshii Exp $
 */
 ...
 * @since $Date: 2004/06/23 07:40:25 $ Tag: $Name: $
 */

public class SubmitTitleDocumentListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		DefaultLogger.debug(this, "trxContext: " + ctx);
		DefaultLogger.debug(this, "trxValue: " + trxValue);
		try {
			if (trxValue.getStatus().equals(ICMSConstant.STATE_REJECTED)) {
				trxValue = proxy.makerResubmitUpdateTitleDocument(ctx, trxValue);
			}
			else {
				trxValue = proxy.makerUpdateTitleDocument(ctx, trxValue);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
