 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/titledocument/list/RejectTitleDocumentListCommand.java,v 1.3 2004/06/17 06:32:06 hshii Exp $
 */
...
public class RejectTitleDocumentListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			trxValue = proxy.checkerRejectUpdateTitleDocument(ctx, trxValue);
		}
		catch (Exception e) {
			e.printStackTrace();
