 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/warehouse/list/RejectWarehouseListCommand.java,v 1.4 2004/07/08 14:25:15 hshii Exp $
 */
...
public class RejectWarehouseListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			if (trxValue.getStatus().equals(ICMSConstant.STATE_PENDING_CREATE)) {
				trxValue = proxy.checkerRejectCreateWarehouse(ctx, trxValue);
			}
			else {
				trxValue = proxy.checkerRejectUpdateWarehouse(ctx, trxValue);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
