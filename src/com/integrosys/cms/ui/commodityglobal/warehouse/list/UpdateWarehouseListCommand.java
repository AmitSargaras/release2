 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/warehouse/list/UpdateWarehouseListCommand.java,v 1.2 2004/08/13 11:06:42 hshii Exp $
 */
 ...
 * @since $Date: 2004/08/13 11:06:42 $ Tag: $Name: $
 */
public class UpdateWarehouseListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			if ((trxValue.getStagingWarehouse() == null) || (trxValue.getStagingWarehouse().length == 0)) {
				...
				trxValue = proxy.makerSaveWarehouse(ctx, trxValue, trxValue.getStagingWarehouse());
			}
		}
		catch (Exception e) {
			e.printStackTrace();
