 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/warehouse/list/ApproveWarehouseListCommand.java,v 1.4 2004/07/08 14:25:15 hshii Exp $
 */
...
public class ApproveWarehouseListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			if (trxValue.getStatus().equals(ICMSConstant.STATE_PENDING_CREATE)) {
				trxValue = proxy.checkerApproveCreateWarehouse(ctx, trxValue);
			}
			else {
				trxValue = proxy.checkerApproveUpdateWarehouse(ctx, trxValue);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
