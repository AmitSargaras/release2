 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/commodityprofile/list/RejectCommProfileListCommand.java,v 1.4 2004/07/20 03:25:20 hshii Exp $
 */
...
public class RejectCommProfileListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			if (trxValue.getStatus().equals(ICMSConstant.STATE_PENDING_CREATE)) {
				trxValue = proxy.checkerRejectCreateProfile(ctx, trxValue);
			}
			else {
				trxValue = proxy.checkerRejectUpdateProfile(ctx, trxValue);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
