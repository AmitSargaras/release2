 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commodityglobal/commodityprofile/list/SubmitCommProfileListCommand.java,v 1.4 2006/09/04 09:53:38 hmbao Exp $
 */
...
public class SubmitCommProfileListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			else if (trxValue.getStatus().equals(ICMSConstant.STATE_REJECTED)) {
				trxValue = proxy.makerResubmitUpdateProfile(ctx, trxValue);
			}
			else {
				trxValue = proxy.makerUpdateProfile(ctx, trxValue);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
