 ...
 */
public class MaintainSystemParametersMapper extends AbstractCommonMapper {
	/**
	 * Default Construtor
	 */
	public MaintainSystemParametersMapper() {
	}
	...
	public Object mapFormToOB(CommonForm cForm, HashMap map) throws MapperException {
		...
		MaintainSystemParametersForm aForm = (MaintainSystemParametersForm) cForm;
		if (event.equals("maker_list_sysparams") || event.equals("redirect_list_sysparams")) {

			// build a default SystemParametersSearchCriteira
			return new SystemParametersSearchCriteria();

		}
		else if (event.equals("maker_edit_sysparams") || event.equals("maker_edit_reject_edit")
				|| event.equalsIgnoreCase("maker_edit_sysparams_read_rejected")) {
			...
			if (event.equalsIgnoreCase("maker_edit_sysparams_read_rejected")) {
	...
	public CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap map) throws MapperException {
		try {
			DefaultLogger.debug(this, "inside mapOb to form MaintainSystemParametersMapper");
			MaintainSystemParametersForm aForm = (MaintainSystemParametersForm) cForm;
			if (obj != null) {
			...
			DefaultLogger.error(this, "error in MaintainSystemParametersMapper is" + e);
		}
		return null;
