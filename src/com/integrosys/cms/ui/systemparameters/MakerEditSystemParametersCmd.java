 ...
 * @since $Date: 2003/09/10 09:37:00 $ Tag: $Name: $
 */
public class MakerEditSystemParametersCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public MakerEditSystemParametersCmd() {
	}
