 ...
 */
public class PrepareCreateMFTemplateCmd extends AbstractCommand {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "MFTemplateTrxObj",
				"com.integrosys.cms.app.propertyparameters.trx.marketfactor.IMFTemplateTrxValue", SERVICE_SCOPE }, });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			OBMFTemplateTrxValue MFTemplateTrxObj = new OBMFTemplateTrxValue();
