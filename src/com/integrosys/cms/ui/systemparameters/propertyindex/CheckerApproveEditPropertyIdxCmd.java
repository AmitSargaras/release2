...
/**
 * Title: CLIMS
 * Description: for Checker to approve the update request for Property Index
 * Copyright: Integro Technologies Sdn Bhd
 * Author: Andy Wong
 * Date: Feb 12, 2008
 */

public class CheckerApproveEditPropertyIdxCmd extends PropertyIdxCmd implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public CheckerApproveEditPropertyIdxCmd() {
    }
