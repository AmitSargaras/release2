...
/**
 * Title: CLIMS
 * Description: for Checker to approve the delete request for Property Index
 * Copyright: Integro Technologies Sdn Bhd
 * Author: Andy Wong
 * Date: Feb 12, 2008
 */

public class CheckerApproveDeletePropertyIdxCmd extends PropertyIdxCmd implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public CheckerApproveDeletePropertyIdxCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            DefaultLogger.debug(this, "trxValue after approve " + trxValueOut);
