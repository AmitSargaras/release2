...
public class MakerDeletePropertyIdxCmd extends PropertyIdxCmd implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public MakerDeletePropertyIdxCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            if (event.equals("maker_confirm_delete")) {
                trxValueOut = getPropertyIdxProxy().makerDeletePropertyIdx(ctx, trxValueIn, trxValueIn.getPrIdx());
            } else {
                // 'maker_confirm_resubmit_delete'
                String remarks = (String) map.get("remarks");
                ctx.setRemarks(remarks);

                trxValueOut = getPropertyIdxProxy().makerEditRejectedPropertyIdx(ctx, trxValueIn, trxValueIn.getPrIdx());
            }
