...
public class MakerClosePropertyIdxCmd extends PropertyIdxCmd implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public MakerClosePropertyIdxCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            IPropertyIdxTrxValue trxValueOut = getPropertyIdxProxy().makerCloseRejectedPropertyIdx(ctx, trxValueIn);
