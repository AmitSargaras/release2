 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/systemparameters/RedirectCheckerCommand.java,v 1.2 2005/09/09 11:56:07 hshii Exp $
 */
 ...
 */
public class RedirectCheckerCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RedirectCheckerCommand() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "event", "java.lang.String", REQUEST_SCOPE },
				...
				{ "redirectChecker", "java.lang.String", REQUEST_SCOPE } });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		DefaultLogger.debug(this, "entered RedirectCheckerCommand" + "");
		...
		try {
			...
			if (businessParameterGroupTrxVal.getTransactionSubType().equals("SP")) {
				resultMap.put("redirectChecker", "SP");
			}
			else {
				resultMap.put("redirectChecker", "CR");
			}
