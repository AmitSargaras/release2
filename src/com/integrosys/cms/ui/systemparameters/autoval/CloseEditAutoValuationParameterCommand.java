...
/**
 * Describe this class. Purpose: for Maker to close the update request for Auto
 * Valuation Parameters Description: command that help the Maker to close the
 * update request for Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class CloseEditAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CloseEditAutoValuationParameterCommand() {
	}
