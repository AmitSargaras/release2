...
/**
 * Describe this class. Purpose: for Maker to update existing Auto Valuation
 * Parameters Description: command that help the Maker to update existing Auto
...
public class EditAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public EditAutoValuationParameterCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, "valParam before edit " + paramItem);

			String event = (String) map.get("event");
			DefaultLogger.debug(this, "event here : " + event);
			// if(event.equals("maker_confirm_resubmit_edit")){
			// }
			...
			if (event.equals("maker_confirm_edit")) {
				// 'maker_confirm_edit'
				trxValue = proxy.makerUpdateDocumentLocation(ctx, iPrPaTrxValue, paramItem);
			}
			else {
