...
/**
 * Describe this class. Purpose: for Maker to view details of Auto Valuation
 * Parameters Description: command that help the Maker to view details of Auto
...
public class ReadAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ReadAutoValuationParameterCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, "obParam.getSecuritySubTypeList() : " + obParam.getSecuritySubTypeList());
