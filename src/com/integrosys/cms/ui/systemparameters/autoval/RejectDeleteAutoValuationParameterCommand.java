...
/**
 * Describe this class. Purpose: for Checker to reject the delete request of
 * Auto Valuation Parameters Description: command that help the Checker to
 * reject the delete request of Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class RejectDeleteAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectDeleteAutoValuationParameterCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// "autoValuationParameter before reject  "+
			// autoValuationParameter);
			...
			IPrPaTrxValue trxValue = proxy.checkerRejectDocumentLocation(ctx, iPrPaTrxValue);

			resultMap.put("request.ITrxValue", trxValue);
			DefaultLogger.debug(this, "trxValue after reject " + trxValue);
