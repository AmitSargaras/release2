...
/**
 * Describe this class. Purpose: for Maker to close the delete request for Auto
 * Valuation Parameters Description: command that help the Maker to close the
 * delete request for Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class CloseDeleteAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CloseDeleteAutoValuationParameterCommand() {
	}
