...
/**
 * Describe this class. Purpose: for Checker to reject the new created Auto
 * Valuation Parameters Description: command that help the Checker to reject the
 * new created Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class RejectCreateAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectCreateAutoValuationParameterCommand() {
	}
