...
/**
 * Describe this class. Purpose: for Maker to resubmit rejected request of Auto
 * Valuation Parameters Description: command that help the Maker to resubmit
 * rejected request of Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class MakerPrepareResubmitAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	...
	public MakerPrepareResubmitAutoValuationParameterCommand() {
	}
