...
public class CreateAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CreateAutoValuationParameterCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			OBPropertyParameters paramItem = (OBPropertyParameters) map.get("autoValuationParameter");
			DefaultLogger.debug(this, "valParam before create " + paramItem);

			String event = (String) map.get("event");
			DefaultLogger.debug(this, "event here : " + event);
			// if(event.equals("maker_confirm_resubmit_create")){
			// }
			...
			if (event.equals("maker_confirm_create")) {
				// 'maker_confirm_create'
				trxValue = proxy.makerCreateDocumentLocation(ctx, paramItem);
			}
			else {
				// 'maker_confirm_resubmit_create'
