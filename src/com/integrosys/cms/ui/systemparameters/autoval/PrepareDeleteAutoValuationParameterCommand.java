...
/**
 * Describe this class. Purpose: for Maker to prepare delete existing Auto
 * Valuation Parameters Description: command that help the Maker to prepare
 * delete existing Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class PrepareDeleteAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public PrepareDeleteAutoValuationParameterCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (!allowTrx) {
				...
				IPrPaTrxValue trxValue = proxy.getCCDocumentLocationTrxValue(Long.parseLong(paramTrxId));
