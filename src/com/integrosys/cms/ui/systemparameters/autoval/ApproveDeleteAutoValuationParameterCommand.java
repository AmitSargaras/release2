...
/**
 * Describe this class. Purpose: for Checker to approve the delete request for
 * Auto Valuation Parameters Description: command that help the Checker to
 * approve the delete request for Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
 */
public class ApproveDeleteAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ApproveDeleteAutoValuationParameterCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, "trxValue after approve " + trxValue);
