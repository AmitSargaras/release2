...
/**
 * Describe this class. Purpose: for Maker/Checker to view details of Auto
 * Valuation Parameters Description: command that help the Maker/Checker to view
 * details of Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class ReadStagingAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ReadStagingAutoValuationParameterCommand() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {
				...
				{ "autoValuationParameter", "com.integrosys.cms.app.propertyparameters.bus.OBPropertyParameters",
						FORM_SCOPE }, { "closeFlag", "java.lang.String", REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			IPrPaTrxValue obj = proxy.getCCDocumentLocationByTrxID(paramTrxId);
			obParam = (OBPropertyParameters) obj.getStagingPrPa();
			...
			resultMap.put("IPrPaTrxValue", obj);
