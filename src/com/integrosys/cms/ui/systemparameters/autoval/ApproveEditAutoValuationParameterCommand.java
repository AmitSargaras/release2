...
/**
 * Describe this class. Purpose: for Checker to approve the update request for
 * Auto Valuation Parameters Description: command that help the Checker to
 * approve the update request for Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class ApproveEditAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ApproveEditAutoValuationParameterCommand() {
	}
