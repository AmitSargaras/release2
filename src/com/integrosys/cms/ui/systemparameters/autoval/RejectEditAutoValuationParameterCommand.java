...
/**
 * Describe this class. Purpose: for Checker to reject the update request of
 * Auto Valuation Parameters Description: command that help the Checker to
 * reject the update request of Auto Valuation Parameters
 * 
 * @author $Author$<br>
 * @version $Revision$
 * @since $Date$ Tag: $Name$
...
public class RejectEditAutoValuationParameterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectEditAutoValuationParameterCommand() {
	}
