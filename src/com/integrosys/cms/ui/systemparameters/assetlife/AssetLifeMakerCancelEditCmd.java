 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/systemparameters/assetlife/AssetLifeMakerCancelEditCmd.java,v 1 2007/01/31 Jerlin Exp $
 */
...
/**
 * Describe this class. Purpose: for Maker to close the transaction after
 * rejected by checker Description: command that let the maker to close the
 * transaction that being rejected by checker
 * 
...
public class AssetLifeMakerCancelEditCmd extends AbstractCommand {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "request.ITrxValue", OBCollateralAssetLifeTrxValue.class.getName(), REQUEST_SCOPE } });
	}

	/**
	 * This method does the Business operations with the HashMap and put the
	 * results back into the HashMap.Here close for Asset Life after rejection
	 * from checker is done.
	 * 
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			collateralAssetLifesTrxVal = getCollateralAssetLifeProxy().makerCancelUpdateCollateralAssetLife(trxContext,
					collateralAssetLifesTrxVal);
			resultMap.put("request.ITrxValue", collateralAssetLifesTrxVal);

		}
		catch (CollateralException e) {
			throw new CommandProcessingException("failed to cancel update collateral asset life workflow", e);
		}
