...
public class ShowCaseDetailsCommand extends AbstractCommand {

	public ShowCaseDetailsCommand() {
	...
	CommandValidationException {
    	...
    	List tat= new ArrayList(); 
    		newTatListArray= (ArrayList)  newTat.getTatCase(caseid);
    		INewTat obj = new OBNewTat();
    		if(newTatListArray!=null){
    			
    		 obj = (INewTat) newTatListArray.get(0);
    		}
