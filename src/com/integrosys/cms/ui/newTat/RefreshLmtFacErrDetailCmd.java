 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class RefreshLmtFacErrDetailCmd extends AbstractCommand {
	public String[][] getParameterDescriptor() {
		return (new String[][] { { "newTatObj", "com.integrosys.cms.app.newTat.bus.OBNewTat", FORM_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,
		...
		INewTat tat1 = (INewTat) map.get("newTatObj");
		HashMap facilityNameMap = (HashMap)map.get("newFacilityNameMap");
			String facName = (String)facilityNameMap.get((String) (tat1.getFacilitySystem()));
			String facSel = (String) (tat1.getFacilitySection());
