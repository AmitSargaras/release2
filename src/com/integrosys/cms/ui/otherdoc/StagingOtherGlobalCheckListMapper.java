...
public class StagingOtherGlobalCheckListMapper extends StagingDocumentationGlobalCheckListMapper {
	public Object mapFormToOB(CommonForm cForm, HashMap map) throws MapperException {
		OtherGlobalForm aForm = (OtherGlobalForm) cForm;
	...
	public CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap map) throws MapperException {
		OtherGlobalForm aForm = (OtherGlobalForm) super.mapOBToForm(cForm, obj, map);
		if (obj != null) {
