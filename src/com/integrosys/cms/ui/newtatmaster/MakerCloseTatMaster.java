...
public class MakerCloseTatMaster extends AbstractCommand implements	ICommonEventConstant{
	 ...
	 public MakerCloseTatMaster() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,ComponentException {
	        ...
	        try {
	            ...
	            trxValueIn.getStagingtatMaster().setCreatedBy(ctx.getUser().getLoginID());
	            trxValueIn.getStagingtatMaster().setCreatedOn(toDate);
	            ITatMasterTrxValue trxValueOut = getTatMasterProxy().makerCloseRejectedTatMaster(ctx, trxValueIn);
