 ...
 */
public class RejectInternalLimitListCommand extends InternalLimitCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException,
		...
		IInternalLimitParameterTrxValue trxValue = (IInternalLimitParameterTrxValue) map.get("internalLmtParamTrxValue");
		try {
			trxValue = getInternalLimitProxy().checkerRejectILP(trxContext, trxValue);
