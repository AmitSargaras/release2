 ...
 */
public class ClosePolicyCapCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ClosePolicyCapCommand() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "request.ITrxValue",
				"com.integrosys.cms.app.creditriskparam.trx.policycap.OBPolicyCapTrxValue", REQUEST_SCOPE } });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			policyCapsTrxVal = proxy.makerClosePolicyCap(trxContext, policyCapsTrxVal);
