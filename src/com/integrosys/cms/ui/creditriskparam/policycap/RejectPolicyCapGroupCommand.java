 ...
 * @since $Date: 2007/Aug/08 $ Tag: $Name: $
 */
public class RejectPolicyCapGroupCommand extends AbstractCommand {

	/**
	 * Default Constructor
	 */
	public RejectPolicyCapGroupCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, ">>>>>>>>>> In RejectPolicyCapGroupCommand");
			proxy.checkerRejectUpdatePolicyCapGroup(trxContext, policyCapGroupTrxVal);
			resultMap.put("request.ITrxValue", policyCapGroupTrxVal);
			DefaultLogger.debug(this, ">>>>>>>>>> Policy Cap Group Rejected");
		}
		catch (Exception e) {
