 ...
 */
//public class CheckerRejectCountryLimitCmd extends AbstractCommand {
public class CheckerRejectCountryLimitCmd extends CountryLimitCommand {
...
//			ICountryLimitProxy proxy = helper.getCountryLimitProxyManager();
			...
			ICountryLimitTrxValue res = proxy.checkerRejectUpdateCountryLimit(ctx, countryLimitTrxObj);
