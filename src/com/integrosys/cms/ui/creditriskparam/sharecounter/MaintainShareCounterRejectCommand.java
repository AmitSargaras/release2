 ...
 * $Header$
 *
 * MaintainShareCounterRejectCommand
 *
 * Created on 4:33:54 PM
 *
 * Purpose:
 * Description:
 *
...
/**
 * Created by IntelliJ IDEA. User: Eric Date: Feb 22, 2007 Time: 4:33:54 PM
 */
public class MaintainShareCounterRejectCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap hashMap) throws CommandValidationException, CommandProcessingException,
		...
		try {
			trxValue = (OBCreditRiskParamGroupTrxValue) proxy.checkerRejectCreditRiskParam(ctx, trxValue, trxValue
