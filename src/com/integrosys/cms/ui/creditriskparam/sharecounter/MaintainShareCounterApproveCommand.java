 ...
 * $Header$
 *
 * MaintainShareCounterApproveCommand
 *
 * Created on 4:01:40 PM
 *
 * Purpose:
 * Description:
 *
...
/**
 * Created by IntelliJ IDEA. User: Eric Date: Feb 22, 2007 Time: 4:01:40 PM
 */
public class MaintainShareCounterApproveCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap hashMap) throws CommandValidationException, CommandProcessingException,
		...
		try {
			trxValue = (OBCreditRiskParamGroupTrxValue) proxy.checkerApproveCreditRiskParam(ctx, trxValue, trxValue
