 ...
 *
 */
public class EICustSearchCommand extends AbstractCommand {

	public final static String EXTERNAL_SEARCH_CRITERIA_OBJ = "EICustSearchCoammnd.customerSearchCriteria";
...
//                + searchCriteria.getCustomerName());
        ...
        try {
			...
			//result.put(EXTERNAL_SEARCH_CRITERIA_OBJ, searchCriteria);
