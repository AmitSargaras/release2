 ...
 */
//public class MakerCloseInternalCreditRatingCommand extends AbstractCommand {
public class MakerCloseInternalCreditRatingCommand extends InternalCreditRatingCommand {
        ...
        try
				{
		        	...
		        	IInternalCreditRatingTrxValue internalCreditRatingTrxObj = (IInternalCreditRatingTrxValue)map.get("internalCreditRatingTrxObj");
							...
							IInternalCreditRatingTrxValue res = null;
//							IInternalCreditRatingProxy proxy = InternalCreditRatingProxyFactory.getProxy();
							...
							res = proxy.makerCloseInternalCreditRating(ctx, internalCreditRatingTrxObj);			
