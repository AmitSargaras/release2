 ...
 */
//public class CheckerRejectInternalCreditRatingCommand extends AbstractCommand {
public class CheckerRejectInternalCreditRatingCommand extends InternalCreditRatingCommand {
...
//		        	IInternalCreditRatingProxy proxy = InternalCreditRatingProxyFactory.getProxy();
                    IInternalCreditRatingProxy proxy = getInternalCreditRatingProxy();
							IInternalCreditRatingTrxValue trxVal = proxy.checkerRejectUpdateInternalCreditRating(ctx, internalCreditRatingTrxObj);
