...
/**
 * The Intermediary class that prepare the EntityLimistTrxValue from one action
 * to another action.
 *
 ...
 * Tag:     $Name:  $
 */
//public class CancelEntityLimitListCommand extends AbstractCommand {
public class CancelEntityLimitListCommand extends EntityLimitCommand {
    ...
    public HashMap doExecute(HashMap map)
        ...
        try {
            ...
            // empty temp entitylimit, rollback all entitylimit selection
