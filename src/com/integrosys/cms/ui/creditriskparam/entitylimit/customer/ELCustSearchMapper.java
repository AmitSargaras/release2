...
public class ELCustSearchMapper extends CustomerSearchMapper {
    ...
    public Object mapFormToOB(CommonForm arg0, HashMap arg1) throws MapperException {
        ELCustSearchForm aForm = (ELCustSearchForm) arg0;
        ...
        if (event.equals(ELCustomerSearchAction.EVENT_CUST_ADD_SELECT)) {
