 ...
 * Tag: $Name:  $
 */
public class RejectExemptFacilityCommand extends AbstractCommand implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public RejectExemptFacilityCommand() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            exemptFacTrxVal = proxy.checkerRejectExemptFacility(trxContext, exemptFacTrxVal);
