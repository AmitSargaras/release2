 ...
 * Tag: $Name:  $
 */
public class PrepareAddExemptFacilityCommand extends AbstractCommand implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public PrepareAddExemptFacilityCommand() {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        resultMap.put("exemptFacility",new OBExemptFacility());
