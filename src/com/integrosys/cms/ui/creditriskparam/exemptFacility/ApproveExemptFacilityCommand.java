 ...
 * Tag: $Name:  $
 */
public class ApproveExemptFacilityCommand extends AbstractCommand implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public ApproveExemptFacilityCommand() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            exemptFacTrxVal = proxy.checkerApproveExemptFacility(trxContext, exemptFacTrxVal);
