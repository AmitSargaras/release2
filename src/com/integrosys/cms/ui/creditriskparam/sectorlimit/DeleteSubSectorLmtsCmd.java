 ...
 * Date: Jun 16, 2008
 */
public class DeleteSubSectorLmtsCmd extends AbstractCommand {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            DefaultLogger.debug(this, "delete command, getSubSectorList = " + obj.getSubSectorList());
            resultMap.put("mainSectorLimitObj", obj);
            resultMap.put("SectorLimitForm", obj);
