...
public class MakerCloseAutoupdationLmtsFileCmd extends AbstractCommand implements ICommonEventConstant{
	public MakerCloseAutoupdationLmtsFileCmd(){		
			}
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,FileUploadException {
        ...
        try {
            ...
            IFileUploadTrxValue trxValueOut = getAutoupdationlmtsuploadProxy().makerCloseRejectUbsFile(ctx, trxValueIn);
