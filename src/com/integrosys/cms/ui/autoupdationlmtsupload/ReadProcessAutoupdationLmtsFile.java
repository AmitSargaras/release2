...
public class ReadProcessAutoupdationLmtsFile extends AbstractCommand implements ICommonEventConstant{
	public ReadProcessAutoupdationLmtsFile(){
...
//			autoupdationlmtsFileList=jdbc.getAllAutoupdationLmtsFile(trxValue.getStagingReferenceID());
			...
			long countFail = 0;
					...
					for (int i = 0; i < uploadList.size(); i++) {
						...
						if ("FAIL".equals(oBAutoupdationLmtsFile.getStatus()) && "N".equals(oBAutoupdationLmtsFile.getUploadStatus())) {
							countFail++;
						} else if ("PASS".equals(oBAutoupdationLmtsFile.getStatus()) && "Y".equals(oBAutoupdationLmtsFile.getUploadStatus())) {
							countPass++;
						}
					}
