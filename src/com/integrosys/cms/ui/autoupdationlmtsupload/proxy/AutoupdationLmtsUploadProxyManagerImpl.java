...
package com.integrosys.cms.ui.autoupdationlmtsupload.proxy;
...
import com.integrosys.cms.batch.autoupdationlmts.IAutoupdationLmtsErrDetLog;
import com.integrosys.cms.batch.autoupdationlmts.IAutoupdationLmtsErrorLog;
import com.integrosys.cms.ui.autoupdationlmtsupload.AutoupdationLmtsUploadException;
 ...
 * 
 */
public class AutoupdationLmtsUploadProxyManagerImpl implements IAutoupdationLmtsUploadProxyManager {
	...
	private IFileUploadTrxValue formulateTrxValue(ITrxContext anITrxContext, IFileUploadTrxValue anFile) {
		...
		anFile.setTransactionType(ICMSConstant.AUTOUPDATIONLMTS_UPLOAD);
        return anFile;
    }
	...
	private IFileUploadTrxValue operate(IFileUploadTrxValue anFileTrxValue, OBCMSTrxParameter anOBCMSTrxParameter) throws FileUploadException,TrxParameterException,TransactionException {
	 ...
	 public IFileUploadTrxValue getFielUploadByTrxID(String aTrxID)throws FileUploadException, TransactionException,
		CommandProcessingException {
		 ...
		 trxValue.setTransactionType(ICMSConstant.AUTOUPDATIONLMTS_UPLOAD);
		 OBCMSTrxParameter param = new OBCMSTrxParameter();
