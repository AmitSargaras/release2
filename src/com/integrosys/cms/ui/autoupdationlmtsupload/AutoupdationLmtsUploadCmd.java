...
public class AutoupdationLmtsUploadCmd extends AbstractCommand implements ICommonEventConstant{

	public AutoupdationLmtsUploadCmd(){
	}
	/**
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
					...
					if(fileUploadJdbc.getAutoupdationLmtsUplodCount()>0){
						preUpload=true;
					}
					if(!preUpload){
