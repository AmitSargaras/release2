...
public class MakerCloseFileCmd extends AbstractCommand implements ICommonEventConstant{
	public MakerCloseFileCmd(){		
			}
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,FileUploadException {
        ...
        try {
            ...
            IFileUploadTrxValue trxValueOut = getFileUploadProxy().makerCloseRejectUbsFile(ctx, trxValueIn);
