...
public class ListBahrainFileCmd extends AbstractCommand implements ICommonEventConstant{
   ...
   public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
  	...
  	DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
       ...
       try{
    	   ...
    	   if(fileUploadJdbc.getUplodCount("BAHRAIN_UPLOAD")>0){
    		   preUpload=true;
    	   }
    	 if(!preUpload){
    		 File path=new File("E:/BAHRAIN");
