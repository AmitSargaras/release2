...
public class MakerCloseMFCheckListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (MFChecklistTrxObj.getStatus().equals(ICMSConstant.STATE_REJECTED_CREATE)) {
				res = getCollateralMarketFactorProxy().makerCloseCreateMFChecklist(ctx, MFChecklistTrxObj);
			}
			else {
				res = getCollateralMarketFactorProxy().makerCloseUpdateMFChecklist(ctx, MFChecklistTrxObj);
			}
