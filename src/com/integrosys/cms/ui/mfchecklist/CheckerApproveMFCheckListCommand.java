...
public class CheckerApproveMFCheckListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			IMFChecklistTrxValue res = getCollateralMarketFactorProxy().checkerApproveUpdateMFChecklist(ctx,
					MFChecklistTrxObj);
