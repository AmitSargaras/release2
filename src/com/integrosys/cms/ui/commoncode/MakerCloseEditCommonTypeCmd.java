 ...
 * @version $Id$
 */
public class MakerCloseEditCommonTypeCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public MakerCloseEditCommonTypeCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		ICommonCodeTypeTrxValue obCommonCodeTypeTrxValue = (ICommonCodeTypeTrxValue) map
		...
		try {
			...
			obCommonCodeTypeTrxValue = proxy.makerCancelUpdate(trxContext, obCommonCodeTypeTrxValue);
