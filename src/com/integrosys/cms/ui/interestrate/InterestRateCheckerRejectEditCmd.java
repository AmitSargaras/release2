 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/interestrate/InterestRateCheckerRejectEditCmd.java,v 1 2007/02/09 Jerlin Exp $
 */
...
public class InterestRateCheckerRejectEditCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, " >>>Debug:::InterestRateCheckerRejectEditCmd Before reject TrxValue = "
					+ AccessorUtil.printMethodValue(interestRateTrxVal));
			interestRateTrxVal = proxy.checkerRejectUpdateInterestRate(trxContext, interestRateTrxVal);
