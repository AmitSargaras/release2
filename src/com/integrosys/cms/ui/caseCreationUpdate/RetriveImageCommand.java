...
public class RetriveImageCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		System.out.println("img.getcategory=>"+img.getCategory());
		...
		if(img != null) {
			...
			String typeOfDoc = imageTagDaoImpl.getEntryNameFromCode(img.getCategory());
			img.setTypeOfDocument(typeOfDoc);
			System.out.println("casecreationUpdate/RetriveImageCommand.java=>typeOfDoc ==>"+typeOfDoc);
			tagDetailList.set(Integer.parseInt(count), img);
			System.out.println("RetriveImageCommand.java => img.setTypeOfDocument(typeOfDoc)=>"+typeOfDoc);
		}else {
			System.out.println("RetriveImageCommand.java => img is null.");
		}
