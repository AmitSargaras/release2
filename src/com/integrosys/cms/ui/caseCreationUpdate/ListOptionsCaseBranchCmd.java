 ...
 */
public class ListOptionsCaseBranchCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public ListOptionsCaseBranchCmd() {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		System.out.println("ListOptionsCaseBranchCmd.java=>before getBranchList()");
		resultMap.put("branchList", getBranchList());
		System.out.println("ListOptionsCaseBranchCmd.java=>After getBranchList()");
