...
* Command for Save CaseCreation
 */
public class MakerSaveCaseCreationCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerSaveCaseCreationCmd() {
	}
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if(event.equals("maker_update_draft_caseCreationUpdate")){
					ICaseCreationTrxValue trxValueIn = (OBCaseCreationTrxValue) map.get("ICaseCreationTrxValue");
					trxValueOut = getCaseCreationProxy().makerUpdateSaveUpdateCaseCreation(ctx, trxValueIn, caseCreationUpdate);
					
					resultMap.put("request.ITrxValue", trxValueOut);
				}else{
				
				trxValueOut = getCaseCreationProxy().makerSaveCaseCreation(ctx,caseCreationUpdate);
