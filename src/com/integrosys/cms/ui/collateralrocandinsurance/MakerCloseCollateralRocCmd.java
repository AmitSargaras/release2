...
public class MakerCloseCollateralRocCmd extends AbstractCommand implements ICommonEventConstant{
     ...
     * Default Constructor
     */
	public MakerCloseCollateralRocCmd() {
	}
	/**
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            if(event.equals("maker_confirm_draft_close")){
            	ICollateralRocTrxValue trxValueOut = getCollateralRocProxy().makerCloseDraftCollateralRoc(ctx, trxValueIn);
            	 resultMap.put("request.ITrxValue", trxValueOut);
            }else{
            ICollateralRocTrxValue trxValueOut = getCollateralRocProxy().makerCloseRejectedCollateralRoc(ctx, trxValueIn);
            resultMap.put("request.ITrxValue", trxValueOut);
            }
