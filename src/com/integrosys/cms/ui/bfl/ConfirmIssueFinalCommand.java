 ...
 */
public class ConfirmIssueFinalCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ConfirmIssueFinalCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,
		...
		try {
			...
			theOBTrxContext.setTrxOrganisationOrigin(limitprofiletrxvalue.getLimitProfile().getOriginatingLocation()
					.getOrganisationCode());
			ICMSTrxResult resultOb = limitproxy.issueFinalBFL(theOBTrxContext, limitprofiletrxvalue);
