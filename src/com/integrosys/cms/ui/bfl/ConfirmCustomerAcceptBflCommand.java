 ...
 */
public class ConfirmCustomerAcceptBflCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ConfirmCustomerAcceptBflCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,
		...
		try {
			...
			theOBTrxContext.setTrxOrganisationOrigin(limitprofiletrxvalue.getLimitProfile().getOriginatingLocation()
					.getOrganisationCode());
			ICMSTrxResult resultOb = limitproxy.customerAcceptBFL(theOBTrxContext, limitprofiletrxvalue, tatEntry);
