 ...
 */
public class ConfirmReceiveDraftBflAckCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ConfirmReceiveDraftBflAckCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,
		...
		try {
			...
			theOBTrxContext.setTrxOrganisationOrigin(limitprofiletrxvalue.getLimitProfile().getOriginatingLocation()
					.getOrganisationCode());
			ICMSTrxResult resultOb = limitproxy.ackReceiptDraftBFL(theOBTrxContext, limitprofiletrxvalue, tatEntry);
