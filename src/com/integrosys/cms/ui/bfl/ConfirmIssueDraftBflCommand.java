 ...
 */
public class ConfirmIssueDraftBflCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ConfirmIssueDraftBflCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,
		...
		try {
			...
			DefaultLogger.debug(this, "TAT ENtry: " + tatEntry);
			...
			theOBTrxContext.setTrxOrganisationOrigin(limitprofiletrxvalue.getLimitProfile().getOriginatingLocation()
					.getOrganisationCode());
			ICMSTrxResult resultOb = null;
			if (theOBTrxContext != null) {
				resultOb = limitproxy.issueDraftBFL(theOBTrxContext, limitprofiletrxvalue, tatEntry);
			}
			else {
				throw (new CommandProcessingException("context is null"));
			}
