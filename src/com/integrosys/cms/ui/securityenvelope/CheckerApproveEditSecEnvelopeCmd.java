...
/**
 * Title: CLIMS
 * Description: for Checker to approve the update request for Security Envelope
 * Copyright: Integro Technologies Sdn Bhd
 * Author: Erene Wong
 * Date: Feb 12, 2010
 */

public class CheckerApproveEditSecEnvelopeCmd extends SecEnvelopeCmd implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public CheckerApproveEditSecEnvelopeCmd() {
    }
