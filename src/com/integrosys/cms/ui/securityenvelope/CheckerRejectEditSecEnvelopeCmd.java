...
/**
 * Title: CLIMS
 * Description: for Checker to reject the update request of Security Envelope
 * Copyright: Integro Technologies Sdn Bhd
 * Author: Erene Wong
 * Date: Feb 07, 2010
 */

public class CheckerRejectEditSecEnvelopeCmd extends SecEnvelopeCmd implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public CheckerRejectEditSecEnvelopeCmd() {
    }
