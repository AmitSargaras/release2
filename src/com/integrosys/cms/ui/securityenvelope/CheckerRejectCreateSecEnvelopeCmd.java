...
/**
 * Title: CLIMS 
 * Description: for Checker to reject the new created Security Envelope
 * Copyright: Integro Technologies Sdn Bhd 
 * Author: Erene Wong
 * Date: Feb 04, 2010
 */

public class CheckerRejectCreateSecEnvelopeCmd extends SecEnvelopeCmd implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public CheckerRejectCreateSecEnvelopeCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            ISecEnvelopeTrxValue trxValueOut = getSecEnvelopeProxy().checkerRejectSecEnvelope(ctx, trxValueIn);

            resultMap.put("request.ITrxValue", trxValueOut);
            DefaultLogger.debug(this, "ISecEnvelopeTrxValue after reject "+trxValueOut);
