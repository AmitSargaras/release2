...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 25, 2007 Time: 1:32:17 AM To
 * change this template use File | Settings | File Templates.
 */
public class UpdateProjectScheduleCommand extends AbstractCommand {

	public UpdateProjectScheduleCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering UpdateProjectScheduleCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside UpdateProjectScheduleCommand doExecute()");
