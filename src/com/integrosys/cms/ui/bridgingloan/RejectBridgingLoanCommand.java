...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 15, 2007 Time: 11:47:51 AM
 * To change this template use File | Settings | File Templates.
 */
public class RejectBridgingLoanCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectBridgingLoanCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			proxy.checkerRejectBridgingLoan(trxContext, trxValue);
