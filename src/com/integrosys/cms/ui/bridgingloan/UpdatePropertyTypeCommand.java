...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 23, 2007 Time: 9:48:12 AM To
 * change this template use File | Settings | File Templates.
 */
public class UpdatePropertyTypeCommand extends AbstractCommand {

	public UpdatePropertyTypeCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering UpdatePropertyTypeCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside UpdatePropertyTypeCommand doExecute()");
