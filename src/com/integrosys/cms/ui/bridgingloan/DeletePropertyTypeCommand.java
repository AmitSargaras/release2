...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 23, 2007 Time: 10:11:41 AM
 * To change this template use File | Settings | File Templates.
 */
public class DeletePropertyTypeCommand extends AbstractCommand {

	public DeletePropertyTypeCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering DeletePropertyTypeCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside DeletePropertyTypeCommand doExecute()");
