...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 16, 2007 Time: 4:41:36 PM To
 * change this template use File | Settings | File Templates.
 */
public class CreatePropertyTypeCommand extends AbstractCommand {

	public CreatePropertyTypeCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering CreatePropertyTypeCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug(this, "Inside CreatePropertyTypeCommand doExecute()");
