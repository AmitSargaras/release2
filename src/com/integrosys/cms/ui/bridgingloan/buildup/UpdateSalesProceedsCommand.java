...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 30, 2007 Time: 11:55:20 AM
 * To change this template use File | Settings | File Templates.
 */
public class UpdateSalesProceedsCommand extends AbstractCommand {

	public UpdateSalesProceedsCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside UpdateSalesProceedsCommand doExecute()");
