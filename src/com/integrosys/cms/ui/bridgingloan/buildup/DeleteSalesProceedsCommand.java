...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 30, 2007 Time: 11:58:14 AM
 * To change this template use File | Settings | File Templates.
 */
public class DeleteSalesProceedsCommand extends AbstractCommand {

	public DeleteSalesProceedsCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering DeleteSalesProceedsCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside DeleteSalesProceedsCommand doExecute()");
