...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 26, 2007 Time: 4:06:53 AM To
 * change this template use File | Settings | File Templates.
 */
public class DeleteBuildUpCommand extends AbstractCommand {

	public DeleteBuildUpCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering DeleteBuildUpCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside DeleteBuildUpCommand doExecute()");
