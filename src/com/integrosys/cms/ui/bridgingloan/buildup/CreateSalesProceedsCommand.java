...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 30, 2007 Time: 11:51:17 AM
 * To change this template use File | Settings | File Templates.
 */
public class CreateSalesProceedsCommand extends AbstractCommand {

	public CreateSalesProceedsCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug(this, ">>>>>>>>>>>> Inside CreateSalesProceedsCommand doExecute()");
