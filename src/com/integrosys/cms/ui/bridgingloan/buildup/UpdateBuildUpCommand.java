...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 25, 2007 Time: 8:03:33 PM To
 * change this template use File | Settings | File Templates.
 */
public class UpdateBuildUpCommand extends AbstractCommand {

	public UpdateBuildUpCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside UpdateBuildUpCommand doExecute()");
