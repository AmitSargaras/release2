...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 25, 2007 Time: 7:26:33 PM To
 * change this template use File | Settings | File Templates.
 */
public class CreateBuildUpCommand extends AbstractCommand {

	public CreateBuildUpCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug(this, ">>>>>>>>>>>> Inside CreateBuildUpCommand doExecute()");
