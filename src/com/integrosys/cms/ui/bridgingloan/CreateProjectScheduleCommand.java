...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 25, 2007 Time: 1:27:21 AM To
 * change this template use File | Settings | File Templates.
 */
public class CreateProjectScheduleCommand extends AbstractCommand {

	public CreateProjectScheduleCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering CreateProjectScheduleCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug(this, "Inside CreateProjectScheduleCommand doExecute()");
