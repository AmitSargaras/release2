...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Apr 25, 2007 Time: 9:42:18 AM To
 * change this template use File | Settings | File Templates.
 */
public class DeleteProjectScheduleCommand extends AbstractCommand {

	public DeleteProjectScheduleCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering DeleteProjectScheduleCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside DeleteProjectScheduleCommand doExecute()");
