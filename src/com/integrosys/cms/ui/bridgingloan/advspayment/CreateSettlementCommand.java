...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 3, 2007 Time: 11:17:08 AM To
 * change this template use File | Settings | File Templates.
 */
public class CreateSettlementCommand extends AbstractCommand {

	public CreateSettlementCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering CreateSettlementCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug(this, ">>>>>>>>>>>> Inside CreateSettlementCommand doExecute()");
