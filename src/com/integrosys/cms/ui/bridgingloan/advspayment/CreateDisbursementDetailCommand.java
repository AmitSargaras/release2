...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Jun 10, 2007 Time: 9:42:08 PM To
 * change this template use File | Settings | File Templates.
 */
public class CreateDisbursementDetailCommand extends AbstractCommand {

	public CreateDisbursementDetailCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering CreateDisbursementDetailCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug(this, ">>>>>>>>>>>> Inside CreateDisbursementDetailCommand doExecute()");
