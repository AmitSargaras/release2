...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 3, 2007 Time: 10:50:07 AM To
 * change this template use File | Settings | File Templates.
 */
public class DeleteDisbursementCommand extends AbstractCommand {

	public DeleteDisbursementCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering DeleteDisbursementCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside DeleteDisbursementCommand doExecute()");
