...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 3, 2007 Time: 10:48:34 AM To
 * change this template use File | Settings | File Templates.
 */
public class UpdateDisbursementCommand extends AbstractCommand {

	public UpdateDisbursementCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering UpdateDisbursementCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside UpdateDisbursementCommand doExecute()");
