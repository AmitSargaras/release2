...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 3, 2007 Time: 12:28:56 PM To
 * change this template use File | Settings | File Templates.
 */
public class DeleteDevelopmentDocCommand extends AbstractCommand {

	public DeleteDevelopmentDocCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering DeleteDevelopmentDocCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside DeleteDevelopmentDocCommand doExecute()");
