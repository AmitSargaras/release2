...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: Jun 10, 2007 Time: 9:52:39 PM To
 * change this template use File | Settings | File Templates.
 */
public class DeleteDisbursementDetailCommand extends AbstractCommand {

	public DeleteDisbursementDetailCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering DeleteDisbursementDetailCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside DeleteDisbursementDetailCommand doExecute()");
