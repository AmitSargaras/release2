...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 9, 2007 Time: 2:29:45 PM To
 * change this template use File | Settings | File Templates.
 */
public class CreateDevelopmentSubDocCommand extends AbstractCommand {

	public CreateDevelopmentSubDocCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering CreateDevelopmentSubDocCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug(this, ">>>>>>>>>>>> Inside CreateDevelopmentSubDocCommand doExecute()");
