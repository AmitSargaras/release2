...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 3, 2007 Time: 11:20:33 AM To
 * change this template use File | Settings | File Templates.
 */
public class DeleteSettlementCommand extends AbstractCommand {

	public DeleteSettlementCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering DeleteSettlementCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside DeleteSettlementCommand doExecute()");
