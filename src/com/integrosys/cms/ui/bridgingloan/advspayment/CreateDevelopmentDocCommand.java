...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 3, 2007 Time: 12:24:30 PM To
 * change this template use File | Settings | File Templates.
 */
public class CreateDevelopmentDocCommand extends AbstractCommand {

	public CreateDevelopmentDocCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering CreateDevelopmentDocCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug(this, ">>>>>>>>>>>> Inside CreateDevelopmentDocCommand doExecute()");
