...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 3, 2007 Time: 11:19:49 AM To
 * change this template use File | Settings | File Templates.
 */
public class UpdateSettlementCommand extends AbstractCommand {

	public UpdateSettlementCommand() {
		DefaultLogger.debug("\n----------------------------->", "Entering UpdateSettlementCommand()");
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException {
		...
		DefaultLogger.debug("\n>>>>>>>>>>>>>>>>>>", "Inside UpdateSettlementCommand doExecute()");
