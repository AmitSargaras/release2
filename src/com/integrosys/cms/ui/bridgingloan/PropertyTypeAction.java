 ...
 * @since $Date$ Tag: $Name$
 */
public class PropertyTypeAction extends BridgingLoanAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_FORM.equals(event) || EVENT_MAKER_PREPARE_CREATE.equals(event)) {
			...
			objArray[0] = new PreparePropertyTypeCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return PropertyTypeValidator.validateInput((PropertyTypeForm) aForm, locale);
	}
