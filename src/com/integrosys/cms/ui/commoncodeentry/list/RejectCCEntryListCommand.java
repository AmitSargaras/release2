...
public class RejectCCEntryListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException,
		...
		try {
			...
			ICommonCodeEntriesTrxValue value = proxy.checkerRejectCategory(trxContext, trxValue);
