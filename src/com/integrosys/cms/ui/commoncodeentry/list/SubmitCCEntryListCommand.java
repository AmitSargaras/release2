...
public class SubmitCCEntryListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException,
		...
		DefaultLogger.debug(this, "In do Execute()");
		...
		try {
			...
			if ((errorMap == null) || (errorMap.size() == 0)) {
				...
				trxValue.getStagingCommonCodeEntries().setCategoryCodeId(ccType.getCommonCategoryId());

				ICommonCodeEntriesTrxValue value = proxy.makerUpdateCategory(trxContext, trxValue, trxValue
						.getStagingCommonCodeEntries());
