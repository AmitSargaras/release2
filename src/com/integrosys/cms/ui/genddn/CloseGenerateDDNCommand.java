 ...
 */
public class CloseGenerateDDNCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CloseGenerateDDNCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ctx.setRemarks(certTrxVal.getRemarks());
			...
			// certTrxVal);
			proxy.makerCloseRejectedGenerateDDN(ctx, certTrxVal);
