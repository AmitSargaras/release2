 ...
 */
public class RejectGenerateDDNCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectGenerateDDNCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// getOrganisationCode());
			certTrxVal = proxy.checkerRejectGenerateDDN(ctx, certTrxVal);
