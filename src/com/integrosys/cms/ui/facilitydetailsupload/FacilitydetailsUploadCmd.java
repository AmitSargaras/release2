...
public class FacilitydetailsUploadCmd extends AbstractCommand implements ICommonEventConstant{

	public FacilitydetailsUploadCmd(){
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
					...
					if(fileUploadJdbc.getFacilitydetailsUplodCount()>0){
						preUpload=true;
					}
					if(!preUpload){
