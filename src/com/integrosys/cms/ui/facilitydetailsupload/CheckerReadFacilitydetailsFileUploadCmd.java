...
public class CheckerReadFacilitydetailsFileUploadCmd extends AbstractCommand implements ICommonEventConstant{
	public CheckerReadFacilitydetailsFileUploadCmd(){
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,ComponentException {
		...
		try {
			...
			fileList=jdbc.getAllFacilitydetailsFile(trxValue.getStagingReferenceID());
			...
			long countFail = 0;
				...
				for (int i = 0; i < uploadList.size(); i++) {
					OBFacilitydetailsFile obj = (OBFacilitydetailsFile) uploadList.get(i);
