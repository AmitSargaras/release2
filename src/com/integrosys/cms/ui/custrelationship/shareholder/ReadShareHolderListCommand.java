 ...
 *
 */
public class ReadShareHolderListCommand extends AbstractCommand {
    ...
    public HashMap doExecute(HashMap map)
        ...
        try {
            ...
            if(trxId == null || trxId.equals("")) {
            	...
            	trxValue = custRelaionshipProxy.getCustShareholderTrxValueByTrxID(theOBTrxContext, trxId);
            ...
            // records.
            if (trxValue.getStagingCustShareholder() == null && 
            		trxValue.getStatus().equals(ICMSConstant.STATE_PENDING_CREATE)) {
                trxValue.setStagingCustShareholder((ICustShareholder[])CommonUtil.deepClone(
                        trxValue.getCustShareholder()));
            }

            if (trxValue.getStatus().equals(ICMSConstant.STATE_ACTIVE) ||
                    trxValue.getStatus().equals(ICMSConstant.STATE_ND) ||
                    ShareHolderListAction.EVENT_READ.equals(event)) {
        ...
        resultMap.put(ShareHolderListForm.MAPPER, trxValue);
