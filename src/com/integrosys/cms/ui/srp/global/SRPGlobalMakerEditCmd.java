 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/srp/global/SRPGlobalMakerEditCmd.java,v 1.2 2003/09/10 09:39:12 dayanand Exp $
 */
 ...
 * @since $Date: 2003/09/10 09:39:12 $ Tag: $Name: $
 */
public class SRPGlobalMakerEditCmd extends AbstractCommand {
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] { { "CollateralSubTypes", "java.util.Collection", FORM_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		Collection paramsCol = (Collection) map.get("CollateralSubTypes");
		OBCollateralSubType[] obCollateralSubTypes = null;
		obCollateralSubTypes = new OBCollateralSubType[paramsCol.size()];
		obCollateralSubTypes = (OBCollateralSubType[]) paramsCol.toArray(obCollateralSubTypes);
		...
		try {
			...
			ICollateralSubTypeTrxValue trxValue = getCollateralParameterProxy().makerUpdateCollateralSubType(
					trxContext, collateralSubTypesTrxVal, obCollateralSubTypes);
			resultMap.put("request.ITrxValue", trxValue);
			resultMap.put("CollateralSubTypeTrxValue", trxValue);
