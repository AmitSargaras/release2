 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/srp/global/SRPGlobalCheckerReadCmd.java,v 1.4 2005/09/08 08:56:22 hshii Exp $
 */
 ...
 */
public class SRPGlobalCheckerReadCmd extends AbstractCommand {
	 ...
	 * Default Constructor
	 */
	public SRPGlobalCheckerReadCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			throw new CommandProcessingException(
					"failed to retrieve collateral sub type workflow value by transaction id [" + trxId + "]", ex);
		}
		...
		subtype = collateralSubTypeTrxVal.getCollateralSubTypes();
		Arrays.sort(subtype);
