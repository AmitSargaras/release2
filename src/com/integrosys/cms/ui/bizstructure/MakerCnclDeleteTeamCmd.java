 ...
 */
public class MakerCnclDeleteTeamCmd extends AbstractTeamCommand implements ICommonEventConstant {

	/**
	 * Default Constructor
	 */
	public MakerCnclDeleteTeamCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			ICompTrxResult trxResult = getCmsTeamProxy().makerCancelDeleteTeam(trxContext, teamTrxVal);
			resultMap.put("request.ITrxResult", trxResult);
		}
		catch (TeamException e) {
			CommandProcessingException cpe = new CommandProcessingException("failed to cancel team deleted");
			cpe.initCause(e);
			throw cpe;
		}
