 ...
 */
public class CheckerRejectAddTeamCmd extends AbstractTeamCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CheckerRejectAddTeamCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			ICompTrxResult trxResult = getCmsTeamProxy().checkerRejectCreateTeam(trxContext, teamTrxVal);
			resultMap.put("request.ITrxResult", trxResult);
		}
		catch (TeamException e) {
			CommandProcessingException cpe = new CommandProcessingException("failed to reject created team");
			cpe.initCause(e);
			throw cpe;
		}
