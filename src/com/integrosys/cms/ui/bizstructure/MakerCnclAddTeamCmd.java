 ...
 */
public class MakerCnclAddTeamCmd extends AbstractTeamCommand implements ICommonEventConstant {

	/**
	 * Default Constructor
	 */
	public MakerCnclAddTeamCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			ICompTrxResult trxResult = getCmsTeamProxy().makerCancelCreateTeam(trxContext, teamTrxVal);
			resultMap.put("request.ITrxResult", trxResult);
		}
		catch (TeamException e) {
			CommandProcessingException cpe = new CommandProcessingException("failed to cancel team created");
			cpe.initCause(e);
			throw cpe;
		}
