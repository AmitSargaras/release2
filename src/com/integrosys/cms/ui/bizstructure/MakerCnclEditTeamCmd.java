 ...
 */
public class MakerCnclEditTeamCmd extends AbstractTeamCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public MakerCnclEditTeamCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			ICompTrxResult trxResult = getCmsTeamProxy().makerCancelUpdateTeam(trxContext, teamTrxVal);
			resultMap.put("request.ITrxResult", trxResult);
		}
		catch (TeamException e) {
			CommandProcessingException cpe = new CommandProcessingException("failed to cancel updated team");
			cpe.initCause(e);
			throw cpe;
		}
