 ...
 */
public class MakerEditTeamCmd extends AbstractTeamCommand implements ICommonEventConstant {

	/**
	 * Default Constructor
	 */
	public MakerEditTeamCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		DefaultLogger.debug(this, "TeamTrxValue before Edit by Maker.........  = ");

		try {
			ICompTrxResult trxResult = getCmsTeamProxy().makerUpdateTeam(trxContext, teamTrxVal, team);
			resultMap.put("request.ITrxResult", trxResult);
		}
		catch (TeamException e) {
			CommandProcessingException cpe = new CommandProcessingException("failed to update maker team");
			cpe.initCause(e);
			throw cpe;
		}
