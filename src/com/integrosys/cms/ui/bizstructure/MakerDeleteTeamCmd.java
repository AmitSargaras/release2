 ...
 */
public class MakerDeleteTeamCmd extends AbstractTeamCommand implements ICommonEventConstant {

	/**
	 * Default Constructor
	 */
	public MakerDeleteTeamCmd() {
	}
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] {
				{ "TeamTrxValue", "com.integrosys.component.bizstructure.app.trx.ITeamTrxValue", SERVICE_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		ITeamTrxValue trxVal = (ITeamTrxValue) map.get("TeamTrxValue");
		OBTrxContext trxContext = (OBTrxContext) map.get("theOBTrxContext");
		try {
			ICompTrxResult trxResult = getCmsTeamProxy().makerDeleteTeam(trxContext, trxVal);
			resultMap.put("request.ITrxResult", trxResult);
		}
		catch (TeamException e) {
			CommandProcessingException cpe = new CommandProcessingException("failed to delete team");
			cpe.initCause(e);
			throw cpe;
		}
