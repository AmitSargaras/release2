...
public class MakerSaveLimitsOfAuthorityCmd extends AbstractCommand implements ICommonEventConstant,
ILimitsOfAuthorityMasterConstant {
	...
	public MakerSaveLimitsOfAuthorityCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (event.equals(LimitsOfAuthorityMasterAction.EVENT_MAKER_UPDATE_DRAFT_LIMITS_OF_AUTHORITY)) { 
