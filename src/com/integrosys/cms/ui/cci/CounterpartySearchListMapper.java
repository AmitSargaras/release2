...
public class CounterpartySearchListMapper extends AbstractCommonMapper {
    /**
     * Default Construtor
     */
    public CounterpartySearchListMapper() {
    ...
    public Object mapFormToOB(CommonForm cForm, HashMap inputs)
        ...
        List list = (List) inputs.get("CounterpartyListMapper");
