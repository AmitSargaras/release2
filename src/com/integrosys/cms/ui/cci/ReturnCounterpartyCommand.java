...
/**
 * This class is used to list the customer details based on some search contsraints
 * @author $Author: hshii $<br>
 * @version $Revision: 1.4 $
 * @since $Date: 2005/05/11 10:25:30 $
 * Tag: $Name:  $
 */
public class ReturnCounterpartyCommand extends AbstractCommand {
    /**
     * Default Constructor
     */
    public ReturnCounterpartyCommand() {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        CustomerSearchCriteria objSearch = (CustomerSearchCriteria) map.get(IGlobalConstant.GLOBAL_CUSTOMERSEARCHCRITERIA_OBJ);
        ...
        if (event.equals("prepare")) {
            ...
            try {
                ...
                SearchResult sr = custproxy.searchCustomerInfoOnly(objSearch);
