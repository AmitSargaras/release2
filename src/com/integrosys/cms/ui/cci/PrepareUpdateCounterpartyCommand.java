...
public class PrepareUpdateCounterpartyCommand extends AbstractCommand {
    ...
    public HashMap doExecute(HashMap inputMap) throws CommandValidationException, CommandProcessingException, AccessDeniedException {
        ...
        ICCICounterparty iCCICounterparty = (ICCICounterparty) inputMap.get("ICCICounterparty");
        ...
        Debug("iCCICounterparty = " + iCCICounterparty);
        ICCICounterparty[] iCCICounterpartyList = null;

        try {
            if (iCCICounterpartyDetails == null) {
                iCCICounterpartyDetails = new OBCCICounterpartyDetails();
                List list = Collections.EMPTY_LIST;
                iCCICounterpartyList = (ICCICounterparty[]) list.toArray(new ICCICounterparty[0]);
            } else {
                iCCICounterpartyList = iCCICounterpartyDetails.getICCICounterparty();
            }

            iCCICounterpartyDetails.setICCICounterparty(iCCICounterpartyList);
