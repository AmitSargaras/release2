 ...
 */
public class SearchListCollateralNewMasterCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public SearchListCollateralNewMasterCommand() {
	   ...
	   public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	            ...
	            collateralNewMasterList= (SearchResult)  getCollateralNewMasterProxy().getAllActual(searchBy, searchText);
