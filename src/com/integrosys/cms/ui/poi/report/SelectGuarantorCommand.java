 ...
 */
public class SelectGuarantorCommand extends AbstractCommand {
	/**
	 * Default Constructor
	 */
	public SelectGuarantorCommand() {
...
//				{ "customerList", "com.integrosys.base.businfra.search.SearchResult", FORM_SCOPE },
				...
				{ "customerSearchCriteria1", "com.integrosys.cms.app.customer.bus.CustomerSearchCriteria",SERVICE_SCOPE },
				{ "guarantorObject", " com.integrosys.cms.app.customer.bus.OBCMSCustomer",SERVICE_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		List guarantorList=(List)map.get("guarantorList");
//		ArrayList resultList = new ArrayList();
//		resultList= (ArrayList) guarantorList.getResultList();
		OBCMSCustomer guarantorObject =(OBCMSCustomer)guarantorList.get(selectId);
		try {
			//ICustomerProxy custproxy = CustomerProxyFactory.getProxy();
			//SearchResult sr = custproxy.searchCustomer(searchCriteria);

			result.put("guarantorList", guarantorList);
			result.put("guarantorObject", guarantorObject);
