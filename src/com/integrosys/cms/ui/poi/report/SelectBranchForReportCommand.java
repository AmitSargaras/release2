 ...
 */
public class SelectBranchForReportCommand extends AbstractCommand {
	/**
	 * Default Constructor
	 */
	public SelectBranchForReportCommand() {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {
				{ "selectedBranchObject", "com.integrosys.cms.app.customer.bus.OBCustomerSearchResult",SERVICE_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		SearchResult sr=(SearchResult)map.get("systemBankBranchList");
		
		ArrayList resultList = (ArrayList) sr.getResultList();
		
		OBSystemBankBranch searchResult =(OBSystemBankBranch)resultList.get(selectId);
			result.put("systemBankBranchList", sr);
			result.put("selectedBranchObject", searchResult);
