...
public class CheckerRejectEditProductMasterCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectEditProductMasterCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		if(remarks == null||remarks.trim().equals("")){
			...
			try {
			    ...
			    IProductMasterTrxValue trxValueOut = getProductMasterProxy().checkerRejectProductMaster(ctx, trxValueIn);
