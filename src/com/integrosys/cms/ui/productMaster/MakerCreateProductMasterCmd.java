...
public class MakerCreateProductMasterCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public MakerCreateProductMasterCmd() {
	}
	 ...
	 /**
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				trxValueOut = getProductMasterProxy().makerCreateProductMaster(ctx,productMaster);
