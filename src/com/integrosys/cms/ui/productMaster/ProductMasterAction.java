...
public class ProductMasterAction extends CommonAction implements IPin{
	...
	public static final String MAKER_LIST_PRODUCT_MASTER= "maker_list_product_master";
	public static final String CHECKER_LIST_PRODUCT_MASTER= "checker_list_product_master";
	public static final String MAKER_PREPARE_CREATE_PRODUCT_MASTER= "maker_prepare_create_product_master";
	public static final String MAKER_CREATE_PRODUCT_MASTER = "maker_create_product_master";
	...
	public static final String MAKER_DRAFT_PRODUCT_MASTER = "maker_draft_product_master";
	public static final String MAKER_UPDATE_DRAFT_PRODUCT_MASTER = "maker_update_draft_product_master";
	//Santosh UBS Limit
	public static final String MAKER_VIEW_PRODUCT_MASTER = "maker_view_product_master";
	public static final String CHECKER_VIEW_PRODUCT_MASTER = "checker_view_product_master";
	public static final String MAKER_EDIT_PRODUCT_MASTER_READ = "maker_edit_product_master_read";
	public static final String MAKER_EDIT_PRODUCT_MASTER = "maker_edit_product_master";
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (event.equals(MAKER_LIST_PRODUCT_MASTER)|| event.equals(CHECKER_LIST_PRODUCT_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("ListProductMasterCmd");

		} else if ((event != null)
				&& event.equals(MAKER_PREPARE_CREATE_PRODUCT_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerPrepareCreateProductMasterCmd");

		}else if ((event.equals(MAKER_CONFIRM_RESUBMIT_CREATE))
				|| event.equals(MAKER_CREATE_PRODUCT_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerCreateProductMasterCmd");
			...
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("CheckerReadProductMasterCmd");
		}else if ((event != null) && event.equals(CHECKER_APPROVE_EDIT)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("CheckerApproveEditProductMasterCmd");
		}else if (event.equals(MAKER_DRAFT_PRODUCT_MASTER)
				|| event.equals(MAKER_UPDATE_DRAFT_PRODUCT_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("MakerSaveProductMasterCmd");
		} 
		//Added by santosh - CR UBS limit
		else if ((event.equals(CHECKER_VIEW_PRODUCT_MASTER))
				|| event.equals(MAKER_VIEW_PRODUCT_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("MakerReadProductMasterCmd");
		}
		else if ((event != null) && event.equals(MAKER_EDIT_PRODUCT_MASTER_READ)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("MakerReadProductMasterCmd");
		}
		else if ((event != null) && event.equals(MAKER_EDIT_PRODUCT_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("MakerEditProductMasterCmd");
		}
		else if ((event.equals(CHECKER_REJECT_CREATE))
				|| event.equals(CHECKER_REJECT_EDIT)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("CheckerRejectEditProductMasterCmd");
		}
			...
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("MakerDeleteProductMasterCmd");
		}
		else if ((event != null) && (event.equals(MAKER_CONFIRM_CLOSE)
				|| event.equals(MAKER_CONFIRM_DRAFT_CLOSE))) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("MakerCloseProductMasterCmd");
		}
	...
	protected String getErrorEvent(String event) {
		...
		}else if (event.equals("maker_create_product_master")|| event.equals("maker_draft_product_master")) {
			errorEvent = "maker_create_product_master_error";
		}else if (event.equals("maker_edit_product_master")) {
			errorEvent = "maker_edit_product_master_error";
		}else if (event.equals("maker_update_draft_product_master")) {
			errorEvent = "maker_edit_product_master_error";
		}else if (event.equals("maker_delete_product_master")) {
		...
		}else if(event.equals("maker_list_product_master")){
			errorEvent="maker_list_product_master";
		}
		return errorEvent;
	}
	protected IPage getNextPage(String event, HashMap resultMap, HashMap exceptionMap) {
		...
		if ((resultMap.get("wip") != null)
			...
			aPage.setPageReference("checker_product_master_page");
			return aPage;
		}else {
	...
	private String getReference(String event) {
		...
		if (event.equals("maker_list_product_master")) {
			forwardName = "list_product_master_page";
		}else if (event.equals("checker_list_product_master")) {
			forwardName = "checker_list_product_master_page";
		}else if (MAKER_PREPARE_CREATE_PRODUCT_MASTER.equals(event) || event.equals("errorCreateSaving") ) {
			forwardName = MAKER_PREPARE_CREATE_PRODUCT_MASTER;
		} else if ((event != null)
				&& event.equals("maker_create_product_master_error")) {
			forwardName = "maker_prepare_create_product_master";
			...
			forwardName = "checker_product_master_page";
		} else if ((event != null) && event.equals("checker_approve_edit")) {
		...
		//added by santosh
				...
				|| event.equals(MAKER_VIEW_PRODUCT_MASTER)) {
			forwardName = "maker_view_product_master_page";
		}else if ((event != null) && event.equals("maker_edit_product_master_read")
				||event.equals("maker_edit_product_master_error")) {
			forwardName = "maker_edit_product_master_read_page";
		}
		else if ((event != null) && event.equals("maker_edit_product_master")
					|| event.equals("maker_confirm_resubmit_delete")
					|| event.equals("maker_draft_product_master")
		...
		else if ((event != null) && event.equals("maker_search_product_master")) {
			forwardName = "list_product_master_page";
		}
		else if ((event.equals("checker_search_list_product_master"))
				|| event.equals("maker_search_list_product_master")) {
