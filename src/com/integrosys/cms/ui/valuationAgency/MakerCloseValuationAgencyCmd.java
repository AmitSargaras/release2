...
public class MakerCloseValuationAgencyCmd extends AbstractCommand implements
	 ...
	 * Default Constructor
	 */
	public MakerCloseValuationAgencyCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
			CommandValidationException, ValuationAgencyException {
		...
		try {
			...
			if (event.equals("maker_confirm_draft_close")) {
				IValuationAgencyTrxValue trxValueOut = getValuationAgencyProxy()
						.makerCloseDraftValuationAgency(ctx, trxValueIn);
				resultMap.put("request.ITrxValue", trxValueOut);
			} else {
				IValuationAgencyTrxValue trxValueOut = getValuationAgencyProxy()
						.makerCloseRejectedValuationAgency(ctx, trxValueIn);
				resultMap.put("request.ITrxValue", trxValueOut);
			}
