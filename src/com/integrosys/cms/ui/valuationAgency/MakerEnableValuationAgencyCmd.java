 ...
 */
public class MakerEnableValuationAgencyCmd extends AbstractCommand implements
	...
	public MakerEnableValuationAgencyCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		try {
			...
			if (event.equals("maker_enable_valuationAgency")) {
				//

				trxValueOut = getValuationAgencyProxy()
						.makerEnableValuationAgency(ctx, trxValueIn,
								valuationAgency);
			} else {
				if( trxValueIn.getFromState().equalsIgnoreCase("PENDING_CREATE") ) // Rejected - then Maker Todo Submit  
