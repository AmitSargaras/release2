 ...
 * 
 */
public class CheckerRejectInsertCountryCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectInsertCountryCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	            ...
	            if(remarks == null || remarks.equals("")){
	            	...
	            	resultMap.put("ICountryTrxValue", trxValueIn);
		            ...
		            ICountryTrxValue trxValueOut = getCountryProxy().checkerRejectInsertCountry(ctx, trxValueIn);
