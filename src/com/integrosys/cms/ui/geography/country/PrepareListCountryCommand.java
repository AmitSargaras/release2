...
public class PrepareListCountryCommand extends AbstractCommand{
	
	public PrepareListCountryCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		DefaultLogger.debug(this, "============ do execute PrepareListCountryCommand ");
