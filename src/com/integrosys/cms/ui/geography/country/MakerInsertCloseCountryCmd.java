...
public class MakerInsertCloseCountryCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerInsertCloseCountryCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            ICountryTrxValue trxValueOut = getCountryProxy().makerInsertCloseRejectedCountry(ctx, trxValueIn);
