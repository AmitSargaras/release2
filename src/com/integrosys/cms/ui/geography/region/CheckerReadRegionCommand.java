...
public class CheckerReadRegionCommand extends AbstractCommand implements
	...
	public CheckerReadRegionCommand() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {
				{ "regionObj",
						"com.integrosys.cms.app.geography.region.bus.OBRegion",
						FORM_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		try {
			...
			String regionCode = (String) (map.get("TrxId"));
			long countryId = 0;
			IRegionTrxValue trxValue = (OBRegionTrxValue) getRegionProxy()
					.getRegionByTrxID(regionCode);

			IRegion region = (OBRegion) trxValue.getStagingRegion();
