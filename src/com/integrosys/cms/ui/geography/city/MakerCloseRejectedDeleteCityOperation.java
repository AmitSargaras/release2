...
import com.integrosys.cms.app.geography.city.trx.AbstractCityTrxOperation;
...
public class MakerCloseRejectedDeleteCityOperation extends
		AbstractCityTrxOperation {

	private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_DELETE_CITY;
	 ...
	 * Defaulc Constructor
	 */
	public MakerCloseRejectedDeleteCityOperation() {
