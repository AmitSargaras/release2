...
public class MakerCloseCityCommand extends AbstractCommand implements
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		try {
			...
			ICityTrxValue trxValueOut = getCityProxy().makerCloseRejectedCity(
					ctx, trxValueIn);
