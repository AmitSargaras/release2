...
public class CheckerRejectCityCommmand extends AbstractCommand implements
	 ...
	 * Default Constructor
	 */
	public CheckerRejectCityCommmand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		try {
			...
			ICityTrxValue trxValueOut = getCityProxy().checkerRejectCity(ctx,
					trxValueIn);
