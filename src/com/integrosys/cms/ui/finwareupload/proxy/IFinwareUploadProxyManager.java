 ...
 */
public interface IFinwareUploadProxyManager {


	public IUbsErrorLog insertFinwarefile(ArrayList result,String fileName,String uploadId,IUbsErrDetLog obUbsErrDetLog[]) throws HolidayException,TrxParameterException,TransactionException;
