...
public class SaveFacilityIslamicMasterToSessionCommand extends FacilityMainCommand {
	public String[][] getParameterDescriptor() {
		return (new String[][] { { FacilityIslamicMasterForm.MAPPER, "com.integrosys.cms.app.limit.bus.IFacilityMaster", FORM_SCOPE }, });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			IFacilityMaster facilityMasterObj = (IFacilityMaster) map.get(FacilityIslamicMasterForm.MAPPER);
