 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/limit/MakerSubmitSystemXrefCommand.java,v 1.6 2003/11/11 04:12:16 pooja Exp $
 */
 ...
 */
public class MakerSubmitSystemXrefCommand extends AbstractCommand {
	/**
	 * Default Constructor
	 */
	public MakerSubmitSystemXrefCommand() {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if ((limittrxvalue.getStatus().equals(ICMSConstant.STATE_ACTIVE))
				...
				DefaultLogger.debug(this, "inside else1111");
			}
