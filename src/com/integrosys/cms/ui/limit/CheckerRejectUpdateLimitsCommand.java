 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/limit/CheckerRejectUpdateLimitsCommand.java,v 1.3 2005/11/07 05:43:01 whuang Exp $
 */
...
public class CheckerRejectUpdateLimitsCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			ICMSTrxResult trxResult = limitProxy.checkerRejectUpdateLimit(trxContext, limitTrxValue);
