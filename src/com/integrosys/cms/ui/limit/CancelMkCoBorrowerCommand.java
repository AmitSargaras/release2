 ...
 */
public class CancelMkCoBorrowerCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CancelMkCoBorrowerCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICMSTrxResult resultOb = coborrowerproxy.makerCancelUpdateCoBorrowerLimit(theOBTrxContext,
