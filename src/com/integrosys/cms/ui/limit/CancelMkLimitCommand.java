 ...
 */
public class CancelMkLimitCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CancelMkLimitCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		ILimitTrxValue iLimitTrxValue = (ILimitTrxValue) map.get("trxValue");
		...
		try {
			...
			theOBTrxContext.setTrxOrganisationOrigin(iLimitTrxValue.getLimit().getBookingLocation()
					.getOrganisationCode());
			ICMSTrxResult resultOb = limitproxy.makerCancelUpdateLimit(theOBTrxContext, iLimitTrxValue);
