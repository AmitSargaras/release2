 ...
 */
public class AppChkLimitCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public AppChkLimitCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			theOBTrxContext.setTrxOrganisationOrigin(iLimitTrxValue.getLimit().getBookingLocation()
					.getOrganisationCode());
			ICMSTrxResult resultOb = limitproxy.checkerApproveUpdateLimit(theOBTrxContext, iLimitTrxValue);
