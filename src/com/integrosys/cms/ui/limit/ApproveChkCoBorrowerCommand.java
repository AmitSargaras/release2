 ...
 */
public class ApproveChkCoBorrowerCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ApproveChkCoBorrowerCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICMSTrxResult resultOb = coborrowerproxy.checkerApproveUpdateCoBorrowerLimit(theOBTrxContext,
