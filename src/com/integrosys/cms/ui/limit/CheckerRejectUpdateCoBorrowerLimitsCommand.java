 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/limit/CheckerRejectUpdateCoBorrowerLimitsCommand.java,v 1.4 2005/11/07 05:43:01 whuang Exp $
 */
...
public class CheckerRejectUpdateCoBorrowerLimitsCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		if ((trxValues != null) && (trxValues.length != 0)) {
			AccessorUtil.copyValue(trxValues[0], coBorrowerLimitTrxValue,
		...
		try {
			ICMSTrxResult trxResult = limitProxy
					.checkerRejectUpdateCoBorrowerLimit(trxContext, coBorrowerLimitTrxValue);
