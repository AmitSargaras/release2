 ...
 */
public class UpdateDocumentLADCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public UpdateDocumentLADCommand() {
	}
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] {
				...
				{ "ladDocumentDate", "java.lang.String", REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			String ladDocDate=(String)map.get("ladDocumentDate");
			long id=Long.parseLong(ladId);
			List listDate=new ArrayList();
			List list=getLadProxy().getLAD(limitProfileID,"REC");
			if(list!=null){
...
//					expDate.setYear(df.parse(ladRecDate).getYear()+3);
					...
					ilad.setDocument_date(df.parse(ladDocDate));
