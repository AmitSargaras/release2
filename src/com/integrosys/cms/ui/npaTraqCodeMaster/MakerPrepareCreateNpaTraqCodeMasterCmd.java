...
public class MakerPrepareCreateNpaTraqCodeMasterCmd extends AbstractCommand implements
ICommonEventConstant{
	 ...
	 * Default Constructor
	 */
	public MakerPrepareCreateNpaTraqCodeMasterCmd() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {
			{"INpaTraqCodeMasterTrxValue", "com.integrosys.cms.app.npaTraqCodeMaster.trx.OBNpaTraqCodeMasterTrxValue", SERVICE_SCOPE}
		});
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		OBNpaTraqCodeMasterTrxValue npaTraqCodeMasterTrxValue = new OBNpaTraqCodeMasterTrxValue();

		resultMap.put("INpaTraqCodeMasterTrxValue", npaTraqCodeMasterTrxValue);
