...
public class MakerEditNpaTraqCodeMasterCmd extends AbstractCommand implements ICommonEventConstant{
	 ...
	 * Default Constructor
	 */
	public MakerEditNpaTraqCodeMasterCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if(trxValueIn.getFromState().equals("PENDING_PERFECTION")){
				...
				trxValueOut = getNpaTraqCodeMasterProxy().makerUpdateSaveCreateNpaTraqCodeMaster(ctx, trxValueIn,npaTraqCodeMaster);
			}
			else{
				if( event.equals("maker_edit_npa_traq_code_master") ||event.equals("maker_save_update") ){
					...
					trxValueOut = getNpaTraqCodeMasterProxy().makerUpdateNpaTraqCodeMaster(ctx, trxValueIn,npaTraqCodeMaster);
				}
