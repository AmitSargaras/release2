...
public class ListNpaTraqCodeMasterCmd extends AbstractCommand implements ICommonEventConstant{
	 ...
	 * Default Constructor
	 */
	public ListNpaTraqCodeMasterCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
 		...
 		//commented for just listing
 			//if(null == searchText ||"".equals(searchText))
 				npaTraqCodeMasterList= (SearchResult)   getNpaTraqCodeMasterProxy().getAllActualNpaTraqCodeMaster();
	        //else
	        	//productMasterList= (SearchResult)  getNpaTraqCodeMasterProxy().getAllFilteredActualProductMaster(type,searchText);	
