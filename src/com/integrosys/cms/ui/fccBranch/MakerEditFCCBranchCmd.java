...
* Command for edit FCCBranch
 */
public class MakerEditFCCBranchCmd extends AbstractCommand implements ICommonEventConstant {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if(trxValueIn.getFromState().equals("PENDING_PERFECTION")){
					...
					trxValueOut = getFccBranchProxy().makerUpdateSaveCreateFCCBranch(ctx, trxValueIn, fccBranch);
				}else{
					if ((event.equals("maker_edit_fccBranch"))||event.equals("maker_delete_fccBranch")||event.equals("maker_save_update")) {
						...
						trxValueOut = getFccBranchProxy().makerUpdateFCCBranch(ctx, trxValueIn, fccBranch);
					} else {
