 ...
 * Command for maker to close the rejected FCCBranch trx value
 */

public class MakerCloseFCCBranchCmd extends AbstractCommand implements ICommonEventConstant {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,FCCBranchException {
        ...
        try {
            ...
            if(event.equals("maker_confirm_draft_close")){
            	IFCCBranchTrxValue trxValueOut = getFccBranchProxy().makerCloseDraftFCCBranch(ctx, trxValueIn);
            	 resultMap.put("request.ITrxValue", trxValueOut);
            }else{
            IFCCBranchTrxValue trxValueOut = getFccBranchProxy().makerCloseRejectedFCCBranch(ctx, trxValueIn);
            resultMap.put("request.ITrxValue", trxValueOut);
            }
