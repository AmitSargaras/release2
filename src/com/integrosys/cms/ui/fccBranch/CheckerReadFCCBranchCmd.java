...
/**
 *$Author: Abhijit R $
 *Command for checker to read FCCBranch Trx value
 */
public class CheckerReadFCCBranchCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerReadFCCBranchCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,FCCBranchException {
		...
		try {
			...
			String txnId=(String) (map.get("TrxId"));
			String event = (String) map.get("event");
			// function to get FCCBranch Trx value
			trxValue = (OBFCCBranchTrxValue) getFccBranchProxy().getFCCBranchByTrxID(txnId);
			
			fccBranch = (OBFCCBranch) trxValue.getStagingFCCBranch();
