...
* Command for Save FCCBranch
 */
public class MakerSaveFCCBranchCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if(event.equals("maker_update_draft_fccBranch")){
					IFCCBranchTrxValue trxValueIn = (OBFCCBranchTrxValue) map.get("IFCCBranchTrxValue");
					trxValueOut = getFccBranchProxy().makerUpdateSaveUpdateFCCBranch(ctx, trxValueIn, fccBranch);
					
					resultMap.put("request.ITrxValue", trxValueOut);
				}else{
				
				trxValueOut = getFccBranchProxy().makerSaveFCCBranch(ctx,fccBranch);
