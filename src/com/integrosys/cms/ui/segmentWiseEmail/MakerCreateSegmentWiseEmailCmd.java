...
public class MakerCreateSegmentWiseEmailCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public MakerCreateSegmentWiseEmailCmd() {
	}
	 ...
	 */
	 public String[][] getParameterDescriptor() {
	        return (new String[][]{
	                ...
	                {"event","java.lang.String",FORM_SCOPE},
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if("maker_confirm_resubmit_create".equals(event)) {
					trxValueOut = getSegmentWiseEmailProxy().makerCreateRejectedSegmentWiseEmail(ctx,segmentWiseEmail);
				}
				else {
					trxValueOut = getSegmentWiseEmailProxy().makerCreateSegmentWiseEmail(ctx,segmentWiseEmail);
				}
