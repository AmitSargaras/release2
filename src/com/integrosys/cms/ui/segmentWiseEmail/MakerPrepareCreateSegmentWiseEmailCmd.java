...
public class MakerPrepareCreateSegmentWiseEmailCmd extends AbstractCommand implements
ICommonEventConstant{
	 ...
	 * Default Constructor
	 */
	public MakerPrepareCreateSegmentWiseEmailCmd() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {
			{"ISegmentWiseEmailTrxValue", "com.integrosys.cms.app.segmentWiseEmail.trx.OBSegmentWiseEmailTrxValue", SERVICE_SCOPE}
		});
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		OBSegmentWiseEmailTrxValue segmentWiseEmailTrxValue = new OBSegmentWiseEmailTrxValue();

		resultMap.put("ISegmentWiseEmailTrxValue", segmentWiseEmailTrxValue);
