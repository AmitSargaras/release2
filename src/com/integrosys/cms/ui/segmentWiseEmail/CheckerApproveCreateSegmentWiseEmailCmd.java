...
public class CheckerApproveCreateSegmentWiseEmailCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerApproveCreateSegmentWiseEmailCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if(null!=trxValueOut && null!=trxValueOut.getReferenceID() && null!=trxValueOut.getStagingReferenceID()) {
				...
				ISegmentWiseEmail segmentWiseEmail= trxValueIn.getSegmentWiseEmail();
				String status=segmentWiseEmail.getStatus();
