...
public class AcknowledgmentUploadCmd extends AbstractCommand implements ICommonEventConstant{

	public AcknowledgmentUploadCmd(){
	}
	/**
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
					...
					if(fileUploadJdbc.getAcknowledgmentUplodCount()>0){
						preUpload=true;
					}
					if(!preUpload){
