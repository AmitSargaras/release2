...
package com.integrosys.cms.ui.acknowledgmentupload.proxy;
...
import com.integrosys.cms.batch.acknowledgment.IAcknowledgmentErrDetLog;
import com.integrosys.cms.batch.acknowledgment.IAcknowledgmentErrorLog;
import com.integrosys.cms.ui.acknowledgmentupload.AcknowledgmentUploadException;
 ...
 * 
 */
public class AcknowledgmentUploadProxyManagerImpl implements IAcknowledgmentUploadProxyManager {
	...
	private IFileUploadTrxValue formulateTrxValue(ITrxContext anITrxContext, IFileUploadTrxValue anFile) {
		...
		anFile.setTransactionType(ICMSConstant.ACKNOWLEDGMENT_UPLOAD);
        return anFile;
    }
	...
	private IFileUploadTrxValue operate(IFileUploadTrxValue anFileTrxValue, OBCMSTrxParameter anOBCMSTrxParameter) throws FileUploadException,TrxParameterException,TransactionException {
	 ...
	 public IFileUploadTrxValue getFielUploadByTrxID(String aTrxID)throws FileUploadException, TransactionException,
		CommandProcessingException {
		 ...
		 trxValue.setTransactionType(ICMSConstant.ACKNOWLEDGMENT_UPLOAD);
		 OBCMSTrxParameter param = new OBCMSTrxParameter();
