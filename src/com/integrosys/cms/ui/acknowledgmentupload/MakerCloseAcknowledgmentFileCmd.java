...
public class MakerCloseAcknowledgmentFileCmd extends AbstractCommand implements ICommonEventConstant{
	public MakerCloseAcknowledgmentFileCmd(){		
			}
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,FileUploadException {
        ...
        try {
            ...
            IFileUploadTrxValue trxValueOut = getAcknowledgmentuploadProxy().makerCloseRejectUbsFile(ctx, trxValueIn);
