 ...
 */
public class ListCompareBondListCommand extends BondCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException,
		...
		IBondFeedGroupTrxValue trxValue = (IBondFeedGroupTrxValue) map.get("bondFeedGroupTrxValue");

		List compareResultsList = (List) map.get("compareResultsList");

		targetOffset = BondListMapper.adjustOffset(targetOffset, length, compareResultsList.size());
