 ...
 */
public class RejectBondListCommand extends BondCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if(remarks == null || remarks.equals("")){
            	...
            	resultMap.put("IBondFeedGroupTrxValue", trxValue);
			...
			value = getBondFeedProxy().checkerRejectBondFeedGroup(trxContext, value);
