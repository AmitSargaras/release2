 ...
 */
public class UnitTrustListForm extends TrxContextForm implements java.io.Serializable {
	...
	public static final String MAPPER = "com.integrosys.cms.ui.feed.unittrust.list.UnitTrustListMapper";

	private String[] updatedUnitPrices;

	private String[] chkDeletes;

	private String[] unitTrustNames;
	...
	public String[] getUnitTrustNames() {
		return unitTrustNames;
	}

	public void setUnitTrustNames(String[] unitTrustNames) {
		this.unitTrustNames = unitTrustNames;
	}
