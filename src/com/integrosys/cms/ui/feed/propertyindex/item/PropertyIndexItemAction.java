 ...
 */
public class PropertyIndexItemAction extends PropertyIndexAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE.equals(event)) {
			return new ICommand[] { new PreparePropertyIndexItemCommand() };
		}
		else if (EVENT_SAVE.equals(event)) {
			return new ICommand[] { new SavePropertyIndexItemCommand() };
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		DefaultLogger.debug(this, "Inside validate Input  class" + ((PropertyIndexItemForm) aForm));

		return PropertyIndexItemFormValidator.validateInput((PropertyIndexItemForm) aForm, locale);
	}
