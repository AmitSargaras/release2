 ...
 */
public class ComparePropertyIndexListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException,
		...
		IPropertyIndexFeedGroup actualFeedGroup = value.getPropertyIndexFeedGroup();
		IPropertyIndexFeedGroup stagingFeedGroup = value.getStagingPropertyIndexFeedGroup();
		...
		if ((actualFeedGroup != null) && (actualFeedGroup.getFeedEntries() != null)) {
			...
			for (int i = 0; i < actualFeedGroup.getFeedEntries().length; i++) {
				...
				DefaultLogger.debug(this, "ref " + i + " = "
						+ String.valueOf(actualFeedGroup.getFeedEntries()[i].getPropertyIndexFeedEntryRef()));
			}
		}
		if ((stagingFeedGroup != null) && (stagingFeedGroup.getFeedEntries() != null)) {
			...
			for (int i = 0; i < stagingFeedGroup.getFeedEntries().length; i++) {
				...
				DefaultLogger.debug(this, "ref " + i + " = "
						+ String.valueOf(stagingFeedGroup.getFeedEntries()[i].getPropertyIndexFeedEntryRef()));
			}
		}
		...
		try {
			...
			offset = PropertyIndexListMapper.adjustOffset(offset, length, compareResultsList.size());
