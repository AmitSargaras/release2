 ...
 */
public class DeletePropertyIndexListCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			IPropertyIndexFeedGroup inputFeedGroup = (IPropertyIndexFeedGroup) inputList.get(0);
			...
			IPropertyIndexFeedEntry[] newEntriesArr = new IPropertyIndexFeedEntry[entriesArr.length
			...
			offset = PropertyIndexListMapper.adjustOffset(offset, length, newEntriesArr.length);
