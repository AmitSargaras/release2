...
public class SubmitGoldListCommand extends GoldCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (value.getStatus().equals(ICMSConstant.STATE_REJECTED)) {
				resultValue = proxy.makerSubmitRejectedGoldFeedGroup(trxContext, value);
			}
			else {
				resultValue = proxy.makerSubmitGoldFeedGroup(trxContext, value, value.getStagingGoldFeedGroup());
			}
