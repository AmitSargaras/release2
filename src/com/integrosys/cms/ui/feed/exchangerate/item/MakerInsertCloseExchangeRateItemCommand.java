...
public class MakerInsertCloseExchangeRateItemCommand extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerInsertCloseExchangeRateItemCommand() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IForexFeedGroupTrxValue trxValueOut = getForexFeedProxy().makerInsertCloseRejectedForexFeedEntry(ctx, trxValueIn);
