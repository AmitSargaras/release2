 ...
 */
public class ReadExchangeRateListCommand extends ExchangeRateCommand {
			...
			if (entriesArr == null) {
				...
				Arrays.sort(entriesArr, new Comparator() {
					public int compare(Object a, Object b) {
						...
						if (entry1.getSystemCode() == null) {
							entry1.setSystemCode("");
						}
						if (entry2.getSystemCode() == null) {
							entry2.setSystemCode("");
						}
						return entry1.getSystemCode().compareTo(entry2.getSystemCode());
					}
				});
			}
		}
