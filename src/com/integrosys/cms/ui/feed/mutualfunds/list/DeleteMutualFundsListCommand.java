 ...
 */
public class DeleteMutualFundsListCommand extends MutualFundsCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			IMutualFundsFeedGroup inputFeedGroup = (IMutualFundsFeedGroup) inputList.get(0);
			...
			IMutualFundsFeedEntry[] newEntriesArr = new IMutualFundsFeedEntry[entriesArr.length - indexDeletesArr.length];
			counter = 0; // reuse
			...
			offset = MutualFundsListMapper.adjustOffset(offset, length, newEntriesArr.length);
