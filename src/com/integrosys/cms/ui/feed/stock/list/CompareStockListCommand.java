 ...
 */
public class CompareStockListCommand extends StockCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException,
		...
		IStockFeedGroup actualFeedGroup = value.getStockFeedGroup();
		IStockFeedGroup stagingFeedGroup = value.getStagingStockFeedGroup();
/*
		if ((actualFeedGroup != null) && (actualFeedGroup.getFeedEntries() != null)) {
			...
			for (int i = 0; i < actualFeedGroup.getFeedEntries().length; i++) {
				...
				DefaultLogger.debug(this, "ref " + i + " = "
						+ String.valueOf(actualFeedGroup.getFeedEntries()[i].getStockFeedEntryRef()));
			}
		}
		if ((stagingFeedGroup != null) && (stagingFeedGroup.getFeedEntries() != null)) {
			...
			for (int i = 0; i < stagingFeedGroup.getFeedEntries().length; i++) {
				...
				DefaultLogger.debug(this, "ref " + i + " = "
						+ String.valueOf(stagingFeedGroup.getFeedEntries()[i].getStockFeedEntryRef()));
			}
		}
*/		
		try {
			...
			offset = StockListMapper.adjustOffset(offset, length, compareResultsList.size());
