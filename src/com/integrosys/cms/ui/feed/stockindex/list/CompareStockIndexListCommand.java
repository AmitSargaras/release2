 ...
 */
public class CompareStockIndexListCommand extends StockIndexCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException,
		...
		IStockIndexFeedGroup actualFeedGroup = value.getStockIndexFeedGroup();
		...
		if ((actualFeedGroup != null) && (actualFeedGroup.getFeedEntries() != null)) {
			...
			for (int i = 0; i < actualFeedGroup.getFeedEntries().length; i++) {
				...
				DefaultLogger.debug(this, "ref " + i + " = "
						+ String.valueOf(actualFeedGroup.getFeedEntries()[i].getStockIndexFeedEntryRef()));
			}
		}
		if ((stagingFeedGroup != null) && (stagingFeedGroup.getFeedEntries() != null)) {
			...
			for (int i = 0; i < stagingFeedGroup.getFeedEntries().length; i++) {
				...
				DefaultLogger.debug(this, "ref " + i + " = "
						+ String.valueOf(stagingFeedGroup.getFeedEntries()[i].getStockIndexFeedEntryRef()));
			}
		}
		...
		try {
			...
			offset = StockIndexListMapper.adjustOffset(offset, length, compareResultsList.size());
