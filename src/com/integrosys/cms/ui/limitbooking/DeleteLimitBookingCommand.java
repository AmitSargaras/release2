...
public class DeleteLimitBookingCommand extends AbstractCommand implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public DeleteLimitBookingCommand() {
        DefaultLogger.debug(this,"Inside Delete Command >>>>>>>>>>>>>>>>>>>>>>>>>>>");
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
        	...
        	ILimitBookingTrxValue newTrxValue = proxy.makerDeleteLimitBooking(ctx, trxVal, Long.toString(ctx.getUser().getUserID()));
