...
public class EditLimitBookingCommand extends AbstractCommand implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public EditLimitBookingCommand() {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        try {
        	...
        	ILimitBookingTrxValue newTrxValue = proxy.makerUpdateLimitBooking(ctx, trxVal, sesslimitbooking);
