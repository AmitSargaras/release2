...
public class PrepareEditPOLCommand extends AbstractCommand implements ICommonEventConstant {
    /**
     * Default Constructor
     */
    public PrepareEditPOLCommand() {
        DefaultLogger.debug(this,"Inside PrepareEditPOLCommand >>>>>>>>>>>>>>>>>>>>>>>>>>>");
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        OBLimitBookingDetail dtl = null;
        for (Iterator iterator = pol.iterator(); iterator.hasNext();) {
            dtl = (OBLimitBookingDetail) iterator.next();
        ...
        resultMap.put(LimitBookingAction.LIMIT_BOOKING_DETAIL,dtl);
