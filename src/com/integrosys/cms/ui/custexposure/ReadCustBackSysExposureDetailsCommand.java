 ...
 */
public class ReadCustBackSysExposureDetailsCommand extends AbstractCommand {

    public ReadCustBackSysExposureDetailsCommand() {
    ...
    public String[][] getResultDescriptor() {
        return (new String[][]{
                ...
                {"coborrowerLimitMap", "java.util.HashMap", REQUEST_SCOPE},
                {"ICustExposure", "com.integrosys.cms.app.custexposure.bus.ICustExposure", SERVICE_SCOPE},
                {"session.ICustExposure", "com.integrosys.cms.app.custexposure.bus.ICustExposure", SERVICE_SCOPE},
        }
        );
    }
    ...
    public HashMap doExecute(HashMap inputMap) throws CommandProcessingException, CommandValidationException {
        ...
        try {
            ...
            if (subProfileID != 0){
                ...
                Debug("getBackSysExposure by >>>>>>>>>> " + subProfileID);
                ...
                Debug("getLimits by >>>>>>>>>> " + subProfileID);
    ...
    private void Debug(String msg) {
    	DefaultLogger.debug(this,ReadCustBackSysExposureDetailsCommand.class.getName() + " = " + msg);
    }
