 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/concentrationreport/CheckerRejectEditConcReportCmd.java,v 1.1 2003/09/24 09:55:54 pooja Exp $
 */
...
/**
 * Command class to add the new ConcReport by admin maker on the corresponding
 * event...
 * @author $Author: pooja $<br>
 * @version $Revision: 1.1 $
 * @since $Date: 2003/09/24 09:55:54 $ Tag: $Name: $
 */
public class CheckerRejectEditConcReportCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CheckerRejectEditConcReportCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			proxy.checkerRejectUpdate(trxContext, businessParameterGroupTrxVal);
			resultMap.put("request.ITrxValue", businessParameterGroupTrxVal);
		}
