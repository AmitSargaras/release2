 ...
 * 
 */
public class CheckerRejectActivatePartyGroupCmd extends AbstractCommand
	 ...
	 * Default Constructor
	 */
	public CheckerRejectActivatePartyGroupCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		try {
			...
			IPartyGroupTrxValue trxValueOut = getPartyGroupProxy()
					.checkerRejectPartyGroup(ctx, trxValueIn);
