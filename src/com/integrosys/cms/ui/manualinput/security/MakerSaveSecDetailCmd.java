 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class MakerSaveSecDetailCmd extends AbstractCommand {
	public String[][] getParameterDescriptor() {
		return (new String[][] {
				{ "secTrxObj", "com.integrosys.cms.app.collateral.trx.ICollateralTrxValue", SERVICE_SCOPE },
				{ "theOBTrxContext", "com.integrosys.cms.app.transaction.OBTrxContext", FORM_SCOPE },
				{ "secDetailForm", "java.lang.Object", FORM_SCOPE }, { "isCreate", "java.lang.String", REQUEST_SCOPE } });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,
		...
		try {
			...
			if ("y".equals(isCreate)) {
				res = proxy.createCollateralTrx(ctx, secTrxObj, true);
				result.put("request.ITrxResult", res);
			}
			else {
				res = proxy.makerUpdateCollateralTrx(ctx, secTrxObj, true);
				result.put("request.ITrxResult", res);
			}
		}
		catch (Exception ex) {
