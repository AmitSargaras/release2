...
public class CheckerRejectCreateCustomerCommand extends AbstractCommand{
	
	public CheckerRejectCreateCustomerCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICMSCustomerTrxValue trxValueOut = CustomerProxyFactory.getProxy().checkerRejectCreateCustomer(ctx, trxValueIn);
