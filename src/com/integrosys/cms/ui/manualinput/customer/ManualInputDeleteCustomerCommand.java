...
public class ManualInputDeleteCustomerCommand extends AbstractCommand{
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			trxValueOut = (ICMSTrxResult)CustomerProxyFactory.getProxy().prepareDeleteCustomer(ctx, trxValueIn, customer);
