...
public class SaveEditedPartyGroupCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		OBSubline subline =new OBSubline();
		try {
			...
			if (partyGrpList == null) {
				...
				if(event.equals("save_edited_party_group_in_edit") || event.equals("save_edited_party_group_in_resubmit") )
				{	
					subline = (OBSubline)partyGrpList.get((Integer.parseInt(index))-1);
				...
				partyGrpList.add((Integer.parseInt(index))-1, subline);
