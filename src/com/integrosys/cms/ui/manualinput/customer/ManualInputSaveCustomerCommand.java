...
public class ManualInputSaveCustomerCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		try {
			...
			{
				trx = CustomerProxyFactory.getProxy().saveCustomerBrmaker(trxValue);
			...
			{
				trx = CustomerProxyFactory.getProxy().saveCustomer(trxValue);
				resultMap.put("customerOb", trx);
				resultMap.put("request.ITrxValue", trx);
				resultMap.put("validate","N");
			}
