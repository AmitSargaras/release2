...
public class ManualInputMakerCloseCustomerCommand extends AbstractCommand implements ICommonEventConstant {
    
		
	/**
     * Default Constructor
     */
    public ManualInputMakerCloseCustomerCommand() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,CustomerException {
		...
		try {
			...
			trxValueOut = (ICMSCustomerTrxValue) CustomerProxyFactory.getProxy().makerCloseRejectedCustomer(ctx, trxValueIn);
