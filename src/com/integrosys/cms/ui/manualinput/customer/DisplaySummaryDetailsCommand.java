...
public class DisplaySummaryDetailsCommand extends AbstractCommand {
	...
	private List getRbiIndustryCodeList(String indName) {
		...
		try {
			...
			while( itSet.hasNext() ){
				...
				//String value =rBICateCodeHashMap.get(oBIndustryCodeCategory.getRbiCodeCategoryId()).toString()+"("+oBIndustryCodeCategory.getRbiCodeCategoryId()+")";
