...
public class ManualInputCreateDraftCustomerCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		ICMSCustomerTrxValue trxValue = (ICMSCustomerTrxValue) map.get("ICMSCustomerTrxValue");
		...
		obCustomer.getCMSLegalEntity().setCriFacList(criFac);
	...
	//	DefaultLogger.debug(this, " -------- Before Create : " + obCustomer);
		...
		try {
			...
			{
				trx = CustomerProxyFactory.getProxy().createDraftCustomerBrmaker(trxValue);
				resultMap.put("customerOb", trx);
				resultMap.put("request.ITrxValue", trx);
			}else
			{
				trx = CustomerProxyFactory.getProxy().createDraftCustomer(trxValue);
				resultMap.put("customerOb", trx);
				resultMap.put("request.ITrxValue", trx);
			}
