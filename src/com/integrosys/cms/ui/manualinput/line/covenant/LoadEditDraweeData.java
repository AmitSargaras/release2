...
public class LoadEditDraweeData extends AbstractCommand implements ILmtCovenantConstants, ILineCovenantConstants{
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	    ...
	    list = (List)map.get(SESSION_DRAWEE_LIST_LINE);
