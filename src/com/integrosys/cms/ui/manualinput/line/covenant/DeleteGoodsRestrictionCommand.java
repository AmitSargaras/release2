...
public class DeleteGoodsRestrictionCommand extends AbstractCommand implements ILmtCovenantConstants,ILineCovenantConstants {
	...
	public String[][] getResultDescriptor() {
		...
		return (new String[][] {
			...
			{ COVENANT_DETAIL_FORM,ILineCovenant.class.getName(), FORM_SCOPE },
			{ SESSION_COVENANT_GOODS_RESTRICTION_LIST, List.class.getName() , SERVICE_SCOPE },
			{ "event", "java.lang.String", REQUEST_SCOPE }, 
			});
	}
	...
	if(AbstractCommonMapper.isEmptyOrNull(event)) {
		event="delete_goods_restriction";
	}
	...
	private List<OBLineCovenant> deleteGoodsRestrictionItems(List<OBLineCovenant> list, List<String> comboList) {
		if(!CollectionUtils.isEmpty(list)) {
			Iterator<OBLineCovenant> itr = list.iterator();
			while(itr.hasNext()) {
	...
	private List<String> getChildGoodsCodeComboByParent(List<OBLineCovenant> list, String goodsCodeParentCombo) {
	...
	private List<String> getSubChildGoodsCodeComboByChild(List<OBLineCovenant> list, String goodsCodeChildCombo) {
