...
public class LoadEditDrawerData extends AbstractCommand implements ILmtCovenantConstants, ILineCovenantConstants{
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	    ...
	    list = (List)map.get(SESSION_DRAWER_LIST_LINE);
