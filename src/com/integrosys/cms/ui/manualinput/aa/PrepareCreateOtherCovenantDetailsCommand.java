...
public class PrepareCreateOtherCovenantDetailsCommand extends AbstractCommand
		implements
	...
	public String[][] getParameterDescriptor() {
		return (new String[][]{{"event", "java.lang.String", SERVICE_SCOPE},
				...
				{"aaID", "java.lang.String", SERVICE_SCOPE},
	...
	public String[][] getResultDescriptor() {
		...
		return (new String[][]{{"event", "java.lang.String", SERVICE_SCOPE},
				...
				{"branchName", "java.lang.String", SERVICE_SCOPE},
				{"customerID", "java.lang.String", SERVICE_SCOPE},
				{"otherCovenantDetailsList", "java.util.List",
						SERVICE_SCOPE},});
	}
	...
	public HashMap doExecute(HashMap map)
		...
		try {
			String chargeID = (new SequenceManager())
					.getSeqNum("SCI_LSP_OTHER_COVENANT_SEQ", true);
			System.out.println(
					"------------------------------->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>.Id from DB SEQ"
							+ chargeID);
		} catch (Exception e1) {
