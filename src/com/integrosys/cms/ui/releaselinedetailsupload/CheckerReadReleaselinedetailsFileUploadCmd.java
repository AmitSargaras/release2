...
public class CheckerReadReleaselinedetailsFileUploadCmd extends AbstractCommand implements ICommonEventConstant{
	public CheckerReadReleaselinedetailsFileUploadCmd(){
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,ComponentException {
		...
		try {
			...
			fileList=jdbc.getAllReleaselinedetailsFile(trxValue.getStagingReferenceID());
			...
			long countFail = 0;
				...
				for (int i = 0; i < uploadList.size(); i++) {
					OBReleaselinedetailsFile obj = (OBReleaselinedetailsFile) uploadList.get(i);
