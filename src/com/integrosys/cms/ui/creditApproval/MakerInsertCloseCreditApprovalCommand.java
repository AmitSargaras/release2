...
public class MakerInsertCloseCreditApprovalCommand extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerInsertCloseCreditApprovalCommand() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            ICreditApprovalTrxValue trxValueOut = getCreditApprovalProxy().makerInsertCloseRejectedCreditApproval(ctx, trxValueIn);
