...
public class MakerCloseBulkUDFFileCmd extends AbstractCommand implements ICommonEventConstant{
	...
	public MakerCloseBulkUDFFileCmd(){
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,FileUploadException {
        ...
        try {
            ...
            IFileUploadTrxValue trxValueOut = getBulkudfuploadProxy().makerCloseRejectUbsFile(ctx, trxValueIn);
