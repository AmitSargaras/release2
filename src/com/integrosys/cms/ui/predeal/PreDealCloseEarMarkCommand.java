 ...
 * $Header$
 *
 * PreDealCloseEarMarkCommand
 *
 * Created on 2:47:31 PM
 *
 * Purpose:
 * Description:
 *
...
/**
 * Created by IntelliJ IDEA. User: Eric Date: Apr 2, 2007 Time: 2:47:31 PM
 */
public class PreDealCloseEarMarkCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap hashMap) throws CommandValidationException, CommandProcessingException,
		...
		try {
			...
			result.put("request.ITrxValue", proxy.makerCloseEar(trxContext, trxValue, trxValue.getStagingPreDeal()));
		}
		catch (PreDealException e) {
			DefaultLogger.debug(this, "Error closing ear Mark ", e);
		}
