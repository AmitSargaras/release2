 ...
 * $Header$
 *
 * PreDealConfrimRejectCommand
 *
 * Created on 11:37:50 AM
 *
 * Purpose:
 * Description:
 *
...
/**
 * Created by IntelliJ IDEA. User: Eric Date: Apr 2, 2007 Time: 11:37:50 AM
 */
public class PreDealConfirmRejectCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap hashMap) throws CommandValidationException, CommandProcessingException,
		...
		try {
			...
			result.put("request.ITrxValue", proxy.checkerReject(trxContext, trxValue));
		}
		catch (PreDealException e) {
			DefaultLogger.debug(this, "Error rejecting new ear Mark ", e);
		}
