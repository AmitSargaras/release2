 ...
 * $Header$
 *
 * PreDealUpdateRejectNewEarMarkCommand
 *
 * Created on 4:52:11 PM
 *
 * Purpose:
 * Description:
 *
...
/**
 * Created by IntelliJ IDEA. User: Eric Date: Apr 2, 2007 Time: 4:52:11 PM
 */
public class PreDealUpdateRejectNewEarMarkCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap hashMap) throws CommandValidationException, CommandProcessingException,
		...
		try {
			...
			ICMSTrxValue iTrxValue = proxy.makerUpdateRejectedEar(trxContext, trxValue, trxValue.getStagingPreDeal());
