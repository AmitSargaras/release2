...
public class EndOfDayBaselUpdateReportCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException {
		...
		Object status= getEndOfDayBatchService().performBaselUpdateReport();
