 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/tat/RedirectCloseCommand.java,v 1.7 2006/04/19 09:42:58 jychong Exp $
 */
 ...
 */
public class RedirectCloseCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RedirectCloseCommand() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "event", "java.lang.String", REQUEST_SCOPE },
				{ "trxID", "java.lang.String", REQUEST_SCOPE }, { "closeToDo", "java.lang.String", REQUEST_SCOPE } });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			 ...
			 * resultMap.put("closeToDo", "Tat"); else if
