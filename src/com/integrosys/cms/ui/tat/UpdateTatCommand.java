 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/tat/UpdateTatCommand.java,v 1.8 2004/06/10 10:37:31 pooja Exp $
 */
 ...
 * @since $Date: 2004/06/10 10:37:31 $ Tag: $Name: $
 */
public class UpdateTatCommand extends AbstractCommand {
	/**
	 * Default Constructor
	 */
	public UpdateTatCommand() {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICMSTrxResult resultOb = limitproxy.makerCreateTAT(theOBTrxContext, txnvalue, limitprofileOb);
