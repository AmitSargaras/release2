 ...
 */
public class CloseGeneratePSCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CloseGeneratePSCCCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// getOrganisationCode());
			proxy.makerCloseRejectedGeneratePartialSCC(ctx, certTrxVal);
