 ...
 */
public class RejectGeneratePSCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectGeneratePSCCCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// getOrganisationCode());
			certTrxVal = proxy.checkerRejectGeneratePartialSCC(ctx, certTrxVal);
