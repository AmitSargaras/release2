 ...
 */
public class TotalGeneratePSCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public TotalGeneratePSCCCommand() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "cert", "com.integrosys.cms.app.sccertificate.bus.IPartialSCCertificate",
				SERVICE_SCOPE }, });
	}
