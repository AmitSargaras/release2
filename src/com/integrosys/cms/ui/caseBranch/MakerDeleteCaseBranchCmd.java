...
*Command for Delete CaseBranch
 */
public class MakerDeleteCaseBranchCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerDeleteCaseBranchCmd() {
	}
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				ICaseBranchTrxValue trxValueOut = new OBCaseBranchTrxValue();
					...
					if (event.equals("maker_delete_caseBranch")) {
						trxValueOut = getCaseBranchProxy().makerDeleteCaseBranch(ctx, trxValueIn, caseBranch);
					} else {
