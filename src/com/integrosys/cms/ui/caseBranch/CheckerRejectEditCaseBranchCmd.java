 ...
 * 
 */
public class CheckerRejectEditCaseBranchCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectEditCaseBranchCmd() {
	}
		 ...
		 HashMap returnMap = new HashMap();
	        HashMap resultMap = new HashMap();
	            ...
	            if(remarks == null||remarks.trim().equals("")){
					exceptionMap.put("caseBranchRemarksError", new ActionMessage("error.reject.remark"));
	            ...
	            ICaseBranchTrxValue trxValueOut = getCaseBranchProxy().checkerRejectCaseBranch(ctx, trxValueIn);
