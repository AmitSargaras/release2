 ...
 */
public class MakerCreateCaseBranchCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerCreateCaseBranchCmd() {
	}
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				trxValueOut = getCaseBranchProxy().makerCreateCaseBranch(ctx,caseBranch);
