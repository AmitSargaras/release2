 ...
 * Command for maker to close the rejected CaseBranch trx value
 */

public class MakerCloseCaseBranchCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerCloseCaseBranchCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,CaseBranchException {
        ...
        try {
            ...
            if(event.equals("maker_confirm_draft_close")){
            	ICaseBranchTrxValue trxValueOut = getCaseBranchProxy().makerCloseDraftCaseBranch(ctx, trxValueIn);
            	 resultMap.put("request.ITrxValue", trxValueOut);
            }else{
            ICaseBranchTrxValue trxValueOut = getCaseBranchProxy().makerCloseRejectedCaseBranch(ctx, trxValueIn);
            resultMap.put("request.ITrxValue", trxValueOut);
            }
