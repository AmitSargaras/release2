...
public class CheckerApproveInsertCaseBranchCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerApproveInsertCaseBranchCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICaseBranchTrxValue trxValueOut = getCaseBranchProxy().checkerApproveInsertCaseBranch(ctx, trxValueIn);
			
			//--------------getList--------------------
			String tempTrxValue = trxValueOut.getCurrentTrxHistoryID();
	        
	        
			List listId = getCaseBranchProxy().getFileMasterList(trxValueOut.getTransactionID());
			...
			for (int i = 0; i < listId.size(); i++) {
    			...
    			ICaseBranch refCaseBranch = getCaseBranchProxy().insertActualCaseBranch(regStage);
    			 
    			 trxValue = getCaseBranchProxy().checkerCreateCaseBranch(ctx, refCaseBranch, regStage);
