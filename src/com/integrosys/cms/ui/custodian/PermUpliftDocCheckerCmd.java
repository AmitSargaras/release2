...
/**
 * Command class to approve the perm uplift of the custodian doc by the
 * checker..
 * @author $Author: jychong $<br>
 * @version $Revision: 1.9.12.1 $
 * @since $Date: 2006/12/14 12:22:26 $ Tag: $Name: DEV_20060126_B286V1 $
 */
public class PermUpliftDocCheckerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public PermUpliftDocCheckerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICMSTrxValue trxValue = proxy.approvePermUplift(theOBTrxContext, iCustodianTrxValue);

			ICheckListProxyManager mgr = CheckListProxyManagerFactory.getCheckListProxyManager();
			mgr.systemUpdateCheckList(iCustodianTrxValue.getCustodianDoc().getCheckListID());
