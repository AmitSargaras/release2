 ...
 */
public class AuthzPermUpliftDocMakerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public AuthzPermUpliftDocMakerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// lodgeCustodianTrxVal.getCustodianDoc().getCheckListID()));
			...
			proxy.authzPermUpliftDocMaker(theOBTrxContext, lodgeCustodianTrxVal);
		}
		catch (Exception e) {
