/**
f * Copyright Integro Technologies Pte Ltd
 * $Header:
 */
...
/**
 * Command class to lodge the custodian doc by maker
 * @author $Author: vishal $<br>
 * @version $Revision: 1.12 $
 * @since $Date: 2005/07/25 18:26:51 $ Tag: $Name: $
 */
public class LodgeDocMakerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public LodgeDocMakerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			 ...
			 * proxy.lodgeDocMaker(theOBTrxContext,lodgeCustodianTrxVal
