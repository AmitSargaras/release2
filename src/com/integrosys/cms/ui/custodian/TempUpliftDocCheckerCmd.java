...
/**
 * Command class to approve the temp uplift of the doc by checker..
 * @author $Author: jychong $<br>
 * @version $Revision: 1.8.12.1 $
 * @since $Date: 2006/12/14 12:22:26 $ Tag: $Name: DEV_20060126_B286V1 $
 */
public class TempUpliftDocCheckerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public TempUpliftDocCheckerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICMSTrxValue trxValue = proxy.approveTempUplift(theOBTrxContext, iCustodianTrxValue);
