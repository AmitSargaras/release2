 ...
 */
public class AuthzPermUpliftDocCheckerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public AuthzPermUpliftDocCheckerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			proxy.authzPermUpliftChecker(theOBTrxContext, iCustodianTrxValue);
		}
		catch (Exception e) {
