 ...
 * @since $Date: 2004/04/19 07:53:46 $ Tag: $Name: $
 */
public class ListReversalMemoCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ListReversalMemoCmd() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "docList", "com.integrosys.base.businfra.search.SearchResult", SERVICE_SCOPE } });
	}
		...
		try {
			...
			if (cust.getNonBorrowerInd()) {
				if (limitProfile != null) {
					sr = proxy.getPendingReversalListForNonBorrower(theOBTrxContext, limitProfile.getLimitProfileID(),
							cust.getCustomerID());
				}
