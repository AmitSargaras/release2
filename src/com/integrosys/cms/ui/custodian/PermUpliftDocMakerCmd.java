...
/**
 * Command class to perm uplift the custodian doc by maker...
 * @author $Author: vishal $<br>
 * @version $Revision: 1.10 $
 * @since $Date: 2005/07/25 18:27:26 $ Tag: $Name: $
 */
public class PermUpliftDocMakerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public PermUpliftDocMakerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			 ...
			 * proxy.permUplift(theOBTrxContext,lodgeCustodianTrxVal,custDoc);
