 ...
 */
public class CreateCustodianDocCheckerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CreateCustodianDocCheckerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			proxy.createDocChecker(theOBTrxContext, iCustodianTrxValue);
		}
		catch (Exception e) {
