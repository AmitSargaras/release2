 ...
 */
public class RejectCustodianCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectCustodianCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		// .getTrxCountryOrigin());
		DefaultLogger.debug(this, ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>  = " + theOBTrxContext.getRemarks());
		// DefaultLogger.debug(this,
		// "Inside doExecute() >> NewCustodianDoc  = "+theOBTrxContext);
		try {
			...
			// proxy.rejectCustodian(theOBTrxContext,iCustodianTrxValue);
			ICMSTrxValue trxValue = proxy.checkerRejectCustodianDoc(theOBTrxContext, iCustodianTrxValue);
			// end CR-34
