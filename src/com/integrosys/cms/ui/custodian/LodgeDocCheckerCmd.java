...
/**
 * Command class to approve the lodge of custodian doc by checker
 * @author $Author: jychong $<br>
 * @version $Revision: 1.11.12.1 $
 * @since $Date: 2006/12/14 12:22:26 $ Tag: $Name: DEV_20060126_B286V1 $
 */
public class LodgeDocCheckerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public LodgeDocCheckerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		// .getTrxCountryOrigin());
		DefaultLogger.debug(this, "Inside doExecute() >> CustodianDoc  = " + theOBTrxContext);
		try {
			...
			ICMSTrxValue trxValue = proxy.lodgeDocChecker(theOBTrxContext, iCustodianTrxValue);
