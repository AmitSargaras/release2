...
/**
 * Command class to approve the relodgement of the custodian doc by checker..
 * @author $Author: jychong $<br>
 * @version $Revision: 1.8.12.1 $
 * @since $Date: 2006/12/14 12:22:26 $ Tag: $Name: DEV_20060126_B286V1 $
 */
public class RelodgeDocCheckerCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RelodgeDocCheckerCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICMSTrxValue trxValue = proxy.reLodgeDocChecker(theOBTrxContext, iCustodianTrxValue);
