 ...
 */
public class CheckerReadFacilityNewMasterCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerReadFacilityNewMasterCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
		...
		try {
			...
			// function to get FacilityNewMaster Trx value
			trxValue = (OBFacilityNewMasterTrxValue) getFacilityNewMasterProxy().getFacilityNewMasterByTrxID(branchCode);
			
			facilityNewMaster = (OBFacilityNewMaster) trxValue.getStagingFacilityNewMaster();
