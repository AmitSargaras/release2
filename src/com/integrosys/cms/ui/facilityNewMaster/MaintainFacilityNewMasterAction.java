...
/**
 * @author $Author: Abhijit R$ Action For FacilityNewMaster
 */
public class MaintainFacilityNewMasterAction extends CommonAction implements IPin {
	...
	// public static final String EVENT_LIST = "maker_list_facilityNewMaster";
	public static final String MAKER_LIST_FACILITY_NEW_MASTER = "maker_list_facilityNewMaster";
	public static final String CHECKER_LIST_FACILITY_NEW_MASTER = "checker_list_facilityNewMaster";
	public static final String CHECKER_VIEW_FACILITY_NEW_MASTER = "checker_view_facilityNewMaster";
	public static final String MAKER_VIEW_FACILITY_NEW_MASTER = "maker_view_facilityNewMaster";
	public static final String MAKER_EDIT_FACILITY_NEW_MASTER_READ = "maker_edit_facilityNewMaster_read";
	...
	public static final String MAKER_EDIT_FACILITY_NEW_MASTER = "maker_edit_facilityNewMaster";
	public static final String MAKER_DELETE_FACILITY_NEW_MASTER = "maker_delete_facilityNewMaster";
	...
	public static final String REDIRECT_LIST_FACILITY_NEW_MASTER = "redirect_list_facilityNewMaster";
	public static final String MAKER_DELETE_FACILITY_NEW_MASTER_READ = "maker_delete_facilityNewMaster_read";
	public static final String MAKER_EDIT_REJECT_EDIT = "maker_edit_reject_edit";
	public static final String MAKER_SEARCH_FACILITY_NEW_MASTER = "maker_search_facilityNewMaster";
	...
	public static final String MAKER_SEARCH_LIST_FACILITY_NEW_MASTER = "maker_search_list_facilityNewMaster";
	public static final String CHECKER_SEARCH_LIST_FACILITY_NEW_MASTER = "checker_search_list_facilityNewMaster";
	...
	public static final String MAKER_PREPARE_CREATE_FACILITY_NEW_MASTER = "maker_prepare_create_facilityNewMaster";
	public static final String MAKER_CREATE_FACILITY_NEW_MASTER = "maker_create_facilityNewMaster";
	public static final String MAKER_DRAFT_FACILITY_NEW_MASTER = "maker_draft_facilityNewMaster";
	...
	public static final String MAKER_UPDATE_DRAFT_FACILITY_NEW_MASTER = "maker_update_draft_facilityNewMaster";
	...
	public ICommand[] getCommandChain(String event) {
		...
		DefaultLogger.debug(this,"In Maintain FacilityNewMaster Action with event --" + event);

		ICommand objArray[] = null;
		if ((event.equals(CHECKER_LIST_FACILITY_NEW_MASTER))
				|| event.equals(MAKER_LIST_FACILITY_NEW_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("ListFacilityNewMasterCmd");

		} else if ((event.equals(CHECKER_VIEW_FACILITY_NEW_MASTER))
				|| event.equals(MAKER_VIEW_FACILITY_NEW_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerReadFacilityNewMasterCmd");

		} else if ((event != null) && event.equals(MAKER_EDIT_FACILITY_NEW_MASTER_READ)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerReadFacilityNewMasterCmd");
		} else if ((event.equals(MAKER_CONFIRM_RESUBMIT_EDIT))
				|| event.equals(MAKER_EDIT_FACILITY_NEW_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerEditFacilityNewMasterCmd");
		} else if ((event != null) && (event.equals(MAKER_DELETE_FACILITY_NEW_MASTER_READ))) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerReadFacilityNewMasterCmd");

		} else if ((event.equals(MAKER_CONFIRM_RESUBMIT_DELETE))
				|| event.equals(MAKER_DELETE_FACILITY_NEW_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerDeleteFacilityNewMasterCmd");
		} else if ((event.equals(MAKER_SEARCH_LIST_FACILITY_NEW_MASTER))
				|| event.equals(CHECKER_SEARCH_LIST_FACILITY_NEW_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"SearchListFacilityNewMasterCommand");
			...
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerCloseFacilityNewMasterCmd");
		} else if ((event != null)
				&& event.equals(MAKER_PREPARE_CREATE_FACILITY_NEW_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerPrepareCreateFacilityNewMasterCmd");

		} else if ((event.equals(MAKER_CONFIRM_RESUBMIT_CREATE))
				|| event.equals(MAKER_CREATE_FACILITY_NEW_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerCreateFacilityNewMasterCmd");

		} else if (event.equals(MAKER_DRAFT_FACILITY_NEW_MASTER)
				|| event.equals(MAKER_UPDATE_DRAFT_FACILITY_NEW_MASTER)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerSaveFacilityNewMasterCmd");
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return FacilityNewMasterValidator.validateInput(aForm, locale);
	}

	protected boolean isValidationRequired(String event) {
		boolean result = false;
		if (event.equals(MAKER_EDIT_FACILITY_NEW_MASTER)
				|| event.equals(MAKER_EDIT_REJECT_EDIT)
				|| event.equals(MAKER_SEARCH_FACILITY_NEW_MASTER)
				|| event.equals(MAKER_CONFIRM_RESUBMIT_EDIT)
				|| event.equals(MAKER_CONFIRM_RESUBMIT_CREATE)
				|| event.equals(MAKER_CREATE_FACILITY_NEW_MASTER)
				|| event.equals(MAKER_DRAFT_FACILITY_NEW_MASTER)
				|| event.equals("maker_update_draft_facilityNewMaster")
				|| event.equals(MAKER_SAVE_UPDATE)
				|| event.equals("maker_list_facilityNewMaster")
				|| event.equals("checker_list_facilityNewMaster")
	...
	public IPage getNextPage(String event, HashMap resultMap,
		...
		if ((resultMap.get("wip") != null)
			...
			aPage.setPageReference("maker_add_edit_facilityNewMaster_page");
			return aPage;
		} else {
	...
	protected String getErrorEvent(String event) {
		...
		if ("maker_add_facilityNewMaster".equals(event)) {
			errorEvent = "maker_add_edit_facilityNewMaster_error";
		}else if ("maker_edit_facilityNewMaster".equals(event)
		...
		} else if (event.equals("maker_search_facilityNewMaster")) {
			errorEvent = "maker_prepare_search_facilityNewMaster";
		}else if (event.equals("maker_create_facilityNewMaster")|| event.equals("maker_draft_facilityNewMaster")) {
			errorEvent = "maker_create_facilityNewMaster_error";
		...
		}else if(event.equals("maker_list_facilityNewMaster")){
			errorEvent = "maker_list_facilityNewMaster";
		}else if(event.equals("checker_list_facilityNewMaster")){
			errorEvent = "checker_list_facilityNewMaster";
		}
		else if (event.equals("maker_update_draft_facilityNewMaster")) 
			errorEvent = "maker_update_draft_facilityNewMaster_error";
		return errorEvent;
	}
	...
	private String getReference(String event) {
		...
		if (event.equals("maker_list_facilityNewMaster")) {
			forwardName = "maker_list_facilityNewMaster_page";
		} else if ((event != null) && event.equals("checker_list_facilityNewMaster")) {
			forwardName = "checker_list_facilityNewMaster_page";
		}else if (event.equals("checker_list_facilityNewMaster")) {
			forwardName = "checker_list_facilityNewMaster_page";
		}
		else if ((event != null) && event.equals("maker_search_facilityNewMaster")) {
			forwardName = "maker_list_facilityNewMaster_page";
		} else if ((event != null) && event.equals("checker_list_pagination")) {
			forwardName = "checker_list_facilityNewMaster_page";
		} else if (event.equals("list_pagination")) {
			forwardName = "maker_list_facilityNewMaster_page";
		} else if ((event != null) && event.equals("redirect_list_facilityNewMaster")) {
			forwardName = "maker_list_facilityNewMaster_page";
		} else if ((event != null) && event.equals("maker_prepare_add_facilityNewMaster")) {
			forwardName = "maker_add_edit_facilityNewMaster_page";
		} else if ((event != null) && event.equals("maker_add_facilityNewMaster")) {
			forwardName = "common_submit_page";
		} else if ((event.equals("checker_view_facilityNewMaster"))
				|| event.equals("maker_view_facilityNewMaster")) {
			forwardName = "maker_view_page";
		} else if ((event.equals("checker_view_facilityNewMaster"))
				|| event.equals("maker_view_facilityNewMaster")) {
			forwardName = "checker_view_page";
		} else if ((event != null) && ( event.equals("maker_edit_facilityNewMaster_read") || event.equals("maker_update_draft_facilityNewMaster_error")) ) {
			forwardName = "maker_add_edit_facilityNewMaster_page";
		} else if ((event.equals("maker_confirm_resubmit_edit"))
				|| event.equals("maker_edit_facilityNewMaster")
				|| event.equals("maker_confirm_resubmit_delete")
				|| event.equals("maker_create_facilityNewMaster")
				|| event.equals("maker_draft_facilityNewMaster")
				|| event.equals("maker_confirm_resubmit_create")
				|| event.equals("maker_save_create")
				|| event.equals("maker_save_update")
				|| event.equals("maker_update_draft_facilityNewMaster")) {
			forwardName = "common_submit_page";
		} else if ((event != null) && event.equals("maker_delete_facilityNewMaster_read")) {
		...
		} else if ((event != null) && event.equals("maker_delete_facilityNewMaster")) {
			forwardName = "common_submit_page";
		} else if ((event != null) && event.equals("checker_add_read")) {
			forwardName = "checker_facilityNewMaster_page";
			...
			forwardName = "work_in_process_page";
				...
				&& event.equals("maker_add_edit_facilityNewMaster_error")) {
			forwardName = "maker_add_edit_facilityNewMaster_page";
			...
			forwardName = "checker_facilityNewMaster_page";
				...
				&& event.equals("maker_prepare_search_facilityNewMaster")) {
			forwardName = "search_facilityNewMaster_page";
		} else if ((event.equals("checker_search_list_facilityNewMaster"))
				|| event.equals("maker_search_list_facilityNewMaster")) {
			forwardName = "maker_list_facilityNewMaster_page";
			...
			forwardName = "common_close_page";
				...
				&& event.equals("maker_prepare_create_facilityNewMaster")) {
			forwardName = "prepare_create_facilityNewMaster";
		} else if (event.equals("maker_prepare_resubmit_create")) {
			forwardName = "maker_prepare_resubmit";
		}else if ((event != null)
				&& (event.equals("maker_create_facilityNewMaster_error"))) {
			forwardName = "prepare_create_facilityNewMaster";
