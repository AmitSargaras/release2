 ...
 */
public class MakerDeleteFacilityNewMasterCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerDeleteFacilityNewMasterCmd() {
	}
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if (event.equals("maker_delete_facilityNewMaster")) {
					trxValueOut = getFacilityNewMasterProxy().makerDeleteFacilityNewMaster(ctx, trxValueIn, facilityNewMaster);
				} else {
