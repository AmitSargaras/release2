 ...
 */
public class SubmitContractFinancingCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public SubmitContractFinancingCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (trxValue.getContractFinancing() != null) { // have actual
				trxValue = proxy.makerUpdateContractFinancing(trxContext, trxValue, obContractFinancing);
			}
			else { // no actual
				if (trxValue.getStagingContractFinancing() != null) {
					// do nothing
				}
				else {
				...
				trxValue = proxy.makerCreateContractFinancing(trxContext, trxValue, obContractFinancing);
			}
