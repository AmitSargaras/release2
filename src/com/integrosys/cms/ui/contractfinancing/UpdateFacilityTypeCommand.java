 ...
 */
public class UpdateFacilityTypeCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public UpdateFacilityTypeCommand() {
	}
	...
	public HashMap doExecute(HashMap hashMap) throws CommandProcessingException {
		...
		try {
			DefaultLogger.debug(this, "in UpdateFDRCommand");
