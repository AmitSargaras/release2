 ...
 */
public class DeleteFacilityTypeCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public DeleteFacilityTypeCommand() {
	}
	...
	public HashMap doExecute(HashMap hashMap) throws CommandProcessingException {
		...
		try {
			DefaultLogger.debug(this, "in DeleteTNCCommand");
