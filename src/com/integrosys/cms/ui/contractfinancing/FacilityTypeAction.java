 ...
 * @since $Date$ Tag: $Name$
 */
public class FacilityTypeAction extends ContractFinancingAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_FORM.equals(event) || EVENT_MAKER_PREPARE_CREATE.equals(event)) {
			...
			objArray[0] = new PrepareFacilityTypeCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		return FacilityTypeValidator.validateInput((FacilityTypeForm) aForm, locale);
	}
