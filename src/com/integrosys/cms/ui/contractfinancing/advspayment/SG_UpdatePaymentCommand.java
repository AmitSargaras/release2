 ...
 */
public class SG_UpdatePaymentCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public SG_UpdatePaymentCommand() {
	}
	...
	public HashMap doExecute(HashMap hashMap) throws CommandProcessingException {
		...
		try {
			DefaultLogger.debug(this, "in UpdatePaymentCommand");
