...
public class CheckerRejectSubmitTatParamCmd extends TatDurationCommand implements ICommonEventConstant 
{
    /**
     * Default Constructor
     */
    public CheckerRejectSubmitTatParamCmd() 
    {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException 
    {
        ...
        try 
        {
            ...
            ITatParamTrxValue trxValueOut = getTatParamProxy().checkerRejectTatParam(ctx, trxValueIn);
