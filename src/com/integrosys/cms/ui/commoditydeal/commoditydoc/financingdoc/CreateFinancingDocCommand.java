 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commoditydeal/commoditydoc/financingdoc/CreateFinancingDocCommand.java,v 1.3 2005/10/24 07:13:45 czhou Exp $
 */
...
public class CreateFinancingDocCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		IFinancingDoc financingDoc = (IFinancingDoc) map.get("financingDocObj");
		...
		Date locDueDate = financingDoc.getLOCDueDate();
		...
		if (exceptionMap.isEmpty()) {
			...
			finDocArr = addFinancingDoc(finDocArr, financingDoc);
	...
	public static IFinancingDoc[] addFinancingDoc(IFinancingDoc[] existingArray, IFinancingDoc obj) {
		int arrayLength = 0;
		if (existingArray != null) {
			arrayLength = existingArray.length;
		}

		IFinancingDoc[] newArray = new IFinancingDoc[arrayLength + 1];
		if (existingArray != null) {
