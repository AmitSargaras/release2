 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/commoditydeal/commoditydoc/titledoc/DeleteWarehouseReceiptCommand.java,v 1.2 2004/06/04 05:05:58 hltan Exp $
 */
 ...
 */
public class DeleteWarehouseReceiptCommand extends AbstractCommand {
	public String[][] getParameterDescriptor() {
		return (new String[][] { { "titleDocObj",
				"com.integrosys.cms.app.commodity.deal.bus.doc.ICommodityTitleDocument", FORM_SCOPE }, });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		result.put("titleDocObj", titleDocObj);
