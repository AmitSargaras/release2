 ...
 */
public class SubmitFacilityMasterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public SubmitFacilityMasterCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			FacilityMasterForm fcform = (FacilityMasterForm) map.get("fcform");
			...
			template.setCollateralSubType(template.getCollateralType());
		//	template.setCollateralSubType("CAM");
			//template.setCollateralType("CAM");
		//	template.setTemplateType(aTemplateType)
			...
			if (temp != null) {
				for (int i = 0; i < temp.length; i++) {
					...
					template.getTemplateItemList()[i].setFacilityCategory((String) map.get("facilityCategory"));
					template.getTemplateItemList()[i].setSystem((String) map.get("system"));
					template.getTemplateItemList()[i].setFacilityType((String) map.get("facilityType"));
				}
			}
			...
			if (secTrxVal == null) {
				...
				if (temp1 != null) {
					for (int i = 0; i < temp1.length; i++) {
                        ...
                        /*template.getTemplateItemList()[i].setFacilityCategory("ABC");
    					template.getTemplateItemList()[i].setSystem("XYZ");
    					template.getTemplateItemList()[i].setFacilityType("UVW");*/
                        template.getTemplateItemList()[i].setFacilityCategory((String) map.get("facilityCategory"));
    					template.getTemplateItemList()[i].setSystem((String) map.get("system"));
    					template.getTemplateItemList()[i].setFacilityType((String) map.get("facilityType"));
					}
