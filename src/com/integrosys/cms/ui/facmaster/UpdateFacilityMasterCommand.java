 ...
 */
public class UpdateFacilityMasterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public UpdateFacilityMasterCommand() {
	}
		...
		try {
			...
			if (temp1 != null) {
				for (int i = 0; i < temp1.length; i++) {
					...
					template.getTemplateItemList()[i].setFacilityCategory(facCategory);;
					template.getTemplateItemList()[i].setFacilityType(facType);
					template.getTemplateItemList()[i].setSystem(facSystem);
