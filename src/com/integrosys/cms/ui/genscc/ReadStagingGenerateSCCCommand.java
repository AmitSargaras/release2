 ...
 */
public class ReadStagingGenerateSCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ReadStagingGenerateSCCCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			HashMap hm = proxy.getSCCertificate(limit, cust, custTypeTrxID);
			...
			ISCCertificate cert = certTrxVal.getStagingSCCertificate();
			refreshLocationDetails(cert, resultMap); // R1.5 CMS-3342
	...
	private void refreshLocationDetails(ISCCertificate cert, HashMap resultMap) {
