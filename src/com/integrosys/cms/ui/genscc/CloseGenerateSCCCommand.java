 ...
 */
public class CloseGenerateSCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CloseGenerateSCCCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// getOrganisationCode());
			proxy.makerCloseRejectedGenerateSCC(ctx, certTrxVal);
