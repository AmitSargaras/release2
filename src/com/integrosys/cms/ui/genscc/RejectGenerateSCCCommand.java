 ...
 */
public class RejectGenerateSCCCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectGenerateSCCCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// getOrganisationCode());
			certTrxVal = proxy.checkerRejectGenerateSCC(ctx, certTrxVal);
