 ...
 * @since $Date: 2006/06/02 05:36:43 $ Tag: $Name: $
 */

public class GenerateSCCForm extends TrxContextForm implements Serializable {
	...
	*/
	...
	public String[][] getMapper() {
		...
		// {"limitProfile","com.integrosys.cms.ui.genscc.LimitProfileMapper"},
				{ "cert", "com.integrosys.cms.ui.genscc.CertMapper" } };
		return input;
	}

    public String toString() {
        return "GenerateSCCForm{" +
