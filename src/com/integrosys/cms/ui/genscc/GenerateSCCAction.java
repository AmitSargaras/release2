 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/genscc/GenerateSCCAction.java,v 1.9 2006/09/29 09:41:37 czhou Exp $
 */
 ...
 * @since $Date: 2006/09/29 09:41:37 $ Tag: $Name: $
 */
public class GenerateSCCAction extends CommonAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if ("generate_scc".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new PrepareGenerateSCCCommand();
			objArray[1] = new GenerateSCCCommand();
			objArray[2] = new FrameFlagSetterCommand();
		}
		else if ("refresh_gen_scc".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new RefreshGenerateSCCCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("submit".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new SubmitGenerateSCCCommand();
			objArray[1] = new RefreshGenerateSCCCommand();
			objArray[2] = new FrameFlagSetterCommand();
		}
		else if ("approve".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new ApproveGenerateSCCCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("reject".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new RejectGenerateSCCCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
			...
			objArray = new ICommand[3];
			objArray[0] = new PrepareGenerateSCCCommand();
			objArray[1] = new ReadStagingGenerateSCCCommand();
			objArray[2] = new FrameFlagSetterCommand();
		}
		else if ("close".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new CloseGenerateSCCCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("total".equals(event)) {
			objArray = new ICommand[4];
			objArray[0] = new PrepareGenerateSCCCommand();
			objArray[1] = new TotalGenerateSCCCommand();
			objArray[2] = new RefreshGenerateSCCCommand();
			...
			objArray = new ICommand[2];
			objArray[0] = new PreparePrintGenerateSCCCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
		else if ("update_view_outer_limit_bca".equals(event)) {
			objArray = new ICommand[4];
			objArray[0] = new SaveGenerateSCCCommand();
			...
			objArray = new ICommand[3];
			objArray[0] = new ViewReturnGenerateSCCCommand();
			objArray[1] = new PrepareGenerateSCCCommand();
			objArray[2] = new FrameFlagSetterCommand();
		}
		else if ("update_return".equals(event)) {
			objArray = new ICommand[3];
			objArray[0] = new ReturnGenerateSCCCommand();
			objArray[1] = new PrepareGenerateSCCCommand();
			objArray[2] = new FrameFlagSetterCommand();
		}
		else if ("view_generate_scc".equals(event)) {
			objArray = new ICommand[2];
			objArray[0] = new GenerateSCCCommand();
			objArray[1] = new FrameFlagSetterCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		// )aForm,locale);
		return GenerateSCCFormValidator.validateInput((GenerateSCCForm) aForm, locale);
	}
	...
	private String getReference(String event) {
		...
		if ("generate_scc".equals(event) || "total".equals(event) || "prepare_form".equals(event)
				|| "update_return".equals(event) || "refresh_gen_scc".equals(event)) {
			forwardName = "after_generate_scc";
		}
		...
		if ("close_item".equals(event) || "to_track".equals(event) || "view_return".equals(event)
				|| "view_generate_scc".equals(event)) {
