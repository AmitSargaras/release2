 ...
 */
public class RejectGenerateReqWaiverCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectGenerateReqWaiverCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (ICMSConstant.STATE_PENDING_RM_VERIFY.equals(iTrxValue.getStatus())) {
				iTrxValue = proxy.rmRejectGenerateRequest(ctx, iTrxValue);
			}
			else {
				iTrxValue = proxy.checkerRejectGenerateRequest(ctx, iTrxValue);
			}
