 ...
 */
public class GenerateReqWaiverFormValidator {
	public static ActionErrors validateInput(GenerateReqWaiverForm aForm, Locale locale) {
		ActionErrors errors = new ActionErrors();
		String errorCode = "";
		DefaultLogger.debug("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", "Inside Validation");
		if (!(errorCode = Validator.checkString(aForm.getWaiverReason(), true, 1, 640)).equals(Validator.ERROR_NONE)) {
			errors.add("waiverReason", new ActionMessage(ErrorKeyMapper.map(ErrorKeyMapper.STRING, errorCode), "1",
					"640"));
		}
