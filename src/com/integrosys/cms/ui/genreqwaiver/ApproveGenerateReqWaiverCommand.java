 ...
 */
public class ApproveGenerateReqWaiverCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ApproveGenerateReqWaiverCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			if (ICMSConstant.STATE_PENDING_RM_VERIFY.equals(iTrxValue.getStatus())) {
				iTrxValue = proxy.rmApproveGenerateRequest(ctx, iTrxValue);
			}
			else {
				iTrxValue = proxy.checkerApproveGenerateRequest(ctx, iTrxValue);
			}
