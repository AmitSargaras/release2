 ...
 */
public class RemoveRecoveryIncomeCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RemoveRecoveryIncomeCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		liquidation.removeIncomeItems(removeAry, recoveryType);
