 ...
 */
public class PrepareAddRecoveryIncomeCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public PrepareAddRecoveryIncomeCommand() {
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] { { "recoveryType", "java.lang.String", SERVICE_SCOPE }, });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		resultMap.put("recoveryIncome", new OBRecoveryIncome());
		resultMap.put("recoveryType", map.get("recoveryType"));
