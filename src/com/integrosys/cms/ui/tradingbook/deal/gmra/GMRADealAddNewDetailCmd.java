...
/**
 * Describe this class. Purpose: for maker to add new GMRA Deal Description:
 * command that let the maker to add new GMRA Deal Value to the database
 * 
...
public class GMRADealAddNewDetailCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			IGMRADealTrxValue trxValue = proxy.makerCreateGMRADeal(trxContext, null, obGMRADeal.getAgreementID(),
					obGMRADeal);
			resultMap.put("request.ITrxValue", trxValue);
			resultMap.put("GMRADealTrxValue", trxValue);
