...
public class GMRADealMakerCancelValuationCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "request.ITrxValue", "com.integrosys.cms.app.tradingbook.trx.OBGMRADealValTrxValue",
				REQUEST_SCOPE } });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			gMRADealValTrxVal = proxy.makerCancelUpdateGMRADealValuation(trxContext, gMRADealValTrxVal);
