...
public class GMRADealCheckerApproveValuationCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			gMRADealValTrxVal = proxy.checkerApproveUpdateGMRADealValuation(trxContext, gMRADealValTrxVal);
