...
public class GMRADealCheckerRejectValuationCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, " >>>Debug:::GMRADealCheckerRejectEditCmd Before reject TrxValue = "
					+ AccessorUtil.printMethodValue(gMRADealValTrxVal));
			gMRADealValTrxVal = proxy.checkerRejectUpdateGMRADealValuation(trxContext, gMRADealValTrxVal);
