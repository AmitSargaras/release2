...
public class ISDACSADealCheckerApproveEditCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, " >>>Debug:::ISDACSADealCheckerApproveEditCmd Before reject TrxValue = "
					+ AccessorUtil.printMethodValue(iSDADealValTrxVal));
			iSDADealValTrxVal = proxy.checkerApproveUpdateISDACSADealValuation(trxContext, iSDADealValTrxVal);
