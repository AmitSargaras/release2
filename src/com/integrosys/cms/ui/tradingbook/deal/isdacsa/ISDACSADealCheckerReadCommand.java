...
public class ISDACSADealCheckerReadCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {
				{ "ISDACSADealTrxValue", "com.integrosys.cms.app.tradingbook.trx.OBISDACSADealValTrxValue",
						SERVICE_SCOPE }, { "timefrequencies.map", "java.util.HashMap", SERVICE_SCOPE },
				{ "event", "java.lang.String", REQUEST_SCOPE }, { "offset", "java.lang.Integer", SERVICE_SCOPE }, // Produce
																													// the
																													// length
																													// .
