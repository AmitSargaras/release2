...
public class ISDACSADealMakerCancelEditCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "request.ITrxValue",
				"com.integrosys.cms.app.tradingbook.trx.OBISDACSADealValTrxValue", REQUEST_SCOPE } });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			iSDADealValTrxVal = proxy.makerCancelUpdateISDACSADealValuation(trxContext, iSDADealValTrxVal);
