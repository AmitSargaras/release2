...
public class CashMarginMakerCancelCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "request.ITrxValue", "com.integrosys.cms.app.tradingbook.trx.OBCashMarginTrxValue",
				REQUEST_SCOPE } });
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			cashMarginTrxVal = proxy.makerCancelUpdateCashMargin(trxContext, cashMarginTrxVal);
