 ...
 * @version $Revision:$
 * @since $Date:9$ Tag: $Name$
 */

public class CashMarginCheckerRejectCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			DefaultLogger.debug(this, " >>>Debug:::CashMarginCheckerRejectCmd Before reject TrxValue = "
					+ AccessorUtil.printMethodValue(cashMarginTrxVal));
			cashMarginTrxVal = proxy.checkerRejectUpdateCashMargin(trxContext, cashMarginTrxVal);
