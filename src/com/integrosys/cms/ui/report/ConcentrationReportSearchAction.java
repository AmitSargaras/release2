 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/report/ConcentrationReportSearchAction.java,v 1.1 2003/08/07 12:11:15 jtan Exp $
 */

/**
 * Description: This action class returns an array of event handlers for
 * ConcentrationReportSearchAction Each event handler is implemented using a
 * command object
 * 
 * @author $Author: jtan $<br>
 * @version $Revision: 1.1 $
 * @since $Date: 2003/08/07 12:11:15 $ Tag: $Name: $
 */
public class ConcentrationReportSearchAction extends CommonAction {
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		...
		ActionErrors errors = ConcentrationReportSearchValidator.validateInput((CommonForm) aForm, locale);
	...
	protected ICommand[] getCommandChain(String event) {
		...
		if (EVENT_SEARCH_REPORT.equals(event)) {
			...
			objArray[0] = getCommand("SearchConcentrationReportCommand");
		}
		else if (EVENT_GET_REPORT.equals(event)) {
			objArray = new ICommand[1];
			objArray[0] = getCommand("GetConcentrationReportCommand");
		}
