 ...
 *               CCIReportSearchAction
 *               Each event handler is implemented using a command object
 *
 * @author $Author:  $<br>
 * @version $Revision:  $
 * @since $Date: $
 * Tag: $Name:  $
 */
public class CCIReportSearchAction extends CommonAction {
    ...
    /**
     * validates the HTML input data captured in the Action form
    ...
    public ActionErrors validateInput(ActionForm aForm, Locale locale) {
        ...
        ActionErrors errors = CCIReportSearchValidator.validateInput((CommonForm) aForm, locale);
    ...
    protected ICommand[] getCommandChain(String event) {
        ...
        if (EVENT_SEARCH_REPORT.equals(event)) {
            ...
            objArray[0] = getCommand("SearchCCIReportCommand");
        } else if (EVENT_GET_REPORT.equals(event)) {
            objArray = new ICommand[1];
            objArray[0] = getCommand("GetCCIReportCommand");
        }
