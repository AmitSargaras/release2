 ...
 */
public class SystemReportSearchValidator {

	public static ActionErrors validateInput(CommonForm aForm, Locale locale) {

		DefaultLogger.info(SystemReportSearchValidator.class.getName(), "Entering method validateInput");

		SystemReportSearchForm form = (SystemReportSearchForm) aForm;
		...
		if (event.equals(SystemReportSearchAction.EVENT_SEARCH_REPORT)) {
	...
	private static void validateDate(String dateEntered, String labelKey, ActionErrors errors) {
		DefaultLogger.info(SystemReportSearchValidator.class.getName(), "Entering method validateDate");

		if (validateString(dateEntered, labelKey, errors, "error.string.date.mandatory")) {

			DefaultLogger.info(SystemReportSearchValidator.class.getName(), "Checking date validity and range");
	...
	private static boolean validateString(String s, String labelKey, ActionErrors errors, String errorKey) {
		DefaultLogger.info(SystemReportSearchValidator.class.getName(), "Entering method validateString");
	...
	private static int getSearchReportDuration() {
		DefaultLogger.info(SystemReportSearchValidator.class.getName(), "Entering method getSearchReportDuration");
		int days = PropertyManager.getInt(ReportConstants.REPORT_PAST_DURATION);
		DefaultLogger.debug(SystemReportSearchValidator.class.getName(), "number of days" + days);
		return days;
	}
