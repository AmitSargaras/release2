 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/report/ConcentrationReportSearchValidator.java,v 1.3 2003/09/09 14:39:23 jtan Exp $
 */

/**
 * Description: Validator class for Concentration Reports Checks that required
 * values are entered by the user
 * 
 * @author $Author: jtan $<br>
 * @version $Revision: 1.3 $
 * @since $Date: 2003/09/09 14:39:23 $ Tag: $Name: $
 */
public class ConcentrationReportSearchValidator {

	public static ActionErrors validateInput(CommonForm aForm, Locale locale) {

		DefaultLogger.info(ConcentrationReportSearchValidator.class.getName(), "Entering method validateInput");

		ConcentrationReportSearchForm form = (ConcentrationReportSearchForm) aForm;
		...
		if (event.equals(ConcentrationReportSearchAction.EVENT_SEARCH_REPORT)) {
	...
	private static void validateDate(String dateEntered, String labelKey, ActionErrors errors) {
		DefaultLogger.info(ConcentrationReportSearchValidator.class.getName(), "Entering method validateDate");

		if (validateString(dateEntered, labelKey, errors, "error.string.date.mandatory")) {

			DefaultLogger.info(ConcentrationReportSearchValidator.class.getName(), "Checking date validity and range");
	...
	private static boolean validateString(String s, String labelKey, ActionErrors errors, String errorKey) {
		DefaultLogger.info(ConcentrationReportSearchValidator.class.getName(), "Entering method validateString");
