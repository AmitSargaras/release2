...
public class MakerCloseFileUploadCommand extends AbstractCommand implements IBondDetailsUploadConstants{
    ...
    public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException, AccessDeniedException {
        ...
        try {
        	...
        	IFileUploadTrxValue trxValueOut = getBondDetailsuploadProxy().makerCloseRejectFileUpload(ctx, trxValueIn);
