 ...
 */
public class DeleteDigitalLibraryCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			IDigitalLibraryGroup inputFeedGroup = (IDigitalLibraryGroup) inputList.get(0);
			...
			IDigitalLibraryEntry[] newEntriesArr = new IDigitalLibraryEntry[entriesArr.length - indexDeletesArr.length];
			counter = 0; // reuse
			...
			offset = DigitalLibraryMapper.adjustOffset(offset, length, newEntriesArr.length);
