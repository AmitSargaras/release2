 ...
 */
public class ListCompareDigitalLibraryCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandValidationException, CommandProcessingException,
		...
		IDigitalLibraryTrxValue trxValue = (IDigitalLibraryTrxValue) map.get("digitalLibraryTrxValue");

		List compareResultsList = (List) map.get("compareResultsList");

		targetOffset = DigitalLibraryMapper.adjustOffset(targetOffset, length, compareResultsList.size());
