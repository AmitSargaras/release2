...
public class MakerCloseInsuranceCoverageDtlsCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerCloseInsuranceCoverageDtlsCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IInsuranceCoverageDtlsTrxValue trxValueOut = getInsuranceCoverageDtlsProxyManager().makerCloseRejectedInsuranceCoverageDtls(ctx, trxValueIn);
