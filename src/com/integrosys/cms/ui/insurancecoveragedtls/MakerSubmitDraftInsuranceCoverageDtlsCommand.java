...
/**
 * This command submits the draft Insurance Coverage Details for creation 
 * 
 * $Author: Dattatray Thorat
 * 
 * @version $Revision: 1.2 $
 */
public class MakerSubmitDraftInsuranceCoverageDtlsCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerSubmitDraftInsuranceCoverageDtlsCommand() {
	}
