...
public class CheckerApproveEditInsuranceCoverageDtlsCmd extends AbstractCommand implements ICommonEventConstant {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			// Function  to approve updated insurance coverage Trx
			IInsuranceCoverageDtlsTrxValue trxValueOut = getInsuranceCoverageDtlsProxyManager().checkerApproveInsuranceCoverageDtls(ctx, trxValueIn);
