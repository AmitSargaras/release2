 ...
 */
public class MakerSubmitCreateInsuranceCoverageDtlsCommand extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public MakerSubmitCreateInsuranceCoverageDtlsCommand() {
	}
	
	public String[][] getParameterDescriptor() {
		
		return (new String[][]{
				{"IInsuranceCoverageDtlsTrxValue", "com.integrosys.cms.app.relationshipmgr.trx.IInsuranceCoverageDtlsTrxValue", SERVICE_SCOPE},
	            {"InsuranceCoverageDtlsObj","com.integrosys.cms.app.relationshipmgr.bus.OBInsuranceCoverageDtls",FORM_SCOPE},
	...
	public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	        	OBInsuranceCoverageDtls insuranceCoverage = (OBInsuranceCoverageDtls) map.get("InsuranceCoverageDtlsObj");
				...
				IInsuranceCoverageDtlsTrxValue trxValueOut = new OBInsuranceCoverageDtlsTrxValue();
					...
					if (event.equals("maker_submit_create_insurance_coverage_dtls")) {
						trxValueOut = getInsuranceCoverageDtlsProxyManager().makerCreateInsuranceCoverageDtls(ctx, trxValueOut, insuranceCoverage);
					} else {
						// event is  maker_confirm_resubmit_edit
						String remarks = (String) map.get("remarks");
						ctx.setRemarks(remarks);
						trxValueOut = getInsuranceCoverageDtlsProxyManager().makerEditRejectedInsuranceCoverageDtls(ctx, trxValueIn, insuranceCoverage);
					} 
