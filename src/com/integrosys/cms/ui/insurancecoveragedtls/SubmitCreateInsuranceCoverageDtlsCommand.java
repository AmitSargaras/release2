 ...
 */
public class SubmitCreateInsuranceCoverageDtlsCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public SubmitCreateInsuranceCoverageDtlsCommand() {
	}
	        ...
	        try {
				...
				IInsuranceCoverageDtlsTrxValue trxValueOut = new OBInsuranceCoverageDtlsTrxValue();
					...
					if (event.equals("maker_submit_create_insurance_coverage_dtls")) {
						trxValueOut = getInsuranceCoverageDtlsProxyManager().makerCreateInsuranceCoverageDtls(ctx, trxValueOut, insuranceCoverageDtls);
					} else {
