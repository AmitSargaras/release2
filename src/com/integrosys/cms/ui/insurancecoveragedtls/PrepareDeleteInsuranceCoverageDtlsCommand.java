...
/**
 * This command Prepares the Insurance Coverage Details before deleting
 * $Author: Dattatray Thorat
 * @version $Revision: 1.0 $
 */
public class PrepareDeleteInsuranceCoverageDtlsCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public PrepareDeleteInsuranceCoverageDtlsCommand() {
	}
	...
	public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	        	...
	        	IInsuranceCoverageDtlsTrxValue insuranceCoverageDtlsTrxValue = null;
	        	IInsuranceCoverageDtls insuranceCoverageDtls = new OBInsuranceCoverageDtls();
	        	
	        	insuranceCoverageDtlsTrxValue = getInsuranceCoverageDtlsProxyManager().getInsuranceCoverageDtlsTrxValue(Long.parseLong(id));
