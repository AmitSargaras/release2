...
public class RefreshStateCmd extends AbstractCommand{
	...
	public String[][] getResultDescriptor() {
		...
		return (new String[][]{
	            ...
	            { "stateList_v2", "java.util.List",REQUEST_SCOPE },
	            { "stateList_v3", "java.util.List",REQUEST_SCOPE },
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	        	...
	        	if( event.equals("refresh_state_id")){	        		
	        		...
	        		long regionId = Long.parseLong((String) map.get("regionId"));
	        		resultMap.put("stateList_v2", getStateList(regionId));
	        	}
	        	else if( event.equals("refresh_state_id_v3")){	        		
	        		long regionId = Long.parseLong((String) map.get("regionId"));
	        		resultMap.put("stateList_v3", getStateList(regionId));
	        	}
