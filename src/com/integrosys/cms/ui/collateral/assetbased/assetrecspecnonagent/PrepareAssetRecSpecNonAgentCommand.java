 ...
 */
public class PrepareAssetRecSpecNonAgentCommand extends PrepareAssetBasedCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareAssetRecSpecNonAgentCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareAssetRecSpecNonAgentCommandHelper.fillPrepare(map, result, exceptionMap);
