 ...
 */
public class AssetRecSpecNonAgentValidator {
	public static ActionErrors validateInput(AssetRecSpecNonAgentForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			AssetRecSpecNonAgentValidationHelper.validateInput(aForm, locale, errors);
		}
