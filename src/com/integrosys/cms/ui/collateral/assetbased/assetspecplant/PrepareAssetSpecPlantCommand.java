 ...
 */
public class PrepareAssetSpecPlantCommand extends PrepareAssetBasedCommand {
	public String[][] getParameterDescriptor() {
		String[][] thisDesc = PrepareAssetSpecPlantCommandHelper.getParameterDescriptor();
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareAssetSpecPlantCommandHelper.getResultDescriptor();
