...
import com.integrosys.cms.ui.collateral.SubmitOtherCheckListCommandIP;
import com.integrosys.cms.ui.collateral.SubmitOtherReceiptCommandIP;
 ...
 */
public class AssetSpecPlantAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetSpecPlantCommand();
		}
			...
			objArray[0] = new PrepareAssetSpecPlantCommand();
		}
			...
			objArray[5] = new SubmitOtherCheckListCommandIP();
			objArray[6] = new SubmitOtherReceiptCommandIP();
			objArray[7] = new ApproveOtherReceiptCommand();
		}
		/*else if(event.equals(MAKER_ADD_INSURANCE)){
			objArray = new ICommand[2];			
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetSpecPlantValidator.validateInput((AssetSpecPlantForm) aForm, locale);
	}
