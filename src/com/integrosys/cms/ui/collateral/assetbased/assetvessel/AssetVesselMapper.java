...
/**
 * Created by IntelliJ IDEA. User: Naveen Date: Jun 22, 2003 Time: 4:45:05 PM To
 * change this template use Options | File Templates.
 */
public class AssetVesselMapper extends AssetBasedMapper {

	public Object mapFormToOB(CommonForm cForm, HashMap inputs) throws MapperException {

		Object obj = AssetVesselMapperHelper.getObject(inputs);

		super.mapFormToOB(cForm, inputs, obj);
		return AssetVesselMapperHelper.mapFormToOB(cForm, inputs, obj);
	...
	public CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap inputs) throws MapperException {
		...
		AssetVesselMapperHelper.mapOBToForm((AssetVesselForm) cForm, obj, inputs);
