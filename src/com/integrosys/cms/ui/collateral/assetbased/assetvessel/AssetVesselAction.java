...
/**
 * Created by IntelliJ IDEA. User: Naveen Date: Jun 20, 2003 Time: 2:49:22 PM To
 * change this template use Options | File Templates.
 */
public class AssetVesselAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetVesselCommand();
		}
			...
			objArray[0] = new PrepareAssetVesselCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetVesselValidator.validateInput((AssetVesselForm) aForm, locale);
	}
