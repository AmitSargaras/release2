 ...
 */
public class AssetSpecOtherValidator {
	public static ActionErrors validateInput(AssetSpecOtherForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			AssetSpecOtherValidationHelper.validateInput(aForm, locale, errors);
		}
