 ...
 */
public class PrepareAssetSpecOtherCommand extends PrepareAssetBasedCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareAssetSpecOtherCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareAssetSpecOtherCommandHelper.fillPrepare(map, result, exceptionMap);
