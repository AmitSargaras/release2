 ...
 */
public class AssetSpecOtherAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetSpecOtherCommand();
		}
			...
			objArray[0] = new PrepareAssetSpecOtherCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetSpecOtherValidator.validateInput((AssetSpecOtherForm) aForm, locale);
	}
