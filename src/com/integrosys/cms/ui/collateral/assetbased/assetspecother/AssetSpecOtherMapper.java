 ...
 */
public class AssetSpecOtherMapper extends AssetBasedMapper {

	public Object mapFormToOB(CommonForm cForm, HashMap inputs) throws MapperException {

		Object obj = AssetSpecOtherMapperHelper.getObject(inputs);

		super.mapFormToOB(cForm, inputs, obj);
		return AssetSpecOtherMapperHelper.mapFormToOB(cForm, inputs, obj);
	...
	public CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap inputs) throws MapperException {
		...
		AssetSpecOtherMapperHelper.mapOBToForm((AssetSpecOtherForm) cForm, obj, inputs);
