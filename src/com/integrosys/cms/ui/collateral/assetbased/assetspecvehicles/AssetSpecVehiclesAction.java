 ...
 */
public class AssetSpecVehiclesAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetSpecVehiclesCommand();
		}
		...
		//	objArray[1] = new PrepareAssetSpecVehiclesCommand();
			...
			objArray[1] = (ICommand) getNameCommandMap().get("PrepareAssetSpecVehiclesCommand");
			
		}
		else if (EVENT_PREPARE_FORM.equals(event)) {
			objArray = new ICommand[1];
			objArray[0] = new PrepareAssetSpecVehiclesCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetSpecVehiclesValidator.validateInput((AssetSpecVehiclesForm) aForm, locale);
	}
