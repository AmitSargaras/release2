 ...
 */
public class AssetAircraftAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetAircraftCommand();
		}
			...
			objArray[0] = new PrepareAssetAircraftCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetAircraftValidator.validateInput((AssetAircraftForm) aForm, locale);
	}
