 ...
 */
public class AssetRecSpecAgentAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetRecSpecAgentCommand();
		}
			...
			objArray[0] = new PrepareAssetRecSpecAgentCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetRecSpecAgentValidator.validateInput((AssetRecSpecAgentForm) aForm, locale);
	}
}
