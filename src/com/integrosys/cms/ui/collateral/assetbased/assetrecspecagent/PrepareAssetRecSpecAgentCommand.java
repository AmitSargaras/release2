 ...
 */
public class PrepareAssetRecSpecAgentCommand extends PrepareAssetBasedCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareAssetRecSpecAgentCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareAssetRecSpecAgentCommandHelper.fillPrepare(map, result, exceptionMap);
