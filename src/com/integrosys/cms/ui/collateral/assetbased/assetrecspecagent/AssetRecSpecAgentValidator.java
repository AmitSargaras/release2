 ...
 */
public class AssetRecSpecAgentValidator {

	public static ActionErrors validateInput(AssetRecSpecAgentForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			AssetRecSpecAgentValidationHelper.validateInput(aForm, locale, errors);
		}
