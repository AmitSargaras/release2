 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/assetbased/NatureOfChargeList.java,v 1.5 2003/10/13 01:57:33 hshii Exp $
 */
 ...
 * @since $Date: 2003/10/13 01:57:33 $ Tag: $Name: $
 */
public class NatureOfChargeList extends BaseList { // ------
	...
	private NatureOfChargeList() {
		...
		natureOfChargeMap = CommonDataSingleton.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_ASS_ASSET);
		natureOfChargeMap.putAll(CommonDataSingleton
				.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_CHARGE_ASSETAIRCRAFT));
		natureOfChargeMap.putAll(CommonDataSingleton
				.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_CHARGE_ASSETGENCHARGE));
		natureOfChargeMap.putAll(CommonDataSingleton
				.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_CHARGE_ASSETPDC));
		natureOfChargeMap.putAll(CommonDataSingleton
				.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_CHARGE_ASSETSPECOTHER));
		natureOfChargeMap.putAll(CommonDataSingleton
				.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_CHARGE_ASSETSPECVEHICLES));
		natureOfChargeMap.putAll(CommonDataSingleton
				.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_CHARGE_ASSETSPECPLANT));
		natureOfChargeMap.putAll(CommonDataSingleton
				.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_CHARGE_ASSETVESSEL));
		natureOfChargeMap.putAll(CommonDataSingleton
				.getCodeCategoryValueLabelMap(CategoryCodeConstant.NAT_OF_CHARGE_ASSETGOLD));
