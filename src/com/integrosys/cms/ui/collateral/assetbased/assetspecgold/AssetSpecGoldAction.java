 ...
 */
public class AssetSpecGoldAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetSpecGoldCommand();
		}
			...
			objArray[0] = new PrepareAssetSpecGoldCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetSpecGoldValidator.validateInput((AssetSpecGoldForm) aForm, locale);
	}
