 ...
 */
public class AssetRecOpenValidator {
	public static ActionErrors validateInput(AssetRecOpenForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			AssetRecOpenValidationHelper.validateInput(aForm, locale, errors);
		}
		return errors;
	}
}
