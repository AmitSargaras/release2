 ...
 */
public class AssetRecOpenAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetRecOpenCommand();
		}
			...
			objArray[0] = new PrepareAssetRecOpenCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetRecOpenValidator.validateInput((AssetRecOpenForm) aForm, locale);
	}
}
