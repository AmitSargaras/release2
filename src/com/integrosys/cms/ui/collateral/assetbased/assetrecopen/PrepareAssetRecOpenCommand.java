 ...
 */
public class PrepareAssetRecOpenCommand extends PrepareAssetBasedCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareAssetRecOpenCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareAssetRecOpenCommandHelper.fillPrepare(map, result, exceptionMap);
