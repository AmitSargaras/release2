 ...
 */
public class AssetRecGenAgentValidator {
	public static ActionErrors validateInput(AssetRecGenAgentForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			AssetRecGenAgentValidationHelper.validateInput(aForm, locale, errors);
		}
		return errors;
	}
}
