 ...
 */
public class PrepareAssetRecGenAgentCommand extends PrepareAssetBasedCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareAssetRecGenAgentCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareAssetRecGenAgentCommandHelper.fillPrepare(map, result, exceptionMap);
