 ...
 */
public class AssetRecGenAgentAction extends AssetBasedAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareAssetRecGenAgentCommand();
		}
			...
			objArray[0] = new PrepareAssetRecGenAgentCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return AssetRecGenAgentValidator.validateInput((AssetRecGenAgentForm) aForm, locale);
	}
}
