 ...
 */
public class PrepareAssetBasedCommand extends PrepareCollateralCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareAssetBasedCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareAssetBasedCommandHelper.fillPrepare(map, result, exceptionMap);
