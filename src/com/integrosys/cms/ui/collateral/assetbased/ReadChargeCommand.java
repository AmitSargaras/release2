 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/assetbased/ReadChargeCommand.java,v 1.7 2004/06/04 05:19:56 hltan Exp $
 */
 ...
 * @since $Date: 2004/06/04 05:19:56 $
 * Tag: $Name:  $
 */
...
public class ReadChargeCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		IAssetBasedCollateral iAsset;
		if ((from_event != null) && from_event.equals("read")) {
			iAsset = (IAssetBasedCollateral) itrxValue.getCollateral();
		}
		else {
			iAsset = (IAssetBasedCollateral) itrxValue.getStagingCollateral();
			if ((from_event != null) && from_event.equals("process")) {
				...
				ILimitCharge stageCharge = getItem(iAsset.getLimitCharges(), index);
