 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/assetbased/assetgencharge/insurance/UpdateInsuranceCommand.java,v 1.7 2006/09/06 01:57:06 pratheepa Exp $
 */
 ...
 * @since $Date: 2006/09/06 01:57:06 $ Tag: $Name: $
 */

public class UpdateInsuranceCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		insPolicyId = insurance.getInsurancePolicyID();
		...
		for (int i = 0; i < insPolicies.length; i++) {
			...
			if (insPolicyId != ICMSConstant.LONG_INVALID_VALUE) {
				if ((tempDocNo != null) && tempDocNo.trim().equalsIgnoreCase(docNo)
						&& (tempInsPolicy.getInsurancePolicyID() != insPolicyId)) {
					documentCount++;
				}
			}
			// Commented by Pratheepa on 09/06/2006 to fix issue CMS-3079
			/*
			 * else{ if(tempDocNo!=null &&
