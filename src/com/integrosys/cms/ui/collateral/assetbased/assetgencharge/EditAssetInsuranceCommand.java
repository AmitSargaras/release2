...
public class EditAssetInsuranceCommand extends AbstractCommand {
...
//			then skip validation
			...
			IGeneralChargeStockDetails existingStockDetails=(IGeneralChargeStockDetails) stockDetailsList.get(obIndex);
			newStockDetails.setGeneralChargeDetailsID(existingStockDetails.getGeneralChargeDetailsID());
			newStockDetails.setGeneralChargeStockDetailsID(existingStockDetails.getGeneralChargeStockDetailsID());
			newStockDetails.setStockType(existingStockDetails.getStockType());
			...
			DefaultLogger.debug(this, "isComponentExist"+isComponentExist);
			if(!isComponentExist){
				stockDetailsList.remove(obIndex);
				stockDetailsList.add(obIndex,newStockDetails);
			}else{
