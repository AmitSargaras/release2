 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/assetbased/assetgencharge/fixedassetsoth/FAOValidator.java,v 1.6 2005/11/09 07:00:57 hshii Exp $
 */
 ...
 * @since $Date: 2005/11/09 07:00:57 $ Tag: $Name: $
 */

public class FAOValidator {
	public static ActionErrors validateInput(FAOForm aForm, Locale locale) {
		...
		boolean isMandatory = aForm.getEvent().equals(FAOAction.EVENT_EDIT);
