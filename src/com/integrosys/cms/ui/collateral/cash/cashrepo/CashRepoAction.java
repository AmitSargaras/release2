 ...
 */
public class CashRepoAction extends CashAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareCashRepoCommand();
		}
			...
			objArray[0] = new PrepareCashRepoCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return CashRepoValidator.validateInput((CashRepoForm) aForm, locale);
	}
}
