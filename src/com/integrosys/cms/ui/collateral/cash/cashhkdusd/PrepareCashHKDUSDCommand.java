 ...
 */
public class PrepareCashHKDUSDCommand extends PrepareCashCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareCashHKDUSDCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareCashHKDUSDCommandHelper.fillPrepare(map, result, exceptionMap);
