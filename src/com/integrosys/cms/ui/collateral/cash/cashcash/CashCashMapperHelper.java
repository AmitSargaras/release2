 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/cash/cashcash/CashCashMapperHelper.java,v 1.8 2006/04/10 07:08:03 hshii Exp $
 */
 ...
 */
public class CashCashMapperHelper {

	public static Object mapFormToOB(CommonForm cForm, HashMap inputs, Object obj) throws MapperException {
		ICashCash iCol = (ICashCash) obj;
		CashCashForm aForm = (CashCashForm) cForm;
		...
		try {
			...
			DefaultLogger.error("com.integrosys.cms.ui.collateral.cash.cashdiff.CashCashMapperHelper", "error is :"
					+ e.toString());
	...
	public static CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap inputs) throws MapperException {
		...
		try {
			...
			DefaultLogger.error("com.integrosys.cms.ui.collateral.cash.cashcash.CashCashMapperHelper", "error is :"
					+ e.toString());
			throw new MapperException(e.getMessage());
		}
	...
	public static Object getObject(HashMap inputs) {
		return ((ICashCash) ((ICollateralTrxValue) inputs.get("serviceColObj")).getStagingCollateral());
	}
