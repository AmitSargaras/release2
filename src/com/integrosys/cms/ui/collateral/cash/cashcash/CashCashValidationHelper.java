 ...
 */
public class CashCashValidationHelper {
	public static ActionErrors validateInput(CashCashForm aForm, Locale locale, ActionErrors errors) {
		String errorCode;
		/*
		 ...
		 * DefaultLogger.debug(
		 * "com.integrosys.cms.ui.collateral.cash,cashcash.CashCashValidationHelper"
		 * ,
