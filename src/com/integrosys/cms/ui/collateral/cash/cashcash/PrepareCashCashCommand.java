 ...
 */
public class PrepareCashCashCommand extends PrepareCashCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareCashCashCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareCashCashCommandHelper.fillPrepare(map, result, exceptionMap);
