 ...
 */
public class PrepareCashFdCommand extends PrepareCashCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareCashFdCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareCashFdCommandHelper.fillPrepare(map, result, exceptionMap);
