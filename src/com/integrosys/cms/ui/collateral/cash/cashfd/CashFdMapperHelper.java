 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/cash/cashfd/CashFdMapperHelper.java,v 1.8 2006/04/10 07:08:03 hshii Exp $
 */
...
public class CashFdMapperHelper {
	...
	public static Object mapFormToOB(CommonForm cForm, HashMap inputs, Object obj) throws MapperException {
		...
		try {
			...
			DefaultLogger.error("com.integrosys.cms.ui.collateral.cash.cashfd.CashFdMapperHelper", "error is :"
					+ e.toString());
	...
	public static Object getObject(HashMap inputs) {
		return ((ICashFd) ((ICollateralTrxValue) inputs.get("serviceColObj")).getStagingCollateral());
	}
