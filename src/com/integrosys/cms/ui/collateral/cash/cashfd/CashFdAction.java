 ...
 */
/*
 * In future with the discussion of janki and archana we will develop code for validating unique Fixed Deposit No. 
 * */
public class CashFdAction extends CashAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[0] = new PrepareCashFdCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return CashFdValidator.validateInput((CashFdForm) aForm, locale);
	}
}
