 ...
 */
public class PrepareCashCommand extends PrepareCollateralCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareCashCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareCashCommandHelper.fillPrepare(map, result, exceptionMap);
