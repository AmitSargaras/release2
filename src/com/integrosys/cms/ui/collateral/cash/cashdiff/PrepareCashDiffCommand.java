 ...
 */
public class PrepareCashDiffCommand extends PrepareCashCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareCashDiffCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareCashDiffCommandHelper.fillPrepare(map, result, exceptionMap);
