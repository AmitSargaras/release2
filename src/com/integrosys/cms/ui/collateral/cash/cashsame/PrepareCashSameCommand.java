 ...
 */
public class PrepareCashSameCommand extends PrepareCashCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareCashSameCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareCashSameCommandHelper.fillPrepare(map, result, exceptionMap);
