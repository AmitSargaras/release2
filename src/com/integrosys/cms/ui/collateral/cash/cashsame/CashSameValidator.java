 ...
 */
public class CashSameValidator {
	public static ActionErrors validateInput(CashSameForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			CashSameValidationHelper.validateInput(aForm, locale, errors);
		}
