 ...
 */
public class MarksecSCBSecAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecSCBSecCommand();
		}
			...
			objArray[0] = new PrepareMarksecSCBSecCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecSCBSecValidator.validateInput((MarksecSCBSecForm) aForm, locale);
	}
	/*
