...
import com.integrosys.cms.app.collateral.bus.type.marketable.subtype.portfolioown.IPortfolioOwn;
 ...
 */
public class MarksecSCBSecMapperHelper {
	...
	public static Object getObject(HashMap inputs) {
		return ((IPortfolioOwn) ((ICollateralTrxValue) inputs.get("serviceColObj")).getStagingCollateral());
	}
