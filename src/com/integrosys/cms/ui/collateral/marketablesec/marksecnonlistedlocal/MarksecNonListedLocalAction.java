 ...
 */
public class MarksecNonListedLocalAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecNonListedLocalCommand();
		}
			...
			objArray[0] = new PrepareMarksecNonListedLocalCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecNonListedLocalValidator.validateInput((MarksecNonListedLocalForm) aForm, locale);
	}
	/*
