 ...
 */
public class MarksecNonListedLocalValidator {
	public static ActionErrors validateInput(MarksecNonListedLocalForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			MarksecNonListedLocalValidationHelper.validateInput(aForm, locale, errors);
		}
