 ...
 */
public class MarksecMainLocalAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecMainLocalCommand();
		}
		...
		//*************** End of Lines added by Dattatray Thorat ****************		
			...
			objArray = new ICommand[1];
			objArray[0] = new PrepareMarksecMainLocalCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecMainLocalValidator.validateInput((MarksecMainLocalForm) aForm, locale);
	}
	/*
