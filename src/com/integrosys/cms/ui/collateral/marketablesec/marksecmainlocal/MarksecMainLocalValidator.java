 ...
 */
public class MarksecMainLocalValidator {
	public static ActionErrors validateInput(MarksecMainLocalForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			MarksecMainLocalValidationHelper.validateInput(aForm, locale, errors);
		}
