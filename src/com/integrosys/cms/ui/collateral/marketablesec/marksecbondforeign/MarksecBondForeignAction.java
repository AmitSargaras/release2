 ...
 */
public class MarksecBondForeignAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecBondForeignCommand();
		}
			...
			objArray[0] = new PrepareMarksecBondForeignCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecBondForeignValidator.validateInput((MarksecBondForeignForm) aForm, locale);
	}
	/*
