 ...
 */
public class PrepareMarksecBondForeignCommand extends PrepareMarketableSecCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareMarksecBondForeignCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareMarksecBondForeignCommandHelper.fillPrepare(map, result, exceptionMap);
