 ...
 */
public class PrepareMarksecMainForeignCommand extends PrepareMarketableSecCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareMarksecMainForeignCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareMarksecMainForeignCommandHelper.fillPrepare(map, result, exceptionMap);
