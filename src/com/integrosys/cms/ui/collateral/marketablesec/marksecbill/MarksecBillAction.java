 ...
 */
public class MarksecBillAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecBillCommand();
		}
			...
			objArray[0] = new PrepareMarksecBillCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecBillValidator.validateInput((MarksecBillForm) aForm, locale);
	}
	 ...
	 * aPage.setPageReference("wip"); return aPage; } if
