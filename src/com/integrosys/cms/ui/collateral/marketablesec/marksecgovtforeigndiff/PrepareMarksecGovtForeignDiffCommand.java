 ...
 */
public class PrepareMarksecGovtForeignDiffCommand extends PrepareMarketableSecCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareMarksecGovtForeignDiffCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareMarksecGovtForeignDiffCommandHelper.fillPrepare(map, result, exceptionMap);
