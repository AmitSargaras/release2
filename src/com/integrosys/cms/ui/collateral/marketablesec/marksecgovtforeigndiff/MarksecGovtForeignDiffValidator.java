 ...
 */
public class MarksecGovtForeignDiffValidator {
	public static ActionErrors validateInput(MarksecGovtForeignDiffForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			MarksecGovtForeignDiffValidationHelper.validateInput(aForm, locale, errors);
		}
