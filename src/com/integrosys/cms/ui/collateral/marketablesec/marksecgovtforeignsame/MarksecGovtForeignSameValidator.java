 ...
 */
public class MarksecGovtForeignSameValidator {
	public static ActionErrors validateInput(MarksecGovtForeignSameForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			MarksecGovtForeignSameValidationHelper.validateInput(aForm, locale, errors);
		}
