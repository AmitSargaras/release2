 ...
 */
public class PrepareMarksecGovtForeignSameCommand extends PrepareMarketableSecCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareMarksecGovtForeignSameCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareMarksecGovtForeignSameCommandHelper.fillPrepare(map, result, exceptionMap);
