 ...
 */
public class MarksecGovtForeignSameAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecGovtForeignSameCommand();
		}
			...
			objArray[0] = new PrepareMarksecGovtForeignSameCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecGovtForeignSameValidator.validateInput((MarksecGovtForeignSameForm) aForm, locale);
	}
	/*
