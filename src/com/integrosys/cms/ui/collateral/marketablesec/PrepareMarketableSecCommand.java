 ...
 */
public class PrepareMarketableSecCommand extends PrepareCollateralCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareMarketableSecCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareMarketableSecCommandHelper.fillPrepare(map, result, exceptionMap);
