 ...
 */
public class MarksecBondLocalValidator {
	public static ActionErrors validateInput(MarksecBondLocalForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject") ||
				aForm.getEvent().equals("marksecbondlocal_prepare"))) {
			MarksecBondLocalValidationHelper.validateInput(aForm, locale, errors);
		}
