 ...
 */
public class MarksecBondLocalAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecBondLocalCommand();
		}
			...
			objArray[0] = new PrepareMarksecBondLocalCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecBondLocalValidator.validateInput((MarksecBondLocalForm) aForm, locale);
	}
	/*
	 * public IPage getNextPage(String event, HashMap resultMap, HashMap
	 * exceptionMap) { Page aPage = new Page();
	 * 
	 ...
	 * aPage.setPageReference(EVENT_PREPARE_UPDATE); } else{
	 * aPage.setPageReference(event); } return aPage; }
	 */
}
