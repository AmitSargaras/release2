...
import com.integrosys.cms.app.collateral.bus.type.marketable.subtype.portfolioothers.IPortfolioOthers;
 ...
 */
public class MarksecCustSecMapperHelper {
	...
	public static Object getObject(HashMap inputs) {
		...
		return ((IPortfolioOthers) ((ICollateralTrxValue) inputs.get("serviceColObj")).getStagingCollateral());
	}
