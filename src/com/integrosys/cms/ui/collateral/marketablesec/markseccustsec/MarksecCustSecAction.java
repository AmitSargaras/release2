 ...
 */
public class MarksecCustSecAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecCustSecCommand();
		}
			...
			objArray[0] = new PrepareMarksecCustSecCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecCustSecValidator.validateInput((MarksecCustSecForm) aForm, locale);
	}
	/*
