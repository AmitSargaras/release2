 ...
 */
public class PrepareMarksecCustSecCommand extends PrepareMarketableSecCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareMarksecCustSecCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareMarksecCustSecCommandHelper.fillPrepare(map, result, exceptionMap);
