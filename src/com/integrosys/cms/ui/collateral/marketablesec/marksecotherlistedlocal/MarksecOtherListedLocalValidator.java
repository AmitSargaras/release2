 ...
 */
public class MarksecOtherListedLocalValidator {
	public static ActionErrors validateInput(MarksecOtherListedLocalForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			MarksecOtherListedLocalValidationHelper.validateInput(aForm, locale, errors);
		}
