 ...
 */
public class MarksecOtherListedLocalAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecOtherListedLocalCommand();
		}
			...
			objArray[0] = new PrepareMarksecOtherListedLocalCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecOtherListedLocalValidator.validateInput((MarksecOtherListedLocalForm) aForm, locale);
	}
	/*
