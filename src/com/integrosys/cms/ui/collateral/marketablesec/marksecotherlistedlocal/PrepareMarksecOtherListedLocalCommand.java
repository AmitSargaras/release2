 ...
 */
public class PrepareMarksecOtherListedLocalCommand extends PrepareMarketableSecCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareMarksecOtherListedLocalCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareMarksecOtherListedLocalCommandHelper.fillPrepare(map, result, exceptionMap);
