...
import com.integrosys.cms.ui.collateral.marketablesec.PrepareMarketableSecCommand;

/**
 * Created by IntelliJ IDEA. User: ssathish Date: Jun 20, 2003 Time: 3:05:13 PM
 * To change this template use Options | File Templates.
 */
public class PrepareMarksecOtherListedForeignCommand extends PrepareMarketableSecCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareMarksecOtherListedForeignCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareMarksecOtherListedForeignCommandHelper.fillPrepare(map, result, exceptionMap);
