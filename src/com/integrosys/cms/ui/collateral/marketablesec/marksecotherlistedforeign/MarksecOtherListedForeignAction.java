 ...
 */
public class MarksecOtherListedForeignAction extends MarketableSecAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareMarksecOtherListedForeignCommand();
		}
			...
			objArray[0] = new PrepareMarksecOtherListedForeignCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return MarksecOtherListedForeignValidator.validateInput((MarksecOtherListedForeignForm) aForm, locale);
	}
	/*
