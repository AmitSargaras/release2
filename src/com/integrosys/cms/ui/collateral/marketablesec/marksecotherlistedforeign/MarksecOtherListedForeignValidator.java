 ...
 */
public class MarksecOtherListedForeignValidator {
	public static ActionErrors validateInput(MarksecOtherListedForeignForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			MarksecOtherListedForeignValidationHelper.validateInput(aForm, locale, errors);
		}
