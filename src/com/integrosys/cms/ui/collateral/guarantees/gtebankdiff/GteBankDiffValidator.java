 ...
 */
public class GteBankDiffValidator {
	public static ActionErrors validateInput(GteBankDiffForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			GteBankDiffValidationHelper.validateInput(aForm, locale, errors);
		}
