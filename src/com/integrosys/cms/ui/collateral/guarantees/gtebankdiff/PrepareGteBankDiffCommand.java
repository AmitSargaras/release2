 ...
 */
public class PrepareGteBankDiffCommand extends PrepareGuaranteesCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareGteBankDiffCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareGteBankDiffCommandHelper.fillPrepare(map, result, exceptionMap);
