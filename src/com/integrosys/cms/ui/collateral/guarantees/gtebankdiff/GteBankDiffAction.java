 ...
 */
public class GteBankDiffAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteBankDiffCommand();
		}
			...
			objArray[0] = new PrepareGteBankDiffCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteBankDiffValidator.validateInput((GteBankDiffForm) aForm, locale);
	}
}
