 ...
 */
public class GteCorp3rdValidator {
	public static ActionErrors validateInput(GteCorp3rdForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			GteCorp3rdValidationHelper.validateInput(aForm, locale, errors);
		}
