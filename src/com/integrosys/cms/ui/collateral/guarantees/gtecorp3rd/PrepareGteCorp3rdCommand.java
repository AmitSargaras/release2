 ...
 */
public class PrepareGteCorp3rdCommand extends PrepareGuaranteesCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareGteCorp3rdCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareGteCorp3rdCommandHelper.fillPrepare(map, result, exceptionMap);
