 ...
 */
public class GteCorpRelAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteCorpRelCommand();
		}
			...
			objArray[0] = new PrepareGteCorpRelCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteCorpRelValidator.validateInput((GteCorpRelForm) aForm, locale);
	}
}
