...
public class GteInwardLCAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteInwardLCCommand();
		}
			...
			objArray[0] = new PrepareGteInwardLCCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteInwardLCValidator.validateInput((GteInwardLCForm) aForm, locale);
	}
}
