 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/guarantees/gteslcdiff/GteSLCDiffMapperHelper.java,v 1.5 2006/04/10 07:10:31 hshii Exp $
 */
...
import com.integrosys.cms.app.collateral.bus.type.guarantee.subtype.sblcdiffccy.ISBLCDifferentCurrency;
 ...
 */
public class GteSLCDiffMapperHelper {

	public static Object mapFormToOB(CommonForm cForm, HashMap inputs, Object obj) throws MapperException {
		ISBLCDifferentCurrency iCol = (ISBLCDifferentCurrency) obj;
		GteSLCDiffForm aForm = (GteSLCDiffForm) cForm;
		...
		try {
			...
			DefaultLogger.error("com.integrosys.cms.ui.collateral.guarantees.gteslcdiff.GteSLCDiffMapperHelper",
					"error is :" + e.toString());
	...
	public static CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap inputs) throws MapperException {
		...
		Locale locale = (Locale) inputs.get(com.integrosys.base.uiinfra.common.Constants.GLOBAL_LOCALE_KEY);
		ISBLCDifferentCurrency iObj = (ISBLCDifferentCurrency) obj;
		try {
	...
	public static Object getObject(HashMap inputs) {
		return ((ISBLCDifferentCurrency) ((ICollateralTrxValue) inputs.get("serviceColObj")).getStagingCollateral());
	}
