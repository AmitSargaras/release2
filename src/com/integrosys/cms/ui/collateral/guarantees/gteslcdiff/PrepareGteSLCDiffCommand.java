 ...
 */
public class PrepareGteSLCDiffCommand extends PrepareGuaranteesCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareGteSLCDiffCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareGteSLCDiffCommandHelper.fillPrepare(map, result, exceptionMap);
