 ...
 */
public class GteSLCDiffAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteSLCDiffCommand();
		}
			...
			objArray[0] = new PrepareGteSLCDiffCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteSLCDiffValidator.validateInput((GteSLCDiffForm) aForm, locale);
	}
}
