 ...
 */
public class GteSLCDiffValidator {
	public static ActionErrors validateInput(GteSLCDiffForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			GteSLCDiffValidationHelper.validateInput(aForm, locale, errors);
		}
