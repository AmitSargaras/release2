 ...
 */
public class GteIndemAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteIndemCommand();
		}
			...
			objArray[0] = new PrepareGteIndemCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteIndemValidator.validateInput((GteIndemForm) aForm, locale);
	}
}
