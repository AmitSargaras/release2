 ...
 */
public class GteBankSameValidator {
	public static ActionErrors validateInput(GteBankSameForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			GteBankSameValidationHelper.validateInput(aForm, locale, errors);
		}
