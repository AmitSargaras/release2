 ...
 */
public class GteBankSameAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteBankSameCommand();
		}
			...
			objArray[0] = new PrepareGteBankSameCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteBankSameValidator.validateInput((GteBankSameForm) aForm, locale);
	}
}
