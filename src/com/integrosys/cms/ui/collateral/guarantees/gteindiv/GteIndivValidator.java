 ...
 */
public class GteIndivValidator {
	public static ActionErrors validateInput(GteIndivForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			GteIndivValidationHelper.validateInput(aForm, locale, errors);
		}
