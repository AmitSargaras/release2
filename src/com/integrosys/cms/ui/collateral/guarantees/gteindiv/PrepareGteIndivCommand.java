 ...
 */
public class PrepareGteIndivCommand extends PrepareGuaranteesCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareGteIndivCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareGteIndivCommandHelper.fillPrepare(map, result, exceptionMap);
