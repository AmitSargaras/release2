 ...
 */
public class GteIndivAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteIndivCommand();
		}
			...
			objArray[0] = new PrepareGteIndivCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteIndivValidator.validateInput((GteIndivForm) aForm, locale);
	}
}
