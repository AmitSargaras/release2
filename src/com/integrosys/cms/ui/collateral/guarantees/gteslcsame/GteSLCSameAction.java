 ...
 */
public class GteSLCSameAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteSLCSameCommand();
		}
			...
			objArray[0] = new PrepareGteSLCSameCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteSLCSameValidator.validateInput((GteSLCSameForm) aForm, locale);
	}
}
