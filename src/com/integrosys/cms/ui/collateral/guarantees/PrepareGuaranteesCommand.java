 ...
 */
public class PrepareGuaranteesCommand extends PrepareCollateralCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareGuaranteesCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareGuaranteesCommandHelper.fillPrepare(map, result, exceptionMap);
