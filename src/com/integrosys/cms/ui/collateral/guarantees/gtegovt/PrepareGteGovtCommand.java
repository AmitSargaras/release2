 ...
 */
public class PrepareGteGovtCommand extends PrepareGuaranteesCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareGteGovtCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareGteGovtCommandHelper.fillPrepare(map, result, exceptionMap);
