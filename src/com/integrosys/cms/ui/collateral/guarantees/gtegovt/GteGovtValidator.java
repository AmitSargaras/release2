 ...
 */
public class GteGovtValidator {
	public static ActionErrors validateInput(GteGovtForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			GteGovtValidationHelper.validateInput(aForm, locale, errors);
		}
