 ...
 */
public class GteGovtAction extends GuaranteesAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareGteGovtCommand();
		}
			...
			objArray[0] = new PrepareGteGovtCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return GteGovtValidator.validateInput((GteGovtForm) aForm, locale);
	}
}
