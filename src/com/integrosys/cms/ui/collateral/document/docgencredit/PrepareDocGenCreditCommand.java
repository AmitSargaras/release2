 ...
 */
public class PrepareDocGenCreditCommand extends PrepareDocumentCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareDocGenCreditCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareDocGenCreditCommandHelper.fillPrepare(map, result, exceptionMap);
