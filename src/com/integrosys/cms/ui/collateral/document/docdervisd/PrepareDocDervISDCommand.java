 ...
 */
public class PrepareDocDervISDCommand extends PrepareDocumentCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareDocDervISDCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		DefaultLogger.debug(this + "prepare doc derv isd command", "entering do execute");
		PrepareDocDervISDCommandHelper.fillPrepare(map, result, exceptionMap);
