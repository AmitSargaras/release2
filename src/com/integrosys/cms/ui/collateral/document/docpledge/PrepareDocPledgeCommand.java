 ...
 */
public class PrepareDocPledgeCommand extends PrepareDocumentCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareDocPledgeCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareDocPledgeCommandHelper.fillPrepare(map, result, exceptionMap);
