 ...
 */
public class PrepareDocDervNetCommand extends PrepareDocumentCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareDocDervNetCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareDocDervNetCommandHelper.fillPrepare(map, result, exceptionMap);
