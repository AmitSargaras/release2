 ...
 */
public class PrepareDocumentCommand extends PrepareCollateralCommand {

	public String[][] getParameterDescriptor() {
		String[][] thisDesc = new String[][] { { "limitMap", "java.util.HashMap", SERVICE_SCOPE }, };
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareDocumentCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		DefaultLogger.debug(this + " PrepareDocumentCommand", "VVVVVVVVVVVVVIIIIIIIIIIIIIII");
		HashMap fromSuper = super.doExecute(map);

		DefaultLogger.debug(this + " PrepareDocumentCommand", "entering prepare document command doExecute");
		PrepareDocumentCommandHelper.fillPrepare(map, result, exceptionMap);
