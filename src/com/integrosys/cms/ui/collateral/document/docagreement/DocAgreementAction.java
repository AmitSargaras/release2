 ...
 *
 */
public class DocAgreementAction extends DocumentAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareDocAgreementCommand();
		}		
			...
			objArray[2] = new PrepareDocAgreementCommand();
		}
		else if (EVENT_PREPARE_FORM.equals(event)) {
			DefaultLogger.debug("DocAgreementAction", "in prepare_form...");
			objArray = new ICommand[1];
			objArray[0] = new PrepareDocAgreementCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return DocAgreementValidator.validateInput((DocAgreementForm) aForm, locale);
	}
}
