 ...
 * @since $Date: 2003/07/18 11:12:39 $
 * Tag: $Name:  $
 */
 ...
 */
public class DocComfortValidationHelper {
	public static ActionErrors validateInput(DocComfortForm aForm, Locale Locale, ActionErrors errors) {
