...
import com.integrosys.cms.app.collateral.bus.type.document.subtype.undertaking.IUndertaking;
 ...
 */
public class DocLoUMapperHelper {

	public static Object mapFormToOB(CommonForm cForm, HashMap inputs, Object obj) throws MapperException {
		DocLoUForm aForm = (DocLoUForm) cForm;
		IUndertaking iObj = (IUndertaking) obj;
	...
	public static Object getObject(HashMap inputs) {
		return ((IUndertaking) ((ICollateralTrxValue) inputs.get("serviceColObj")).getStagingCollateral());
	}
}