 ...
 */
public class DocLoUValidator {
	public static ActionErrors validateInput(DocLoUForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			DocLoUValidationHelper.validateInput(aForm, locale, errors);
		}
