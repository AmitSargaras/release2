 ...
 */
public class PrepareDocLoUCommand extends PrepareDocumentCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareDocLoUCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareDocLoUCommandHelper.fillPrepare(map, result, exceptionMap);
