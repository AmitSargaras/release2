 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/commodity/loanagency/ViewSecurityDocCommand.java,v 1.4 2004/07/19 13:42:41 hshii Exp $
 */
 ...
 */
public class ViewSecurityDocCommand extends AbstractCommand {
	public String[][] getParameterDescriptor() {
		return (new String[][] {
				{ IGlobalConstant.GLOBAL_LIMITPROFILE_OBJ, "com.integrosys.cms.app.limit.bus.ILimitProfile",
						GLOBAL_SCOPE }, { "serviceSecID", "java.lang.String", SERVICE_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		String securityID = (String) map.get("serviceSecID");
		DefaultLogger.debug(this, "Before Doing Search -- securityID: " + securityID);
