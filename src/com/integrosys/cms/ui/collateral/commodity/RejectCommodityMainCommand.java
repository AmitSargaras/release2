 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/commodity/RejectCommodityMainCommand.java,v 1.6 2005/07/15 06:19:30 hshii Exp $
 */
...
public class RejectCommodityMainCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			trxValueList = CollateralProxyFactory.getProxy().checkerRejectUpdateCollaterals(ctxArr, trxValueList);
		}
		catch (Exception e) {
			e.printStackTrace();
