 ...
 */
public class InsCrdtDerivMapper extends InsProtectionMapper {

	public Object mapFormToOB(CommonForm cForm, HashMap inputs) throws MapperException {

		Object obj = InsCrdtDerivMapperHelper.getObject(inputs);

		super.mapFormToOB(cForm, inputs, obj);
		return InsCrdtDerivMapperHelper.mapFormToOB(cForm, inputs, obj);
	...
	public CommonForm mapOBToForm(CommonForm cForm, Object obj, HashMap inputs) throws MapperException {
		...
		InsCrdtDerivMapperHelper.mapOBToForm((InsCrdtDerivForm) cForm, obj, inputs);
