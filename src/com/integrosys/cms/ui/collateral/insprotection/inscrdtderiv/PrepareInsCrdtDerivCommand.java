 ...
 */
public class PrepareInsCrdtDerivCommand extends PrepareInsProtectionCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareInsCrdtDerivCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareInsCrdtDerivCommandHelper.fillPrepare(map, result, exceptionMap);
