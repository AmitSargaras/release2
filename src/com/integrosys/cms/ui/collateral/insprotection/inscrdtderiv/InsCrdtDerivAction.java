 ...
 */
public class InsCrdtDerivAction extends InsProtectionAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareInsCrdtDerivCommand();
		}
			...
			objArray[0] = new PrepareInsCrdtDerivCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return InsCrdtDerivValidator.validateInput((InsCrdtDerivForm) aForm, locale);
	}
}
