 ...
 */
public class PrepareInsCrdtCommand extends PrepareInsProtectionCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareInsCrdtCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareInsCrdtCommandHelper.fillPrepare(map, result, exceptionMap);
