 ...
 */
public class InsCrdtAction extends InsProtectionAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareInsCrdtCommand();
		}
			...
			objArray[0] = new PrepareInsCrdtCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return InsCrdtValidator.validateInput((InsCrdtForm) aForm, locale);
	}
}
