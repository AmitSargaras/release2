...
import com.integrosys.cms.ui.collateral.insprotection.InsProtectionAction;
 ...
 */
public class InsKeymanAction extends InsProtectionAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = (ICommand) getNameCommandMap().get("PrepareInsKeymanCommand");
		}
			...
			objArray[0] = (ICommand) getNameCommandMap().get("PrepareInsKeymanCommand");
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return InsKeymanValidator.validateInput((InsKeymanForm) aForm, locale);
	}
}
