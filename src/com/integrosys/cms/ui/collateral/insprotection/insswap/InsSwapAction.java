 ...
 */
public class InsSwapAction extends InsProtectionAction implements IPin {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PrepareInsSwapCommand();
		}
			...
			objArray[0] = new PrepareInsSwapCommand();
		}
			...
			objArray = new ICommand[2];
			objArray[0] = new DeleteCDSItemCommand();
			objArray[1] = new PrepareInsSwapCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return InsSwapValidator.validateInput((InsSwapForm) aForm, locale);
	}
}
