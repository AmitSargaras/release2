 ...
 */
public class PrepareInsSwapCommand extends PrepareInsProtectionCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareInsSwapCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareInsSwapCommandHelper.fillPrepare(map, result, exceptionMap);
