 ...
 */
public class PrepareInsProtectionCommand extends PrepareCollateralCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PrepareInsProtectionCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareInsProtectionCommandHelper.fillPrepare(map, result, exceptionMap);
