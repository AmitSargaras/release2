 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/others/PrepareChargeCommand.java,v 1.2 2006/09/15 08:32:34 hshii Exp $
 */
...
public class PrepareChargeCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		ICollateralLimitMap[] collateralLimitMaps;
		...
		int collateraLimitMapLength = (collateralLimitMaps == null) ? 0 : collateralLimitMaps.length;
		for (int i = 0; i < collateraLimitMapLength; i++) {
