 ...
 */
public class PrepareOthersCommand extends PrepareCollateralCommand {
	...
	public String[][] getResultDescriptor() {
		...
		String[][] thisDesc = PrepareOthersCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PrepareOthersCommandHelper.fillPrepare(map, result, exceptionMap);
