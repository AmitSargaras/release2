...
public class RefreshCityCmd extends AbstractCommand{
	...
	public String[][] getResultDescriptor() {
		...
		return (new String[][]{
	            ...
	            { "cityList_v2", "java.util.List",REQUEST_SCOPE },
	            { "cityList_v3", "java.util.List",REQUEST_SCOPE },
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	        	...
	        	if( event.equals("refresh_city_id")){	        		
	        		...
	        		long stateId = Long.parseLong((String) map.get("stateId"));
	        		resultMap.put("cityList_v2", getCityList(stateId));
	        	}else if( event.equals("refresh_city_id_v3")){	        		
	        		long stateId = Long.parseLong((String) map.get("stateId"));
	        		resultMap.put("cityList_v3", getCityList(stateId));
	        	}
