...
public class RefreshRegionCmd extends AbstractCommand{
	...
	public String[][] getResultDescriptor() {
		...
		return (new String[][]{
	            ...
	            { "regionList_v2", "java.util.List",REQUEST_SCOPE },
	            { "regionList_v3", "java.util.List",REQUEST_SCOPE },
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
	        ...
	        try {
	        	...
	        	if( event.equals("refresh_region_id")){	        		
	        		...
	        		long countryId = Long.parseLong((String) map.get("countryId"));
	        		resultMap.put("regionList_v2", getRegionList(countryId));
	        	}else if( event.equals("refresh_region_id_v3")){	        		
	        		long countryId = Long.parseLong((String) map.get("countryId"));
	        		resultMap.put("regionList_v3", getRegionList(countryId));
	        	}
