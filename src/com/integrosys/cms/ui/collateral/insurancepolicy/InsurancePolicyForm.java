...
public class InsurancePolicyForm extends CommonForm implements Serializable {
	...
	public String[][] getMapper() {
		String[][] input = { { "insurancePolicyObj",
				"com.integrosys.cms.ui.collateral.insurancepolicy.InsurancePolicyMapper" }, };
		return input;
	}
