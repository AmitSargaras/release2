 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/insurancepolicy/PrepareInsurancePolicyCommand.java,v 1.2 2006/04/11 09:04:37 pratheepa Exp $
 */
...
public class PrepareInsurancePolicyCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		DefaultLogger.debug(this, "Coming inside PrepareInsurancePolicyCommand");
		...
		if ((collateralLoc == null) || "".equals(collateralLoc.trim())) {
			...
			commonCode = CommonCodeList.getInstance(CategoryCodeConstant.INSURANCE_TYPE);
			...
			commonCode = CommonCodeList.getInstance(collateralLoc, CategoryCodeConstant.INSURANCE_TYPE);
			result.put("insuranceTypeID", commonCode.getCommonCodeValues());
			result.put("insuranceTypeValue", commonCode.getCommonCodeLabels());
		}
