 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/insurancepolicy/RefreshAddtionalDocumentFacilityDetailsCommand.java,v 1.2 2006/04/11 09:05:36 pratheepa Exp $
 */
 ...
 */
public class RefreshAddtionalDocumentFacilityDetailsCommand extends AbstractCommand {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { { "addtionalDocumentFacilityDetailsObj", "java.util.HashMap", FORM_SCOPE },
				{ "event", "java.lang.String", ICommonEventConstant.REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		OBAddtionalDocumentFacilityDetails obAddtionalDocumentFacilityDetails = (OBAddtionalDocumentFacilityDetails) map.get("addtionalDocumentFacilityDetailsObj");
		//ICheckListProxyManager proxy = CheckListProxyManagerFactory.getCheckListProxyManager();
		//ILimitProxy limitProxy = LimitProxyFactory.getProxy();
		String from_event = (String) map.get("event");
		String docsIdFromForm = (String) obAddtionalDocumentFacilityDetails.getDocumentNo();
		...
		insuranceMap.put("obj", map.get("addtionalDocumentFacilityDetailsObj"));
		insuranceMap.put("col", trxValue.getStagingCollateral());

		result.put("addtionalDocumentFacilityDetailsObj", insuranceMap);

		/*
		lmtProfileId = String.valueOf(obAddtionalDocumentFacilityDetails.getLmtProfileId());
