 ...
 */
public class PreparePropCommShopCommand extends PreparePropertyCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PreparePropCommShopCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PreparePropCommShopCommandHelper.fillPrepare(map, result, exceptionMap);
