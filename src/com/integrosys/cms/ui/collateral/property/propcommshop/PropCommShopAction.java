 ...
 */
public class PropCommShopAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropCommShopCommand();
		}
			...
			objArray[0] = new PreparePropCommShopCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropCommShopValidator.validateInput((PropCommShopForm) aForm, locale);
	}
