 ...
 */
public class PreparePropCommServiceAptCommand extends PreparePropertyCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PreparePropCommServiceAptCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PreparePropCommServiceAptCommandHelper.fillPrepare(map, result, exceptionMap);
