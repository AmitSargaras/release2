 ...
 */
public class PropCommServiceAptAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropCommServiceAptCommand();
		}
			...
			objArray[0] = new PreparePropCommServiceAptCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropCommServiceAptValidator.validateInput((PropCommServiceAptForm) aForm, locale);
	}
