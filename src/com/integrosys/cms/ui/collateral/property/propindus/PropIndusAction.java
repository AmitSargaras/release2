 ...
 */
public class PropIndusAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropIndusCommand();
		}
			...
			objArray[0] = new PreparePropIndusCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropIndusValidator.validateInput((PropIndusForm) aForm, locale);
	}
