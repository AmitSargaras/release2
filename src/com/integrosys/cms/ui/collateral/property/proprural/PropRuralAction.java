 ...
 */
public class PropRuralAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropRuralCommand();
		}
			...
			objArray[0] = new PreparePropRuralCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropRuralValidator.validateInput((PropRuralForm) aForm, locale);
	}
