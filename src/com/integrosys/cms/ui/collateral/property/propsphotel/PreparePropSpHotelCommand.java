 ...
 */
public class PreparePropSpHotelCommand extends PreparePropertyCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PreparePropSpHotelCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PreparePropSpHotelCommandHelper.fillPrepare(map, result, exceptionMap);
