 ...
 */
public class PropSpHotelAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropSpHotelCommand();
		}
			...
			objArray[0] = new PreparePropSpHotelCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropSpHotelValidator.validateInput((PropSpHotelForm) aForm, locale);
	}
