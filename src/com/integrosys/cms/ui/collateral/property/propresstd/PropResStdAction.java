 ...
 */
public class PropResStdAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropResStdCommand();
		}
			...
			objArray[0] = new PreparePropResStdCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropResStdValidator.validateInput((PropResStdForm) aForm, locale);
	}
