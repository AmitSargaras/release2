 ...
 */
public class PreparePropResStdCommand extends PreparePropertyCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PreparePropResStdCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PreparePropResStdCommandHelper.fillPrepare(map, result, exceptionMap);
