 ...
 */
public class PreparePropSpOtherCommand extends PreparePropertyCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PreparePropSpOtherCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PreparePropSpOtherCommandHelper.fillPrepare(map, result, exceptionMap);
