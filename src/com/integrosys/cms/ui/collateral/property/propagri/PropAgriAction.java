 ...
 */
public class PropAgriAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropAgriCommand();			
		}
			...
			objArray[0] = new PreparePropAgriCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropAgriValidator.validateInput((PropAgriForm) aForm, locale);
	}
