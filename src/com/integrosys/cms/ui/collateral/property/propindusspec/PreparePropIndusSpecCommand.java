 ...
 */
public class PreparePropIndusSpecCommand extends PreparePropertyCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PreparePropIndusSpecCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PreparePropIndusSpecCommandHelper.fillPrepare(map, result, exceptionMap);
