 ...
 */
public class PropIndusSpecAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropIndusSpecCommand();
		}
			...
			objArray[0] = new PreparePropIndusSpecCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropIndusSpecValidator.validateInput((PropIndusSpecForm) aForm, locale);
	}
