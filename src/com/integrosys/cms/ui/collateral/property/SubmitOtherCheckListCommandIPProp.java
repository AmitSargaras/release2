...
public class SubmitOtherCheckListCommandIPProp extends AbstractCommand implements ICommonEventConstant{
	 ...
	 * Default Constructor
	 */
	public SubmitOtherCheckListCommandIPProp() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		for (Object key : limitAndChecklistTrxValue.keySet()) {
			ICheckListTrxValue checkListTrxVal = (ICheckListTrxValue) limitAndChecklistTrxValue.get(key);
		...
		ICheckList checkList = (ICheckList) limitAndChecklist.get(key);
		...
		SearchResult allInsuranceList= (SearchResult)insuranceGCJdbc.getAllInsurancePolicy(collateralID);
		...
		Set<String> insIdNotPresentinChklist=insuranceGCJdbc.getInsPolicyIdNotPresentInChecklist( checkList.getCheckListID(), collateralID);
