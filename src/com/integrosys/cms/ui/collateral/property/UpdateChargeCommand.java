 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/collateral/property/UpdateChargeCommand.java,v 1.22 2006/09/15 08:33:04 hshii Exp $
 */
 ...
 * @since $Date: 2006/09/15 08:33:04 $
 * Tag: $Name:  $
 */
...
public class UpdateChargeCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		IPropertyCollateral iPropertyCollateral = (IPropertyCollateral) itrxValue.getStagingCollateral();
		...
		if (iLimit != null) {
			...
			if ((exceptionMap.get("rank") == null) && (iLimit.getSecurityRank() != 0)) {
				ILimitCharge[] charge = iPropertyCollateral.getLimitCharges();
		...
		if (exceptionMap.size() == 0) {
			...
			ILimitCharge limitArray[] = iPropertyCollateral.getLimitCharges();
			...
			iPropertyCollateral.setLimitCharges(limitArray);
			itrxValue.setStagingCollateral(iPropertyCollateral);
