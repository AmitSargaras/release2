 ...
 */
public class PreparePropCommGeneralCommand extends PreparePropertyCommand {
	...
	public String[][] getResultDescriptor() {
		String[][] thisDesc = PreparePropCommGeneralCommandHelper.getResultDescriptor();
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		PreparePropCommGeneralCommandHelper.fillPrepare(map, result, exceptionMap);
