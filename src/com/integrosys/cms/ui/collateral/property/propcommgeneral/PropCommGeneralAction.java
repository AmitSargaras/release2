 ...
 */
public class PropCommGeneralAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[0] = new PreparePropCommGeneralCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropCommGeneralValidator.validateInput((PropCommGeneralForm) aForm, locale);
	}
