 ...
 */
public class PropLandUrbanAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropLandUrbanCommand();
		}
			...
			objArray[0] = new PreparePropLandUrbanCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropLandUrbanValidator.validateInput((PropLandUrbanForm) aForm, locale);
	}
