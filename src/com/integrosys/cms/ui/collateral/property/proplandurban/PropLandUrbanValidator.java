 ...
 */
public class PropLandUrbanValidator {
	public static ActionErrors validateInput(PropLandUrbanForm aForm, Locale locale) {
		...
		if (!(aForm.getEvent().equals("approve") || aForm.getEvent().equals("reject"))) {
			PropLandUrbanValidationHelper.validateInput(aForm, locale, errors);
		}
		return errors;
