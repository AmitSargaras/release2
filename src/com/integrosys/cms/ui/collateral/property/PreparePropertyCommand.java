 ...
 */
public class PreparePropertyCommand extends PrepareCollateralCommand {
	public String[][] getParameterDescriptor() {
		String[][] thisDesc = PreparePropertyCommandHelper.getResultDescriptor();
		thisDesc = mergeResultDescriptor(thisDesc, PreparePropertyCommandHelper.getParameterDescriptor());
