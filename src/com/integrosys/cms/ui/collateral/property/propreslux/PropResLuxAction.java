 ...
 */
public class PropResLuxAction extends PropertyAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		if (EVENT_PREPARE_CREATE.equals(event)) {
			...
			objArray[1] = new PreparePropResLuxCommand();
		}
			...
			objArray[0] = new PreparePropResLuxCommand();
		}
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale) {
		return PropResLuxValidator.validateInput((PropResLuxForm) aForm, locale);
	}
