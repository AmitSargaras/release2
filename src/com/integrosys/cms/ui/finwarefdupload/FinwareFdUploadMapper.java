...
public class FinwareFdUploadMapper extends AbstractCommonMapper {
	DateFormat df = new SimpleDateFormat("dd/MMM/yyyy");
	public Object mapFormToOB(CommonForm cForm, HashMap inputs) throws MapperException {

		DefaultLogger.debug(this, "Entering method mapFormToOB");
		FinwareFdUploadForm form = (FinwareFdUploadForm) cForm;

		IFinwareFdUpload obItem = null;
		try {
			
				obItem = new OBFinwareFdUpload();
