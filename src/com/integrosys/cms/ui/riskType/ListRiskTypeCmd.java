...
public class ListRiskTypeCmd extends AbstractCommand implements ICommonEventConstant{
        ...
        try {
        	...
        	String event = (String) (map.get("event"));
 			...
 			if(null == searchText ||"".equals(searchText))
 				riskTypeList= (SearchResult)   getRiskTypeProxy().getAllActualRiskType();
	        else
	        	riskTypeList= (SearchResult)  getRiskTypeProxy().getAllFilteredActualRiskType(type,searchText);	
