...
public class CheckerApproveEditRiskTypeCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerApproveEditRiskTypeCmd() {
	}
...
//			String productName = (String) map.get("productName");
	     ...
	     //   st.setValuationAmount(vals);
			...
			// Function  to approve updated RiskType Trx
			IRiskTypeTrxValue trxValueOut = getRiskTypeProxy().checkerApproveRiskType(ctx, trxValueIn);
