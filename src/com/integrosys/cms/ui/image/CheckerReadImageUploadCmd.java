 ...
 */
public class CheckerReadImageUploadCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerReadImageUploadCmd() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] { 
				{ "imageUploadObj", "com.integrosys.cms.app.image.bus.OBImageUploadDetails", REQUEST_SCOPE },
				{"IImageUploadDetailsTrxValue", "com.integrosys.cms.app.image.trx.IImageUploadDetailsTrxValue", REQUEST_SCOPE},
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
		...
		try {
			IImageUploadDetails imageUpload;
			IImageUploadDetailsTrxValue trxValue=null;
			List imageList = new ArrayList();
			String imgTrxId=(String) (map.get("TrxId"));
			// function to get system bank Trx value
			trxValue = (OBImageUploadDetailsTrxValue) getImageUploadProxyManager().getImageUploadByTrxID(imgTrxId);
			//   systemBank = (OBSystemBank) trxValue.getSystemBank();
			// function to get stging value of system bank trx value
			imageUpload = (OBImageUploadDetails) trxValue.getStagingImageUploadDetails();
			...
			imageList = getImageUploadProxyManager().getUploadImageList(Long.toString(imageUpload.getId()));

			resultMap.put("obImageUploadAddList", imageList);
			resultMap.put("IImageUploadDetailsTrxValue", trxValue);
