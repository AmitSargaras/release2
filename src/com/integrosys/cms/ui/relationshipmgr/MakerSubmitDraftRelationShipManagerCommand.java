...
/**
 * This command submit draft record selected for submission 
 * 
 * $Author: Dattatray Thorat
 * 
 * @version $Revision: 1.2 $
 */
public class MakerSubmitDraftRelationShipManagerCommand extends AbstractCommand implements ICommonEventConstant {
	...
	public MakerSubmitDraftRelationShipManagerCommand() {
	}
