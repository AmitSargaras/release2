...
public class MakerCloseRelationShipManagerCmd extends AbstractCommand implements ICommonEventConstant {
     ...
     * Default Constructor
     */
    public MakerCloseRelationShipManagerCmd() {
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,SystemBankException {
        ...
        try {
            ...
            IRelationshipMgrTrxValue trxValueOut = getRelationshipMgrProxyManager().makerCloseRejectedRelationshipMgr(ctx, trxValueIn);
