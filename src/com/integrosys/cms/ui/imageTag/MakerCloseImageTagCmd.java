...
public class MakerCloseImageTagCmd extends AbstractCommand implements ICommonEventConstant {
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,ImageTagException {
        ...
        try {
            ...
            IImageTagTrxValue trxValueOut = getImageTagProxyManager().makerCloseRejectedImageTag(ctx, trxValueIn);
