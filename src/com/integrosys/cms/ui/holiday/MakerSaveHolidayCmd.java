...
* Command for Save Holiday
 */
public class MakerSaveHolidayCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if(event.equals("maker_update_draft_holiday")){
					IHolidayTrxValue trxValueIn = (OBHolidayTrxValue) map.get("IHolidayTrxValue");
					trxValueOut = getHolidayProxy().makerUpdateSaveUpdateHoliday(ctx, trxValueIn, holiday);
					
					resultMap.put("request.ITrxValue", trxValueOut);
				}else{
				
				trxValueOut = getHolidayProxy().makerSaveHoliday(ctx,holiday);
