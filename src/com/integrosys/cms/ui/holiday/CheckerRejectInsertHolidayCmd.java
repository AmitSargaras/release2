 ...
 * 
 */
public class CheckerRejectInsertHolidayCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectInsertHolidayCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		 HashMap returnMap = new HashMap();
	        ...
	        try {
	            ...
	            IHolidayTrxValue trxValueOut = getHolidayProxy().checkerRejectInsertHoliday(ctx, trxValueIn);
