...
* Command for edit Holiday
 */
public class MakerEditHolidayCmd extends AbstractCommand implements ICommonEventConstant {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				if(trxValueIn.getFromState().equals("PENDING_PERFECTION")){
					trxValueOut = getHolidayProxy().makerUpdateSaveCreateHoliday(ctx, trxValueIn, holiday);
				}else{
					if ((event.equals("maker_edit_holiday"))||event.equals("maker_delete_holiday")||event.equals("maker_save_update")) {
						trxValueOut = getHolidayProxy().makerUpdateHoliday(ctx, trxValueIn, holiday);
					} else {
