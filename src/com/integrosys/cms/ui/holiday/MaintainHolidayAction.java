 ...
 */
public class MaintainHolidayAction extends CommonAction implements IPin {
	...
	// public static final String EVENT_LIST = "maker_list_holiday";
	public static final String MAKER_LIST_HOLIDAY = "maker_list_holiday";
	public static final String CHECKER_LIST_HOLIDAY = "checker_list_holiday";
	public static final String CHECKER_VIEW_HOLIDAY = "checker_view_holiday";
	public static final String MAKER_VIEW_HOLIDAY = "maker_view_holiday";
	public static final String MAKER_EDIT_HOLIDAY_READ = "maker_edit_holiday_read";
	...
	public static final String MAKER_EDIT_HOLIDAY = "maker_edit_holiday";
	public static final String MAKER_DELETE_HOLIDAY = "maker_delete_holiday";
	...
	public static final String REDIRECT_LIST_HOLIDAY = "redirect_list_holiday";
	public static final String MAKER_DELETE_HOLIDAY_READ = "maker_delete_holiday_read";
	public static final String MAKER_EDIT_REJECT_EDIT = "maker_edit_reject_edit";
	public static final String MAKER_SEARCH_HOLIDAY = "maker_search_holiday";
	...
	public static final String MAKER_SEARCH_LIST_HOLIDAY = "maker_search_list_holiday";
	public static final String CHECKER_SEARCH_LIST_HOLIDAY = "checker_search_list_holiday";
	...
	public static final String MAKER_PREPARE_CREATE_HOLIDAY = "maker_prepare_create_holiday";
	public static final String MAKER_CREATE_HOLIDAY = "maker_create_holiday";
	public static final String MAKER_DRAFT_HOLIDAY = "maker_draft_holiday";
	...
	public static final String MAKER_UPDATE_DRAFT_HOLIDAY = "maker_update_draft_holiday";
	...
	public static final String MAKER_PREPARE_UPLOAD_HOLIDAY = "maker_prepare_upload_holiday";
	public static final String MAKER_EVENT_UPLOAD_HOLIDAY = "maker_event_upload_holiday";
	...
	public ICommand[] getCommandChain(String event) {
		...
		DefaultLogger.debug(this,"In Maintain Holiday Action with event --" + event);

		ICommand objArray[] = null;
		if ((event.equals(CHECKER_LIST_HOLIDAY))
				|| event.equals(MAKER_LIST_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("ListHolidayCmd");

		} else if ((event.equals(CHECKER_VIEW_HOLIDAY))
				|| event.equals(MAKER_VIEW_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerReadHolidayCmd");

		} else if ((event != null) && event.equals(MAKER_EDIT_HOLIDAY_READ)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerReadHolidayCmd");
		} else if ((event.equals(MAKER_CONFIRM_RESUBMIT_EDIT))
				|| event.equals(MAKER_EDIT_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerEditHolidayCmd");
		} else if ((event != null) && (event.equals(MAKER_DELETE_HOLIDAY_READ))) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerReadHolidayCmd");

		} else if ((event.equals(MAKER_CONFIRM_RESUBMIT_DELETE))
				|| event.equals(MAKER_DELETE_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerDeleteHolidayCmd");
		} else if ((event.equals(MAKER_SEARCH_LIST_HOLIDAY))
				|| event.equals(CHECKER_SEARCH_LIST_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"SearchListHolidayCommand");
			...
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerCloseHolidayCmd");
		} else if ((event != null)
				&& event.equals(MAKER_PREPARE_CREATE_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerPrepareCreateHolidayCmd");

		} else if ((event.equals(MAKER_CONFIRM_RESUBMIT_CREATE))
				|| event.equals(MAKER_CREATE_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerCreateHolidayCmd");

		} else if (event.equals(MAKER_DRAFT_HOLIDAY)
				|| event.equals(MAKER_UPDATE_DRAFT_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerSaveHolidayCmd");
		...
		}else if (event.equals(MAKER_PREPARE_UPLOAD_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerPrepareUploadHolidayCmd");

		}else if (event.equals(MAKER_EVENT_UPLOAD_HOLIDAY)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"MakerUploadHolidayCmd");
			...
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get("CheckerApproveInsertHolidayCmd");
		}else if ( event.equals(CHECKER_REJECT_INSERT)) {
			objArray = new ICommand[1];
			objArray[0] = (ICommand) getNameCommandMap().get(
					"CheckerRejectInsertHolidayCmd");
	...
	public ActionErrors validateInput(ActionForm aForm, Locale locale)  {
		return HolidayValidator.validateInput(aForm, locale);
	}

	protected boolean isValidationRequired(String event) {
		boolean result = false;
		if (event.equals(MAKER_EDIT_HOLIDAY)
				|| event.equals(MAKER_EDIT_REJECT_EDIT)
				|| event.equals(MAKER_SEARCH_HOLIDAY)
				|| event.equals(MAKER_CONFIRM_RESUBMIT_EDIT)
				|| event.equals(MAKER_CREATE_HOLIDAY)
				|| event.equals(MAKER_SAVE_UPDATE)
				|| event.equals("maker_draft_holiday")
	...
	public IPage getNextPage(String event, HashMap resultMap,
		...
		if ((resultMap.get("wip") != null)
			...
			aPage.setPageReference("maker_add_edit_holiday_page");
			return aPage;
		} else if(event.equalsIgnoreCase("maker_add_edit_holiday_error")) {
			aPage.setPageReference("maker_add_edit_holiday_page");
			return aPage;
		}else if ((resultMap.get("errorEveList") != null) && ((String) resultMap.get("errorEveList")).equals("errorEveList")) {
			aPage.setPageReference("maker_fileupload_holiday_page");
			return aPage;
		}else if(event.equalsIgnoreCase("checker_reject_edit_error")) {
			aPage.setPageReference("checker_holiday_page");
			return aPage;
		}else {
	...
	protected String getErrorEvent(String event) {
		...
		if ("maker_add_holiday".equals(event)) {
			errorEvent = "maker_add_edit_holiday_error";
		} else if ("maker_edit_holiday".equals(event)
				|| event.equals("maker_confirm_resubmit_edit")|| event.equals("maker_update_draft_holiday")) {
			errorEvent = "maker_add_edit_holiday_error";
		...
		} else if (event.equals("maker_search_holiday")) {
			errorEvent = "maker_prepare_search_holiday";
		}else if (event.equals("maker_create_holiday")|| event.equals("maker_draft_holiday")) {
			errorEvent = "maker_prepare_create_holiday";
	...
	private String getReference(String event) {
		...
		if ((event.equals("checker_list_holiday"))
				|| event.equals("maker_list_holiday")) {
			forwardName = "maker_list_holiday_page";
		} else if ((event != null) && event.equals("maker_search_holiday")) {
			forwardName = "maker_list_holiday_page";
		} else if ((event.equals("checker_list_pagination"))
				|| event.equals("list_pagination")) {
			forwardName = "maker_list_holiday_page";
		} else if ((event != null) && event.equals("redirect_list_holiday")) {
			forwardName = "maker_list_holiday_page";
		} else if ((event != null) && event.equals("checker_list_holiday")) {
			forwardName = "checker_list_holiday_page";
		} else if ((event != null) && event.equals("maker_prepare_add_holiday")) {
			forwardName = "maker_add_edit_holiday_page";
		} else if ((event != null) && event.equals("maker_add_holiday")) {
			...
			forwardName = "maker_add_edit_holiday_page";
				...
				|| event.equals("maker_save_update")
				|| event.equals("maker_update_draft_holiday")
				|| event.equals("maker_event_upload_holiday")) {
			forwardName = "common_submit_page";
		} else if ((event != null) && event.equals("maker_delete_holiday_read")) {
		...
		} else if ((event != null) && event.equals("maker_delete_holiday")) {
			forwardName = "common_submit_page";
		} else if ((event != null) && event.equals("checker_add_read")) {
			forwardName = "checker_holiday_page";
			...
			forwardName = "work_in_process_page";
				...
				&& event.equals("maker_add_edit_holiday_error")) {
			forwardName = "maker_add_edit_holiday_page";
			...
			forwardName = "checker_holiday_page";
				...
				&& event.equals("maker_prepare_search_holiday")) {
			forwardName = "search_holiday_page";
		} else if ((event.equals("checker_search_list_holiday"))
				|| event.equals("maker_search_list_holiday")) {
			forwardName = "maker_list_holiday_page";
			...
			forwardName = "common_close_page";
				...
				&& (event.equals("maker_prepare_create_holiday"))) {
			forwardName = "prepare_create_holiday";
		}else if ((event != null)
				&& (event.equals("maker_create_holiday_error"))) {
			forwardName = "prepare_create_holiday";
		} else if (event.equals("maker_prepare_resubmit_create")) {
			forwardName = "maker_prepare_resubmit";
		}else if ((event != null) && event.equals("maker_prepare_upload_holiday")) {
			forwardName = "prepare_upload_holiday_page";
		...
		forwardName = "common_reject_page";
			...
			forwardName = "checker_holiday_insert_page";
		}else if ((event != null)
