 ...
 */
public class MakerCreateHolidayCmd extends AbstractCommand implements ICommonEventConstant {
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
				...
				trxValueOut = getHolidayProxy().makerCreateHoliday(ctx,holiday);
