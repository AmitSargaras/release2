...
public class ExcludedFacilityForm  extends TrxContextForm implements Serializable{
	...
	public static final String EXCLUDED_FACILITY_MAPPER = "com.integrosys.cms.ui.excludedfacility.ExcludedFacilityMapper";
	public static final String TRX_MAPPER = "com.integrosys.cms.ui.common.TrxContextMapper";
	
	
	public String[][] getMapper() {
		String[][] input = {  { "excludedFacilityObj", EXCLUDED_FACILITY_MAPPER },
