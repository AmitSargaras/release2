 ...
 */
public class MakerDeleteUserCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public MakerDeleteUserCmd() {
	}
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] {
				{ "CommonUserTrxValue", "com.integrosys.component.user.app.trx.ICommonUserTrxValue", SERVICE_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		ICommonUserTrxValue trxVal = (ICommonUserTrxValue) map.get("CommonUserTrxValue");
		OBTrxContext trxContext = (OBTrxContext) map.get("theOBTrxContext");
		try {
			CMSUserProxy proxy = new CMSUserProxy();
			ICompTrxResult trxResult = proxy.makerDeleteUser(trxContext, trxVal);
