 ...
 */
public class CheckerRejectAddUserCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CheckerRejectAddUserCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICompTrxResult trxResult = proxy.checkerRejectCreateUser(trxContext, userTrxVal);
