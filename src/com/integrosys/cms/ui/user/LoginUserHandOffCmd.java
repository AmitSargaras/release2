 ...
 */
public class LoginUserHandOffCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public static String CREATE_ACTIVE_USER = "integrosys.los.smeuser.create.active.user";

	public LoginUserHandOffCmd() {
	}
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] { { "CommonUser", "com.integrosys.cms.app.user.bus.OBCMSUser", FORM_SCOPE },
				...
				{ "hand", "java.lang.String", REQUEST_SCOPE },
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {
				...
				{ "hand", "java.lang.String", REQUEST_SCOPE },
				{ "isHandOffActivityPerformed", "java.lang.String", REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		String PARAM_VALUE ="";
		PARAM_VALUE = (String) map.get("hand");
		String logedInUser= "";
		if(PARAM_VALUE != null && !PARAM_VALUE.equals("")){
			try{
			logedInUser = stdUserDAO.getLogedInUserName();
			}catch(Exception e){
				System.out.println("Exception caught in stdUserDAO.getLogedInUserName()=>e=>"+e.getMessage());
				logedInUser = "";
			}
			stdUserDAO.updateUserHandover(PARAM_VALUE,logedInUser);
		}else{
			...
			for(int i=0;i<generalParamEntries.length;i++){
				if(generalParamEntries[i].getParamCode().equals("USER_HAND_OFF")){
					PARAM_VALUE = generalParamEntries[i].getParamValue();
				}
			}
			
		}
		try {
			boolean isHandOffActivityPerformed=stdUserDAO.isHandOffActivityPerformed();
			
			resultMap.put("isHandOffActivityPerformed", String.valueOf(isHandOffActivityPerformed));
		...
		resultMap.put("hand", PARAM_VALUE);
