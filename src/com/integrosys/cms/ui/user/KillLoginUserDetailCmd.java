 ...
 */
public class KillLoginUserDetailCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public static String CREATE_ACTIVE_USER = "integrosys.los.smeuser.create.active.user";

	public KillLoginUserDetailCmd() {
	}
	...
	public String[][] getParameterDescriptor() {
		return (new String[][] { { "CommonUser", "com.integrosys.cms.app.user.bus.OBCMSUser", FORM_SCOPE },
				...
				{ "status", "java.lang.String", REQUEST_SCOPE },{ "hand", "java.lang.String", REQUEST_SCOPE },
				{ "teamTypeMembership", "java.lang.String", REQUEST_SCOPE },
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		String hand = (String) map.get("hand");
		String isHandOffActivityPerformed = (String) map.get("isHandOffActivityPerformed");
		...
		resultMap.put("hand", hand);
		resultMap.put("isHandOffActivityPerformed", isHandOffActivityPerformed);
