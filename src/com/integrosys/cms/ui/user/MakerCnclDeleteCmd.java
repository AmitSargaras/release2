 ...
 */
public class MakerCnclDeleteCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public MakerCnclDeleteCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICompTrxResult trxResult = proxy.makerCancelDeleteUser(trxContext, userTrxVal);
