 ...
 */
public class CheckerRejectEditUserCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CheckerRejectEditUserCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICompTrxResult trxResult = proxy.checkerRejectUpdateUser(trxContext, userTrxVal);
