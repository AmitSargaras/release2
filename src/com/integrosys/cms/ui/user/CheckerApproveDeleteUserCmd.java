 ...
 */
public class CheckerApproveDeleteUserCmd extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CheckerApproveDeleteUserCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICompTrxResult trxResult = proxy.checkerApproveDeleteUser(trxContext, userTrxVal);
