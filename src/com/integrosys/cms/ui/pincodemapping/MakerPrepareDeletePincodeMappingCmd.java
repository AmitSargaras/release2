...
public class MakerPrepareDeletePincodeMappingCmd extends AbstractCommand implements
ICommonEventConstant  {
	 ...
	 * Default Constructor
	 */
	public MakerPrepareDeletePincodeMappingCmd() {
	}
	/**
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		try {
			...
			boolean status = false;	
			 status = limitDao.getCAMMigreted("CMS_STATE_PINCODE_MAP",pincodeMapping.getId(),"ID");
