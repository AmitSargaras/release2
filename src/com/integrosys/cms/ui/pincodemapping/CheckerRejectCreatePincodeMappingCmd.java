...
public class CheckerRejectCreatePincodeMappingCmd extends AbstractCommand implements
ICommonEventConstant {
	 ...
	 * Default Constructor
	 */
	public CheckerRejectCreatePincodeMappingCmd() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		try {
			...
			IPincodeMappingTrxValue trxValueOut = getPincodeMappingProxy()
					.checkerRejectPincodeMapping(ctx, trxValueIn);
