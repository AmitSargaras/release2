...
/**
 * @author 
 * added for new Limit UDF tab2
 */
public class UdfTag2 extends TagSupport {
...
//				udfListNonMandatory = udfDao.getUdfByMandatoryView("3");	
			...
			udfOldList_2.addAll(udfList1_2);
		}
		...
		if("add".equalsIgnoreCase(action)) {
			udfList_2=udfDao.getUdfByModuleIdAndStatus(this.module, "ACTIVE");
			udfList=udfDao.getUdfByModuleIdAndStatus("3", "ACTIVE");
		}else {
			udfList_2=udfDao.getUdfByModuleIdAndStatus(this.module, "ACTIVE");
			udfList=udfDao.getUdfByModuleIdAndStatus("3", "ACTIVE");
		}
...
//				udfListNonMandatory = udfDao.getUdfByNonMandatoryView("3");	
		...
		try {
			...
			if (null == udfList  || udfList.size() == 0) {
