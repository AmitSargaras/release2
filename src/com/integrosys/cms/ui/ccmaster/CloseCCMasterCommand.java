 ...
 * @since $Date: 2003/09/02 04:25:32 $ Tag: $Name: $
 */
public class CloseCCMasterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public CloseCCMasterCommand() {
	}
