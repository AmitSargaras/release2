 ...
 * @since $Date: 2003/07/14 05:13:44 $ Tag: $Name: $
 */
public class ReadStagingCCMasterCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public ReadStagingCCMasterCommand() {
	}
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {
				...
				{ "isEdit", "java.lang.String", REQUEST_SCOPE }, { "closeFlag", "java.lang.String", REQUEST_SCOPE } });
	}
