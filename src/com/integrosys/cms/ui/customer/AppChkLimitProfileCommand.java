 ...
 */
public class AppChkLimitProfileCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public AppChkLimitProfileCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			ICMSTrxResult resultOb = limitproxy
					.checkerApproveUpdateLimitProfile(theOBTrxContext, iLimitProfileTrxValue);
