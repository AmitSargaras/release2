...
public class RetriveImageCommand extends AbstractCommand {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException,
		...
		DefaultLogger.debug(this,"count --- :" + count );
		DefaultLogger.debug(this,"tagDetailList --- :" + tagDetailList );
		...
		hcpFileName = img.getHCPFileName();
		hcpStatus = img.getHCPStatus();
		}
			}
		}
		
		DefaultLogger.debug(this,"----------------------192--------------------- :");
		...
		imagePath="C:\\Documents and Settings\\All Users\\Documents\\My Pictures\\Sample Pictures"+"\\"+imageName;
			...
			try {
				...
				params[1] = imageName;
				params[2] = status;
				System.out.println("Comment out getContentManagerService..........");
				//imagePath=(String)getContentManagerFactory().getContentManagerService().retrieveDocument(params);
				
				if(null == hcpStatus || hcpStatus.equals("N")) {
					System.out.println("Called getContentManagerService..........");
					imagePath=(String)getContentManagerFactory().getContentManagerService().retrieveDocument(params);
					}else {
