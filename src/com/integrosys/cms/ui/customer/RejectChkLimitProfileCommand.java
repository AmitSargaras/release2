 ...
 */
public class RejectChkLimitProfileCommand extends AbstractCommand implements ICommonEventConstant {
	/**
	 * Default Constructor
	 */
	public RejectChkLimitProfileCommand() {
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			theOBTrxContext.setTrxOrganisationOrigin(iLimitProfileTrxValue.getLimitProfile().getOriginatingLocation()
					.getOrganisationCode());
			// iLimitProfileTrxValue.setTransactionSubType("LimitProfile");
			ICMSTrxResult resultOb = limitproxy.checkerRejectUpdateLimitProfile(theOBTrxContext, iLimitProfileTrxValue);
