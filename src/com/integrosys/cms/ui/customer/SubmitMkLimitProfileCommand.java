 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/ui/customer/SubmitMkLimitProfileCommand.java,v 1.7 2003/11/11 03:58:30 pooja Exp $
 */
 ...
 * @since $Date: 2003/11/11 03:58:30 $ Tag: $Name: $
 */
public class SubmitMkLimitProfileCommand extends AbstractCommand {
	/**
	 * Default Constructor
	 */
	public SubmitMkLimitProfileCommand() {
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
		...
		try {
			...
			theOBTrxContext.setTrxCountryOrigin(limitprofileob.getOriginatingLocation().getCountryCode());
			theOBTrxContext.setTrxOrganisationOrigin(limitprofileob.getOriginatingLocation().getOrganisationCode());
			OBLimitProfileTrxValue txnvalue = (OBLimitProfileTrxValue) map.get("trxValue");
			DefaultLogger.debug(this, "after getting txnvalue");
