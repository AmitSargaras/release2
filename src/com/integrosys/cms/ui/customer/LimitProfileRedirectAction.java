 ...
 */
public class LimitProfileRedirectAction extends CommonAction {
	...
	public ICommand[] getCommandChain(String event) {
		...
		objArray[0] = new RedirectLimitProfileCommand();
	...
	public IPage getNextPage(String event, HashMap resultMap, HashMap exceptionMap) {
		...
		if ((resultMap.get("trxSubType") != null)
			...
			aPage.setPageReference(ICMSConstant.MANUAL_INPUT_TRX_TYPE + "_" + event);
		}
		else {
