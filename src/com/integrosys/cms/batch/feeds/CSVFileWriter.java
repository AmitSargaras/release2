 ...
 */
public class CSVFileWriter extends AbstractMonitorAdapter {
	 ...
	 * will be written using the default comment character '#'.
	 * 
	 * @param out stream to which to print.
	 */
	public CSVFileWriter(OutputStream out) {
	 ...
	 */
	public CSVFileWriter(OutputStream out, char commentStart) {
		this(out);
	 ...
	 * @param commentStart Character used to start comments.
	 */
	public CSVFileWriter(Writer out, char commentStart) {
		this(out);
		this.commentStart = commentStart;
	}
	 ...
	 * 
	 * @param args First argument is the file name. System.out used if no
	 *        filename given.
	 */
	private static void main(String[] args) {
		...
		try {
			...
			DefaultLogger.debug("CSVFileWriter",e.getMessage());
		}
	}
}
