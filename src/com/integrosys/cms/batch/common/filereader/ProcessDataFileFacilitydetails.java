 ...
 * 
 */
public class ProcessDataFileFacilitydetails {
	...
	public ProcessDataFileFacilitydetails() {
	}
	public ProcessDataFileFacilitydetails(String propertiesFileName) {
	...
	public ProcessDataFileFacilitydetails(String propertiesFileName,String batchJobName) {
...
//			System.out.println("propertiesFilePath=" + propertiesFilePath);
	...
	public ArrayList doProcessData() {
		...
		if (getFileFormat().equals(EXCEL_FILE_FORMAT)) {
			FacilitydetailsExcel pe = new FacilitydetailsExcel();
			pe.readExcel(this);
		}
		return rowArray;
	}
...
//				delimiter="|";
				...
				if(dataFile.getHeader().getColumn()!=null && dataFile.getHeader().getColumn().length>0){
					...
					if("FacilitydetailsUpload".equalsIgnoreCase(master))
					{
						FacilitydetailsExcel excel = new FacilitydetailsExcel();
