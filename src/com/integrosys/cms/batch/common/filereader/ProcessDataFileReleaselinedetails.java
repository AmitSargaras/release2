 ...
 * 
 */
public class ProcessDataFileReleaselinedetails {
	...
	public ProcessDataFileReleaselinedetails() {
	}
	public ProcessDataFileReleaselinedetails(String propertiesFileName) {
	...
	public ProcessDataFileReleaselinedetails(String propertiesFileName,String batchJobName) {
...
//			System.out.println("propertiesFilePath=" + propertiesFilePath);
	...
	public ArrayList doProcessData() {
		...
		if (getFileFormat().equals(EXCEL_FILE_FORMAT)) {
			ReleaselinedetailsExcel pe = new ReleaselinedetailsExcel();
			pe.readExcel(this);
		}
		return rowArray;
	}
...
//				delimiter="|";
				...
				if(dataFile.getHeader().getColumn()!=null && dataFile.getHeader().getColumn().length>0){
					...
					if("ReleaselinedetailsUpload".equalsIgnoreCase(master))
					{
						ReleaselinedetailsExcel excel = new ReleaselinedetailsExcel();
