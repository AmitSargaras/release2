 ...
 * 
 */
public class ProcessDataFilePartyCam {
	...
	public ProcessDataFilePartyCam() {
	}
	public ProcessDataFilePartyCam(String propertiesFileName) {
	...
	public ProcessDataFilePartyCam(String propertiesFileName,String batchJobName) {
...
//				delimiter="|";
				...
				//MAX_RECORD_PROCESS
				//maxRecProcess=50;
				if("PartyCamUpload".equals(master)){
				PartyCamCSVReader csv = new PartyCamCSVReader();
