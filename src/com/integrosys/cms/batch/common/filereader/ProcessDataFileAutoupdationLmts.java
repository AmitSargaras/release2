 ...
 * 
 */
public class ProcessDataFileAutoupdationLmts {
	...
	public ProcessDataFileAutoupdationLmts() {
	}
	public ProcessDataFileAutoupdationLmts(String propertiesFileName) {
	...
	public ProcessDataFileAutoupdationLmts(String propertiesFileName,String batchJobName) {
...
//			System.out.println("propertiesFilePath=" + propertiesFilePath);
	...
	public ArrayList doProcessData() {
		...
		if (getFileFormat().equals(EXCEL_FILE_FORMAT)) {
			AutoupdationLmtsExcel pe = new AutoupdationLmtsExcel();
			pe.readExcel(this);
		}
		return rowArray;
	}
...
//				delimiter="|";
				...
				if(dataFile.getHeader().getColumn()!=null && dataFile.getHeader().getColumn().length>0){
					...
					if("AutoupdationLmtsUpload".equalsIgnoreCase(master))
					{
						AutoupdationLmtsExcel excel = new AutoupdationLmtsExcel();
