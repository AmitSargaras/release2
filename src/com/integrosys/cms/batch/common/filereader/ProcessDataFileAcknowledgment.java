 ...
 * 
 */
public class ProcessDataFileAcknowledgment {
	...
	public ProcessDataFileAcknowledgment() {
	}
	public ProcessDataFileAcknowledgment(String propertiesFileName) {
	...
	public ProcessDataFileAcknowledgment(String propertiesFileName,String batchJobName) {
...
//			System.out.println("propertiesFilePath=" + propertiesFilePath);
	...
	public ArrayList doProcessData() {
		...
		if (getFileFormat().equals(EXCEL_FILE_FORMAT)) {
			CersaiAcknowledgmentExcel pe = new CersaiAcknowledgmentExcel();
			pe.readExcel(this);
		}
		return rowArray;
	}
...
//				delimiter="|";
				...
				if(dataFile.getHeader().getColumn()!=null && dataFile.getHeader().getColumn().length>0){
					...
					if("AcknowledgmentUpload".equalsIgnoreCase(master))
					{
						CersaiAcknowledgmentExcel excel = new CersaiAcknowledgmentExcel();
