...
/**
 * Process data file like excel, fixed length and dump it to an array.
 ...
 * 
 */
public class ProcessDataFileCreatefacilityline {
	...
	public ProcessDataFileCreatefacilityline() {
	}
	public ProcessDataFileCreatefacilityline(String propertiesFileName) {
	...
	public ProcessDataFileCreatefacilityline(String propertiesFileName,String batchJobName) {
...
//			System.out.println("propertiesFilePath=" + propertiesFilePath);
	...
	public ArrayList doProcessData() {
		...
		if (getFileFormat().equals(EXCEL_FILE_FORMAT)) {
			CreatefacilitylineExcel pe = new CreatefacilitylineExcel();
			pe.readExcel(this);
		}
		return rowArray;
	}
...
//				delimiter="|";
				...
				if(dataFile.getHeader().getColumn()!=null && dataFile.getHeader().getColumn().length>0){
					...
					if("CreatefacilitylineUpload".equalsIgnoreCase(master))
					{
						CreatefacilitylineExcel excel = new CreatefacilitylineExcel();
