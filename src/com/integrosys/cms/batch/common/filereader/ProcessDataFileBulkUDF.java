 ...
 * 
 */
public class ProcessDataFileBulkUDF {
	...
	public ProcessDataFileBulkUDF() {
	}
	public ProcessDataFileBulkUDF(String propertiesFileName) {
	...
	public ProcessDataFileBulkUDF(String propertiesFileName,String batchJobName) {
...
//				delimiter="|";
				...
				//MAX_RECORD_PROCESS
				//maxRecProcess=50;
				if("BulkUDFUpload".equals(master)){
			    BulkUDFCSVReader csv = new BulkUDFCSVReader();
