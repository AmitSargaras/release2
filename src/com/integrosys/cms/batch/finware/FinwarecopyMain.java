...
public class FinwarecopyMain implements BatchJob {

	private IFinwarecopyDao dao;
	...
	public void execute(Map context) throws BatchJobException {
		...
		ProcessDataFile dataFile = new ProcessDataFile(
				"batch-job.properties","FINWARECOPY");
...
//		System.out.println("ArrayList : " + resultList);
	...
	public IFinwarecopyDao getDao() {
		return dao;
	}

	public void setDao(IFinwarecopyDao dao) {
		this.dao = dao;
	}
