...
public class HongkongFileUploadJob {

	private final static Logger logger = LoggerFactory.getLogger(HongkongFileUploadJob.class);

	public static void main(String[] args) {

		new HongkongFileUploadJob().execute();
	}

	public HongkongFileUploadJob() {
	...
	public void execute() {	
		DefaultLogger.info(this, "::: Start HongkongFileUploadJob :::");
		System.out.println("::: Start HongkongFileUploadJob :::");
		...
		if(null!= autoUploadServerName && autoUploadServerName.equalsIgnoreCase("app1")){
			...
			Map resultMap  = FileUploadHelper.downloadFilesFromRemoteLocation(IFileUploadConstants.FILEUPLOAD_HONGKONG);
			...
			if(fileInfo != null && fileInfo.size()>0) {
				...
				DefaultLogger.info(this, "::: End HongkongFileUploadJob Success :::");
				System.out.println("::: End HongkongFileUploadJob Success :::");
			}
			else {
				DefaultLogger.info(this, "::: End HongkongFileUploadJob  :: fileInfo is null!! :::");
				System.out.println("::: End HongkongFileUploadJob  :: fileInfo is null!! :::");
			}
		}
	}
}
