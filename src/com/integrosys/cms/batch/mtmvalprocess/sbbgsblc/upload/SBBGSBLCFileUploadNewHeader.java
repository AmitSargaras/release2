...
public enum SBBGSBLCFileUploadNewHeader {
	...
	MATURITY_DATE("MATURITY DATE"), FOLLOW_UP_DATE("FOLLOWUP DATE"), INVESTMENT_ACCOUNT_NUMBER("INVESTMENT ACCOUNT NUMBER");
	
	private final String headerName;
	
	SBBGSBLCFileUploadNewHeader(String headerName){
	...
	public static List<String> getHeaderNames() {
		SBBGSBLCFileUploadNewHeader[] headers = values();
		
		List<String> headerNames = new ArrayList<String>();
		for(SBBGSBLCFileUploadNewHeader header : headers) {
