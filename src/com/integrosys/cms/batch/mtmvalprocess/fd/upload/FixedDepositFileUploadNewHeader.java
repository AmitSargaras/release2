...
public enum FixedDepositFileUploadNewHeader {
	...
	LAST_APPROVED_BY("LAST APPROVED BY"), LAST_APPROVED_ON("LAST APPROVED ON"), FD_REBOOKING("FD REBOOKING"), INVESTMENT_ACCOUNT_NUMBER("INVESTMENT ACCOUNT NUMBER");
	
	private final String headerName;
	
	FixedDepositFileUploadNewHeader(String headerName){
	...
	public static List<String> getHeaderNames() {
		FixedDepositFileUploadNewHeader[] headers = values();
		
		List<String> headerNames = new ArrayList<String>();
		for(FixedDepositFileUploadNewHeader header : headers) {
