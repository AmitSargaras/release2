...
public class ReadComponentIDOperation extends AbstractComponentTrxOperation	implements ITrxReadOperation {
	
	public ReadComponentIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_COMPONENT_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBComponentTrxValue newValue = new OBComponentTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IComponent component=getStagingComponentBusManager().getComponentById(stagingPK);
                newValue.setStagingComponent(component);
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setComponent(getComponentBusManager().getComponentById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
