...
public class MakerEditRejectedDeleteComponentOperation extends
		AbstractComponentTrxOperation {

    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteComponentOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_COMPONENT; 
        }
        ...
        */
        public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException
        {
            ...
            replicatedComponent.setDebtors(stage.getDeprecated());
