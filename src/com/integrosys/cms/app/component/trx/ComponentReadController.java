...
public class ComponentReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public ComponentReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_COMPONENT)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadComponentOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_COMPONENT_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadComponentIDOperation");
            }else{
