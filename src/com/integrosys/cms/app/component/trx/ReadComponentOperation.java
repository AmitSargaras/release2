...
public class ReadComponentOperation extends AbstractComponentTrxOperation implements ITrxReadOperation {

	 
	    public ReadComponentOperation() {
	        super();
	    }
	    ...
	    public String getOperationName() {
	        return ICMSConstant.ACTION_READ_COMPONENT;
	    }
	    ...
	    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
	    	try {
	            ...
	            if (null != stagingRef) {
	                ...
	                newValue.setStagingComponent(getStagingComponentBusManager().getComponentById(stagingPK));
	            }else{
