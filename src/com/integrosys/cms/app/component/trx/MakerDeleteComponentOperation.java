...
public class MakerDeleteComponentOperation extends AbstractComponentTrxOperation {
	
	  public MakerDeleteComponentOperation() {
	        super();
	    }
	    ...
	    public String getOperationName() {
	        return ICMSConstant.ACTION_MAKER_DELETE_COMPONENT;
	    }
	    ...
	    public ITrxValue preProcess(ITrxValue anITrxValue) throws TrxOperationException {
	        ...
	        IComponent staging = trxValue.getStagingComponent();
	        IComponent actual = trxValue.getComponent();
	        try {
	            if (staging != null) {
	                

	                if (staging.getId() != ICMSConstant.LONG_INVALID_VALUE) {
	                	ICMSTrxValue parentTrx = getTrxManager().getTrxByRefIDAndTrxType(String.valueOf(actual.getId()), ICMSConstant.INSTANCE_COMPONENT);
