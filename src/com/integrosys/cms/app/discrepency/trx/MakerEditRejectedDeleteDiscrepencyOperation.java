...
public class MakerEditRejectedDeleteDiscrepencyOperation extends AbstractDiscrepencyTrxOperation{

	 /**
     * Defaulc Constructor
     */
     public MakerEditRejectedDeleteDiscrepencyOperation()
     {
         super();
     }
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_DISCREPENCY;
     }
