...
public class DiscrepencyReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public DiscrepencyReadController() {
    }
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param)throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_DISCREPENCY)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadDiscrepencyOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_DISCREPENCY_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadDiscrepencyIDOperation");
            }else{
