...
public class ReadDiscrepencyIDOperation extends AbstractDiscrepencyTrxOperation implements ITrxReadOperation {

	 public ReadDiscrepencyIDOperation() {
	        super();
	    }
	    ...
	    public String getOperationName() {
	        return ICMSConstant.ACTION_READ_DISCREPENCY_ID;
	    }
	    ...
	    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
	    	try {
	            ...
	            OBDiscrepencyTrxValue newValue = new OBDiscrepencyTrxValue(trxValue);
	            ...
	            if (stagingRef != null) {
	                ...
	                newValue.setStagingDiscrepency(getStagingDiscrepencyBusManager().getDiscrepencyById(stagingPK));
	            }

	            if (actualRef != null) {
	                long actualPK = (new Long(actualRef)).longValue();
	                newValue.setActualDiscrepency(getDiscrepencyBusManager().getDiscrepencyById(actualPK));
	            }
	            return newValue;
	        }
	        catch (Exception ex) {
