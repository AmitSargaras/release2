...
public class CheckerApproveDeleteDiscrepencyOperation extends AbstractDiscrepencyTrxOperation{

	/**
	 * Default Constructor
	 */
	public CheckerApproveDeleteDiscrepencyOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_DISCREPENCY;
	}
	...
	private IDiscrepencyTrxValue updateActualDiscrepency(IDiscrepencyTrxValue anIDiscrepencyTrxValue)
		...
		try {
			...
			IDiscrepency updatedDiscrepency = getDiscrepencyBusManager().deleteDiscrepency(actual);
