...
/**
 * This factory creates transaction controller for MF Template given its
 ...
 * @since $Date: $ Tag: $Name: $
 */
public class MFTemplateTrxControllerFactory implements ITrxControllerFactory {
	/**
	 * Default Constructor
	 */
	public MFTemplateTrxControllerFactory() {
		super();
	}
	...
	public ITrxController getController(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		if (isReadOperation(param.getAction())) {
			return new MFTemplateReadController();
		}
		return new MFTemplateTrxController();
	}
	...
	private boolean isReadOperation(String anAction) {
		if (anAction.equals(ICMSConstant.ACTION_READ_MF_TEMPLATE)
				|| anAction.equals(ICMSConstant.ACTION_READ_MF_TEMPLATE_BY_TRXID)) {
			return true;
		}
		else {
			return false;
