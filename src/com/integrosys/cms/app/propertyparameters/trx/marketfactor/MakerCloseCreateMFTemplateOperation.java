 ...
 * @since $Date: $ Tag: $Name: $
 */
public class MakerCloseCreateMFTemplateOperation extends AbstractMFTemplateTrxOperation {
	/**
	 * Default constructor.
	 */
	public MakerCloseCreateMFTemplateOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CLOSE_MF_TEMPLATE;
	}
