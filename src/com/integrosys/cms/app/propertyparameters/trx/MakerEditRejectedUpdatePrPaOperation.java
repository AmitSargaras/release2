...
/**
 * Created by IntelliJ IDEA. User: zhaijian Date: Feb 1, 2007 Time: 10:04:02 AM
 * To change this template use File | Settings | File Templates.
 */
public class MakerEditRejectedUpdatePrPaOperation extends AbstractProPaTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedUpdatePrPaOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_PRPA;
	}
