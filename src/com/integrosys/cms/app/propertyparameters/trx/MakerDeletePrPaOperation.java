 ...
 */
public class MakerDeletePrPaOperation extends AbstractProPaTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerDeletePrPaOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_DELETE_PRPA;
	}
	...
	public ITrxValue preProcess(ITrxValue anITrxValue) throws TrxOperationException {
		...
		try {
			if (staging != null) {
				...
				if (staging.getParameterId() != ICMSConstant.LONG_INVALID_VALUE) {
