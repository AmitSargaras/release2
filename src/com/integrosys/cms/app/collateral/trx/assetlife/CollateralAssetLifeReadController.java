...
/**
 * This transaction controller is to be used for reading security assetlifes.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class CollateralAssetLifeReadController extends AbstractTrxController implements ITrxOperationFactory {
	 ...
	 * Default constructor.
	 */
	public CollateralAssetLifeReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue trxVal, ITrxParameter param) throws TrxParameterException {
		...
		if (action.equals(ICMSConstant.ACTION_READ_ASSETLIFE)) {
			return getTrxOperation("ReadCollateralAssetLifeOperation");
		}
		else if (action.equals(ICMSConstant.ACTION_READ_ASSETLIFE_BY_TRXID)) {
			return getTrxOperation("ReadCollateralAssetLifeByTrxIDOperation");
		}
		else {
