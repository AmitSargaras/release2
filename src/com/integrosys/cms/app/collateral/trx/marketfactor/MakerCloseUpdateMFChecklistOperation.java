 ...
 * @since $Date: $ Tag: $Name: $
 */
public class MakerCloseUpdateMFChecklistOperation extends AbstractMFChecklistTrxOperation {
	/**
	 * Default constructor.
	 */
	public MakerCloseUpdateMFChecklistOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CLOSE_UPDATE_MF_CHECKLIST;
	}
	...
	public ITrxResult performProcess(ITrxValue value) throws TrxOperationException {
		try {
			...
			trxValue.setStagingMFChecklist(trxValue.getMFChecklist());
