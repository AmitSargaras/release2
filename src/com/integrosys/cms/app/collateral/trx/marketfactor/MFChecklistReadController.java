...
/**
 * This transaction controller is to be used for reading MF Checklist.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class MFChecklistReadController extends AbstractTrxController implements ITrxOperationFactory {
	 ...
	 * Default constructor.
	 */
	public MFChecklistReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue trxVal, ITrxParameter param) throws TrxParameterException {
		...
		if (action.equals(ICMSConstant.ACTION_READ_MF_CHECKLIST)) {
			return getTrxOperation("ReadMFChecklistOperation");
		}
		else if (action.equals(ICMSConstant.ACTION_READ_MF_CHECKLIST_BY_TRXID)) {
			return getTrxOperation("ReadMFChecklistByTrxIDOperation");
		}
		else {
