 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/collateral/trx/CollateralParameterReadController.java,v 1.7 2003/08/15 04:09:11 lyng Exp $
 */
...
/**
 * This transaction controller is to be used for reading security parameters
 * 
 * @author $Author: lyng $<br>
 * @version $Revision: 1.7 $
 * @since $Date: 2003/08/15 04:09:11 $ Tag: $Name: $
 */
public class CollateralParameterReadController extends AbstractTrxController implements ITrxOperationFactory {
	 ...
	 * Default constructor.
	 */
	public CollateralParameterReadController() {
	}
	...
	public ITrxResult operate(ITrxValue trxValue, ITrxParameter param) throws TrxParameterException,
		...
		Validate.notNull(trxValue, "trx value must not be null.");
		...
		try {
			...
			throw new TrxControllerException("Caught Unknown Exception: " + e);
		}
	}
	...
	public ITrxOperation getOperation(ITrxValue trxVal, ITrxParameter param) throws TrxParameterException {
		...
		if (action.equals(ICMSConstant.ACTION_READ_COLPARAM_BY_COUNTRY_COLTYPE)) {
			return getTrxOperation("ReadColParamByCountryAndColTypeOperation");
		}
		else if (action.equals(ICMSConstant.ACTION_READ_COLPARAM_BY_TRXID)) {
			return getTrxOperation("ReadColParamByTrxIDOperation");
		}
		else {
