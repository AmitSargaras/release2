 ...
 */
public class OBInsurancePolicyColl implements IInsurancePolicy {
	...
	private long insurancePolicyID = ICMSConstant.LONG_INVALID_VALUE;
	...
	private String uniqueInsuranceId;

	public String getUniqueInsuranceId() {
		return uniqueInsuranceId;
	}

	public void setUniqueInsuranceId(String uniqueInsuranceId) {
		this.uniqueInsuranceId = uniqueInsuranceId;
	}
	...
	private String nonScheme_Scheme="N";
	 ...
	 */
	public OBInsurancePolicyColl(IInsurancePolicy obj) {
		this();
	...
	public boolean equals(Object obj) {
		...
		else if (!(obj instanceof OBInsurancePolicyColl)) {
			return false;
		}
		else {
