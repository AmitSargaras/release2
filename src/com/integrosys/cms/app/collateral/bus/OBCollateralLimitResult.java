...
public class OBCollateralLimitResult implements ICollateralLimitResult {
	 ...
	 * Default Constructor
	 */
	public OBCollateralLimitResult() {
	}
	 ...
	 */
	public OBCollateralLimitResult(ICollateralSearchResult value) {
		this();
