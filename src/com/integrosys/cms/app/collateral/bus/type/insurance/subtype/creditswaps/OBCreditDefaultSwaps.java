 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/collateral/bus/type/insurance/subtype/creditswaps/OBCreditDefaultSwaps.java,v 1.4 2004/01/16 08:23:45 lyng Exp $
 */
...
/**
 * This class represents Insurance of type Credit Default Swaps.
 * 
 * @author $Author: lyng $<br>
 * @version $Revision: 1.4 $
 * @since $Date: 2004/01/16 08:23:45 $ Tag: $Name: $
 */
public class OBCreditDefaultSwaps extends OBInsuranceCollateral implements ICreditDefaultSwaps {
	 ...
	 * Default Constructor.
	 */
	public OBCreditDefaultSwaps() {
		super();
		super.setCollateralSubType(new OBCollateralSubType(ICMSConstant.COLTYPE_INS_CR_DEFAULT_SWAPS));
	}

	/**
	 * Construct the object from its interface.
	 * 
	 * @param obj is of type ICreditDefaultSwaps
	 */
	public OBCreditDefaultSwaps(ICreditDefaultSwaps obj) {
		this();
	...
	public boolean equals(Object obj) {
		...
		else if (!(obj instanceof OBCreditDefaultSwaps)) {
			return false;
		}
		else {
