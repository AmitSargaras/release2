 ...
 */
public interface EBLienLocalHome extends EJBLocalHome {
	/**
	 ...
	 */
	public EBLienLocal create(ILienMethod value) throws CreateException;
	 ...
	 */
	public EBLienLocal findByPrimaryKey(Long pk) throws FinderException;
}