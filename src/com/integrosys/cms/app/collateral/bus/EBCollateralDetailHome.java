 ...
 */
public interface EBCollateralDetailHome extends EJBHome {
	/**
	 ...
	 */
	public EBCollateralDetail create(ICollateral collateral) throws CreateException, RemoteException;
	 ...
	 * @throws RemoteException on error during remote method call
	 */
	public EBCollateralDetail findByPrimaryKey(Long collateralID) throws FinderException, RemoteException;
}
