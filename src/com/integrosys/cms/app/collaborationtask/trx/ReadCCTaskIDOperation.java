 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/collaborationtask/trx/ReadCCTaskIDOperation.java,v 1.2 2005/10/14 08:14:59 hshii Exp $
 */
...
/**
 * This operation is responsible for reading a CC task trx based on a CC task ID
 * 
 * @author $Author: hshii $
 * @version $Revision: 1.2 $
 * @since $Date: 2005/10/14 08:14:59 $ Tag: $Name: $
 */
public class ReadCCTaskIDOperation extends CMSTrxOperation implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadCCTaskIDOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_CC_TASK_ID;
	}
