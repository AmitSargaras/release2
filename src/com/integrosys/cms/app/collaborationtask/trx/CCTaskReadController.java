 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/collaborationtask/trx/CCTaskReadController.java,v 1.1 2003/08/31 14:00:35 hltan Exp $
 */
 ...
 */
public class CCTaskReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public CCTaskReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_CC_TASK)) {
				return new ReadCCTaskOperation();
			}

			if (action.equals(ICMSConstant.ACTION_READ_CC_TASK_ID)) {
				return new ReadCCTaskIDOperation();
			}
