 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/collaborationtask/trx/CollateralTaskReadController.java,v 1.1 2003/08/15 14:02:24 hltan Exp $
 */
 ...
 * @since $Date: 2003/08/15 14:02:24 $ Tag: $Name: $
 */
public class CollateralTaskReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public CollateralTaskReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_COLLATERAL_TASK)) {
				return new ReadCollateralTaskOperation();
			}

			if (action.equals(ICMSConstant.ACTION_READ_COLLATERAL_TASK_ID)) {
				return new ReadCollateralTaskIDOperation();
			}
