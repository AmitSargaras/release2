 ...
 * AbstractLiquidationProxy, wrapped in an EJB mechanism.
 * 
 * @author $Author: lini$<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class SBLiquidationProxyBean extends AbstractLiquidationProxy implements SessionBean {
	 ...
	 * Default Constructor
	 */
	public SBLiquidationProxyBean() {
	}

	/**
	 * Method to rollback a transaction
	 * 
	 * @throws LiquidationException on errors rolling back
	 */
