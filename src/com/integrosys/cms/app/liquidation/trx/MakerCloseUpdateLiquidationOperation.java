...
/**
 * This operation class is invoked by maker to close draft updated by him/her,
 ...
 * @since $Date: $ Tag: $Name: $
 */
public class MakerCloseUpdateLiquidationOperation extends AbstractLiquidationTrxOperation {

	/**
	 * Default constructor.
	 */
	public MakerCloseUpdateLiquidationOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CLOSE_LIQUIDATION;
	}
