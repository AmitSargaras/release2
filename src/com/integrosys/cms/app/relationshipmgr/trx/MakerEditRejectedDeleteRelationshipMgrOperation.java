 ...
 */
public class MakerEditRejectedDeleteRelationshipMgrOperation extends AbstractRelationshipMgrTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteRelationshipMgrOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_RELATIONSHIP_MGR;
        }
