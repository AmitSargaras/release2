...
public class CheckerApproveDeleteRelationshipMgrOperation extends AbstractRelationshipMgrTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveDeleteRelationshipMgrOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_RELATIONSHIP_MGR;
	}
	...
	private IRelationshipMgrTrxValue updateActualRelationshipMgr(IRelationshipMgrTrxValue anICCRelationshipMgrTrxValue)
		...
		try {
			...
			IRelationshipMgr updatedRelationshipMgr = getRelationshipMgrBusManager().deleteRelationshipMgr(actual);
