 ...
 */
public class MakerEditRejectedUpdateRelationshipMgrOperation extends AbstractRelationshipMgrTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateRelationshipMgrOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_RELATIONSHIP_MGR;
        }
