...
public class FileInsertReadOperation extends AbstractRelationshipMgrTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId relationshipMgr = getStagingRelationshipMgrFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId relationshipMgr = getStagingRelationshipMgrFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(relationshipMgr);
            }
            return newValue;
        }
