 ...
 * Read Relationship Manager Controller
 */
public class RelationshipMgrReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public RelationshipMgrReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_RELATIONSHIP_MGR)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadRelationShipMgrOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_RELATIONSHIP_MGR_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadRelationShipMgrIDOperation");
            }else{
