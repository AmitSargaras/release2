...
public class CheckerApproveCreateRelationshipMgrOperation extends AbstractRelationshipMgrTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveCreateRelationshipMgrOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_CREATE_RELATIONSHIP_MGR;
	}
	...
	private IRelationshipMgrTrxValue updateActualRelationshipMgr(IRelationshipMgrTrxValue anICCRelationshipMgrTrxValue)
		...
		try {
			...
			IRelationshipMgr replicatedRelationshipMgr = RelationshipMgrReplicationUtils.replicateRelationshipMgrForCreateStagingCopy(staging);
			IRelationshipMgr updatedRelationshipMgr = getRelationshipMgrBusManager().createRelationshipMgr(replicatedRelationshipMgr);
