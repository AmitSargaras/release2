 ...
 * @since $Date: 2003/08/18 03:34:40 $ Tag: $Name: $
 */
public class EditRejectAuthzPermUpliftCustodianDocTrxOperation extends AbstractUpdateCustodianDocTrxOperation {
	/**
	 * Default Constructor
	 */
	public EditRejectAuthzPermUpliftCustodianDocTrxOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_EDIT_REJECT_PERM_UPLIFT_AUTHZ_CUSTODIAN_DOC;
	}
