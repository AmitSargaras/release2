 ...
 */
public class EditRejectPermUpliftCustodianDocTrxOperation extends AbstractUpdateCustodianDocTrxOperation {
	/**
	 * Default Constructor
	 */
	public EditRejectPermUpliftCustodianDocTrxOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_EDIT_REJECT_PERM_UPLIFT_CUSTODIAN_DOC;
	}
