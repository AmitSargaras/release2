 ...
 */
public class EditRejectLodgeCustodianDocTrxOperation extends AbstractUpdateCustodianDocTrxOperation {
	/**
	 * Default Constructor
	 */
	public EditRejectLodgeCustodianDocTrxOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_EDIT_REJECT_LODGE_CUSTODIAN_DOC;
	}
