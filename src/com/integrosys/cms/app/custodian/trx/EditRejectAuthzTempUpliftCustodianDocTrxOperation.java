 ...
 */
public class EditRejectAuthzTempUpliftCustodianDocTrxOperation extends AbstractUpdateCustodianDocTrxOperation {
	/**
	 * Default Constructor
	 */
	public EditRejectAuthzTempUpliftCustodianDocTrxOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_EDIT_REJECT_TEMP_UPLIFT_AUTHZ_CUSTODIAN_DOC;
	}
