 ...
 */
public class MakerEditRejectedUpdateOtherBankOperation extends AbstractOtherBankTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateOtherBankOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_OTHER_BANK;
        }
