 ...
 * Read Other Bank Operation By Trx ID
 */

public class ReadOtherBankIDOperation extends AbstractOtherBankTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadOtherBankIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_OTHER_BANK_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBOtherBankTrxValue newValue = new OBOtherBankTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                newValue.setStagingOtherBank(getStagingOtherBankBusManager().getOtherBankById(stagingPK));
            }

            if (actualRef != null) {
                long actualPK = (new Long(actualRef)).longValue();
                newValue.setOtherBank(getOtherBankBusManager().getOtherBankById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
