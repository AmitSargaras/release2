...
public class FileInsertOtherBankReadOperation  extends AbstractOtherBankTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public FileInsertOtherBankReadOperation() {
        super();
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId holiday = getStagingOtherBankFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId holiday = getStagingOtherBankFileMapperIdBusManager().getInsertFileById(actualPK); 
                newValue.setStagingFileMapperID(holiday);
            }
            return newValue;
        }
