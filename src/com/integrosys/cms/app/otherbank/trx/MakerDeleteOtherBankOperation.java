 ...
 * Maker delete operation to  delete other bank 
 */
public class MakerDeleteOtherBankOperation extends AbstractOtherBankTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerDeleteOtherBankOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_DELETE_OTHER_BANK;
    }
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        IOtherBank replicatedOtherBank = OtherBankReplicationUtils.replicateOtherBankForCreateStagingCopy(stage);
