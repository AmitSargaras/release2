 ...
 * 
 * Maker Save create operation to  save record in Draft by maker
 * 
 * @author Dattatray Thorat
 * 
 */
public class MakerSaveCreateOtherBankOperation extends AbstractOtherBankTrxOperation {

	private static final long serialVersionUID = -6138935003644406544L;

	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_SAVE_CREATE_OTHER_BANK;
	}
