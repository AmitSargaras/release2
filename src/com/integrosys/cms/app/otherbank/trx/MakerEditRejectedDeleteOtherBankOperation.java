 ...
 */
public class MakerEditRejectedDeleteOtherBankOperation extends AbstractOtherBankTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteOtherBankOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_OTHER_BANK;
        }
