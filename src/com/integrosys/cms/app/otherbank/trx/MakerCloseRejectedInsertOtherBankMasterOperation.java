...
public class MakerCloseRejectedInsertOtherBankMasterOperation extends AbstractOtherBankTrxOperation{
    ...
    * Defaulc Constructor
    */
    public MakerCloseRejectedInsertOtherBankMasterOperation()
    {
