...
public class CheckerApproveUpdateOtherBankOperation extends AbstractOtherBankTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveUpdateOtherBankOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_UPDATE_OTHER_BANK;
	}
	...
	private IOtherBankTrxValue updateActualOtherBank(IOtherBankTrxValue anICCOtherBankTrxValue)
		...
		try {
			...
			IOtherBank updatedOtherBank = getOtherBankBusManager().updateToWorkingCopy(actual, staging);
			
			IOtherBank replicatedOtherBank = OtherBankReplicationUtils.replicateOtherBankForCreateStagingCopy(updatedOtherBank);
			
			anICCOtherBankTrxValue.setOtherBank(replicatedOtherBank);
