 ...
 * Read Other Bank Controller
 */
public class OtherBankReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public OtherBankReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_OTHER_BANK)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadOtherBankOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_OTHER_BANK_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadOtherBankIDOperation");
            }else{
