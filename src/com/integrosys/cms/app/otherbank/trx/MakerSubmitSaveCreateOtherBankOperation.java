 ...
 * Maker Submit create operation to  create record saved in Draft by maker
 */
public class MakerSubmitSaveCreateOtherBankOperation extends AbstractOtherBankTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerSubmitSaveCreateOtherBankOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_SUBMIT_SAVE_CREATE_OTHER_BANK;
        }
