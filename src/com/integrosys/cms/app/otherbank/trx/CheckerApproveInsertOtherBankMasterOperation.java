...
public class CheckerApproveInsertOtherBankMasterOperation extends AbstractOtherBankTrxOperation {
     ...
     */
    private IOtherBankTrxValue actualMaster(IOtherBankTrxValue idxTrxValue) throws OtherBankException, TrxParameterException, TransactionException, ConcurrentUpdateException {
        try {
            IFileMapperId staging = idxTrxValue.getStagingFileMapperID();
            IFileMapperId actual = idxTrxValue.getFileMapperID();

            IFileMapperId updatedActual = getOtherBankFileMapperIdBusManager().insertOtherBank(staging,idxTrxValue);           
