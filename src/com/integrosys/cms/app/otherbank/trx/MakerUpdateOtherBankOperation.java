 ...
 * Maker Update operation to  update other bank 
 */
public class MakerUpdateOtherBankOperation extends AbstractOtherBankTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerUpdateOtherBankOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_UPDATE_OTHER_BANK;
    }
