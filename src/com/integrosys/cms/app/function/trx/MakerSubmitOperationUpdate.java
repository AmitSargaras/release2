...
public class MakerSubmitOperationUpdate extends AbstractTeamFunctionGrpTrxOperation {
	public MakerSubmitOperationUpdate() {
		super();
	}

	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_SUBMIT_TEAM_FUNCTION_GRP_UPDATE;
	}
