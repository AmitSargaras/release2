...
public class TeamFunctionGrpReadController extends AbstractTrxController implements ITrxOperationFactory {
private Map nameTrxOperationMap;
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_TEAM_FUNCTION_GRP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadTeamFunctionGrpOperation");
			}
