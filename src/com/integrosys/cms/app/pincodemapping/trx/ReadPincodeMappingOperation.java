...
public class ReadPincodeMappingOperation extends AbstractPincodeMappingTrxOperation
implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadPincodeMappingOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_PINCODE_MAPPING;
	}
	/**
