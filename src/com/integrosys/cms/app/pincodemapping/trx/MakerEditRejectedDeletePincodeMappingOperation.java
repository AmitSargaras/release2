...
public class MakerEditRejectedDeletePincodeMappingOperation extends
AbstractPincodeMappingTrxOperation  {

	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedDeletePincodeMappingOperation() {
		super();
	}
	/**
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_PINCODE_MAPPING;
	}
	/**
	...
	public ITrxResult performProcess(ITrxValue anITrxValue)
		...
		/*replicatedPincodeMapping.setStateCode(stage.getStateCode());*/
