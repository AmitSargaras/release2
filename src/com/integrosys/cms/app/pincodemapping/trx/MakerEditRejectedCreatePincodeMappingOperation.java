...
public class MakerEditRejectedCreatePincodeMappingOperation extends AbstractPincodeMappingTrxOperation {

	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedCreatePincodeMappingOperation() {
		super();
	}
	/**
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_CREATE_PINCODE_MAPPING;
	}
	/**
