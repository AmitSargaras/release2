...
public class MakerEditRejectedUpdatePincodeMappingOperation extends
AbstractPincodeMappingTrxOperation {

	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedUpdatePincodeMappingOperation() {
		super();
	}
	/**
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_PINCODE_MAPPING;
	}
	/**
