...
public class MakerDeletePincodeMappingOperation extends
AbstractPincodeMappingTrxOperation  {

	/**
	 * Defaulc Constructor
	 */
	public MakerDeletePincodeMappingOperation() {
		super();
	}
	/**
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_DELETE_PINCODE_MAPPING;
	}
	/**
				...
				if (staging.getId() != ICMSConstant.LONG_INVALID_VALUE) {
					ICMSTrxValue parentTrx = getTrxManager()
							.getTrxByRefIDAndTrxType(
									...
									ICMSConstant.INSTANCE_PINCODE_MAPPING);
