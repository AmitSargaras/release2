...
public class SegmentWiseEmailReadController extends AbstractTrxController implements ITrxOperationFactory{
	 ...
	 * Default Constructor
	 */
	public SegmentWiseEmailReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_SEGMENT_WISE_EMAIL)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadSegmentWiseEmailOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_SEGMENT_WISE_EMAIL_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadSegmentWiseEmailIDOperation");
            }else{
