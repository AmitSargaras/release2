...
public class CheckerRejectSegmentWiseEmailOperation extends AbstractSegmentWiseEmailTrxOperation{

	 public CheckerRejectSegmentWiseEmailOperation(){
		 super();
	 }
	  
	public String getOperationName() {
       return ICMSConstant.ACTION_CHECKER_REJECT_SEGMENT_WISE_EMAIL;
   }
