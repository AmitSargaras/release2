...
public class SegmentWiseEmailTrxController extends CMSTrxController{
     ...
     * Default Constructor
     */
    public SegmentWiseEmailTrxController() {
    	super();
	}
    /**
    ...
    public String getInstanceName() {
        return ICMSConstant.INSTANCE_SEGMENT_WISE_EMAIL;
    }
    ...
    private ITrxOperation factoryOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if ((toState == null) || (toState.equals(ICMSConstant.STATE_ND))) {
            if (action.equals(ICMSConstant.ACTION_MAKER_CREATE_SEGMENT_WISE_EMAIL)) {
                return (ITrxOperation) getNameTrxOperationMap().get("MakerCreateSegmentWiseEmailOperation");
            }
            ...
            if (action.equals(ICMSConstant.ACTION_CHECKER_APPROVE_SEGMENT_WISE_EMAIL)) {
                return (ITrxOperation) getNameTrxOperationMap().get("CheckerApproveCreateSegmentWiseEmailOperation");
            }

            if (action.equals(ICMSConstant.ACTION_CHECKER_REJECT_SEGMENT_WISE_EMAIL)) {
                return (ITrxOperation) getNameTrxOperationMap().get("CheckerRejectSegmentWiseEmailOperation");
            }
            throw new TrxParameterException("Unknown Action: " + action + " with toState: " + toState);
        } 
        else if (toState.equals(ICMSConstant.STATE_REJECTED)) {
        	if (action.equals(ICMSConstant.ACTION_MAKER_EDIT_REJECTED_SEGMENT_WISE_EMAIL)) {
                if (fromState.equals(ICMSConstant.STATE_PENDING_CREATE)) {
                    return (ITrxOperation) getNameTrxOperationMap().get("MakerEditRejectedCreateSegmentWiseEmailOperation");
                } 
                else if (fromState.equals(ICMSConstant.STATE_PENDING_UPDATE)) {
                    return (ITrxOperation) getNameTrxOperationMap().get("MakerEditRejectedUpdateSegmentWiseEmailOperation");
            ...
            } else if (action.equals(ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_SEGMENT_WISE_EMAIL)) {
                if (fromState.equals(ICMSConstant.STATE_PENDING_CREATE)) {
                    return (ITrxOperation) getNameTrxOperationMap().get("MakerCloseRejectedCreateSegmentWiseEmailOperation");
                } else if (fromState.equals(ICMSConstant.STATE_PENDING_UPDATE)) {
                    return (ITrxOperation) getNameTrxOperationMap().get("MakerCloseRejectedUpdateSegmentWiseEmailOperation");
                } /*else if (fromState.equals(ICMSConstant.STATE_PENDING_DELETE)) {
        	...
        	if (action.equals(ICMSConstant.ACTION_MAKER_UPDATE_SEGMENT_WISE_EMAIL)) {
        		return (ITrxOperation) getNameTrxOperationMap().get("MakerUpdateSegmentWiseEmailOperation");
        	}
        	else if (action.equals(ICMSConstant.ACTION_MAKER_DELETE_SEGMENT_WISE_EMAIL)) {
                return (ITrxOperation) getNameTrxOperationMap().get("MakerDeleteSegmentWiseEmailOperation");
            }
            ...
            if (action.equals(ICMSConstant.ACTION_CHECKER_APPROVE_SEGMENT_WISE_EMAIL)) {
                return (ITrxOperation) getNameTrxOperationMap().get("CheckerApproveUpdateSegmentWiseEmailOperation");
            } else if (action.equals(ICMSConstant.ACTION_CHECKER_REJECT_SEGMENT_WISE_EMAIL)) {
                return (ITrxOperation) getNameTrxOperationMap().get("CheckerRejectSegmentWiseEmailOperation");
            }
            throw new TrxParameterException("Unknown Action: " + action + " with toState: " + toState);
        } 
