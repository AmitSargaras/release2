...
/**
 * @author Govind.sahu
 * Read Image Upload Controller
 */
public class ImageUploadReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public ImageUploadReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            ...
            } else if (action.equals(ICMSConstant.ACTION_READ_IMAGE_UPLOAD_ID)) {
