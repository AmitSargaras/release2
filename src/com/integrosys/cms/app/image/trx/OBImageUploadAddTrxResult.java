 ...
 */
public class OBImageUploadAddTrxResult extends OBCMSTrxResult implements IImageUploadAddTrxResult {
	/**
	 * Default Constructor
	 */
	public OBImageUploadAddTrxResult() {
		super();
	}
	 ...
	 */
	public OBImageUploadAddTrxResult(IImageUploadAddTrxResult obj) {
		this();
