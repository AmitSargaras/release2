...
/**
 * This factory creates transaction controller for GMRA deal valuation given its
 ...
 * @since $Date: $ Tag: $Name: $
 */
public class GMRADealValTrxControllerFactory implements ITrxControllerFactory {
	/**
	 * Default Constructor
	 */
	public GMRADealValTrxControllerFactory() {
		super();
	}
	...
	public ITrxController getController(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		if (isReadOperation(param.getAction())) {
			return new GMRADealValReadController();
		}
		return new GMRADealValTrxController();
	}
	...
	private boolean isReadOperation(String anAction) {
		if (anAction.equals(ICMSConstant.ACTION_READ_GMRA_DEAL_VAL)
				|| anAction.equals(ICMSConstant.ACTION_READ_GMRA_DEAL_VAL_BY_TRXID)) {
			return true;
		}
		else {
			return false;
