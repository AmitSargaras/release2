...
/**
 * This transaction controller is to be used for reading GMRA deal valuation.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class GMRADealValReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default constructor.
	 */
	public GMRADealValReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue trxVal, ITrxParameter param) throws TrxParameterException {
		...
		if (action.equals(ICMSConstant.ACTION_READ_GMRA_DEAL_VAL)) {
			return new ReadGMRADealValOperation();
		}
		else if (action.equals(ICMSConstant.ACTION_READ_GMRA_DEAL_VAL_BY_TRXID)) {
			return new ReadGMRADealValByTrxIDOperation();
		}
		else {
