...
/**
 * This operation class is invoked by maker to save cash margin.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class MakerSaveCashMarginOperation extends AbstractCashMarginTrxOperation {
	/**
	 * Default constructor.
	 */
	public MakerSaveCashMarginOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_SAVE_CASH_MARGIN;
	}
