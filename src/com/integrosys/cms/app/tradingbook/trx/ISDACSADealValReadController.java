...
/**
 * This transaction controller is to be used for reading ISDA CSA deal
 * valuation.
 * 
 ...
 * @since $Date: $ Tag: $Name: $
 */
public class ISDACSADealValReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default constructor.
	 */
	public ISDACSADealValReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue trxVal, ITrxParameter param) throws TrxParameterException {
		...
		if (action.equals(ICMSConstant.ACTION_READ_ISDA_DEAL_VAL)) {
			return new ReadISDACSADealValOperation();
		}
		else if (action.equals(ICMSConstant.ACTION_READ_ISDA_DEAL_VAL_BY_TRXID)) {
			return new ReadISDACSADealValByTrxIDOperation();
		}
		else {
