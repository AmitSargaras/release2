...
/**
 * This operation class is invoked by maker to update GMRA deal valuation.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class MakerUpdateGMRADealValOperation extends AbstractGMRADealValTrxOperation {
	/**
	 * Default constructor.
	 */
	public MakerUpdateGMRADealValOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_UPDATE_GMRA_DEAL_VAL;
	}
