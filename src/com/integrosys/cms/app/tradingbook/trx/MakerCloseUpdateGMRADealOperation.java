 ...
 * @since $Date: $ Tag: $Name: $
 */
public class MakerCloseUpdateGMRADealOperation extends AbstractGMRADealTrxOperation {
	/**
	 * Default constructor.
	 */
	public MakerCloseUpdateGMRADealOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CLOSE_UPDATE_GMRA_DEAL;
	}
	...
	public ITrxResult performProcess(ITrxValue value) throws TrxOperationException {
		try {
			...
			trxValue.setStagingGMRADeal(trxValue.getGMRADeal());
