...
/**
 * This factory creates transaction controller for ISDA CSA deal valuation given
 ...
 * @since $Date: $ Tag: $Name: $
 */
public class ISDACSADealValTrxControllerFactory implements ITrxControllerFactory {
	/**
	 * Default Constructor
	 */
	public ISDACSADealValTrxControllerFactory() {
		super();
	}
	...
	public ITrxController getController(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		if (isReadOperation(param.getAction())) {
			return new ISDACSADealValReadController();
		}
		return new ISDACSADealValTrxController();
	}
	...
	private boolean isReadOperation(String anAction) {
		if (anAction.equals(ICMSConstant.ACTION_READ_ISDA_DEAL_VAL)
				|| anAction.equals(ICMSConstant.ACTION_READ_ISDA_DEAL_VAL_BY_TRXID)) {
			return true;
		}
		else {
			return false;
