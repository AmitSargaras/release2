 ...
 * @since $Date: $ Tag: $Name: $
 */
public class CheckerApproveDeleteGMRADealOperation extends AbstractGMRADealTrxOperation {
	/**
	 * Default constructor.
	 */
	public CheckerApproveDeleteGMRADealOperation() {
	}
	...
	public ITrxResult performProcess(ITrxValue value) throws TrxOperationException {
		try {
			...
			trxValue = super.deleteActualGMRADeal(trxValue);
