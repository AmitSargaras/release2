...
/**
 * This transaction controller is to be used for reading GMRA deal.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class GMRADealReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default constructor.
	 */
	public GMRADealReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue trxVal, ITrxParameter param) throws TrxParameterException {
		...
		if (action.equals(ICMSConstant.ACTION_READ_GMRA_DEAL)) {
			return new ReadGMRADealOperation();
		}
		else if (action.equals(ICMSConstant.ACTION_READ_GMRA_DEAL_BY_TRXID)) {
			return new ReadGMRADealByTrxIDOperation();
		}
		else {
