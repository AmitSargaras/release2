...
/**
 * This operation class is invoked by maker to save ISDA CSA deal valuation.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class MakerSaveISDACSADealValOperation extends AbstractISDACSADealValTrxOperation {
	/**
	 * Default constructor.
	 */
	public MakerSaveISDACSADealValOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_SAVE_ISDA_DEAL_VAL;
	}
