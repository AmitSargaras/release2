 ...
 * @since $Date: $ Tag: $Name: $
 */
public class CheckerRejectUpdateGMRADealOperation extends AbstractGMRADealTrxOperation {
	/**
	 * Default constructor.
	 */
	public CheckerRejectUpdateGMRADealOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_REJECT_GMRA_DEAL;
	}
