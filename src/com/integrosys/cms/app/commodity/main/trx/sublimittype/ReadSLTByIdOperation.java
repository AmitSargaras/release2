 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/commodity/main/trx/sublimittype/ReadSLTByIdOperation.java,v 1.1 2005/10/06 05:08:56 hmbao Exp $
 */
 ...
 * @since 2005-9-15
 * @Tag 
 *      com.integrosys.cms.app.commodity.main.trx.sublimittype.ReadSLTByIdOperation
 *      .java
 */
public class ReadSLTByIdOperation extends CMSTrxOperation implements ITrxReadOperation {

	public ReadSLTByIdOperation() {
		super();
	}
	...
	public ITrxValue getTransaction(ITrxValue value) throws TransactionException {
		...
		try {
			...
			DefaultLogger.debug(this, " trxId : " + trxValue.getReferenceID());
			DefaultLogger.debug(this, " TransactionType: " + trxValue.getTransactionType());
