 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/commodity/main/trx/price/CommodityPriceReadController.java,v 1.2 2004/06/04 04:53:53 hltan Exp $
 */
...
/**
 * This trx controller is to be used in reading Commodity Price.
 * 
 * @author $Author: hltan $<br>
 * @version $Revision: 1.2 $
 * @since $Date: 2004/06/04 04:53:53 $ Tag: $Name: $
 */
public class CommodityPriceReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default constructor.
	 */
	public CommodityPriceReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_COMMODITY_MAIN_TRXID)) {
				return new ReadCommodityPriceByTrxIDOperation();
			}
			else if (action.equals(ICMSConstant.ACTION_READ_COMMODITY_MAIN_CAT_PROD)) {
				return new ReadCommodityPriceByCategoryProductOperation();
			}
			else {
