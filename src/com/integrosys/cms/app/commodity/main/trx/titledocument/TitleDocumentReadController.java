 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/commodity/main/trx/titledocument/TitleDocumentReadController.java,v 1.3 2004/08/17 06:52:31 wltan Exp $
 */
 ...
 */
public class TitleDocumentReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public TitleDocumentReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_COMMODITY_MAIN_TRXID)) {
				return new ReadTitleDocumentTrxIDOperation();
			}
			else if (action.equals(ICMSConstant.ACTION_READ_COMMODITY_MAIN_ID)) {
				return new ReadTitleDocumentIDOperation();
			}
