 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/commodity/main/trx/profile/ReadProfileIDOperation.java,v 1.3 2004/08/17 06:52:17 wltan Exp $
 */
 ...
 */
public class ReadProfileIDOperation extends CMSTrxOperation implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadProfileIDOperation() {
		super();
	}
	...
	public ITrxValue getTransaction(ITrxValue val) throws TransactionException {
		try {
			...
			if (null != stagingRef) {
				stagingProfile = (IProfile[]) getStagingCommodityMainInfoManager().getCommodityMainInfosByGroupID(
