 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/commodity/main/bus/profile/EBSupplierBean.java,v 1.3 2004/08/12 03:14:49 wltan Exp $
 */
...
public abstract class EBSupplierBean implements javax.ejb.EntityBean, ISupplier {

	private javax.ejb.EntityContext context;

	private static final String[] EXCLUDE_METHOD = new String[] { "getSupplierID", "getCommonReferenceID" };

	public EBSupplierBean() {
	}

	public OBSupplier getValue() {
		OBSupplier contents = new OBSupplier();
	...
	public long getSupplierID() {
		return getSupplierPK().longValue();
	}

	public void setSupplierID(long theID) {
		setSupplierPK(new Long(theID));
	}
	...
	public abstract Long getSupplierPK();

	public abstract void setSupplierPK(Long pk);
	 ...
	 */
	public Long ejbCreate(OBSupplier supplier) throws CreateException {
		try {
			long newSupplierPK = generateSupplierPK();
			AccessorUtil.copyValue(supplier, this, EXCLUDE_METHOD);
			setSupplierPK(new Long(newSupplierPK));
			long commonRefID = supplier.getCommonReferenceID();
			DefaultLogger.debug(this, "########## ########## EBSupplierBean.create -- supplier : " + supplier);
			setCommonReferenceID((commonRefID == ICMSConstant.LONG_INVALID_VALUE) ? newSupplierPK : commonRefID);
	 ...
	 * @param value is of type ISupplier
	 * @throws javax.ejb.CreateException on error creating references for this
	 *         borrower.
	 */
	public void ejbPostCreate(OBSupplier value) throws CreateException {
	}
