 ...
 */
public class MakerEditRejectedDeleteFCCBranchOperation extends AbstractFCCBranchTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteFCCBranchOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_FCCBRANCH;
        }
