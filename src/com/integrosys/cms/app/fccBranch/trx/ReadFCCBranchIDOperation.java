 ...
 * Read FCCBranch Operation By Trx vID
 */

public class ReadFCCBranchIDOperation extends AbstractFCCBranchTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadFCCBranchIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_FCCBRANCH_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBFCCBranchTrxValue newValue = new OBFCCBranchTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IFCCBranch fccBranch=getStagingFCCBranchBusManager().getFCCBranchById(stagingPK);
                newValue.setStagingFCCBranch(fccBranch);
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setFCCBranch(getFccBranchBusManager().getFCCBranchById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
