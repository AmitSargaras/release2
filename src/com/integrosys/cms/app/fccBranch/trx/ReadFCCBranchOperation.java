 ...
 * Read FCCBranch Operation 
 */

public class ReadFCCBranchOperation extends AbstractFCCBranchTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadFCCBranchOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_FCCBRANCH;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingFCCBranch(getStagingFCCBranchBusManager().getFCCBranchById(stagingPK));
            }else{
