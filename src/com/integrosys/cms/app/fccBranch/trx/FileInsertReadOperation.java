...
public class FileInsertReadOperation extends AbstractFCCBranchTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId holiday = getStagingFCCBranchFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId holiday = getStagingFCCBranchFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(holiday);
            }
            return newValue;
        }
