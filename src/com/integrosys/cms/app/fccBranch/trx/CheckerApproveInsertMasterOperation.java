...
public class CheckerApproveInsertMasterOperation extends AbstractFCCBranchTrxOperation {
     ...
     */
    private IFCCBranchTrxValue actualMaster(IFCCBranchTrxValue idxTrxValue) throws FCCBranchException, TrxParameterException, TransactionException, ConcurrentUpdateException {
        try {
            IFileMapperId staging = idxTrxValue.getStagingFileMapperID();
            IFileMapperId actual = idxTrxValue.getFileMapperID();

            IFileMapperId updatedActual = getFccBranchFileMapperIdBusManager().insertFCCBranch(staging,idxTrxValue);           
