 ...
 * Read FCCBranch Controller
 */
public class FCCBranchReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public FCCBranchReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_FCCBRANCH)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadFCCBranchOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_FCCBRANCH_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadFCCBranchIDOperation");
            }else{
