...
public class MakerEditRejectedDeleteBaselOperation extends AbstractBaselTrxOperation{

    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteBaselOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_BASEL; 
        }
