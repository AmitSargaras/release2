...
public class BaselReadController extends AbstractTrxController implements ITrxOperationFactory {
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_BASEL)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadBaselOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_BASEL_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadBaselIDOperation");
            }else{
