 ...
 * Read CaseBranch Operation 
 */

public class ReadCaseBranchOperation extends AbstractCaseBranchTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadCaseBranchOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_CASEBRANCH;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingCaseBranch(getStagingCaseBranchBusManager().getCaseBranchById(stagingPK));
            }else{
