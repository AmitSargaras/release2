 ...
 */
public class MakerEditRejectedDeleteCaseBranchOperation extends AbstractCaseBranchTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteCaseBranchOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_CASEBRANCH;
        }
