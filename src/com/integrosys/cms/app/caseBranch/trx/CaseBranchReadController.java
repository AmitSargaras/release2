 ...
 * Read CaseBranch Controller
 */
public class CaseBranchReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public CaseBranchReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_CASEBRANCH)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCaseBranchOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_CASEBRANCH_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCaseBranchIDOperation");
            }else{
