 ...
 * Date: Jan 18, 2008
 */
public class MakerCaseBranchInsertFileOperation extends AbstractCaseBranchTrxOperation {

   /**
    * Defaulc Constructor
    */
    public MakerCaseBranchInsertFileOperation()
    {
        super();
    }
	...
	*/
	private ICaseBranchTrxValue createFileIdTransaction(ICaseBranchTrxValue anICCICaseBranchTrxValue) throws TrxOperationException,CaseBranchException
	{
		try
		{
			anICCICaseBranchTrxValue = prepareInsertTrxValue(anICCICaseBranchTrxValue);
			ICMSTrxValue trxValue = createTransaction(anICCICaseBranchTrxValue);
            OBCaseBranchTrxValue caseBranchTrxValue = new OBCaseBranchTrxValue (trxValue);
            caseBranchTrxValue.setStagingFileMapperID(anICCICaseBranchTrxValue.getStagingFileMapperID());
            caseBranchTrxValue.setFileMapperID(anICCICaseBranchTrxValue.getFileMapperID());
