 ...
 * Read CaseBranch Operation By Trx vID
 */

public class ReadCaseBranchIDOperation extends AbstractCaseBranchTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadCaseBranchIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_CASEBRANCH_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBCaseBranchTrxValue newValue = new OBCaseBranchTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                ICaseBranch caseBranch=getStagingCaseBranchBusManager().getCaseBranchById(stagingPK);
                newValue.setStagingCaseBranch(caseBranch);
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setCaseBranch(getCaseBranchBusManager().getCaseBranchById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
