 ...
 */
public class MakerDeleteCaseBranchOperation extends AbstractCaseBranchTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerDeleteCaseBranchOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_DELETE_CASEBRANCH;
    }
    ...
    public ITrxValue preProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        ICaseBranch staging = trxValue.getStagingCaseBranch();
        try {
            if (staging != null) {
                

                if (staging.getId() != ICMSConstant.LONG_INVALID_VALUE) {
                	ICMSTrxValue parentTrx = getTrxManager().getTrxByRefIDAndTrxType(String.valueOf(staging.getId()), ICMSConstant.INSTANCE_CASEBRANCH);
