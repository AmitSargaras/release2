...
public class CheckerDeleteRejectCaseBranchOperation extends AbstractCaseBranchTrxOperation{

    public CheckerDeleteRejectCaseBranchOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_DELETE_CASEBRANCH;
    }
