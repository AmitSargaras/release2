 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/generatereq/trx/WaiverRequestReadController.java,v 1.1 2003/09/11 05:49:17 hltan Exp $
 */
 ...
 */
public class WaiverRequestReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public WaiverRequestReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_WAIVER_REQ)) {
				return new ReadWaiverRequestOperation();
			}

			if (action.equals(ICMSConstant.ACTION_READ_WAIVER_REQ_ID)) {
				return new ReadWaiverRequestIDOperation();
			}
