 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/generatereq/trx/ReadWaiverRequestOperation.java,v 1.1 2003/09/11 05:49:17 hltan Exp $
 */
 ...
 */
public class ReadWaiverRequestOperation extends CMSTrxOperation implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadWaiverRequestOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_WAIVER_REQ;
	}
	...
	public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
		try {
			...
			OBWaiverRequestTrxValue newValue = new OBWaiverRequestTrxValue(trxValue);
			...
			if (stagingRef != null) {
				...
				IWaiverRequest stagingRequest = getSBStagingGenerateRequestBusManager().getWaiverRequest(stagingPK);
				newValue.setStagingWaiverRequest(stagingRequest);
			}

			if (actualRef != null) {
				long actualPK = (new Long(actualRef)).longValue();
				IWaiverRequest actualRequest = getSBGenerateRequestBusManager().getWaiverRequest(actualPK);
				newValue.setWaiverRequest(actualRequest);
			}
			return newValue;
		}
		catch (Exception ex) {
