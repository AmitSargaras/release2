 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/generatereq/trx/ReadWaiverRequestIDOperation.java,v 1.1 2003/09/11 05:49:17 hltan Exp $
 */
 ...
 */
public class ReadWaiverRequestIDOperation extends CMSTrxOperation implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadWaiverRequestIDOperation() {
		super();
	}
	...
	public ITrxValue getTransaction(ITrxValue val) throws TransactionException {
		try {
			...
			if (null != actualRef) {
				...
				newValue.setWaiverRequest(mgr.getWaiverRequest(actualPK));
			}
			if (null != stagingRef) {
				long stagingPK = Long.parseLong(stagingRef);
				SBGenerateRequestBusManager mgr = getSBStagingGenerateRequestBusManager();
				IWaiverRequest stage = mgr.getWaiverRequest(stagingPK);
				newValue.setStagingWaiverRequest(stage);
			}
			return newValue;
		}
		catch (Exception ex) {
