 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/generatereq/bus/EBWaiverRequestItemLocal.java,v 1.1 2003/09/11 05:48:55 hltan Exp $
 */
...
/**
 * This is the local interface to the EBWaiverRequestItem entity bean.
 * 
 * @author $Author: hltan $
 * @version $Revision: 1.1 $
 * @since $Date: 2003/09/11 05:48:55 $ Tag: $Name: $
 */
public interface EBWaiverRequestItemLocal extends EJBLocalObject {
	/**
	 ...
	 */
	public void setValue(IWaiverRequestItem value);
