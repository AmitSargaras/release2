 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/documentlocation/trx/CCDocumentLocationReadController.java,v 1.1 2004/02/17 02:12:37 hltan Exp $
 */
 ...
 */
public class CCDocumentLocationReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public CCDocumentLocationReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_CC_DOC_LOC)) {
				return new ReadCCDocumentLocationOperation();
			}

			if (action.equals(ICMSConstant.ACTION_READ_CC_DOC_LOC_ID)) {
				return new ReadCCDocumentLocationIDOperation();
			}
