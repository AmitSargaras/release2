...
@XmlRootElement(name = "FacilityDeleteRequest")
public class FacilityDeleteRequestDTO extends RequestDTO{
	
	private static final long serialVersionUID = -114309476199265735L;
