...
public class ExcludedFacilityReadController extends AbstractTrxController implements ITrxOperationFactory {
	 ...
	 * Default Constructor
	 */
	public ExcludedFacilityReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_EXCLUDED_FACILITY)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadExcludedFacilityOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_EXCLUDED_FACILITY_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadExcludedFacilityIDOperation");
            }else{
