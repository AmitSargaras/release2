...
public class MakerEditRejectedUpdateExcludedFacilityOperation extends AbstractExcludedFacilityTrxOperation {

	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedUpdateExcludedFacilityOperation() {
		super();
	}
	 /**
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_EXCLUDED_FACILITY;
     }
     /**
