...
public class MakerDeleteExcludedFacilityOperation extends AbstractExcludedFacilityTrxOperation {

	/**
     * Defaulc Constructor
     */
	public MakerDeleteExcludedFacilityOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_DELETE_EXCLUDED_FACILITY;
    }
        ...
        try {
            if (staging != null) {
                ...
                if (staging.getId() != ICMSConstant.LONG_INVALID_VALUE) {
                	ICMSTrxValue parentTrx = getTrxManager().getTrxByRefIDAndTrxType(String.valueOf(staging.getId()), ICMSConstant.INSTANCE_EXCLUDED_FACILITY);
