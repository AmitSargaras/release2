...
public class MakerSaveExcludedFacilityOperation extends AbstractExcludedFacilityTrxOperation{

	/**
	    * Defaulc Constructor
	    */
	public MakerSaveExcludedFacilityOperation() {
        super();
	}
	...
	*/
	...
	{
		return ICMSConstant.ACTION_MAKER_SAVE_EXCLUDED_FACILITY;
	}
	...
	*/
	private IExcludedFacilityTrxValue createExcludedFacilityTransaction(IExcludedFacilityTrxValue anICCExcludedFacilityTrxValue) throws TrxOperationException,ExcludedFacilityException
	{
		...
		{
			throw new ExcludedFacilityException("Error in Create Excluded Facility ");
		}
