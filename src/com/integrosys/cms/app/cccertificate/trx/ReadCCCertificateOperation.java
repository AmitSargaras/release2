 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/cccertificate/trx/ReadCCCertificateOperation.java,v 1.1 2003/08/04 12:56:09 hltan Exp $
 */
 ...
 */
public class ReadCCCertificateOperation extends CMSTrxOperation implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadCCCertificateOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_CCC;
	}
	...
	public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
		try {
			...
			if (stagingRef != null) {
				...
				ICCCertificate stagingCCCert = getSBStagingCertificateBusManager().getCCCertificate(stagingPK);
				newValue.setStagingCCCertificate(stagingCCCert);
			}

			if (actualRef != null) {
				long actualPK = (new Long(actualRef)).longValue();
				ICCCertificate actualCCCert = getSBCCCertificateBusManager().getCCCertificate(actualPK);
				newValue.setCCCertificate(actualCCCert);
			}
			return newValue;
		}
		catch (Exception ex) {
