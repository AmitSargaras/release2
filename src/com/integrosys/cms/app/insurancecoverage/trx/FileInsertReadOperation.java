...
public class FileInsertReadOperation extends AbstractInsuranceCoverageTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId relationshipMgr = getStagingInsuranceCoverageFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId relationshipMgr = getStagingInsuranceCoverageFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(relationshipMgr);
            }
            return newValue;
        }
