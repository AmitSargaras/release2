 ...
 * Maker Submit Save update operation to save record  in Draft by maker
 */
public class MakerSubmitSaveUpdateInsuranceCoverageOperation extends AbstractInsuranceCoverageTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerSubmitSaveUpdateInsuranceCoverageOperation()
        {
            super();
        }
