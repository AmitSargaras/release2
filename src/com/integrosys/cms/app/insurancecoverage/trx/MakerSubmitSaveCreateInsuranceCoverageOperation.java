 ...
 */
public class MakerSubmitSaveCreateInsuranceCoverageOperation extends AbstractInsuranceCoverageTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerSubmitSaveCreateInsuranceCoverageOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_SUBMIT_SAVE_CREATE_INSURANCE_COVERAGE;
        }
