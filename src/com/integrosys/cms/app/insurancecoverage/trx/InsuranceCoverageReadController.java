 ...
 * Read Insurance Coverage Controller
 */
public class InsuranceCoverageReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public InsuranceCoverageReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_INSURANCE_COVERAGE)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadInsuranceCoverageOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_INSURANCE_COVERAGE_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadInsuranceCoverageIDOperation");
            }else{
