...
public class CheckerApproveUpdateInsuranceCoverageOperation extends AbstractInsuranceCoverageTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveUpdateInsuranceCoverageOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_UPDATE_INSURANCE_COVERAGE;
	}
	...
	private IInsuranceCoverageTrxValue updateActualInsuranceCoverage(IInsuranceCoverageTrxValue anICCInsuranceCoverageTrxValue)
		...
		try {
			...
			IInsuranceCoverage updatedInsuranceCoverage = getInsuranceCoverageBusManager().updateToWorkingCopy(actual, staging);
