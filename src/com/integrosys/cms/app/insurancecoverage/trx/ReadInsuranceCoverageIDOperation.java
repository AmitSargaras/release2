 ...
 * Read Insurance Coverage Operation By Trx ID
 */

public class ReadInsuranceCoverageIDOperation extends AbstractInsuranceCoverageTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadInsuranceCoverageIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_INSURANCE_COVERAGE_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            IInsuranceCoverageTrxValue newValue = new OBInsuranceCoverageTrxValue(trxValue);
