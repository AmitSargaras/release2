 ...
 */
public class MakerEditRejectedUpdateInsuranceCoverageOperation extends AbstractInsuranceCoverageTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateInsuranceCoverageOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_INSURANCE_COVERAGE;
        }
