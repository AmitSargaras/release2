 ...
 */
public class MakerEditRejectedDeleteInsuranceCoverageOperation extends AbstractInsuranceCoverageTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteInsuranceCoverageOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_INSURANCE_COVERAGE;
        }
