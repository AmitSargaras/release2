 ...
 */
public class ReadTatDocOperation extends AbstractTatDocTrxOperation implements ITrxReadOperation {

    /**
     * Default Constructor
     */
    public ReadTatDocOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_TAT_DOC;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
        try {
            ...
            trxValue = getTrxManager().getTrxByRefIDAndTrxType(trxValue.getReferenceID(), trxValue.getTransactionType());
