 ...
 * Date: Sep 1, 2008
 */
public class MakerSaveTatDocOperation extends AbstractTatDocTrxOperation {

	/**
	 * Default Constructor
	 */
	public MakerSaveTatDocOperation() {
	}
	...
	public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
        DefaultLogger.debug(this, "in MakerSaveTatDocOperation");
