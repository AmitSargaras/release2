 ...
 */
public class PreDealTrxReadOperation extends CMSTrxOperation implements ITrxReadOperation {

	public String getOperationName() {
		return ICMSConstant.ACTION_READ_PRE_DEAL_BY_TRX_ID;
	}

	public ITrxValue getTransaction(ITrxValue value) throws TransactionException {
		try {
			ICMSTrxValue trxValue = getTrxManager().getTransaction(value.getTransactionID());
