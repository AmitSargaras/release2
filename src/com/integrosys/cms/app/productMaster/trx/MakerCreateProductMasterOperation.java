...
public class MakerCreateProductMasterOperation extends AbstractProductMasterTrxOperation{

	/**
	 * Defaulc Constructor
	 */
	public MakerCreateProductMasterOperation() {
		super();
	}
	...
	*/
	private IProductMasterTrxValue createProductMasterTransaction(IProductMasterTrxValue anICCProductMasterTrxValue) throws TrxOperationException,ProductMasterException
	{
		...
		{
			throw new ProductMasterException("Error in Create ProductMaster Operation ");
		}
