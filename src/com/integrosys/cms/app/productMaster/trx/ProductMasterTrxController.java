...
public class ProductMasterTrxController extends CMSTrxController{
     ...
     * Default Constructor
     */
    public ProductMasterTrxController() {
    	super();
	}
    /**
    ...
    public String getInstanceName() {
        return ICMSConstant.INSTANCE_PRODUCT_MASTER;
    }
    ...
    private ITrxOperation factoryOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if(toState!=null){
           ...
           if (action.equals(ICMSConstant.ACTION_MAKER_SAVE_PRODUCT_MASTER)) {
                return (ITrxOperation) getNameTrxOperationMap().get("MakerSaveProductMasterOperation");
            }
