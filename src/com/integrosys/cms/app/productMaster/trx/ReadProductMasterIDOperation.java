...
public class ReadProductMasterIDOperation extends AbstractProductMasterTrxOperation implements ITrxReadOperation {

	/**
     * Default Constructor
     */
	public ReadProductMasterIDOperation() {
		 super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_PRODUCT_MASTER_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBProductMasterTrxValue newValue = new OBProductMasterTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IProductMaster productMaster=getStagingProductMasterBusManager().getProductMasterById(stagingPK);
                newValue.setStagingProductMaster(productMaster);
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setProductMaster(getProductMasterBusManager().getProductMasterById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
