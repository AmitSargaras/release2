...
public class ProductMasterReadController extends AbstractTrxController implements ITrxOperationFactory{
	 ...
	 * Default Constructor
	 */
	public ProductMasterReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_PRODUCT_MASTER)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadProductMasterOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_PRODUCT_MASTER_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadProductMasterIDOperation");
            }else{
