...
public class MakerSaveUpdateProductMasterOperation extends AbstractProductMasterTrxOperation  {

	/**
	 * Defaulc Constructor
	 */
	public MakerSaveUpdateProductMasterOperation() {
		super();
	}
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_SAVE_UPDATE_PRODUCT_MASTER;
    }
