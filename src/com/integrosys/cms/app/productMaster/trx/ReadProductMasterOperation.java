...
public class ReadProductMasterOperation extends AbstractProductMasterTrxOperation implements ITrxReadOperation  {

	/**
     * Default Constructor
     */
	public ReadProductMasterOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_PRODUCT_MASTER;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingProductMaster(getStagingProductMasterBusManager().getProductMasterById(stagingPK));
            }else{
