...
public class MakerUpdateDraftCreateProductMasterOperation extends AbstractProductMasterTrxOperation  {

	/**
	 * Defaulc Constructor
	 */
	public MakerUpdateDraftCreateProductMasterOperation() {
		super();
	}
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_CREATE_PRODUCT_MASTER;
    }
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        IProductMaster replicatedProductMaster = ProductMasterReplicationUtils.replicateProductMasterForCreateStagingCopy(stage);
