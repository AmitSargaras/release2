...
/**
 * Entity bean implementation for Customer Relationship entity.
 *
 ...
 * Tag:     $Name:  $
 */
public abstract class EBCustRelationshipBean implements ICustRelationship, EntityBean
{
    /** The container assigned reference to the entity. */
    private EntityContext context;

    /** A list of methods to be excluded during update to the Customer Relationship. */
    ...
    /**
	    * @see com.integrosys.cms.app.custrelationship.bus.ICustRelationship#getCustRelationshipID
	    */
    ...
    /**
	    * @see com.integrosys.cms.app.custrelationship.bus.ICustRelationship#setCustRelationshipID
	    */
    ...
    /**
	    * @see com.integrosys.cms.app.custrelationship.bus.ICustRelationship#getParentSubProfileID
	    */
    ...
    /**
	    * @see com.integrosys.cms.app.custrelationship.bus.ICustRelationship#setParentSubProfileID
	    */
	...
	/**
	    * @see com.integrosys.cms.app.custrelationship.bus.ICustRelationship#getSubProfileID
	    */
	...
	/**
	    * @see com.integrosys.cms.app.custrelationship.bus.ICustRelationship#setSubProfileID
	    */
    ...
    /**
    * @see com.integrosys.cms.app.custrelationship.bus.ICustRelationship#getCustomerDetails
    */
    ...
    /**
	    * @see com.integrosys.cms.app.custrelationship.bus.ICustRelationship#setCustomerDetails
	    */
    ...
    /**
	    * @see com.integrosys.cms.app.custrelationship.bus.EBCustRelationship#getValue
	    */
    public ICustRelationship getValue()
    {
        OBCustRelationship custRelnship = new OBCustRelationship();
        AccessorUtil.copyValue (this, custRelnship);
        return custRelnship;
    }

    /**
	    * @see com.integrosys.cms.app.custrelationship.bus.EBCustRelationship#setValue
	    */
    public void setValue (ICustRelationship custRelnship)
        throws VersionMismatchException
    {
        checkVersionMismatch ( custRelnship);
        AccessorUtil.copyValue ( custRelnship, this, EXCLUDE_METHOD );
        setVersionTime ( VersionGenerator.getVersionNumber() );
    }   

    /**
	    * @see com.integrosys.cms.app.custrelationship.bus.EBCustRelationship#setStatusDeleted
	    */
    ...
    /**
	     * Check the version of this Customer Relationship.
	     *
	     * @param custRelnship of type ICustRelationship
	     * @throws VersionMismatchException if the entity version is invalid
	     */
    private void checkVersionMismatch (ICustRelationship custRelnship)
        throws VersionMismatchException
    {
        if (getVersionTime() != custRelnship.getVersionTime())
            throw new VersionMismatchException ("Mismatch timestamp! " + custRelnship.getVersionTime());
    }
     ...
     */
    public Long ejbCreate (long parentSubProfileID, ICustRelationship custRelnship) throws CreateException
    {
		if(null == custRelnship) {
			throw new CreateException("ICustRelationship is null!");
		}
        ...
        try {
            ...
            DefaultLogger.debug(this, "Creating cust relationship with ID: " + pk);
            setCustRelationshipIDPK( new Long( pk ) );

            AccessorUtil.copyValue(custRelnship, this, EXCLUDE_METHOD);
			setEBParentSubProfileID( new Long( parentSubProfileID ) );
			if (custRelnship.getRefID() == ICMSConstant.LONG_INVALID_VALUE) {
				setRefID ( pk );
			}
			if (custRelnship.getGroupID() == ICMSConstant.LONG_MIN_VALUE) {
				setGroupID ( pk );
			}
			setVersionTime( VersionGenerator.getVersionNumber() );
     ...
     * @param custRelnship of type ICustRelationship
     */
    public void ejbPostCreate (long parentSubProfileID, ICustRelationship custRelnship)
    {}
