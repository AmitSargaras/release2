...
/**
 * This trx controller is to be used in Customer Relationship. It provides
 * factory for trx operations that are specific to Customer Relationship.
 *
 ...
 * Tag:      $Name: $
 */
public class CustRelationshipTrxController extends CMSTrxController
{
    /**
     * Default Constructor
     */
    public CustRelationshipTrxController() {
        super();
    }
     ...
     *
     * @return instance of Customer Relationship
     */
    public String getInstanceName() {
        return ICMSConstant.INSTANCE_CUST_RELNSHIP;
    }
        ...
        throws TrxParameterException
    {
        ...
        if (fromState.equals (ICMSConstant.STATE_ND)) {
            if (action.equals (ICMSConstant.ACTION_MAKER_CREATE_CUST_RELNSHIP) ) {
                return new MakerCreateCustRelationshipOperation();
            }
            else {
            ...
            if (action.equals (ICMSConstant.ACTION_MAKER_UPDATE_CUST_RELNSHIP)) {
                return new MakerUpdateCustRelationshipOperation();
            }
            else {
                throw new TrxParameterException ("Unknown Action: " +
                            action + " with fromState: " + fromState);
            ...
            if (action.equals (ICMSConstant.ACTION_CHECKER_APPROVE_CUST_RELNSHIP)) {
                return new CheckerApproveUpdateCustRelationshipOperation();
            }
            else if (action.equals (ICMSConstant.ACTION_CHECKER_REJECT_CUST_RELNSHIP)) {
                return new CheckerRejectUpdateCustRelationshipOperation();
            }
            else {
                throw new TrxParameterException ("Unknown Action: " +
                            action + " with fromState: " + fromState);
            ...
            else if (action.equals (ICMSConstant.ACTION_MAKER_CLOSE_CUST_RELNSHIP)) {
                return new MakerCloseCreateCustRelationshipOperation();
            }
            else {
                throw new TrxParameterException ("Unknown Action: " +
                            action + " with fromState: " + fromState);
            ...
            if (action.equals (ICMSConstant.ACTION_MAKER_CLOSE_UPDATE_CUST_RELNSHIP)) {
                return new MakerCloseUpdateCustRelationshipOperation();
            }
            else if (action.equals (ICMSConstant.ACTION_MAKER_UPDATE_CUST_RELNSHIP)) {
                return new MakerUpdateCustRelationshipOperation();
            }
            else {
                throw new TrxParameterException ("Unknown Action: " +
