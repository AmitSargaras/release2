...
/**
 * This transaction controller is to be used for reading Customer Shareholder.
 *
 ...
 * Tag:      $Name: $
 */
public class CustShareholderReadController extends AbstractTrxController implements ITrxOperationFactory
{
    /**
     * Default constructor.
     */
    public CustShareholderReadController()
    {}
        ...
        throws TrxParameterException
    {
        ...
        if (action.equals(ICMSConstant.ACTION_READ_SHAREHOLDER) ) {
            return new ReadCustShareholderOperation();
        }
        else if (action.equals (ICMSConstant.ACTION_READ_SHAREHOLDER_BY_TRXID)) {
            return new ReadCustShareholderByTrxIDOperation();
        }
        else {
