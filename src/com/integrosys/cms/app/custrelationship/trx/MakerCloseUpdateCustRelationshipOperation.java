 ...
 * Tag:      $Name: $
 */
public class MakerCloseUpdateCustRelationshipOperation extends AbstractCustRelationshipTrxOperation
{
    /**
     * Default constructor.
     */
    public MakerCloseUpdateCustRelationshipOperation()
    {}
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_CLOSE_UPDATE_CUST_RELNSHIP;
    }
    ...
    public ITrxResult performProcess (ITrxValue value) throws TrxOperationException
    {
        try {
			...
			trxValue.setStagingCustRelationship (trxValue.getCustRelationship());
