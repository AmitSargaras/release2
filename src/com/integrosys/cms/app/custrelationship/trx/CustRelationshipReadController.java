...
/**
 * This transaction controller is to be used for reading Customer Relationship.
 *
 ...
 * Tag:      $Name: $
 */
public class CustRelationshipReadController extends AbstractTrxController implements ITrxOperationFactory
{
    /**
     * Default constructor.
     */
    public CustRelationshipReadController()
    {}
        ...
        throws TrxParameterException
    {
        ...
        if (action.equals(ICMSConstant.ACTION_READ_CUST_RELNSHIP) ) {
            return new ReadCustRelationshipOperation();
        }
        else if (action.equals (ICMSConstant.ACTION_READ_CUST_RELNSHIP_BY_TRXID)) {
            return new ReadCustRelationshipByTrxIDOperation();
        }
        else {
