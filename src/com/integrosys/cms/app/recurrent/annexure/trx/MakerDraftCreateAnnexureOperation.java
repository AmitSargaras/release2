 ...
 */
public class MakerDraftCreateAnnexureOperation extends AbstractAnnexureTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerDraftCreateAnnexureOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_DRAFT_CREATE_ANNEXURE_CHECKLIST;
	}
