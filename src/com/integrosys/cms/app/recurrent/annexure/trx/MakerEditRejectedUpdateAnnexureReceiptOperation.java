 ...
 */
public class MakerEditRejectedUpdateAnnexureReceiptOperation extends
		MakerEditRejectedUpdateAnnexureOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedUpdateAnnexureReceiptOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_ANNEXURE_CHECKLIST_RECEIPT;
	}
}