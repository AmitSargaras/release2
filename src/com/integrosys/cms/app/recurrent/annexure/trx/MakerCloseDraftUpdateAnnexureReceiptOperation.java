 ...
 */
public class MakerCloseDraftUpdateAnnexureReceiptOperation extends
		MakerCloseRejectedUpdateAnnexureOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerCloseDraftUpdateAnnexureReceiptOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CLOSE_DRAFT_ANNEXURE_CHECKLIST_RECEIPT;
	}
}