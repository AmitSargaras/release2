 ...
 */
public class MakerCreateAnnexureOperation extends AbstractAnnexureTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerCreateAnnexureOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CREATE_ANNEXURE_CHECKLIST;
	}
