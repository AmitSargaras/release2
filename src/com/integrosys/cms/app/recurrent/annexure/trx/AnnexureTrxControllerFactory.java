 ...
 */
public class AnnexureTrxControllerFactory implements ITrxControllerFactory {
	/**
	 * Default Constructor
	 */
	public AnnexureTrxControllerFactory() {
		super();
	}
	...
	public ITrxController getController(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (isRecurrentCheckListRelated(param.getAction())) {
			if (isReadOperation(param.getAction())) {
				return new AnnexureReadController();
			}
			return new AnnexureTrxController();
		}
