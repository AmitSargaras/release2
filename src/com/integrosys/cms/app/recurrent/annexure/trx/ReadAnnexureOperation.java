 ...
 */
public class ReadAnnexureOperation extends AbstractAnnexureReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadAnnexureOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_ANNEXURE_CHECKLIST;
	}
