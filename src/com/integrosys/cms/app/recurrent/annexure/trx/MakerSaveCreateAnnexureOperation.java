 ...
 */
public class MakerSaveCreateAnnexureOperation extends AbstractAnnexureTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerSaveCreateAnnexureOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_SAVE_CREATE_ANNEXURE_CHECKLIST;
	}
