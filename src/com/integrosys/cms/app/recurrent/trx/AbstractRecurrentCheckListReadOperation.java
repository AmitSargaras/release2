 ...
 * @since 08.09.2008
 */
public abstract class AbstractRecurrentCheckListReadOperation extends CMSTrxOperation implements ITrxReadOperation {
	...
	public ITrxValue getTransaction(ITrxValue val) throws TransactionException {
		try {
			...
			OBRecurrentCheckListTrxValue newValue = new OBRecurrentCheckListTrxValue(trxValue);
