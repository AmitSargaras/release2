 ...
 */
public class MakerSaveRecurrentCheckListReceiptOperation extends MakerUpdateRecurrentCheckListOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerSaveRecurrentCheckListReceiptOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_SAVE_RECURRENT_CHECKLIST_RECEIPT;
	}
}