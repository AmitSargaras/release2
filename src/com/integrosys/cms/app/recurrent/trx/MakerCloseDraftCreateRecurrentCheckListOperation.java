 ...
 */
public class MakerCloseDraftCreateRecurrentCheckListOperation extends AbstractRecurrentCheckListTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerCloseDraftCreateRecurrentCheckListOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CLOSE_DRAFT_CREATE_RECURRENT_CHECKLIST;
	}
