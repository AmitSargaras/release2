 ...
 */
public class SystemCreateRecurrentCheckListOperation extends AbstractRecurrentCheckListTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public SystemCreateRecurrentCheckListOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_SYSTEM_CREATE_RECURRENT_CHECKLIST;
	}
