 ...
 */
public class MakerCreateRecurrentCheckListOperation extends AbstractRecurrentCheckListTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerCreateRecurrentCheckListOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CREATE_RECURRENT_CHECKLIST;
	}
