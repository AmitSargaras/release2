 ...
 */
public class MakerCloseRejectedUpdateRecurrentCheckListReceiptOperation extends
		MakerCloseRejectedUpdateRecurrentCheckListOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerCloseRejectedUpdateRecurrentCheckListReceiptOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_UPDATE_RECURRENT_CHECKLIST_RECEIPT;
	}
}