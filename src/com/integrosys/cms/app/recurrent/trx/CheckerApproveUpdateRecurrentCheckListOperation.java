 ...
 */
public class CheckerApproveUpdateRecurrentCheckListOperation extends AbstractRecurrentCheckListTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public CheckerApproveUpdateRecurrentCheckListOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_UPDATE_RECURRENT_CHECKLIST;
	}
