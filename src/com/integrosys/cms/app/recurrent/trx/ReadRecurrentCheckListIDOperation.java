 ...
 */
public class ReadRecurrentCheckListIDOperation extends AbstractRecurrentCheckListReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadRecurrentCheckListIDOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_RECURRENT_CHECKLIST_ID;
	}
