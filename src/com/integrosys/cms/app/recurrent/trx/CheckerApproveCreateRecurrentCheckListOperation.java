 ...
 */
public class CheckerApproveCreateRecurrentCheckListOperation extends AbstractRecurrentCheckListTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveCreateRecurrentCheckListOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_CREATE_RECURRENT_CHECKLIST;
	}
