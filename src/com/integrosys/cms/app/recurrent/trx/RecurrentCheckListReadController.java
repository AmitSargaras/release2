 ...
 */
public class RecurrentCheckListReadController extends AbstractTrxController implements ITrxOperationFactory {
	 ...
	 * Default Constructor
	 */
	public RecurrentCheckListReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_RECURRENT_CHECKLIST)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadRecurrentCheckListOperation");
			}

			if (action.equals(ICMSConstant.ACTION_READ_RECURRENT_CHECKLIST_ID)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadRecurrentCheckListIDOperation");
			}
