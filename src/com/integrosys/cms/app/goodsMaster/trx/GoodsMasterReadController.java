...
public class GoodsMasterReadController extends AbstractTrxController implements ITrxOperationFactory{
	 ...
	 * Default Constructor
	 */
	public GoodsMasterReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_GOODS_MASTER)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadGoodsMasterOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_GOODS_MASTER_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadGoodsMasterIDOperation");
            }else{
