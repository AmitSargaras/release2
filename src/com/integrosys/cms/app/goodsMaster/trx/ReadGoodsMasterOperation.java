...
public class ReadGoodsMasterOperation extends AbstractGoodsMasterTrxOperation implements ITrxReadOperation  {

	/**
     * Default Constructor
     */
	public ReadGoodsMasterOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_GOODS_MASTER;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingGoodsMaster(getStagingGoodsMasterBusManager().getGoodsMasterById(stagingPK));
            }else{
