...
public class MakerSaveGoodsMasterOperation extends AbstractGoodsMasterTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerSaveGoodsMasterOperation() {
		super();
	}
	...
	*/
	...
	{
		return ICMSConstant.ACTION_MAKER_SAVE_GOODS_MASTER;
	}
	...
	* @param anICCGoodsMasterIdxTrxValue of ICCGoodsMasterIdxTrxValue type
	* @return ICCGoodsMasterIdxTrxValue
	...
	*/
	private IGoodsMasterTrxValue createGoodsMasterTransaction(IGoodsMasterTrxValue anICCGoodsMasterTrxValue) throws TrxOperationException,GoodsMasterException
	{
		...
		{
			throw new GoodsMasterException("Error in Create GoodsMaster");
		}
