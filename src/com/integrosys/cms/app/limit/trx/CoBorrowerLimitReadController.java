 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/limit/trx/CoBorrowerLimitReadController.java,v 1.2 2005/09/22 02:03:08 whuang Exp $
 */
 ...
 */
public class CoBorrowerLimitReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public CoBorrowerLimitReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_CO_LIMIT)) {
				return new ReadCoBorrowerLimitOperation();
			}
			else if (action.equals(ICMSConstant.ACTION_READ_CO_LIMIT_ID)) {
				return new ReadCoBorrowerLimitIDOperation();
			}
			else if (action.equals(ICMSConstant.ACTION_READ_CO_BORROWER_LIMIT_BY_LPID)) {
				return new ReadCoBorrowerLimitByProfileOperation();
			}
			else {
