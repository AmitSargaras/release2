 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/limit/trx/SystemUpdateLimitOperation.java,v 1.1 2003/09/11 10:53:24 kllee Exp $
 */
...
/**
 * This operation allows system to update limit
 * 
 * @author $Author: kllee $
 * @version $Revision: 1.1 $
 * @since $Date: 2003/09/11 10:53:24 $ Tag: $Name: $
 */
public class SystemUpdateLimitOperation extends AbstractLimitTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public SystemUpdateLimitOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_SYSTEM_UPDATE_LIMIT;
	}
