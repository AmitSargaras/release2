 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/limit/proxy/SBLimitProxy.java,v 1.40 2006/10/09 05:30:02 jzhai Exp $
 */
...
/**
 * This is the remote interface to the SBLimitProxy session bean.
 * 
 * @author $Author: jzhai $
 * @version $Revision: 1.40 $
 * @since $Date: 2006/10/09 05:30:02 $ Tag: $Name: $
 */
public interface SBLimitProxy extends EJBObject {
	/**
	 ...
	 */
	public int getCCCStatus(ILimitProfile value) throws RemoteException;
	 ...
	 */
	public ICMSTrxResult createLimitProfile(ILimitProfile value) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult createLimitProfile(ILimitProfileTrxValue value) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult createLimit(ILimit value) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult createLimit(ILimitTrxValue value) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult createCoBorrowerLimit(ICoBorrowerLimit value) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult createCoBorrowerLimit(ICoBorrowerLimitTrxValue value) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ILimitTrxValue getTrxLimit(String trxID) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ILimitTrxValue getTrxLimit(long limitID) throws LimitException, RemoteException;
	 ...
	 * @throws RemoteException on any unexpected errors during remote method
	 *         call
	 */
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICoBorrowerLimitTrxValue getTrxCoBorrowerLimit(String trxID) throws LimitException, RemoteException;
	 ...
	 */
	public ICoBorrowerLimitTrxValue getTrxCoBorrowerLimits(String trxID) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICoBorrowerLimitTrxValue getTrxCoBorrowerLimit(long limitID) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ILimitProfileTrxValue getTrxLimitProfile(String trxID) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ILimitProfileTrxValue getTrxLimitProfile(long limitProfileID) throws LimitException, RemoteException;
	 ...
	 * ILimitTrxValue trxValue, ILimit limit) throws LimitException,
	 * RemoteException;
	 */
	/**
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult systemUpdateLimit(ILimitTrxValue trxValue) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult systemDeleteLimit(ILimitTrxValue trxValue) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult systemCloseLimit(ICMSTrxValue trxValue) throws LimitException, RemoteException;
	...
	public ICMSTrxResult makerUpdateCoBorrowerLimit(ITrxContext context, ICoBorrowerLimitTrxValue trxValue,
			ICoBorrowerLimit limit) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult systemCloseCoBorrowerLimit(ICMSTrxValue trxValue) throws LimitException, RemoteException;
	...
	public ICMSTrxResult makerUpdateLimitProfile(ITrxContext context, ILimitProfileTrxValue trxValue,
			ILimitProfile limitProfile) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult systemCloseLimitProfile(ICMSTrxValue trxValue) throws LimitException, RemoteException;
	 ...
	 * @return transaction result
	 * @throws LimitException on any errors encountered
	 * @throws RemoteException errors during remote method call
	 */
	...
	public ICMSTrxResult specialIssueCleanTypeBFL(ITrxContext context, ILimitProfileTrxValue trxValue,
			ITATEntry tatEntry) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult cccGenerated(ILimitProfileTrxValue trxValue) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult sccGenerated(ILimitProfileTrxValue trxValue) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public ICMSTrxResult completeProcessBCA(ILimitProfileTrxValue trxValue) throws LimitException, RemoteException;
	...
	// newProfile) throws LimitException, RemoteException;
	/**
	 ...
	 * @throws LimitException, RemoteException on error
	 */
	public void renewBCA(long profileID) throws LimitException, RemoteException;
	 ...
	 */
	public HashMap getFAMName(long limitProfileID) throws RemoteException, LimitException;
	 ...
	 */
	public String getTrxSubTypeByTrxID(long trxID) throws RemoteException, LimitException;
	 ...
	 * @return the name of the FAM
	 */
	public HashMap getFAMNameByCustomer(long customerID) throws LimitException, RemoteException;
	 ...
	 */
	public Date getDueDate(Date startDate, int numOfDays, String countryCode) throws RemoteException;
	 ...
	 * @throws RemoteException on any error during remote method call
	 */
	public IBookingLocation[] getBookingLocationByCountry(String country) throws LimitException, RemoteException;
	 ...
	 */
	public List getBFLTATParameter(String country) throws LimitException, RemoteException;
	 ...
	 * @throws RemoteException on any error during remote method call
	 */
	public String[] getUniqueBookingLocation(String country) throws LimitException, RemoteException;
	 ...
	 * @throws RemoteException on any error during remote method call
	 */
	public IBookingLocation getBookingLocation(long sciBkgLocknID) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException, RemoteException on errors
	 */
	public boolean isCleanBFLReminderRequired(long limitProfileID) throws LimitException, RemoteException;
	...
	public ITATEntry[] getTatEntry(long limitProfileID) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException
	 */
	public HashMap getApprovedLimitAmount(List limitIDList) throws LimitException, RemoteException;

	public HashMap getApprovedLimitAmount4CoBorrower(List limitIDList) throws LimitException, RemoteException;
	 ...
	 * @throws Exception
	 */
	public void performChargeAllocation(ICollateral col, CollateralThresholdDAO dao) throws Exception, RemoteException;
	 ...
	 * @throws LimitException on errors
	 */
	public HashMap getLimitProfileIds(long collateralId) throws LimitException, RemoteException;
	 ...
	 * @throws LimitException on errors
	 */
	public List getLimitProfileIdsByApprLmts(long collateralId) throws LimitException, RemoteException;
	 ...
	 */
	public String getLEIdAndBCARef(long limitProfileId) throws LimitException, RemoteException;
	...
	public ICMSTrxResult makerCreateLimitProfile(ITrxContext context, ILimitProfileTrxValue trxValue,
			ILimitProfile value) throws LimitException, RemoteException;
	...
	public boolean getTrxCam(String customerID) throws LimitException, RemoteException;
	...
	public ICMSTrxResult submitCreateLimitProfile(OBTrxContext trxContext, ILimitProfileTrxValue limitProfileTrxVal,
			OBLimitProfile newLimitProfile) throws LimitException,RemoteException;
