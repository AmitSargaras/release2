...
public abstract class EBLimitProfileUdfBean implements EntityBean, ILimitProfileUdf {


	private static final String SEQUENCE_NAME = ICMSConstant.SEQUENCE_LIMIT_UDF;
	private static final String[] EXCLUDE_METHOD = new String[] { "getId", "getLimitProfileId" };
	...
	public long getLimitProfileId() {
		if (null != getLimitProfileIdFK()) {
			return getLimitProfileIdFK().longValue();
		}
		else {
			return com.integrosys.cms.app.common.constant.ICMSConstant.LONG_INVALID_VALUE;
		}
	...
	public void setLimitProfileId(long value) {
		setLimitProfileIdFK(new Long(value));
	}
	
	
	public ILimitProfileUdf getValue() {
		ILimitProfileUdf value = new OBLimitProfileUdf();
		AccessorUtil.copyValue(this, value);
		return value;
	}
	
	public Long ejbCreate(ILimitProfileUdf value) throws CreateException {
		if (null == value) {
			throw new CreateException("ILimitProfileUdf is null!");
		}
		try {
	...
	public void ejbPostCreate(ILimitProfileUdf value) {}
	...
	public abstract Long getLimitProfileIdFK();
	public abstract void setLimitProfileIdFK(Long value);
