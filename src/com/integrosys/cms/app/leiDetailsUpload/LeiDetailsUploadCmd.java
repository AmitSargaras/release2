...
public class LeiDetailsUploadCmd extends AbstractCommand implements ICommonEventConstant{

	public LeiDetailsUploadCmd(){
	}
	/**
	 ...
	 public String[][] getResultDescriptor() {
	    ...
	    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
			...
			try {
					...
					if(fileUploadJdbc.getLeiDetailsUplodCount()>0){
						preUpload=true;
					}
					if(!preUpload){
//						String refreshStatus = fileUploadJdbc.spUploadTransaction("LEIDETAILSUPLOAD");
