...
public class MakerCloseLeiDetailsFileCmd extends AbstractCommand implements ICommonEventConstant{
	public MakerCloseLeiDetailsFileCmd(){		
			}
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,FileUploadException {
        ...
        try {
            ...
            IFileUploadTrxValue trxValueOut = getLeiDetailsuploadProxy().makerCloseRejectUbsFile(ctx, trxValueIn);
