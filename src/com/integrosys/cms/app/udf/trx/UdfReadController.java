...
public class UdfReadController extends AbstractTrxController implements ITrxOperationFactory{
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_UDF)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadUdfOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_UDF_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadUdfIDOperation");
            }else{
