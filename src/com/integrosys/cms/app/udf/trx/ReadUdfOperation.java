...
public class ReadUdfOperation extends AbstractUdfTrxOperation implements ITrxReadOperation  {

	/**
     * Default Constructor
     */
	public ReadUdfOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_UDF;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingUdf(getStagingUdfBusManager().getUdfById(stagingPK));
            }else{
