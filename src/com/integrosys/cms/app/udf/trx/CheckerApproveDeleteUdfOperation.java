...
public class CheckerApproveDeleteUdfOperation extends
		AbstractUdfTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveDeleteUdfOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_UDF;
	}
	...
	private IUdfTrxValue updateActualUdf(
		...
		try {
			...
			IUdf updatedUdf = getUdfBusManager().deleteUdfNew(actual); 
