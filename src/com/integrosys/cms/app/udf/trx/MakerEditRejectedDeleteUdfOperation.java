...
/**
 * @author uma.khot Maker Edit Rejected operation to update rejected
 *         record by checker
 */
public class MakerEditRejectedDeleteUdfOperation extends
		AbstractUdfTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedDeleteUdfOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_UDF;
	}
