 ...
 */
public class ApprovalMatrixReadController extends AbstractTrxController implements ITrxOperationFactory {
	...
	public ApprovalMatrixReadController() {
	}
	...
	public String getInstanceName() {
		return ICMSConstant.INSTANCE_APROVAL_MATRIX_GROUP;
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_APROVAL_MATRIX_GROUP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadApprovalMatrixOperation");
			}
