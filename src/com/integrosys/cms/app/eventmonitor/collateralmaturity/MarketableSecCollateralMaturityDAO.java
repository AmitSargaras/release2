 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/eventmonitor/collateralmaturity/MarketableSecCollateralMaturityDAO.java,v 1.22 2006/08/21 02:46:34 hmbao Exp $
 */
 ...
 *      MarketableSecCollateralMaturityDAO.java
 */
public class MarketableSecCollateralMaturityDAO extends AbstractCollateralMaturityDAO {
	/*
...
*/
	protected String getSelectStmt() {
		...
		sqlBuffer.append("CMS_PORTFOLIO_ITEM.SECURITY_MATURITY_DATE, ");
		sqlBuffer
				.append("calendar_days(cast(? as date), CAST(CMS_PORTFOLIO_ITEM.SECURITY_MATURITY_DATE AS DATE)  ) AS daysdue ");
	...
	protected String getFromStmt(boolean isCoBorrower) {
		...
		sqlBuffer.append(" FROM CMS_PORTFOLIO_ITEM,");
	...
	protected String getConditionStmt(boolean isByCountry, boolean isCoBorrower) {
		...
		sqlBuffer.append(" AND CMS_SECURITY.SECURITY_SUB_TYPE_ID LIKE 'MS%' ");
		sqlBuffer.append(" AND CMS_SECURITY.CMS_COLLATERAL_ID = CMS_PORTFOLIO_ITEM.CMS_COLLATERAL_ID");
		sqlBuffer
				.append(" AND calendar_days(cast(? as date), CAST(CMS_PORTFOLIO_ITEM.SECURITY_MATURITY_DATE AS DATE) ) ");
