 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/eventmonitor/commoditylimitlevel/CommodityLimitLevelListener.java,v 1.1 2004/06/07 06:47:20 pooja Exp $
 */
...
public class CommodityLimitLevelListener extends CommonCMSEventListener {
	...
	public void fireEvent(String eventID, List params) throws EventHandlingException {
		OBCommodityLimitLevel eventInfo = (OBCommodityLimitLevel) params.get(0);
