 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/eventmonitor/collateralcharge/ColChargeTypeListener.java,v 1.1 2006/10/06 05:50:23 jychong Exp $
 */
...
public class ColChargeTypeListener extends CommonCMSEventListener {
	...
	public void fireEvent(String eventID, List params) throws EventHandlingException {
		OBColChargeTypeInfo eventInfo = (OBColChargeTypeInfo) params.get(0);
