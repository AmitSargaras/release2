 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/feed/trx/propertyindex/PropertyIndexFeedGroupReadController.java,v 1.1 2003/08/20 10:59:58 btchng Exp $
 */
 ...
 */
public class PropertyIndexFeedGroupReadController extends AbstractTrxController implements ITrxOperationFactory {

	/**
	 * Default Constructor
	 */
	public PropertyIndexFeedGroupReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_PROPERTY_INDEX_FEED_GROUP)) {
				return new ReadPropertyIndexGroupOperation();
			}
