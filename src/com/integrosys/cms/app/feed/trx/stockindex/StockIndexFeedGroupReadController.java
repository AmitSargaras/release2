 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/feed/trx/stockindex/StockIndexFeedGroupReadController.java,v 1.1 2003/08/18 10:13:16 btchng Exp $
 */
 ...
 */
public class StockIndexFeedGroupReadController extends AbstractTrxController implements ITrxOperationFactory {
	 ...
	 * Default Constructor
	 */
	public StockIndexFeedGroupReadController() {
	}
	...
	public String getInstanceName() {
		return ICMSConstant.INSTANCE_STOCK_INDEX_FEED_GROUP;
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_STOCK_INDEX_FEED_GROUP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadStockIndexGroupOperation");
			}
