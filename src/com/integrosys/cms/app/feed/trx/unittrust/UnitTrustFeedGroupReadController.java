 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/feed/trx/unittrust/UnitTrustFeedGroupReadController.java,v 1.1 2003/08/08 04:26:15 btchng Exp $
 */
 ...
 */
public class UnitTrustFeedGroupReadController extends AbstractTrxController implements ITrxOperationFactory {

	/**
	 * Default Constructor
	 */
	public UnitTrustFeedGroupReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_UNIT_TRUST_FEED_GROUP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadUnitTrustGroupOperation"); 
			}
