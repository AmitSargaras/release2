 ...
 */
public class MutualFundsFeedGroupReadController extends AbstractTrxController implements ITrxOperationFactory {
	...
	public MutualFundsFeedGroupReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_MUTUAL_FUNDS_FEED_GROUP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadMutualFundsGroupOperation");
			}
