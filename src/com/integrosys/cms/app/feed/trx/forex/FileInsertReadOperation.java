...
public class FileInsertReadOperation extends AbstractForexTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBForexFeedGroupTrxValue newValue = new OBForexFeedGroupTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId creditApproval = getStagingForexFeedFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId creditApproval = getStagingForexFeedFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(creditApproval);
            }
            return newValue;
        }
