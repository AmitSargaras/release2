 ...
 */
public class ForexFeedGroupReadController extends AbstractTrxController implements ITrxOperationFactory {
	 ...
	 * Default Constructor
	 */
	public ForexFeedGroupReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_FOREX_FEED_GROUP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadForexGroupOperation");
			}
