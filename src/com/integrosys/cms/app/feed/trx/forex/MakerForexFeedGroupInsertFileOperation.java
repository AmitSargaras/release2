 ...
 * Date: Jan 18, 2008
 */
public class MakerForexFeedGroupInsertFileOperation extends AbstractForexTrxOperation {

   /**
    * Defaulc Constructor
    */
    public MakerForexFeedGroupInsertFileOperation()
    {
        super();
    }
	...
	*/
	private IForexFeedGroupTrxValue createFileIdTransaction(IForexFeedGroupTrxValue anICCIForexFeedGroupTrxValue) throws TrxOperationException,CreditApprovalException
	{
		try
		{
			anICCIForexFeedGroupTrxValue = prepareInsertTrxValue(anICCIForexFeedGroupTrxValue);
			ICMSTrxValue trxValue = createTransaction(anICCIForexFeedGroupTrxValue);
            OBForexFeedGroupTrxValue creditApprovalTrxValue = new OBForexFeedGroupTrxValue (trxValue);
            creditApprovalTrxValue.setStagingFileMapperID(anICCIForexFeedGroupTrxValue.getStagingFileMapperID());
            creditApprovalTrxValue.setFileMapperID(anICCIForexFeedGroupTrxValue.getFileMapperID());
