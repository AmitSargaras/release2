 ...
 * Date: Jan 18, 2008
 */
public class MakerStockFeedGroupInsertFileOperation extends AbstractStockTrxOperation {

   /**
    * Defaulc Constructor
    */
    public MakerStockFeedGroupInsertFileOperation()
    {
        super();
    }
	...
	*/
	private IStockFeedGroupTrxValue createFileIdTransaction(IStockFeedGroupTrxValue anICCIStockFeedGroupTrxValue) throws TrxOperationException,CreditApprovalException
	{
		try
		{
			anICCIStockFeedGroupTrxValue = prepareInsertTrxValue(anICCIStockFeedGroupTrxValue);
			ICMSTrxValue trxValue = createTransaction(anICCIStockFeedGroupTrxValue);
            OBStockFeedGroupTrxValue creditApprovalTrxValue = new OBStockFeedGroupTrxValue (trxValue);
            creditApprovalTrxValue.setStagingFileMapperID(anICCIStockFeedGroupTrxValue.getStagingFileMapperID());
            creditApprovalTrxValue.setFileMapperID(anICCIStockFeedGroupTrxValue.getFileMapperID());
	        return creditApprovalTrxValue;
		}
		catch(CreditApprovalException se)
		{
			throw new CreditApprovalException("Error in Create StockFeedGroup Operation ");
		}
