...
public class FileInsertReadOperation extends AbstractStockTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBStockFeedGroupTrxValue newValue = new OBStockFeedGroupTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId creditApproval = getStagingStockFeedFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId creditApproval = getStagingStockFeedFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(creditApproval);
            }
            return newValue;
        }
