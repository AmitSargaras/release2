 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/feed/trx/stock/StockFeedGroupReadController.java,v 1.1 2003/08/07 08:36:38 btchng Exp $
 */
 ...
 */
public class StockFeedGroupReadController extends AbstractTrxController implements ITrxOperationFactory {
	 ...
	 * Default Constructor
	 */
	public StockFeedGroupReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_STOCK_FEED_GROUP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadStockGroupOperation");
			}
