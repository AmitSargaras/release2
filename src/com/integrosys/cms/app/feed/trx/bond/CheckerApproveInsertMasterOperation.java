...
public class CheckerApproveInsertMasterOperation extends AbstractBondTrxOperation {
     ...
     */
    private IBondFeedGroupTrxValue actualMaster(IBondFeedGroupTrxValue idxTrxValue) throws CreditApprovalException, TrxParameterException, TransactionException, ConcurrentUpdateException {
        try {
            IFileMapperId staging = idxTrxValue.getStagingFileMapperID();
            IFileMapperId actual = idxTrxValue.getFileMapperID();

            IFileMapperId updatedActual = getBondFeedFileMapperIdBusManager().insertBondFeedEntry(staging,idxTrxValue);           
