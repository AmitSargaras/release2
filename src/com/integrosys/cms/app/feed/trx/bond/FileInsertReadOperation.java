...
public class FileInsertReadOperation extends AbstractBondTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBBondFeedGroupTrxValue newValue = new OBBondFeedGroupTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId creditApproval = getStagingBondFeedFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId creditApproval = getStagingBondFeedFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(creditApproval);
            }
            return newValue;
        }
