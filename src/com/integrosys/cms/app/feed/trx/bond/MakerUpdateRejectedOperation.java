 ...
 */
public class MakerUpdateRejectedOperation extends AbstractBondTrxOperation {
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_UPDATE_REJECTED_BOND_FEED_GROUP;
	}
	...
	public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
		IBondFeedGroupTrxValue trxValue = createStagingBondFeedGroup(getBondFeedGroupTrxValue(anITrxValue));
