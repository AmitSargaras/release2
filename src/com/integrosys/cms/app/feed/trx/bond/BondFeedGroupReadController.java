 ...
 */
public class BondFeedGroupReadController extends AbstractTrxController implements ITrxOperationFactory {
	...
	public BondFeedGroupReadController() {
	}
	...
	public String getInstanceName() {
		return ICMSConstant.INSTANCE_BOND_FEED_GROUP;
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_BOND_FEED_GROUP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadBondGroupOperation");
			}
