 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/sccertificate/trx/MakerUpdateSCCOperation.java,v 1.1 2003/08/08 12:45:37 hltan Exp $
 */
...
/**
 * This operation allows a maker to update a sc certificate
 * 
 * @author $Author: hltan $
 * @version $Revision: 1.1 $
 * @since $Date: 2003/08/08 12:45:37 $ Tag: $Name: $
 */
public class MakerUpdateSCCOperation extends AbstractSCCTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerUpdateSCCOperation() {
		super();
	}
