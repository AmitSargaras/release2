 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/sccertificate/trx/PartialSCCertificateReadController.java,v 1.1 2003/08/11 12:51:02 hltan Exp $
 */
 ...
 */
public class PartialSCCertificateReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public PartialSCCertificateReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_PSCC)) {
				return new ReadPSCCertificateOperation();
			}

			if (action.equals(ICMSConstant.ACTION_READ_PSCC_ID)) {
				return new ReadPSCCertificateIDOperation();
			}
