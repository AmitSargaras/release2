 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/sccertificate/trx/ReadPSCCertificateOperation.java,v 1.1 2003/08/11 12:51:02 hltan Exp $
 */
 ...
 */
public class ReadPSCCertificateOperation extends CMSTrxOperation implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadPSCCertificateOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_PSCC;
	}
	...
	public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
		try {
			...
			OBPartialSCCertificateTrxValue newValue = new OBPartialSCCertificateTrxValue(trxValue);
			...
			if (stagingRef != null) {
				...
				IPartialSCCertificate stagingSCCert = getSBStagingCertificateBusManager().getPartialSCCertificate(
						stagingPK);
				newValue.setStagingPartialSCCertificate(stagingSCCert);
			}

			if (actualRef != null) {
				long actualPK = (new Long(actualRef)).longValue();
				IPartialSCCertificate actualSCCert = getSBSCCertificateBusManager().getPartialSCCertificate(actualPK);
				newValue.setPartialSCCertificate(actualSCCert);
			}
			return newValue;
		}
		catch (Exception ex) {
