 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/sccertificate/trx/ReadPSCCertificateIDOperation.java,v 1.1 2003/08/11 12:51:02 hltan Exp $
 */
...
/**
 * This operation is responsible for reading a partial sc certificate trx based
 * on a certificate ID
 * 
 * @author $Author: hltan $
 ...
 */
public class ReadPSCCertificateIDOperation extends CMSTrxOperation implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadPSCCertificateIDOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_PSCC_ID;
	}
	...
	public ITrxValue getTransaction(ITrxValue val) throws TransactionException {
		try {
			...
			if (null != actualRef) {
				...
				newValue.setPartialSCCertificate(mgr.getPartialSCCertificate(actualPK));
			}
			if (null != stagingRef) {
				long stagingPK = Long.parseLong(stagingRef);
				SBSCCertificateBusManager mgr = getSBStagingCertificateBusManager();
				IPartialSCCertificate stage = mgr.getPartialSCCertificate(stagingPK);
				newValue.setStagingPartialSCCertificate(stage);
			}
			return newValue;
		}
		catch (Exception ex) {
