 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/sccertificate/trx/SCCertificateReadController.java,v 1.1 2003/08/08 12:45:37 hltan Exp $
 */
 ...
 */
public class SCCertificateReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public SCCertificateReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_SCC)) {
				return new ReadSCCertificateOperation();
			}

			if (action.equals(ICMSConstant.ACTION_READ_SCC_ID)) {
				return new ReadSCCertificateIDOperation();
			}
