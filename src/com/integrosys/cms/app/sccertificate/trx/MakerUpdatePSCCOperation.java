 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/sccertificate/trx/MakerUpdatePSCCOperation.java,v 1.1 2003/08/11 12:51:02 hltan Exp $
 */
...
/**
 * This operation allows a maker to update a partial sc certificate
 * 
 * @author $Author: hltan $
 * @version $Revision: 1.1 $
 * @since $Date: 2003/08/11 12:51:02 $ Tag: $Name: $
 */
public class MakerUpdatePSCCOperation extends AbstractPSCCTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerUpdatePSCCOperation() {
		super();
	}
