 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/sccertificate/bus/EBPartialSCCertificateItemBean.java,v 1.13 2006/05/30 10:19:38 czhou Exp $
 */
...
/**
 * This entity bean represents the persistence for partial scc item Information
 * 
 * @author $Author: czhou $
 * @version $Revision: 1.13 $
 * @since $Date: 2006/05/30 10:19:38 $ Tag: $Name: $
 */
public abstract class EBPartialSCCertificateItemBean implements EntityBean, IPartialSCCertificateItem, Cloneable {
	 ...
	 * Default Constructor
	 */
	public EBPartialSCCertificateItemBean() {
	}
	...
	public abstract String getIsPartialSCCIndStr();
	...
	public abstract void setIsPartialSCCIndStr(String anIsPartialSCCIndStr);
	...
	public boolean getIsPartialSCCIssued() {
		if ((getIsPartialSCCIndStr() != null) && getIsPartialSCCIndStr().equals(ICMSConstant.TRUE_VALUE)) {
			return true;
		}
		return false;
	}
	...
	public void setIsPartialSCCIssued(boolean anIsPartialSCCIssuedInd) {
		if (anIsPartialSCCIssuedInd) {
			setIsPartialSCCIndStr(ICMSConstant.TRUE_VALUE);
			return;
		}
		setIsPartialSCCIndStr(ICMSConstant.FALSE_VALUE);
	}

	// *****************************************************
	/**
	 * Create a scc item Information
	 * @param anIPartialSCCertificateItem of IPartialSCCertificateItem type
	 * @return Long - the scc item ID (primary key)
	 * @throws CreateException on error
	 */
	public Long ejbCreate(IPartialSCCertificateItem anIPartialSCCertificateItem) throws CreateException {
		if (anIPartialSCCertificateItem == null) {
		...
		try {
			...
			setSCCertItemID(pk);
			if (com.integrosys.cms.app.common.constant.ICMSConstant.LONG_INVALID_VALUE == anIPartialSCCertificateItem
					.getSCCertItemRef()) {
				setSCCertItemRef(pk);
			}
			else {
				setSCCertItemRef(anIPartialSCCertificateItem.getSCCertItemRef());
			}
			AccessorUtil.copyValue(anIPartialSCCertificateItem, this, EXCLUDE_METHOD);
			setCMPLimitID(new Long(anIPartialSCCertificateItem.getLimitID()));
			return new Long(pk);
		}
		catch (Exception ex) {
	 ...
	 * @param anIPartialSCCertificateItem of IPartialSCCertificateItem type
	 */
	public void ejbPostCreate(IPartialSCCertificateItem anIPartialSCCertificateItem) throws CreateException {
	}
	...
	public IPartialSCCertificateItem getValue() {
		IPartialSCCertificateItem value = new OBPartialSCCertificateItem(getLimitType(), getLimitID());
	...
	/**
	 * Persist a partial scc item information
	 * 
	 * @param anIPartialSCCertificateItem of IPartialSCCertificateItem type
	 */
	public void setValue(IPartialSCCertificateItem anIPartialSCCertificateItem) {
		AccessorUtil.copyValue(anIPartialSCCertificateItem, this, EXCLUDE_METHOD);
	}
	...
	protected String getSequenceName() {
		return ICMSConstant.SEQUENCE_PARTIAL_SC_CERTIFICATE_ITEM;
	}
