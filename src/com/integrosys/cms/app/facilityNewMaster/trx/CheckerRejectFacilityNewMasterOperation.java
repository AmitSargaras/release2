...
public class CheckerRejectFacilityNewMasterOperation extends AbstractFacilityNewMasterTrxOperation{

    public CheckerRejectFacilityNewMasterOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_FACILITY_NEW_MASTER;
    }
