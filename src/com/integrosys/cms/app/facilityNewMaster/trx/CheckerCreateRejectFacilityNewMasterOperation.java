...
public class CheckerCreateRejectFacilityNewMasterOperation extends AbstractFacilityNewMasterTrxOperation{

    public CheckerCreateRejectFacilityNewMasterOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_CREATE_FACILITY_NEW_MASTER;
    }
