 ...
 */
public class MakerEditRejectedUpdateFacilityNewMasterOperation extends AbstractFacilityNewMasterTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateFacilityNewMasterOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_FACILITY_NEW_MASTER;
        }
