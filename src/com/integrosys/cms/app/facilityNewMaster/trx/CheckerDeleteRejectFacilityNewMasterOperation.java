...
public class CheckerDeleteRejectFacilityNewMasterOperation extends AbstractFacilityNewMasterTrxOperation{

    public CheckerDeleteRejectFacilityNewMasterOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_DELETE_FACILITY_NEW_MASTER;
    }
