 ...
 */
public class FacilityNewMasterReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public FacilityNewMasterReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_FACILITY_NEW_MASTER)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadFacilityNewMasterOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_FACILITY_NEW_MASTER_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadFacilityNewMasterIDOperation");
            }else{
