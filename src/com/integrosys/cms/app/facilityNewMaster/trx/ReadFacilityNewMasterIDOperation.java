...
public class ReadFacilityNewMasterIDOperation extends AbstractFacilityNewMasterTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadFacilityNewMasterIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_FACILITY_NEW_MASTER_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFacilityNewMaster facilityNewMaster=getStagingFacilityNewMasterBusManager().getFacilityNewMasterById(stagingPK);
                newValue.setStagingFacilityNewMaster(facilityNewMaster);
            }else{
