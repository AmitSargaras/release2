...
public class ReadIDOperation extends AbstractTrxOperation implements ITrxReadOperation {
	...
	public String getOperationName() {
        return ICMSConstant.ACTION_READ_BANKING_ARRANGEMENT_FAC_EXCLUSION_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBBankingArrangementFacExclusionTrxValue newValue = new OBBankingArrangementFacExclusionTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IBankingArrangementFacExclusion obj = getStagingBusManager().getById(stagingPK);
