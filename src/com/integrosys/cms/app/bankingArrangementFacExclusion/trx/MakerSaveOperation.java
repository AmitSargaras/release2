...
public class MakerSaveOperation extends AbstractTrxOperation {
	...
	{
		return ICMSConstant.ACTION_MAKER_SAVE_BANKING_ARRANGEMENT_FAC_EXCLUSION;
	}
	...
	private IBankingArrangementFacExclusionTrxValue createActualTransaction(IBankingArrangementFacExclusionTrxValue trx) throws TrxOperationException,BankingArrangementFacExclusionException
	{
		try
		{
            ...
            OBBankingArrangementFacExclusionTrxValue objTrx = new OBBankingArrangementFacExclusionTrxValue (trxValue);
		...
		{
			throw new ValuationAmountAndRatingException("Error in Create BankingArrangementFacExclusion");
		}
