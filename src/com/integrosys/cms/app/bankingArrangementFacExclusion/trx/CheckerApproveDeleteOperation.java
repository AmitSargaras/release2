...
public class CheckerApproveDeleteOperation extends AbstractTrxOperation {
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_BANKING_ARRANGEMENT_FAC_EXCLUSION;
	}
	...
	private IBankingArrangementFacExclusionTrxValue updateActual(IBankingArrangementFacExclusionTrxValue trx)
		...
		try {
			...
			IBankingArrangementFacExclusion updated = getBusManager().deleteToWorkingCopy(actual, staging);
