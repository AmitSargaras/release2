...
public class TrxControllerFactory implements ITrxControllerFactory{
    ...
    private boolean isReadOperation(String anAction) {
        if ((anAction.equals(ICMSConstant.ACTION_READ_BANKING_ARRANGEMENT_FAC_EXCLUSION)) ||
                (anAction.equals(ICMSConstant.ACTION_READ_BANKING_ARRANGEMENT_FAC_EXCLUSION_ID))) {
            return true;
        }
        return false;
    }
