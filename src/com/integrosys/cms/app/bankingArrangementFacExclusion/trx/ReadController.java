...
public class ReadController extends AbstractTrxController implements ITrxOperationFactory{
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_BANKING_ARRANGEMENT_FAC_EXCLUSION)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_BANKING_ARRANGEMENT_FAC_EXCLUSION_ID)) {
