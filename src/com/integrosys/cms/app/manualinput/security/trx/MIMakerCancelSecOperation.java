 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class MIMakerCancelSecOperation extends AbstractMISecOperation {
	/*
	 * (non-Javadoc)
	 * 
	 * @see
	...
	public String getOperationName() {
		return TransactionActionConst.ACTION_MANUAL_CLOSE_SEC;
	}
	...
	public ITrxResult performProcess(ITrxValue value) throws TrxOperationException {
		try {
			...
			secTrxValue.setStagingCollateral(secTrxValue.getCollateral());
			if (secTrxValue.getCollateral() != null) {
				secTrxValue = helper.createStagingCollateral(secTrxValue);
			}
			...
			ex.printStackTrace();
			throw new TrxOperationException("Error in MICancleSecOperation perform process");
		}
	}
}
