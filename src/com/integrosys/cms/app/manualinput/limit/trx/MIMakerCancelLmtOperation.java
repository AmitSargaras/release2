 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class MIMakerCancelLmtOperation extends AbstractMILmtOperation {
	...
	public String getOperationName() {
		...
		return TransactionActionConst.ACTION_MANUAL_CLOSE_LMT;
	}
	...
	public ITrxResult performProcess(ITrxValue value) throws TrxOperationException {
		try {
			...
			lmtTrxValue.setStagingLimit(lmtTrxValue.getLimit());
			...
			ex.printStackTrace();
			throw new TrxOperationException("Error in MICancleLmtOperation perform process");
		}
	}
}
