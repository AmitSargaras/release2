 ...
 */
public class MakerEditRejectedDeleteOtherBankBranchOperation extends AbstractOtherBankBranchTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteOtherBankBranchOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_OTHER_BANK_BRANCH;
        }
