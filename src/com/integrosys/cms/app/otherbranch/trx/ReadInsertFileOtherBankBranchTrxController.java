...
public class ReadInsertFileOtherBankBranchTrxController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public ReadInsertFileOtherBankBranchTrxController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_FILE_INSERT)) {
                return (ITrxOperation) getNameTrxOperationMap().get("FileInsertOtherBankBranchReadOperation");
            }else{
