 ...
 */
public class MakerSubmitSaveUpdateOtherBankBranchOperation extends AbstractOtherBankBranchTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerSubmitSaveUpdateOtherBankBranchOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_UPDATE_OTHER_BANK_BRANCH;
        }
