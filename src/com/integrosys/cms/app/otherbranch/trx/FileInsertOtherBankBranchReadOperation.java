...
public class FileInsertOtherBankBranchReadOperation extends AbstractOtherBankBranchTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public FileInsertOtherBankBranchReadOperation() {
        super();
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId holiday = getStagingOtherBankBranchFileMapperIdBusManager().getInsertFileByIdBankBranch(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId holiday = getStagingOtherBankBranchFileMapperIdBusManager().getInsertFileByIdBankBranch(actualPK); 
                newValue.setStagingFileMapperID(holiday);
            }
            return newValue;
        }
