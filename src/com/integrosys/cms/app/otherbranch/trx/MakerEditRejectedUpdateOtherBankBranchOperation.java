 ...
 */
public class MakerEditRejectedUpdateOtherBankBranchOperation extends AbstractOtherBankBranchTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateOtherBankBranchOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_OTHER_BANK_BRANCH;
        }
