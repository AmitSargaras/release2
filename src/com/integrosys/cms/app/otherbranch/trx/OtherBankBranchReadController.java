 ...
 * Read Other Bank branch Controller
 */
public class OtherBankBranchReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public OtherBankBranchReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_OTHER_BANK_BRANCH)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadOtherBranchOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_OTHER_BANK_BRANCH_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadOtherBranchIDOperation");
            }else{
