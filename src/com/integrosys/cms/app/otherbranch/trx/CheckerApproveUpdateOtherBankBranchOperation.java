...
public class CheckerApproveUpdateOtherBankBranchOperation extends AbstractOtherBankBranchTrxOperation{
	/**
	 * Default Constructor
	 */
	public CheckerApproveUpdateOtherBankBranchOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_UPDATE_OTHER_BANK_BRANCH;
	}
	...
	private IOtherBankBranchTrxValue updateActualOtherBankBranch(IOtherBankBranchTrxValue anICCOtherBankTrxValue)
		...
		try {
			...
			IOtherBranch updatedOtherBankBranch = getOtherBranchBusManager().updateToWorkingCopy(actual, staging);
			anICCOtherBankTrxValue.setOtherBranch(updatedOtherBankBranch);
