 ...
 */
public class CheckerApproveCreateContractFinancingOperation extends AbstractContractFinancingTrxOperation {

	/**
	 * Default Constructor
	 */
	public CheckerApproveCreateContractFinancingOperation() {
	}
	...
	public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
		...
		trxValue = createActualContractFinancing(trxValue);
