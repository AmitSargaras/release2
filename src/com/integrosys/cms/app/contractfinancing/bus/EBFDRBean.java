...
public abstract class EBFDRBean implements EntityBean, IFDR {
	...
	private static final String[] EXCLUDE_METHOD = new String[] { "getFdrID", "getContractID", "getCommonRef" };
	...
	public Long ejbCreate(IFDR object) throws CreateException {
		...
		try {
			long pk = Long.parseLong((new SequenceManager()).getSeqNum(ICMSConstant.SEQUENCE_CF_FDR, true));
			setFdrID(pk);
