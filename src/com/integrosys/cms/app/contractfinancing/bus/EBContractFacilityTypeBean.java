 ...
 * @since $Date$ Tag: $Name$
 */
public abstract class EBContractFacilityTypeBean implements EntityBean, IContractFacilityType, Cloneable {
	...
	private static final String[] EXCLUDE_METHOD = new String[] { "getFacilityTypeID", "getContractID", "getCommonRef" };

	// /**
	// * Default Constructor
	// */
	// protected EBContractFacilityTypeBean() {
	// }
	...
	// ====================================
	/**
	 * Retrieve an instance of contract facility type object.
	 * @return contract facility type business object
	 */
	public IContractFacilityType getValue() {
		IContractFacilityType value = new OBContractFacilityType();
		AccessorUtil.copyValue(this, value);
		return value;
	}

	/**
	 * Set the contract facility type object.
	 * @param value of type IContractFacilityType
	...
	public abstract Float getCMPMOA();

	public abstract Double getCMPMaxCapValue();

	public abstract String getCMPMaxCapCurrency();
	...
	public float getMoa() {
		return TypeConverter.convertToPrimitiveType(getCMPMOA());
	}

	public Amount getMaxCap() {
		return TypeConverter.convertToAmount(getCMPMaxCapValue(), getCMPMaxCapCurrency());
	}
	...
	// Setters
	// ========================
	public abstract void setCMPFacilityTypeID(Long facilityTypeID);

	public abstract void setCMPContractID(Long contractID);

	public abstract void setCMPMOA(Float moa);

	public abstract void setCMPMaxCapValue(Double maxCapValue);

	public abstract void setCMPMaxCapCurrency(String maxCapCurrency);
	...
	public void setFacilityTypeID(long facilityTypeID) {
		setCMPFacilityTypeID(new Long(facilityTypeID));
	}
	...
	public void setMoa(float moa) {
		setCMPMOA(new Float(moa));
	}

	public void setMaxCap(Amount maxCap) {
		if (maxCap != null) {
			setCMPMaxCapValue(new Double(maxCap.getAmount()));
			setCMPMaxCapCurrency(maxCap.getCurrencyCode());
		}
		else {
			setCMPMaxCapValue(null);
			setCMPMaxCapCurrency(null);
		}
	}
	 ...
	 */
	public Long ejbCreate(IContractFacilityType object) throws CreateException {
		if (object == null) {
			throw new CreateException("IContractFacilityType object to be created is null");
		}

		try {
			long pk = Long.parseLong((new SequenceManager()).getSeqNum(ICMSConstant.SEQUENCE_CF_FACILITY_TYPE, true));
			setFacilityTypeID(pk);
	 ...
	 */
	public void ejbPostCreate(IContractFacilityType value) throws CreateException {
	}
