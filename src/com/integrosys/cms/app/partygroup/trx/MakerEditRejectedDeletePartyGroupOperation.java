 ...
 *         record by checker
 */
public class MakerEditRejectedDeletePartyGroupOperation extends
		AbstractPartyGroupTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedDeletePartyGroupOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_PARTY_GROUP;
	}
