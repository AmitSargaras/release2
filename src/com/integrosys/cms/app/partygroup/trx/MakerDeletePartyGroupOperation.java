...
/**
 * @author Bharat waghela Maker Update operation to update system
 */
public class MakerDeletePartyGroupOperation extends
		AbstractPartyGroupTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerDeletePartyGroupOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_DELETE_PARTY_GROUP;
	}
				...
				if (staging.getId() != ICMSConstant.LONG_INVALID_VALUE) {
					ICMSTrxValue parentTrx = getTrxManager()
							.getTrxByRefIDAndTrxType(
									...
									ICMSConstant.INSTANCE_PARTY_GROUP);
	...
	public ITrxResult performProcess(ITrxValue anITrxValue)
		...
		// replicatedPartyGroup.getSystemBankCode().setId(stage.getSystemBankCode().getId());
