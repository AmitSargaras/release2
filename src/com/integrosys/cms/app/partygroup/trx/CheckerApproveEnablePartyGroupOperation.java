...
/**
 * @author Bharat Waghela Checker approve Operation to approve delete made by
 *         maker
 */

public class CheckerApproveEnablePartyGroupOperation extends
		AbstractPartyGroupTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveEnablePartyGroupOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_ENABLE_PARTY_GROUP;
	}
