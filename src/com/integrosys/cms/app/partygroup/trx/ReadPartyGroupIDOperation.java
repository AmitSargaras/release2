...
/**
 * @author bharat Waghela Read Party Group Operation By Trx vID
 */

public class ReadPartyGroupIDOperation extends AbstractPartyGroupTrxOperation
		implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadPartyGroupIDOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_PARTY_GROUP_ID;
	}
