...
import com.integrosys.cms.app.cci.trx.ReadCounterpartyDetailsByGroupCCINoOperation;
...
public class CustGrpIdentifierReadController extends AbstractTrxController implements ITrxOperationFactory
{
    /**
     * Default constructor.
     */
    public CustGrpIdentifierReadController()
    {}
        ...
        throws TrxParameterException
    {
        ...
        if (action.equals(ICMSConstant.ACTION_READ_CUST_GRP_IDENTIFIER) ) {
            return new ReadCustGrpIdentifierByTrxIDOperation();
        }else if (action.equals (ICMSConstant.ACTION_READ_CCIN_BY_TRX_ID)) {
            return new ReadCustGrpIdentifierByTrxIDOperation();
         }else if (action.equals (ICMSConstant.ACTION_READ_BY_GROUP_ID)) {
            return new ReadCustGrpIdentifierByGroupIDOperation();
        }else {
