 ...
 */
public class DigitalLibraryReadController extends AbstractTrxController implements ITrxOperationFactory {
	...
	public DigitalLibraryReadController() {
	}
	...
	public String getInstanceName() {
		return ICMSConstant.INSTANCE_DIGITAL_LIBRARY_GROUP;
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_DIGITAL_LIBRARY_GROUP)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadDigitalLibraryOperation");
			}
