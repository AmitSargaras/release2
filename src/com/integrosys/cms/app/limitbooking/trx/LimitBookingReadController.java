...
/**
 * This transaction controller is to be used for reading Limit Booking.
 *
 ...
 * Tag:      $Name: $
 */
public class LimitBookingReadController extends AbstractTrxController implements ITrxOperationFactory
{
    /**
     * Default constructor.
     */
    public LimitBookingReadController()
    {}
        ...
        throws TrxParameterException
    {
        ...
        if (action.equals(ICMSConstant.ACTION_READ_LIMIT_BOOKING) ) {
            return new ReadLimitBookingOperation();
        }
        else if (action.equals (ICMSConstant.ACTION_READ_LIMIT_BOOKING_BY_TRXID)) {
            return new ReadLimitBookingByTrxIDOperation();
        }
        else {
