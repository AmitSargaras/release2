...
public class CheckerCreateRejectSystemBankBranchOperation extends AbstractSystemBankBranchTrxOperation{

    public CheckerCreateRejectSystemBankBranchOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_CREATE_SYSTEM_BANK_BRANCH;
    }
