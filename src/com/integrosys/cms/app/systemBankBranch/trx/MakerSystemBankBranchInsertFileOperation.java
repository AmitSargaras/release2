 ...
 * Date: Jan 18, 2008
 */
public class MakerSystemBankBranchInsertFileOperation extends AbstractSystemBankBranchTrxOperation {

   /**
    * Defaulc Constructor
    */
    public MakerSystemBankBranchInsertFileOperation()
    {
        super();
    }
	...
	*/
	private ISystemBankBranchTrxValue createFileIdTransaction(ISystemBankBranchTrxValue anICCSystemBankBranchTrxValue) throws TrxOperationException,SystemBankBranchException
	{
		try
		{
            anICCSystemBankBranchTrxValue = prepareInsertTrxValue(anICCSystemBankBranchTrxValue);
            ...
            systemBankBranchTrxValue.setStagingFileMapperID(anICCSystemBankBranchTrxValue.getStagingFileMapperID());
            systemBankBranchTrxValue.setFileMapperID(anICCSystemBankBranchTrxValue.getFileMapperID());
