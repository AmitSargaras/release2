...
public class FileInsertReadOperation extends AbstractSystemBankBranchTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId systemBankBranch = getStagingFileMapperIdSysBusManager().getInsertFileById(stagingPK);
                newValue.setStagingFileMapperID(systemBankBranch);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId systemBankBranch = getStagingFileMapperIdSysBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(systemBankBranch);
            }
            return newValue;
        }
