...
public class MakerCloseRejectedInsertSystemBankBranchOperation extends AbstractSystemBankBranchTrxOperation{
    ...
    * Defaulc Constructor
    */
    public MakerCloseRejectedInsertSystemBankBranchOperation()
    {
