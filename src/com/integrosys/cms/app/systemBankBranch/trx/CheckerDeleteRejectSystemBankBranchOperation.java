...
public class CheckerDeleteRejectSystemBankBranchOperation extends AbstractSystemBankBranchTrxOperation{

    public CheckerDeleteRejectSystemBankBranchOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_DELETE_SYSTEM_BANK_BRANCH;
    }
