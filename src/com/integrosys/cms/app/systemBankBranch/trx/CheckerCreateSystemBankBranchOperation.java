 ...
 * Date: Jan 18, 2008
 */
public class CheckerCreateSystemBankBranchOperation extends AbstractSystemBankBranchTrxOperation {

   /**
    * Defaulc Constructor
    */
    public CheckerCreateSystemBankBranchOperation()
    {
        super();
    }
	...
	*/
	...
	{
		return ICMSConstant.ACTION_CHECKER_CREATE_SYSTEM_BANK_BRANCH;
	}
	...
	*/
	public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException
	{
        ...
        DefaultLogger.debug(this, " ---- trxValue.getStagingPrIdx() is null ? ----- " + (trxValue.getSystemBankBranch()==null));

	    trxValue = insertActualSystemBankBranch(trxValue);
	...
	*/
	...
	{	
		try
		{
			String refTemp= anICCSystemBankBranchTrxValue.getStagingReferenceID();
			ISystemBankBranchTrxValue inSystemBankBranchTrxValue = prepareTrxValue(anICCSystemBankBranchTrxValue);
			
			inSystemBankBranchTrxValue.setFromState("PENDING_CREATE");
			inSystemBankBranchTrxValue.setTransactionType("SYSTEM_BANK_BRANCH");
			inSystemBankBranchTrxValue.setToState("ACTIVE");
			inSystemBankBranchTrxValue.setStatus("ACTIVE");
			inSystemBankBranchTrxValue.setStagingReferenceID(refTemp);
			
			ICMSTrxValue trxValue = createTransaction(inSystemBankBranchTrxValue);
