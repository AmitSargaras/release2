...
public class SystemBankBranchTrxController extends CMSTrxController {
    ...
    private ITrxOperation factoryOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if(toState.equals(ICMSConstant.STATE_DRAFT)){
            ...
            }if (action.equals(ICMSConstant.ACTION_CHECKER_CREATE_SYSTEM_BANK_BRANCH)) {
                return (ITrxOperation) getNameTrxOperationMap().get("CheckerCreateSystemBankBranchOperation");
            }
