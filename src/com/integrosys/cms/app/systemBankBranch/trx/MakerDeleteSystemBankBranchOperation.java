 ...
 */
public class MakerDeleteSystemBankBranchOperation extends AbstractSystemBankBranchTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerDeleteSystemBankBranchOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_DELETE_SYSTEM_BANK_BRANCH;
    }
    ...
    public ITrxValue preProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        ISystemBankBranch staging = trxValue.getStagingSystemBankBranch();
        try {
            if (staging != null) {
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
     ...
     //   replicatedSystemBankBranch.getSystemBankCode().setId(stage.getSystemBankCode().getId());
