...
public class CheckerRejectInsertSystemBankBranchOperation extends AbstractSystemBankBranchTrxOperation{

    public CheckerRejectInsertSystemBankBranchOperation()
    {
        super();
    }
    ...
    */
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException
    {
        ...
        trxValue = super.updateSystemBankBranchInsertTrx(trxValue);
