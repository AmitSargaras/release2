...
public class ReadSystemBankBranchOperation extends AbstractSystemBankBranchTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadSystemBankBranchOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_SYSTEM_BANK_BRANCH;
    }
