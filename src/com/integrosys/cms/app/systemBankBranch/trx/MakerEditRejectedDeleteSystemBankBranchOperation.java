 ...
 */
public class MakerEditRejectedDeleteSystemBankBranchOperation extends AbstractSystemBankBranchTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteSystemBankBranchOperation()
        {
            super();
        }
