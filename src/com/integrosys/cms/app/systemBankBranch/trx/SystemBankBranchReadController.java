 ...
 */
public class SystemBankBranchReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public SystemBankBranchReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_SYSTEM_BANK_BRANCH)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadSystemBankBranchOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_SYSTEM_BANK_BRANCH_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadSystemBankBranchIDOperation");
            }else{
