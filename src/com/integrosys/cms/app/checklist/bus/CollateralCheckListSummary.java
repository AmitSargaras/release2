 ...
 */
public class CollateralCheckListSummary implements ICheckListSummary, Comparable {
	...
	private String collateralName = null;
	...
	public int compareTo(Object other) {
		String otherCollateralRef = (other == null) ? null : ((CollateralCheckListSummary) other).getCollateralRef();
