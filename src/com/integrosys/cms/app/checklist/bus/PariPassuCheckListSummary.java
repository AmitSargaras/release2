 ...
 */
public class PariPassuCheckListSummary implements ICheckListSummary, Comparable {
	...
	private ICollateralType pariPassuType = null;

	private ICollateralSubType pariPassuSubType = null;

	private String pariPassuName = null;
...
//	}
	...
	public ICollateralType getPariPassuType() {
		return pariPassuType;
	}

	public void setPariPassuType(ICollateralType pariPassuType) {
		this.pariPassuType = pariPassuType;
	}

	public ICollateralSubType getPariPassuSubType() {
		return pariPassuSubType;
	}

	public void setPariPassuSubType(ICollateralSubType pariPassuSubType) {
		this.pariPassuSubType = pariPassuSubType;
	}

	public String getPariPassuName() {
		return pariPassuName;
	}

	public void setPariPassuName(String pariPassuName) {
		this.pariPassuName = pariPassuName;
	}
