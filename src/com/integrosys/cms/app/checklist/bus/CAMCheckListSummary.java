 ...
 */
public class CAMCheckListSummary implements ICheckListSummary, Comparable {
	...
	private ICollateralType camType = null;

	private ICollateralSubType camSubType = null;
...
//	}
	...
	public ICollateralType getCamType() {
		return camType;
	}

	public void setCamType(ICollateralType camType) {
		this.camType = camType;
	}

	public ICollateralSubType getCamSubType() {
		return camSubType;
	}

	public void setCamSubType(ICollateralSubType camSubType) {
		this.camSubType = camSubType;
	}
	...
	public int compareTo(Object other) {
		String otherCollateralRef = (other == null) ? null : ((CAMCheckListSummary) other).getCollateralRef();
