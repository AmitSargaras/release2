 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/checklist/trx/SystemRejectGenerateWaiverRequestCheckListOperation.java,v 1.2 2003/09/23 03:02:14 hltan Exp $
 */
...
/**
 * This operation allows a system to reject a generate waiver request for a
 * checklist
 * 
 * @author $Author: hltan $
 ...
 */
public class SystemRejectGenerateWaiverRequestCheckListOperation extends AbstractCheckListTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public SystemRejectGenerateWaiverRequestCheckListOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_SYSTEM_REJECT_GENERATE_CHECKLIST_WAIVER;
	}
	...
	public ITrxValue preProcess(ITrxValue anITrxValue) throws TrxOperationException {
		...
		for (int ii = 0; ii < orgItemList.length; ii++) {
			if (ICMSConstant.STATE_ITEM_WAIVER_REQ.equals(orgItemList[ii].getItemStatus())) {
