 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/checklist/trx/SystemApproveGenerateWaiverRequestCheckListOperation.java,v 1.4 2004/04/08 12:52:44 hltan Exp $
 */
...
/**
 * This operation allows a system to approve waiver generation on a checklist
 * 
 * @author $Author: hltan $
 * @version $Revision: 1.4 $
 * @since $Date: 2004/04/08 12:52:44 $ Tag: $Name: $
 */
public class SystemApproveGenerateWaiverRequestCheckListOperation extends AbstractCheckListTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public SystemApproveGenerateWaiverRequestCheckListOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_SYSTEM_APPROVE_GENERATE_CHECKLIST_WAIVER;
	}
	...
	private boolean requireStateChange(String anItemStatus) {
		if (anItemStatus.equals(ICMSConstant.STATE_ITEM_WAIVER_REQ)) {
			return true;
		}
		return false;
	}
