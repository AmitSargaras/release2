 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/checklist/trx/CheckListReadController.java,v 1.1 2003/07/17 12:26:22 hltan Exp $
 */
 ...
 * @since $Date: 2003/07/17 12:26:22 $ Tag: $Name: $
 */
public class CheckListReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public CheckListReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_CHECKLIST)) {
				return new ReadCheckListOperation();
			}

			if (action.equals(ICMSConstant.ACTION_READ_CHECKLIST_ID)) {
				return new ReadCheckListIDOperation();
			}
