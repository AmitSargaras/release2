...
public class MakerCreateCollateralRocOperation extends AbstractCollateralRocTrxOperation {

	/**
	 * Defaulc Constructor
	 */
	public MakerCreateCollateralRocOperation() {
		super();
	}
	/**
	...
	*/
	...
	{
		return ICMSConstant.ACTION_MAKER_CREATE_COLLATERAL_ROC;
	}
	...
	*/
	private ICollateralRocTrxValue createCollateralRocTransaction(ICollateralRocTrxValue anICCCollateralRocTrxValue) throws TrxOperationException,CollateralRocException
	{
		...
		{
			throw new CollateralRocException("Error in Create CollateralRoc Operation ");
		}
