...
public class MakerEditRejectedUpdateCollateralRocOperation extends AbstractCollateralRocTrxOperation {

	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedUpdateCollateralRocOperation() {
		super();
	}
	/**
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_COLLATERAL_ROC;
     }
     /**
