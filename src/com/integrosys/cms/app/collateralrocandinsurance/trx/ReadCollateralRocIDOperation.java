...
public class ReadCollateralRocIDOperation extends AbstractCollateralRocTrxOperation implements ITrxReadOperation{

	/**
     * Default Constructor
     */
	public ReadCollateralRocIDOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_COLLATERAL_ROC_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                ICollateralRoc collateralRoc=getStagingCollateralRocBusManager().getCollateralRocById(stagingPK);
                newValue.setStagingCollateralRoc(collateralRoc);
            }else{
