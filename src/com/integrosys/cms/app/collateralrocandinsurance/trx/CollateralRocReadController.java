...
public class CollateralRocReadController extends AbstractTrxController implements ITrxOperationFactory{
	 ...
	 * Default Constructor
	 */
	public CollateralRocReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_COLLATERAL_ROC)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCollateralRocOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_COLLATERAL_ROC_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCollateralRocIDOperation");
            }else{
