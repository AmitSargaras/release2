 ...
 */
public class MakerEditRejectedUpdateValuationAgencyOperation extends
		AbstractValuationAgencyTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedUpdateValuationAgencyOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_VALUATION_AGENCY;
	}
