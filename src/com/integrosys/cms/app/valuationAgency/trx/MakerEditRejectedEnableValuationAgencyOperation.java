 ...
 */
public class MakerEditRejectedEnableValuationAgencyOperation extends
		AbstractValuationAgencyTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedEnableValuationAgencyOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_ENABLE_VALUATION_AGENCY;
	}
