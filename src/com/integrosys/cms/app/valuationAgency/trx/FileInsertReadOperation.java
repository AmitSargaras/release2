...
public class FileInsertReadOperation  extends AbstractValuationAgencyTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId holiday = getStagingValuationAgencyFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId holiday = getStagingValuationAgencyFileMapperIdBusManager().getInsertFileById(actualPK); 
                newValue.setStagingFileMapperID(holiday);
            }
            return newValue;
        }
