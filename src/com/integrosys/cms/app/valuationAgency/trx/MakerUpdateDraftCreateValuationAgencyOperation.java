 ...
 */
public class MakerUpdateDraftCreateValuationAgencyOperation extends
		AbstractValuationAgencyTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerUpdateDraftCreateValuationAgencyOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CREATE_VALUATION_AGENCY;
	}
	...
	public ITrxValue preProcess(ITrxValue anITrxValue)
		...
		IValuationAgency staging = trxValue.getStagingValuationAgency();
		try {
			// if (staging != null) {
			//                
			//
