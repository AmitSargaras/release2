...
public class CheckerApproveInsertMasterOperation extends AbstractValuationAgencyTrxOperation {
     ...
     */
    private IValuationAgencyTrxValue actualMaster(IValuationAgencyTrxValue idxTrxValue) throws ValuationAgencyException, TrxParameterException, TransactionException, ConcurrentUpdateException {
        try {
            IFileMapperId staging = idxTrxValue.getStagingFileMapperID();
            IFileMapperId actual = idxTrxValue.getFileMapperID();

            IFileMapperId updatedActual = getValuationAgencyFileMapperIdBusManager().insertValuationAgency(staging,idxTrxValue);           
