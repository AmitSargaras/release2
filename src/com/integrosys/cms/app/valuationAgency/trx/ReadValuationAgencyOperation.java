 ...
 */
public class ReadValuationAgencyOperation extends
		AbstractValuationAgencyTrxOperation implements ITrxReadOperation {
	/**
	 * Default Constructor
	 */
	public ReadValuationAgencyOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_READ_VALUATION_AGENCY;
	}
	...
	public ITrxValue getTransaction(ITrxValue anITrxValue)
		...
		try {
			...
			OBValuationAgencyTrxValue newValue = new OBValuationAgencyTrxValue(trxValue);
			...
			if (null != stagingRef) {
				...
				newValue
						.setStagingValuationAgency(getStagingValuationAgencyBusManager()
								.getValuationAgencyById(stagingPK));
			} else {
			...
			if (null != actualRef) {
				...
				newValue.setValuationAgency(getValuationAgencyBusManager()
						.getValuationAgencyById(actualPK));
			} else {
