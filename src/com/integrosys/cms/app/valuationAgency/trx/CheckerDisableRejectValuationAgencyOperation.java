...
public class CheckerDisableRejectValuationAgencyOperation extends
		AbstractValuationAgencyTrxOperation {

	public CheckerDisableRejectValuationAgencyOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_REJECT_DISABLE_VALUATION_AGENCY;
	}
