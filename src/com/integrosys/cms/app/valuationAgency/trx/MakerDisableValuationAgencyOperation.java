 ...
 */
public class MakerDisableValuationAgencyOperation extends
		AbstractValuationAgencyTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerDisableValuationAgencyOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_DISABLE_VALUATION_AGENCY;
	}
	...
	public ITrxResult performProcess(ITrxValue anITrxValue)
		...
		IValuationAgencyTrxValue trxValue = disableStagingValuationAgency(idxTrxValue);
