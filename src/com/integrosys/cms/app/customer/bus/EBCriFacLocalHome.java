 ...
 */
public interface EBCriFacLocalHome extends EJBLocalHome {
	/**
	 ...
	 */
	public EBCriFacLocal create(ICriFac value) throws CreateException;
	 ...
	 */
	public EBCriFacLocal findByPrimaryKey(Long pk) throws FinderException;
}