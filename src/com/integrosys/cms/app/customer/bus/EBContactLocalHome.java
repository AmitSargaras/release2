 ...
 */
public interface EBContactLocalHome extends EJBLocalHome {
	/**
	 ...
	 */
	public EBContactLocal create(long legalID, IContact value) throws CreateException;
	 ...
	 */
	public EBContactLocal findByPrimaryKey(Long pk) throws FinderException;
}