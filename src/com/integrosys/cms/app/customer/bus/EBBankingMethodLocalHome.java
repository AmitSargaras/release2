 ...
 */
public interface EBBankingMethodLocalHome extends EJBLocalHome {
	/**
	 ...
	 */
	public EBBankingMethodLocal create(IBankingMethod value) throws CreateException;
	 ...
	 */
	public EBBankingMethodLocal findByPrimaryKey(Long pk) throws FinderException;
}