...
public class OBLineCovenant implements ILineCovenant{
	...
	private String countryRestrictionFlag;
	private String draweeFlag;
	private String drawerFlag;
	private String beneficiaryFlag;
	private String runningAccountFlag;
	private String goodsRestrictionFlag;
	private String currencyRestrictionFlag;
	private String bankRestrictionFlag;
	...
	public String getCountryRestrictionFlag() {
		return countryRestrictionFlag;
	}

	public void setCountryRestrictionFlag(String countryRestrictionFlag) {
		this.countryRestrictionFlag = countryRestrictionFlag;
	}

	public String getDraweeFlag() {
		return draweeFlag;
	}

	public void setDraweeFlag(String draweeFlag) {
		this.draweeFlag = draweeFlag;
	}

	public String getDrawerFlag() {
		return drawerFlag;
	}

	public void setDrawerFlag(String drawerFlag) {
	...
	public String getRunningAccountFlag() {
		return runningAccountFlag;
	}

	public void setRunningAccountFlag(String runningAccountFlag) {
		this.runningAccountFlag = runningAccountFlag;
	}


	public String getGoodsRestrictionFlag() {
		return goodsRestrictionFlag;
	}

	public void setGoodsRestrictionFlag(String goodsRestrictionFlag) {
		this.goodsRestrictionFlag = goodsRestrictionFlag;
	}

	public String getCurrencyRestrictionFlag() {
		return currencyRestrictionFlag;
	}

	public void setCurrencyRestrictionFlag(String currencyRestrictionFlag) {
		this.currencyRestrictionFlag = currencyRestrictionFlag;
	}

	public String getBankRestrictionFlag() {
		return bankRestrictionFlag;
	}

	public void setBankRestrictionFlag(String bankRestrictionFlag) {
		this.bankRestrictionFlag = bankRestrictionFlag;
	}

	public String getRestrictedBeneInd() {
		return restrictedBeneInd;
	}

	public void setRestrictedBeneInd(String restrictedBeneInd) {
		this.restrictedBeneInd = restrictedBeneInd;
	}
	...
	public static class Comparators {
        public static Comparator<ILineCovenant> GOODS_RESTRICTION_COMPARATOR = new Comparator<ILineCovenant>() {
            @Override
            public int compare(ILineCovenant l1, ILineCovenant l2) {
