 ...
 */
public interface EBSublineLocalHome extends EJBLocalHome {
	/**
	 ...
	 */
	public EBSublineLocal create(ISubline value) throws CreateException;
	 ...
	 */
	public EBSublineLocal findByPrimaryKey(Long pk) throws FinderException;
}