 ...
 */
public interface EBSystemLocalHome extends EJBLocalHome {
	/**
	 ...
	 */
	public EBSystemLocal create(ISystem value) throws CreateException;
	 ...
	 */
	public EBSystemLocal findByPrimaryKey(Long pk) throws FinderException;
}