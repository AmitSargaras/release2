 ...
 */
public interface EBDirectorLocalHome extends EJBLocalHome {
	/**
	 ...
	 */
	public EBDirectorLocal create(IDirector value) throws CreateException;
	 ...
	 */
	public EBDirectorLocal findByPrimaryKey(Long pk) throws FinderException;
}