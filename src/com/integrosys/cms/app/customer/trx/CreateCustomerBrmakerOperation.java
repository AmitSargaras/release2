 ...
 */
public class CreateCustomerBrmakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public CreateCustomerBrmakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CREATE_CUSTOMER_BRMAKER;
	}
