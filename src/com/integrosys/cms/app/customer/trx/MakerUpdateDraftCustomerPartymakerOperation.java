 ...
 */
public class MakerUpdateDraftCustomerPartymakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerUpdateDraftCustomerPartymakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_UPDATE_DRAFT_CUSTOMER_PARTY;
	}
