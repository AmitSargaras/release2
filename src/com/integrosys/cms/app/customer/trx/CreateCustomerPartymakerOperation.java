 ...
 */
public class CreateCustomerPartymakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public CreateCustomerPartymakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CREATE_CUSTOMER_PARTY;
	}
