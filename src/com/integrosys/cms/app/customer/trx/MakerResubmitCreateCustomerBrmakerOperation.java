 ...
 */
public class MakerResubmitCreateCustomerBrmakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerResubmitCreateCustomerBrmakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_RESUBMIT_CREATE_CUSTOMER_BRMAKER;
	}
