...
/**
 * This operation allows a checker to approve a customer for delete
 * 
 * @author sandiip.shinde
 * @version $Revision: 1.3 $
 * @since $Date: 2011/04/05 03:39:31 $ Tag: $Name: $
 */
public class CheckerApproveDeleteCustomerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public CheckerApproveDeleteCustomerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_CUSTOMER;
	}
