 ...
 */
public class MakerUpdateDraftCustomerBrmakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerUpdateDraftCustomerBrmakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_UPDATE_DRAFT_CUSTOMER_BRMAKER;
	}
