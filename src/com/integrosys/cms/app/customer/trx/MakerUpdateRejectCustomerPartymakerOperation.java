 ...
 */
public class MakerUpdateRejectCustomerPartymakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerUpdateRejectCustomerPartymakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_UPDATE_REJECTED_CUSTOMER_PARTY;
	}
