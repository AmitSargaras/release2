 ...
 */
public class MakerResubmitCreateCustomerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerResubmitCreateCustomerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_RESUBMIT_CREATE_CUSTOMER;
	}
