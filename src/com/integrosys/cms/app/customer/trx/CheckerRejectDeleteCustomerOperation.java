 ...
 * @since $Date: 2011/04/05 04:04:31 $ Tag: $Name: $
 */
public class CheckerRejectDeleteCustomerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public CheckerRejectDeleteCustomerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_REJECT_DELETE_CUSTOMER;
	}
