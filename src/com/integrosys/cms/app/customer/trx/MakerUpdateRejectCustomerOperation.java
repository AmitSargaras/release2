 ...
 */
public class MakerUpdateRejectCustomerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerUpdateRejectCustomerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_UPDATE_REJECTED_CUSTOMER;
	}
