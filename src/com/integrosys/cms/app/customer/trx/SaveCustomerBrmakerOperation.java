 ...
 */
public class SaveCustomerBrmakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public SaveCustomerBrmakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_SAVE_CUSTOMER_BRMAKER;
	}
