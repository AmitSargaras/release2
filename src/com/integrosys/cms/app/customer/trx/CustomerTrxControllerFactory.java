 ...
 */
public class CustomerTrxControllerFactory implements ITrxControllerFactory {
	/**
	 * Default Constructor
	 */
	public CustomerTrxControllerFactory() {
		super();
	}
	...
	public ITrxController getController(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		if (param.getAction()!=null && isReadOperation(param.getAction())) {
			return new CustomerReadController();
		}
		else {
			return new CustomerTrxController();
		}
	}
