 ...
 */
public class SaveEditCustomerPartymakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public SaveEditCustomerPartymakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_SAVE_CUSTOMER_IN_EDIT_PARTY;
	}
