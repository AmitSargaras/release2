 ...
 */
public class MakerResubmitDeleteCustomerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Default Constructor.
	 */
	public MakerResubmitDeleteCustomerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_RESUBMIT_DELETE_CUSTOMER;
	}
