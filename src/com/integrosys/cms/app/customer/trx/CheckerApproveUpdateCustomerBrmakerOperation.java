 ...
 */
public class CheckerApproveUpdateCustomerBrmakerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public CheckerApproveUpdateCustomerBrmakerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_UPDATE_CUSTOMER_BRMAKER;
	}
