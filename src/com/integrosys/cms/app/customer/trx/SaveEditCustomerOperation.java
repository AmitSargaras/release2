 ...
 */
public class SaveEditCustomerOperation extends AbstractCustomerTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public SaveEditCustomerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_SAVE_CUSTOMER_IN_EDIT;
	}
