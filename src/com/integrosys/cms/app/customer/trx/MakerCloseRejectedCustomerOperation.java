...
public class MakerCloseRejectedCustomerOperation extends AbstractCustomerTrxOperation{

	public MakerCloseRejectedCustomerOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CLOSE_CUSTOMER;
	}
