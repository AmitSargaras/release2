...
public class LeiDateValidationReadController extends AbstractTrxController implements ITrxOperationFactory{
	 ...
	 * Default Constructor
	 */
	public LeiDateValidationReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_LEI_DATE_VALIDATION)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadLeiDateValidationOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_LEI_DATE_VALIDATION_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadLeiDateValidationIDOperation");
            }else{
