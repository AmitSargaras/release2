...
public class ReadLeiDateValidationIDOperation extends AbstractLeiDateValidationTrxOperation implements ITrxReadOperation {

	/**
     * Default Constructor
     */
	public ReadLeiDateValidationIDOperation() {
		 super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_LEI_DATE_VALIDATION_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBLeiDateValidationTrxValue newValue = new OBLeiDateValidationTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                ILeiDateValidation leiDateValidation=getStagingLeiDateValidationBusManager().getLeiDateValidationById(stagingPK);
                newValue.setStagingLeiDateValidation(leiDateValidation);
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setLeiDateValidation(getLeiDateValidationBusManager().getLeiDateValidationById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
