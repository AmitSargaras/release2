...
public class ReadLeiDateValidationOperation extends AbstractLeiDateValidationTrxOperation implements ITrxReadOperation  {

	/**
     * Default Constructor
     */
	public ReadLeiDateValidationOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_LEI_DATE_VALIDATION;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingLeiDateValidation(getStagingLeiDateValidationBusManager().getLeiDateValidationById(stagingPK));
            }else{
