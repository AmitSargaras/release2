...
public class CersaiMappingReadController extends AbstractTrxController implements ITrxOperationFactory{
	 ...
	 * Default Constructor
	 */
	public CersaiMappingReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_CERSAI_MAPPING)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCersaiMappingOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_CERSAI_MAPPING_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCersaiMappingIDOperation");
            }else{
