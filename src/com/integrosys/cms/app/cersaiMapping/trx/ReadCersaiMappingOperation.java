...
public class ReadCersaiMappingOperation extends AbstractCersaiMappingTrxOperation implements ITrxReadOperation  {

	/**
     * Default Constructor
     */
	public ReadCersaiMappingOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_CERSAI_MAPPING;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingCersaiMapping(getStagingCersaiMappingBusManager().getCersaiMappingById(stagingPK));
            }else{
