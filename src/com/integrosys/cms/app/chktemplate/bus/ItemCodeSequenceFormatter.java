 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/checklist/bus/ItemCodeSequenceFormatter.java,v 1.2 2003/07/08 03:12:46 hltan Exp $
 */
 ...
 */
public class ItemCodeSequenceFormatter implements ISequenceFormatter {
	 ...
	 * Default Constructor
	 */
	public ItemCodeSequenceFormatter() {
	}
	...
	protected int getSequenceLength() {
		return ITEM_CODE_MAX_LENGTH - getSequencePrefix().length();
	}
