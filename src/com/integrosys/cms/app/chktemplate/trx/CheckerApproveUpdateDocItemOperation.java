 ...
 */
public class CheckerApproveUpdateDocItemOperation extends AbstractDocItemTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public CheckerApproveUpdateDocItemOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_UPDATE_DOC_ITEM;
	}
