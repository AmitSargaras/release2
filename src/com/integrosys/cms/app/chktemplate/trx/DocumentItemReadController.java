 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/checklist/trx/DocumentItemReadController.java,v 1.2 2003/07/03 01:36:59 hltan Exp $
 */
...
import com.integrosys.cms.app.chktemplate.trx.ReadDocItemOperation;
 ...
 * @since $Date: 2003/07/03 01:36:59 $ Tag: $Name: $
 */
public class DocumentItemReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public DocumentItemReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_DOC_ITEM)) {
				return new ReadDocItemOperation();
			}
