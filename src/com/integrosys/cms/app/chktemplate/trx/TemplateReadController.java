 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/checklist/trx/TemplateReadController.java,v 1.1 2003/07/03 01:37:27 hltan Exp $
 */
 ...
 */
public class TemplateReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public TemplateReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_TEMPLATE)) {
				return new ReadTemplateOperation();
			}
