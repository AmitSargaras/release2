 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/checklist/trx/MakerUpdateDocItemOperation.java,v 1.3 2003/07/23 07:32:14 hltan Exp $
 */
...
/**
 * This operation allows a maker to update a doc item
 * 
 * @author $Author: hltan $
 * @version $Revision: 1.3 $
 * @since $Date: 2003/07/23 07:32:14 $ Tag: $Name: $
 */
public class MakerUpdateDocItemOperation extends AbstractDocItemTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerUpdateDocItemOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_UPDATE_DOC_ITEM;
	}
