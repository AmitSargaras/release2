 ...
 */
public class MakerEditRejectedUpdateDocItemOperation extends AbstractDocItemTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerEditRejectedUpdateDocItemOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_DOC_ITEM;
	}
