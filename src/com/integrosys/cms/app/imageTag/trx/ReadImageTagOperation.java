...
public class ReadImageTagOperation extends AbstractImageTagTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadImageTagOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_IMAGE_TAG;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBImageTagTrxValue newValue = new OBImageTagTrxValue(trxValue);
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingImageTagDetails(getStagingImageTagBusManager().getImageTagById(stagingPK));
            }else{
            ...
            if (null != actualRef) {
                ...
                newValue.setImageTagDetails(getImageTagBusManager().getImageTagById(actualPK));
            }else{
