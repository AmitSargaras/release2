 ...
 */
public class ImageTagReadController extends AbstractTrxController implements ITrxOperationFactory {
    ...
    public String getInstanceName() {
        return ICMSConstant.INSTANCE_IMAGE_TAG;
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_IMAGE_TAG)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadImageTagOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_IMAGE_TAG_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadImageTagIDOperation");
            }else{
