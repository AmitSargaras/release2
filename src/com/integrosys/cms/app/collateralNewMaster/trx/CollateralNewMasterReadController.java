 ...
 */
public class CollateralNewMasterReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public CollateralNewMasterReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_COLLATERAL_NEW_MASTER)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCollateralNewMasterOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_COLLATERAL_NEW_MASTER_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCollateralNewMasterIDOperation");
            }else{
