...
public class ReadCollateralNewMasterIDOperation extends AbstractCollateralNewMasterTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadCollateralNewMasterIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_COLLATERAL_NEW_MASTER_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                ICollateralNewMaster collateralNewMaster=getStagingCollateralNewMasterBusManager().getCollateralNewMasterById(stagingPK);
                newValue.setStagingCollateralNewMaster(collateralNewMaster);
            }else{
