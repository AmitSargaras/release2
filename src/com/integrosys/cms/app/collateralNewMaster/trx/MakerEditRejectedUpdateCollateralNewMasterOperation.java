 ...
 */
public class MakerEditRejectedUpdateCollateralNewMasterOperation extends AbstractCollateralNewMasterTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateCollateralNewMasterOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_COLLATERAL_NEW_MASTER;
        }
