...
public class MakerEditRejectedDeletePrIdxOperation extends AbstractPropertyIdxTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeletePrIdxOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_PRIDX;
        }
