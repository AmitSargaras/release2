...
public class CheckerApproveUpdatePrIdxOperation extends AbstractPropertyIdxTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveUpdatePrIdxOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_UPDATE_PRIDX;
	}
