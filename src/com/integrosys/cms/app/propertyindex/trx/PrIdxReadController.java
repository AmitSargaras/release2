 ...
 * Date: Jan 17, 2008
 */
public class PrIdxReadController extends AbstractTrxController implements ITrxOperationFactory {
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_PRIDX)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadPrIdxOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_PRIDX_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadPrIdxIDOperation");
            }
