 ...
 * Date: Jan 18, 2008
 */
public class MakerEditRejectedCreatePrIdxOperation extends AbstractPropertyIdxTrxOperation{
  /**
    * Defaulc Constructor
    */
    public MakerEditRejectedCreatePrIdxOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_CREATE_PRIDX;
    }
