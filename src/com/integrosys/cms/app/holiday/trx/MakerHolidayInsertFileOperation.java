 ...
 * Date: Jan 18, 2008
 */
public class MakerHolidayInsertFileOperation extends AbstractHolidayTrxOperation {

   /**
    * Defaulc Constructor
    */
    public MakerHolidayInsertFileOperation()
    {
        super();
    }
	...
	*/
	private IHolidayTrxValue createFileIdTransaction(IHolidayTrxValue anICCIHolidayTrxValue) throws TrxOperationException,HolidayException
	{
		try
		{
			anICCIHolidayTrxValue = prepareInsertTrxValue(anICCIHolidayTrxValue);
			ICMSTrxValue trxValue = createTransaction(anICCIHolidayTrxValue);
            OBHolidayTrxValue holidayTrxValue = new OBHolidayTrxValue (trxValue);
            holidayTrxValue.setStagingFileMapperID(anICCIHolidayTrxValue.getStagingFileMapperID());
            holidayTrxValue.setFileMapperID(anICCIHolidayTrxValue.getFileMapperID());
