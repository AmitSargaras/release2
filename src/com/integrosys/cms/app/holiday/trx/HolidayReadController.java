 ...
 * Read Holiday Controller
 */
public class HolidayReadController extends AbstractTrxController implements ITrxOperationFactory {
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_HOLIDAY)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadHolidayOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_HOLIDAY_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadHolidayIDOperation");
            }else{
