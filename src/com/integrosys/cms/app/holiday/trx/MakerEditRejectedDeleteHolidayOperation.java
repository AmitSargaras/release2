 ...
 */
public class MakerEditRejectedDeleteHolidayOperation extends AbstractHolidayTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteHolidayOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_HOLIDAY;
        }
