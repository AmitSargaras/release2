...
public class CheckerApproveDeleteValuationAmountAndRatingOperation extends AbstractValuationAmountAndRatingTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveDeleteValuationAmountAndRatingOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_VALUATION_AMOUNT_AND_RATING;
	}
	...
	private IValuationAmountAndRatingTrxValue updateActualValuationAmountAndRating(IValuationAmountAndRatingTrxValue anICCValuationAmountAndRatingTrxValue)
		...
		try {
			...
			IValuationAmountAndRating updatedValuationAmountAndRating = getValuationAmountAndRatingBusManager().deleteToWorkingCopy(actual, staging);
