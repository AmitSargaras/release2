...
public class MakerCreateValuationAmountAndRatingOperation extends AbstractValuationAmountAndRatingTrxOperation{

	/**
	 * Defaulc Constructor
	 */
	public MakerCreateValuationAmountAndRatingOperation() {
		super();
	}
	...
	*/
	private IValuationAmountAndRatingTrxValue createValuationAmountAndRatingTransaction(IValuationAmountAndRatingTrxValue anICCValuationAmountAndRatingTrxValue) throws TrxOperationException,ValuationAmountAndRatingException
	{
		...
		{
			throw new ValuationAmountAndRatingException("Error in Create ValuationAmountAndRating Operation ");
		}
