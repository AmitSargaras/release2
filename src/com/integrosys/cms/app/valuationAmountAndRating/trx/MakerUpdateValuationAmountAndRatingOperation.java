 ...
 */
public class MakerUpdateValuationAmountAndRatingOperation extends AbstractValuationAmountAndRatingTrxOperation{
	 /**
     * Defaulc Constructor
     */
    public MakerUpdateValuationAmountAndRatingOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_UPDATE_VALUATION_AMOUNT_AND_RATING;
    }
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        IValuationAmountAndRating replicatedFCCBranch = ValuationAmountAndRatingReplicationUtils.replicateValuationAmountAndRatingForCreateStagingCopy(stage);
        idxTrxValue.setStagingValuationAmountAndRating(replicatedFCCBranch);
