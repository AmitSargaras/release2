...
public class ValuationAmountAndRatingReadController extends AbstractTrxController implements ITrxOperationFactory{
	 ...
	 * Default Constructor
	 */
	public ValuationAmountAndRatingReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_VALUATION_AMOUNT_AND_RATING)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadValuationAmountAndRatingOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_VALUATION_AMOUNT_AND_RATING_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadValuationAmountAndRatingIDOperation");
            }else{
