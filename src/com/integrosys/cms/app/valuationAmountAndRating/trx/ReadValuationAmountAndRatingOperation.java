...
public class ReadValuationAmountAndRatingOperation extends AbstractValuationAmountAndRatingTrxOperation implements ITrxReadOperation  {

	/**
     * Default Constructor
     */
	public ReadValuationAmountAndRatingOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_VALUATION_AMOUNT_AND_RATING;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingValuationAmountAndRating(getStagingValuationAmountAndRatingBusManager().getValuationAmountAndRatingById(stagingPK));
            }else{
