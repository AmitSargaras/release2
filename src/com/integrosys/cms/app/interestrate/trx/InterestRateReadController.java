...
/**
 * This transaction controller is to be used for reading interest rate.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class InterestRateReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default constructor.
	 */
	public InterestRateReadController() {
	}
	 ...
	 * 
	 * @return instance of interest rate
	 */
	...
	public ITrxOperation getOperation(ITrxValue trxVal, ITrxParameter param) throws TrxParameterException {
		...
		if (action.equals(ICMSConstant.ACTION_READ_INT_RATE)) {
			return new ReadInterestRateOperation();
		}
		else if (action.equals(ICMSConstant.ACTION_READ_INT_RATE_BY_TRXID)) {
			return new ReadInterestRateByTrxIDOperation();
		}
		else {
