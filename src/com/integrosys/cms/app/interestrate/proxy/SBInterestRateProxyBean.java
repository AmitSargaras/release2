 ...
 * AbstractInterestRateProxy, wrapped in an EJB mechanism.
 * 
 * @author $Author: pctan $<br>
 * @version $Revision: $
 * @since $Date: $ Tag: $Name: $
 */
public class SBInterestRateProxyBean extends AbstractInterestRateProxy implements SessionBean {
	 ...
	 * Default Constructor
	 */
	public SBInterestRateProxyBean() {
	}

	/**
	 * Method to rollback a transaction
	 * 
	 * @throws InterestRateException on errors rolling back
	 */
	protected void rollback() throws InterestRateException {
		try {
			...
			throw new InterestRateException(e.toString());
		}
	}
