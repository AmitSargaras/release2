 ...
 * $Header: /home/cms2/cvsroot/cms2/src/com/integrosys/cms/app/ddn/trx/DDNReadController.java,v 1.2 2005/06/08 06:33:54 htli Exp $
 */
 ...
 */
public class DDNReadController extends AbstractTrxController implements ITrxOperationFactory {
	/**
	 * Default Constructor
	 */
	public DDNReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_DDN)) {
				return new ReadDDNOperation();
			}
			else if (action.equals(ICMSConstant.ACTION_READ_DDN_ID)) {
				return new ReadDDNIDOperation();
			}
			else if (action.equals(ICMSConstant.ACTION_READ_PREVIOUS_DDN)) {
				return new ReadPreviousDDNOperation();
			}
