...
public class ReadFileUploadIDOperation extends AbstractFielUploadTrxOperation implements ITrxReadOperation {
	
	public ReadFileUploadIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_FILEUPLOAD_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBFileUploadTrxValue newValue = new OBFileUploadTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IFileUpload file =getStagingfileUploadBusManager().getFileUploadById(stagingPK);
                newValue.setStagingfileUpload(file);
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setFileUpload(getStagingfileUploadBusManager().getFileUploadById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
