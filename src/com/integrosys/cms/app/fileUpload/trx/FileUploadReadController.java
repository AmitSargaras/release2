...
public class FileUploadReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public FileUploadReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_FILEUPLOAD)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadComponentOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_FILEUPLOAD_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadFileUploadIDOperation");
            }else{
