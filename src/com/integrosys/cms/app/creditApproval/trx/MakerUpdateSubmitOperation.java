...
/**
 * @author govind.sahu
 * Maker Update operation to  update 
 */
public class MakerUpdateSubmitOperation extends AbstractCreditApprovalTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerUpdateSubmitOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_UPDATE_CREDIT_APPROVAL;
    }
...
//            }
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
    	...
    	if(idxTrxValue.getReferenceID()!=null && !idxTrxValue.getReferenceID().equals(""))
    	{
    	actual.setId(Long.parseLong(idxTrxValue.getReferenceID()));
    	idxTrxValue.setCreditApproval(actual);
    	}
    	else
    	{
    		DefaultLogger.debug(this, "ReferenceID is :" + idxTrxValue.getReferenceID());
    	}
