 ...
 */
public class CreditApprovalReadController extends AbstractTrxController implements ITrxOperationFactory {
	...
	public CreditApprovalReadController() {
	}
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
		...
		if (action != null) {
			if (action.equals(ICMSConstant.ACTION_READ_CREDIT_APPROVAL)) {
				return (ITrxOperation) getNameTrxOperationMap().get("ReadCreditApprovalOperation");
			}
