 ...
 */
public class MakerEditRejectedCreateCreditApprovalOperation extends AbstractCreditApprovalTrxOperation {
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedCreateCreditApprovalOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_CREATE_CREDIT_APPROVAL;
        }
