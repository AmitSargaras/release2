...
public class FileInsertReadOperation extends AbstractCreditApprovalTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBCreditApprovalTrxValue newValue = new OBCreditApprovalTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId creditApproval = getStagingCreditApprovalFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId creditApproval = getStagingCreditApprovalFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(creditApproval);
            }
            return newValue;
        }
