...
public class ReadNpaTraqCodeMasterOperation extends AbstractNpaTraqCodeMasterTrxOperation implements ITrxReadOperation  {

	/**
     * Default Constructor
     */
	public ReadNpaTraqCodeMasterOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_NPA_TRAQ_CODE_MASTER;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingNpaTraqCodeMaster(getStagingNpaTraqCodeMasterBusManager().getNpaTraqCodeMasterById(stagingPK));
            }else{
