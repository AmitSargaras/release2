...
public class MakerSaveNpaTraqCodeMasterOperation extends AbstractNpaTraqCodeMasterTrxOperation {
	/**
	 * Defaulc Constructor
	 */
	public MakerSaveNpaTraqCodeMasterOperation() {
		super();
	}
	...
	*/
	...
	{
		return ICMSConstant.ACTION_MAKER_SAVE_NPA_TRAQ_CODE_MASTER;
	}
	...
	* @param anICCNpaTraqCodeMasterIdxTrxValue of ICCNpaTraqCodeMasterIdxTrxValue type
	* @return ICCNpaTraqCodeMasterIdxTrxValue
	...
	*/
	private INpaTraqCodeMasterTrxValue createNpaTraqCodeMasterTransaction(INpaTraqCodeMasterTrxValue anICCNpaTraqCodeMasterTrxValue) throws TrxOperationException,NpaTraqCodeMasterException
	{
		...
		{
			throw new NpaTraqCodeMasterException("Error in Create NpaTraqCodeMaster");
		}
