...
public class NpaTraqCodeMasterReadController extends AbstractTrxController implements ITrxOperationFactory{
	 ...
	 * Default Constructor
	 */
	public NpaTraqCodeMasterReadController() {
	}
	/**
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_NPA_TRAQ_CODE_MASTER)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadNpaTraqCodeMasterOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_NPA_TRAQ_CODE_MASTER_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadNpaTraqCodeMasterIDOperation");
            }else{
