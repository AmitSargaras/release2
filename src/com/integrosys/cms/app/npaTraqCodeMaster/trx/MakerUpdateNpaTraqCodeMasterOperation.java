 ...
 */
public class MakerUpdateNpaTraqCodeMasterOperation extends AbstractNpaTraqCodeMasterTrxOperation{
	 /**
     * Defaulc Constructor
     */
    public MakerUpdateNpaTraqCodeMasterOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_UPDATE_NPA_TRAQ_CODE_MASTER;
    }
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        INpaTraqCodeMaster replicatedFCCBranch = NpaTraqCodeMasterReplicationUtils.replicateNpaTraqCodeMasterForCreateStagingCopy(stage);
        idxTrxValue.setStagingNpaTraqCodeMaster(replicatedFCCBranch);
