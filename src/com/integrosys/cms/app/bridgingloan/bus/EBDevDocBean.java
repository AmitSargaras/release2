...
public abstract class EBDevDocBean implements EntityBean, IDevelopmentDoc {
	...
	private static final String[] EXCLUDE_METHOD = new String[] { "getDevDocID", "getScheduleID", "getCommonRef" };
	...
	// ====================================
	/**
	 * Retrieve an instance of Development Doc object.
	 * @return Development Doc business object
	 */
	public IDevelopmentDoc getValue() {
		IDevelopmentDoc value = new OBDevelopmentDoc();
	 ...
	 * @param value of type IDevelopmentDoc
	 */
	...
	// Getters
	// ========================
	public abstract Long getCMPDevDocID();
	...
	public long getDevDocID() {
		return TypeConverter.convertToPrimitiveType(getCMPDevDocID());
	}
	...
	// Setters
	// ========================
	public abstract void setCMPDevDocID(Long id);
	...
	public void setDevDocID(long id) {
		setCMPDevDocID(new Long(id));
	}
	 ...
	 * 
	 * @param object IDevelopmentDoc object to be created
	 * @throws javax.ejb.CreateException on error creating the entity object
	 */
	public Long ejbCreate(IDevelopmentDoc object) throws CreateException {
		if (object == null) {
			throw new CreateException("IDevelopmentDoc object to be created is null");
		}

		try {
			long pk = Long.parseLong((new SequenceManager()).getSeqNum(ICMSConstant.SEQUENCE_BL_DEV_DOC, true));
			setDevDocID(pk);
	 ...
	 * 
	 * @param value object of IDevelopmentDoc
	 * @throws javax.ejb.CreateException on error creating the references
	 */
	public void ejbPostCreate(IDevelopmentDoc value) throws CreateException {
	}
