 ...
 */
public class CheckerApproveUpdateBridgingLoanOperation extends AbstractBridgingLoanTrxOperation {

	/**
	 * Default Constructor
	 */
	public CheckerApproveUpdateBridgingLoanOperation() {
	}
	...
	public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
		...
		trxValue = updateActualBridgingLoan(trxValue);
