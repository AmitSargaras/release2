...
/**
 * Created by IntelliJ IDEA. User: KLYong Date: May 16, 2007 Time: 10:54:39 AM
 * To change this template use File | Settings | File Templates.
 */
public class MakerDeleteBridgingLoanOperation extends AbstractBridgingLoanTrxOperation {
	/**
	 * Default Constructor
	 */
	public MakerDeleteBridgingLoanOperation() {
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_DELETE_BRIDGING_LOAN;
	}
