...
public class ReadRiskTypeOperation extends AbstractRiskTypeTrxOperation implements ITrxReadOperation  {

	/**
     * Default Constructor
     */
	public ReadRiskTypeOperation() {
		super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_RISK_TYPE;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingRiskType(getStagingRiskTypeBusManager().getRiskTypeById(stagingPK));
            }else{
