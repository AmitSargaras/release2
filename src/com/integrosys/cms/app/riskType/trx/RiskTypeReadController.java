...
public class RiskTypeReadController extends AbstractTrxController implements ITrxOperationFactory{
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_RISK_TYPE)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadRiskTypeOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_RISK_TYPE_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadRiskTypeIDOperation");
            }else{
