 ...
 */
public class MakerUpdateRiskTypeOperation extends AbstractRiskTypeTrxOperation{
	 /**
     * Defaulc Constructor
     */
    public MakerUpdateRiskTypeOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_UPDATE_RISK_TYPE;
    }
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        IRiskType replicatedFCCBranch = RiskTypeReplicationUtils.replicateRiskTypeForCreateStagingCopy(stage);
        idxTrxValue.setStagingRiskType(replicatedFCCBranch);
