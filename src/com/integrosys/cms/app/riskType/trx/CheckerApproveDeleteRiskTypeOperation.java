...
public class CheckerApproveDeleteRiskTypeOperation extends AbstractRiskTypeTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveDeleteRiskTypeOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_RISK_TYPE;
	}
	...
	private IRiskTypeTrxValue updateActualRiskType(IRiskTypeTrxValue anICCRiskTypeTrxValue)
		...
		try {
			...
			IRiskType updatedRiskType = getRiskTypeBusManager().deleteToWorkingCopy(actual, staging);
