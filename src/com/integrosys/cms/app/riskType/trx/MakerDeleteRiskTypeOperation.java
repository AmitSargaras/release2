 ...
 */
public class MakerDeleteRiskTypeOperation extends AbstractRiskTypeTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerDeleteRiskTypeOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_DELETE_RISK_TYPE;
    }
    ...
    public ITrxValue preProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        IRiskType staging = trxValue.getStagingRiskType();
        try {
//            if (staging != null) {
//                
//
