...
public class ReadRiskTypeIDOperation extends AbstractRiskTypeTrxOperation implements ITrxReadOperation {

	/**
     * Default Constructor
     */
	public ReadRiskTypeIDOperation() {
		 super();
	}
	/**
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_RISK_TYPE_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBRiskTypeTrxValue newValue = new OBRiskTypeTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                IRiskType valuationAmountAndRating=getStagingRiskTypeBusManager().getRiskTypeById(stagingPK);
                newValue.setStagingRiskType(valuationAmountAndRating);
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setRiskType(getRiskTypeBusManager().getRiskTypeById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
