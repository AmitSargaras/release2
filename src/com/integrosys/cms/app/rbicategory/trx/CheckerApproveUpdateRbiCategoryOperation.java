...
public class CheckerApproveUpdateRbiCategoryOperation extends AbstractRbiCategoryTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveUpdateRbiCategoryOperation() {
		super();
	}
	...
	public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
		...
		trxValue = updateActualRbiCategory(trxValue);
	 ...
	 */
	private IRbiCategoryTrxValue updateActualRbiCategory(IRbiCategoryTrxValue anICCRbiCategoryTrxValue)
			throws TrxOperationException {
		try {
			...
			IRbiCategory updatedRbiCategory = getRbiCategoryBusManager().updateToWorkingCopy(actual, staging);
