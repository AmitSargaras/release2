...
/**
  * @author Govind.Sahu
 * Read RbiCategory Operation By Trx vID
 */

public class ReadRbiCategoryIDOperation extends AbstractRbiCategoryTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadRbiCategoryIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_RBI_CATEGORY_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBRbiCategoryTrxValue newValue = new OBRbiCategoryTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                newValue.setStagingRbiCategory(getStagingRbiCategoryBusManager().getRbiCategoryById(stagingPK));
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setRbiCategory(getRbiCategoryBusManager().getRbiCategoryById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
