...
public class CheckerDeleteRejectRbiCategoryOperation extends AbstractRbiCategoryTrxOperation{

    public CheckerDeleteRejectRbiCategoryOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_DELETE_RBI_CATEGORY;
    }
