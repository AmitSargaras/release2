 ...
 */
public class MakerEditRejectedDeleteRbiCategoryOperation extends AbstractRbiCategoryTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteRbiCategoryOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_RBI_CATEGORY;
        }
