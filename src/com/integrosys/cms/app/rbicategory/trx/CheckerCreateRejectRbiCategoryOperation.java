...
public class CheckerCreateRejectRbiCategoryOperation extends AbstractRbiCategoryTrxOperation{

    public CheckerCreateRejectRbiCategoryOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_CREATE_RBI_CATEGORY;
    }
