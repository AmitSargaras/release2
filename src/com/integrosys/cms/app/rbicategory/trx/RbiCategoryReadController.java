...
/**
 * @author Govind.Sahu
 * RbiCategory Controller
 */
public class RbiCategoryReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public RbiCategoryReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_RBI_CATEGORY)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadRbiCategoryOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_RBI_CATEGORY_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadRbiCategoryIDOperation");
            }else{
