...
public class CheckerRejectRbiCategoryOperation extends AbstractRbiCategoryTrxOperation{

    public CheckerRejectRbiCategoryOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_RBI_CATEGORY;
    }
