 ...
 */
public class MakerEditRejectedUpdateCaseCreationBranchOperation extends AbstractCaseCreationTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateCaseCreationBranchOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_CASECREATION_BRANCH;
        }
