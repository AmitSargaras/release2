 ...
 * Read CaseCreation Controller
 */
public class CaseCreationReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public CaseCreationReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_CASECREATION)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCaseCreationOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_CASECREATION_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCaseCreationIDOperation");
            }else{
