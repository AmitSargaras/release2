 ...
 * Read CaseCreation Operation 
 */

public class ReadCaseCreationOperation extends AbstractCaseCreationTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadCaseCreationOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_CASECREATION;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingCaseCreation(getStagingCaseCreationBusManager().getCaseCreationById(stagingPK));
            }else{
