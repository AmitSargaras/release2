 ...
 * Read CaseCreation Operation By Trx vID
 */

public class ReadCaseCreationIDOperation extends AbstractCaseCreationTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadCaseCreationIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_CASECREATION_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            OBCaseCreationTrxValue newValue = new OBCaseCreationTrxValue(trxValue);
            ...
            if (stagingRef != null) {
                ...
                ICaseCreation caseCreationUpdate=getStagingCaseCreationBusManager().getCaseCreationById(stagingPK);
                newValue.setStagingCaseCreation(caseCreationUpdate);
            }else{
            ...
            if (actualRef != null) {
                ...
                newValue.setCaseCreation(getCaseCreationBusManager().getCaseCreationById(actualPK));
            }
            return newValue;
        }
        catch (Exception ex) {
