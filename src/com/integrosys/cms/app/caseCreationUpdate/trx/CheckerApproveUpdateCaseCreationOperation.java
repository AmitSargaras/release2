...
public class CheckerApproveUpdateCaseCreationOperation extends AbstractCaseCreationTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveUpdateCaseCreationOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_UPDATE_CASECREATION;
	}
