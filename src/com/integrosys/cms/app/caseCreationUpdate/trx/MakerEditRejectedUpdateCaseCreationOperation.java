 ...
 */
public class MakerEditRejectedUpdateCaseCreationOperation extends AbstractCaseCreationTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateCaseCreationOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_CASECREATION;
        }
