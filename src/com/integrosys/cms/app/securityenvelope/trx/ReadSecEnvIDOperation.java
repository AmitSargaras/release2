...
public class ReadSecEnvIDOperation extends AbstractSecEnvelopeTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadSecEnvIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_SECENVELOPE_ID;
    }
