 ...
 * Date: Feb 08, 2010
 */
public class MakerEditRejectedUpdateSecEnvelopeOperation extends AbstractSecEnvelopeTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateSecEnvelopeOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_SECENV;
        }
