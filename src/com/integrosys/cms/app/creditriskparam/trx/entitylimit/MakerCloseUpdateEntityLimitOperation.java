 ...
 * Tag:      $Name: $
 */
public class MakerCloseUpdateEntityLimitOperation extends AbstractEntityLimitTrxOperation
{
     ...
     * Default constructor.
     */
    public MakerCloseUpdateEntityLimitOperation()
    {}
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_CLOSE_UPDATE_ENTITY_LIMIT;
    }
    ...
    public ITrxResult performProcess (ITrxValue value) throws TrxOperationException
    {
        try {
			...
			trxValue.setStagingEntityLimit (trxValue.getEntityLimit());
