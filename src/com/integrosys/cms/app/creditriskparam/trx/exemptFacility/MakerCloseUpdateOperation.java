...
/**
 * This operation class is invoked by maker to close Exempted Facilty rejected by a checker.
 *
 ...
 * Tag:      $Name: $
 */
public class MakerCloseUpdateOperation extends AbstractExemptFacilityTrxOperation
{
    /**
     * Default constructor.
     */
    public MakerCloseUpdateOperation()
    {}
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_CLOSE_UPDATE_EXEMPT_FACILITY;
    }
    ...
    public ITrxResult performProcess (ITrxValue value) throws TrxOperationException
    {
        try {
			...
			trxValue.setStagingExemptFacilityGroup (trxValue.getExemptFacilityGroup());
