 ...
 * Tag:      $Name: $
 */
public class MakerCloseUpdateExemptedInstOperation extends AbstractExemptedInstTrxOperation
{
    /**
     * Default constructor.
     */
    public MakerCloseUpdateExemptedInstOperation()
    {}
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_CLOSE_UPDATE_EXEMPT_INST;
    }
    ...
    public ITrxResult performProcess (ITrxValue value) throws TrxOperationException
    {
        try {
			...
			trxValue.setStagingExemptedInst (trxValue.getExemptedInst());
