 ...
 * the AbstractExemptedInstProxy, wrapped in an EJB mechanism.
 *
 ...
 * Tag:     $Name:  $
 */
public class SBExemptedInstProxyBean extends AbstractExemptedInstProxy implements SessionBean
{
     ...
     * Default Constructor
     */
    public SBExemptedInstProxyBean() {}

    /**
     * Method to rollback a transaction
     *
     * @throws ExemptedInstException on errors rolling back
     */
    protected void rollback() throws ExemptedInstException
    {
        try {
            ...
            throw new ExemptedInstException (e.toString());
        }
    }
