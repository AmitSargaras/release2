...
public class CheckerApproveCreateInsuranceCoverageDtlsOperation extends AbstractInsuranceCoverageDtlsTrxOperation {
	/**
	 * Default Constructor
	 */
	public CheckerApproveCreateInsuranceCoverageDtlsOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_CREATE_INSURANCE_COVERAGE_DTLS;
	}
	...
	private IInsuranceCoverageDtlsTrxValue updateActualInsuranceCoverageDtls(IInsuranceCoverageDtlsTrxValue anICCInsuranceCoverageDtlsTrxValue)
		...
		try {
			...
			IInsuranceCoverageDtls replicatedInsuranceCoverageDtls = InsuranceCoverageDtlsReplicationUtils.replicateInsuranceCoverageDtlsForCreateStagingCopy(staging);
			IInsuranceCoverageDtls updatedInsuranceCoverageDtls = getInsuranceCoverageDtlsBusManager().createInsuranceCoverageDtls(replicatedInsuranceCoverageDtls);
