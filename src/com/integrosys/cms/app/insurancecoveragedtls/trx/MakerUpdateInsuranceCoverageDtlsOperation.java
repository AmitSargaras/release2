 ...
 */
public class MakerUpdateInsuranceCoverageDtlsOperation extends AbstractInsuranceCoverageDtlsTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerUpdateInsuranceCoverageDtlsOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_UPDATE_INSURANCE_COVERAGE_DTLS;
    }
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        IInsuranceCoverageDtls replicatedInsuranceCoverageDtls = InsuranceCoverageDtlsReplicationUtils.replicateInsuranceCoverageDtlsForCreateStagingCopy(stage);
        idxTrxValue.setStagingInsuranceCoverageDtls(replicatedInsuranceCoverageDtls);
