 ...
 */
public class MakerSubmitSaveUpdateInsuranceCoverageDtlsOperation extends AbstractInsuranceCoverageDtlsTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerSubmitSaveUpdateInsuranceCoverageDtlsOperation()
        {
            super();
        }
