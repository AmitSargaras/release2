 ...
 */
public class MakerSubmitSaveCreateInsuranceCoverageDtlsOperation extends AbstractInsuranceCoverageDtlsTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerSubmitSaveCreateInsuranceCoverageDtlsOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_SUBMIT_SAVE_CREATE_INSURANCE_COVERAGE_DTLS;
        }
