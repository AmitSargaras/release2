 ...
 */
public class MakerEditRejectedDeleteInsuranceCoverageDtlsOperation extends AbstractInsuranceCoverageDtlsTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDeleteInsuranceCoverageDtlsOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_INSURANCE_COVERAGE_DTLS;
        }
