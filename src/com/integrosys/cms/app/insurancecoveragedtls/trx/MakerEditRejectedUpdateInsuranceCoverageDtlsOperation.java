 ...
 */
public class MakerEditRejectedUpdateInsuranceCoverageDtlsOperation extends AbstractInsuranceCoverageDtlsTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedUpdateInsuranceCoverageDtlsOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_UPDATE_INSURANCE_COVERAGE_DTLS;
        }
