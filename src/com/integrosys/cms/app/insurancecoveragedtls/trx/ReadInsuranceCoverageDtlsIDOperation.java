 ...
 * Read Insurance Coverage Details Operation By Trx ID
 */

public class ReadInsuranceCoverageDtlsIDOperation extends AbstractInsuranceCoverageDtlsTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    public ReadInsuranceCoverageDtlsIDOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_INSURANCE_COVERAGE_DTLS_ID;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            IInsuranceCoverageDtlsTrxValue newValue = new OBInsuranceCoverageDtlsTrxValue(trxValue);
