 ...
 * Maker Update operation to save update Insurance Coverage Details in draft 
 */
public class MakerSaveUpdateInsuranceCoverageDtlsOperation extends AbstractInsuranceCoverageDtlsTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerSaveUpdateInsuranceCoverageDtlsOperation() {
        super();
    }
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_UPDATE_SAVE_INSURANCE_COVERAGE_DTLS;
     }
