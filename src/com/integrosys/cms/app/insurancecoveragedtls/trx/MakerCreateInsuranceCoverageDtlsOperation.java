...
/**
 * Transaction Operation to be invoked to create Insurance Coverage Details, create transaction.
 * 
 * @author Dattatray Thorat
 * 
 */
public class MakerCreateInsuranceCoverageDtlsOperation extends AbstractInsuranceCoverageDtlsTrxOperation {

	private static final long serialVersionUID = -6138935003644406544L;

	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_CREATE_INSURANCE_COVERAGE_DTLS;
	}
