...
public class MakerCloseRejectedDeleteRegionOperation extends AbstractRegionTrxOperation{

	private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_DELETE_REGION;
    ...
    * Defaulc Constructor
    */
    public MakerCloseRejectedDeleteRegionOperation()
    {
