...
public class MakerEditRejectedCreateRegionOperation extends AbstractRegionTrxOperation{

	/**
     * Defaulc Constructor
     */
     public MakerEditRejectedCreateRegionOperation()
     {
         super();
     }
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_CREATE_REGION;
     }
