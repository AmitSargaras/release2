...
public class CheckerApproveInsertMasterOperation extends AbstractRegionTrxOperation {
     ...
     */
    private IRegionTrxValue actualMaster(IRegionTrxValue idxTrxValue) throws NoSuchGeographyException, TrxParameterException, TransactionException, ConcurrentUpdateException {
        try {
            IFileMapperId staging = idxTrxValue.getStagingFileMapperID();
            IFileMapperId actual = idxTrxValue.getFileMapperID();

            IFileMapperId updatedActual = getRegionFileMapperIdBusManager().insertRegion(staging,idxTrxValue);           
