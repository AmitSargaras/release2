...
public class MakerEditRejectedDeleteRegionOperation extends AbstractRegionTrxOperation{

	 /**
     * Defaulc Constructor
     */
     public MakerEditRejectedDeleteRegionOperation()
     {
         super();
     }
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_REGION;
     }
