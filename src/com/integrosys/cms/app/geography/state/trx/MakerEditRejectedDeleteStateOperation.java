...
public class MakerEditRejectedDeleteStateOperation extends AbstractStateTrxOperation{

	 /**
     * Defaulc Constructor
     */
     public MakerEditRejectedDeleteStateOperation()
     {
         super();
     }
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_STATE;
     }
