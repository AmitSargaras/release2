...
public class ReadStateIDOperation extends AbstractStateTrxOperation implements ITrxReadOperation {

	 public ReadStateIDOperation() {
	        super();
	    }
	    ...
	    public String getOperationName() {
	        return ICMSConstant.ACTION_READ_STATE_ID;
	    }
	    ...
	    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
	    	try {
	            ...
	            OBStateTrxValue newValue = new OBStateTrxValue(trxValue);
	            ...
	            if (stagingRef != null) {
	                ...
	                newValue.setStagingState(getStagingStateBusManager().getStateById(stagingPK));
	            }

	            if (actualRef != null) {
	                long actualPK = (new Long(actualRef)).longValue();
	                newValue.setActualState(getStateBusManager().getStateById(actualPK));
	            }
	            return newValue;
	        }
	        catch (Exception ex) {
