...
public class MakerSaveCreateStateOperation extends AbstractStateTrxOperation{

	private static final long serialVersionUID = -6138935003644406544L;

	public String getOperationName() {
		return ICMSConstant.ACTION_MAKER_SAVE_STATE;
	}

	public ITrxResult performProcess(ITrxValue value) throws TrxOperationException {
		Validate.notNull(value, "transaction value must not be null");

		IStateTrxValue trxValue = (IStateTrxValue) value;
		trxValue = super.createStagingState(trxValue);
