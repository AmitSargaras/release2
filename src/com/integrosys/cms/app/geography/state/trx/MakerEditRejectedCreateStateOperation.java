...
public class MakerEditRejectedCreateStateOperation extends AbstractStateTrxOperation{

	/**
     * Defaulc Constructor
     */
     public MakerEditRejectedCreateStateOperation()
     {
         super();
     }
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_CREATE_STATE;
     }
