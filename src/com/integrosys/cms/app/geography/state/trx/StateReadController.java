...
public class StateReadController extends AbstractTrxController implements ITrxOperationFactory {
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param)throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_STATE)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadStateOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_STATE_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadStateIDOperation");
            }else{
