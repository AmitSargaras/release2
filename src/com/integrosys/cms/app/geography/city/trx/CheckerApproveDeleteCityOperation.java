...
public class CheckerApproveDeleteCityOperation extends AbstractCityTrxOperation{

	/**
	 * Default Constructor
	 */
	public CheckerApproveDeleteCityOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_CITY;
	}
	...
	private ICityTrxValue updateActualCity(ICityTrxValue anICityTrxValue)
		...
		try {
			...
			ICity updatedCity = getCityBusManager().deleteCity(actual);
