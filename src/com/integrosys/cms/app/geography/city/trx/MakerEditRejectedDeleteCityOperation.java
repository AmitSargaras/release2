...
public class MakerEditRejectedDeleteCityOperation extends AbstractCityTrxOperation{

	 /**
     * Defaulc Constructor
     */
     public MakerEditRejectedDeleteCityOperation()
     {
         super();
     }
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DELETE_CITY;
     }
