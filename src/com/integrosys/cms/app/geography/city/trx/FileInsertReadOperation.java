...
public class FileInsertReadOperation extends AbstractCityTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId relationshipMgr = getStagingCityFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId relationshipMgr = getStagingCityFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(relationshipMgr);
            }
            return newValue;
        }
