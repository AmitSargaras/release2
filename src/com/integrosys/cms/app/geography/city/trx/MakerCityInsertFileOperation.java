 ...
 * Date: Jan 18, 2008
 */
public class MakerCityInsertFileOperation extends AbstractCityTrxOperation {

   /**
    * Defaulc Constructor
    */
    public MakerCityInsertFileOperation()
    {
        super();
    }
	...
	*/
	private ICityTrxValue createFileIdTransaction(ICityTrxValue anICCICityTrxValue) throws TrxOperationException,NoSuchGeographyException
	{
		try
		{
			anICCICityTrxValue = prepareInsertTrxValue(anICCICityTrxValue);
			ICMSTrxValue trxValue = createTransaction(anICCICityTrxValue);
            OBCityTrxValue holidayTrxValue = new OBCityTrxValue (trxValue);
            holidayTrxValue.setStagingFileMapperID(anICCICityTrxValue.getStagingFileMapperID());
            holidayTrxValue.setFileMapperID(anICCICityTrxValue.getFileMapperID());
