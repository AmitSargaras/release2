...
public class CityReadController extends AbstractTrxController implements ITrxOperationFactory {
	...
	public ITrxOperation getOperation(ITrxValue value, ITrxParameter param)throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_CITY)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCityOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_CITY_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadCityIDOperation");
            }else{
