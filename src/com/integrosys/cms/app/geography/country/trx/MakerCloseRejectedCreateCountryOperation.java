...
public class MakerCloseRejectedCreateCountryOperation extends AbstractCountryTrxOperation{

	private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_CREATE_COUNTRY;
    ...
    * Defaulc Constructor
    */
    public MakerCloseRejectedCreateCountryOperation()
    {
