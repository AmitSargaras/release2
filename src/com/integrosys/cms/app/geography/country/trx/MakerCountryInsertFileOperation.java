 ...
 * Date: Jan 18, 2008
 */
public class MakerCountryInsertFileOperation extends AbstractCountryTrxOperation {

   /**
    * Defaulc Constructor
    */
    public MakerCountryInsertFileOperation()
    {
        super();
    }
	...
	*/
	private ICountryTrxValue createFileIdTransaction(ICountryTrxValue anICCICountryTrxValue) throws TrxOperationException,CountryException
	{
		try
		{
			anICCICountryTrxValue = prepareInsertTrxValue(anICCICountryTrxValue);
			ICMSTrxValue trxValue = createTransaction(anICCICountryTrxValue);
            OBCountryTrxValue holidayTrxValue = new OBCountryTrxValue (trxValue);
            holidayTrxValue.setStagingFileMapperID(anICCICountryTrxValue.getStagingFileMapperID());
            holidayTrxValue.setFileMapperID(anICCICountryTrxValue.getFileMapperID());
