...
public class FileInsertReadOperation extends AbstractCountryTrxOperation implements ITrxReadOperation {
    /**
     * Default Constructor
     */
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (stagingRef != null) {
                ...
                IFileMapperId relationshipMgr = getStagingCountryFileMapperIdBusManager().getInsertFileById(stagingPK);
            ...
            if (actualRef != null) {
                ...
                IFileMapperId relationshipMgr = getStagingCountryFileMapperIdBusManager().getInsertFileById(actualPK);
                newValue.setStagingFileMapperID(relationshipMgr);
            }
            return newValue;
        }
