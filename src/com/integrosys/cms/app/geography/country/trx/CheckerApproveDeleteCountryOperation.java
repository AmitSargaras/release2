...
public class CheckerApproveDeleteCountryOperation extends AbstractCountryTrxOperation{

	/**
	 * Default Constructor
	 */
	public CheckerApproveDeleteCountryOperation() {
		super();
	}
	...
	public String getOperationName() {
		return ICMSConstant.ACTION_CHECKER_APPROVE_DELETE_COUNTRY;
	}
	...
	private ICountryTrxValue updateActualCountry(ICountryTrxValue anICountryTrxValue)
		...
		try {
			...
			ICountry updatedCountry = getCountryBusManager().deleteCountry(actual);
