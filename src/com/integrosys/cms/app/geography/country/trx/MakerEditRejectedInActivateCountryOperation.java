...
public class MakerEditRejectedInActivateCountryOperation extends AbstractCountryTrxOperation{

	private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_EDIT_REJECTED_INACTIVE_COUNTRY;
    ...
    * Defaulc Constructor
    */
    public MakerEditRejectedInActivateCountryOperation()
    {
