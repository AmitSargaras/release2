...
public class MakerUpdateCountryOperation extends AbstractCountryTrxOperation{
	
	/**
     * Defaulc Constructor
     */
    public MakerUpdateCountryOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_UPDATE_COUNTRY;
    }
