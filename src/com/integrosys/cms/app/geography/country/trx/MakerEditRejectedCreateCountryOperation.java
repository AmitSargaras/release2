...
public class MakerEditRejectedCreateCountryOperation extends AbstractCountryTrxOperation{

	/**
     * Defaulc Constructor
     */
     public MakerEditRejectedCreateCountryOperation()
     {
         super();
     }
     ...
     */
     ...
     {
         return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_CREATE_COUNTRY;
     }
