...
public class MakerCloseRejectedInActivateCountryOperation extends AbstractCountryTrxOperation{

	private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_INACTIVE_COUNTRY;
    ...
    * Defaulc Constructor
    */
    public MakerCloseRejectedInActivateCountryOperation()
    {
