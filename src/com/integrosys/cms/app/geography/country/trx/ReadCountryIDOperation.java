...
public class ReadCountryIDOperation extends AbstractCountryTrxOperation implements ITrxReadOperation {

	 public ReadCountryIDOperation() {
	        super();
	    }
	    ...
	    public String getOperationName() {
	        return ICMSConstant.ACTION_READ_COUNTRY_ID;
	    }
	    ...
	    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
	    	try {
	            ...
	            OBCountryTrxValue newValue = new OBCountryTrxValue(trxValue);
	            ...
	            if (stagingRef != null) {
	                ...
	                newValue.setStagingCountry(getStagingCountryBusManager().getCountryById(stagingPK));
	            }

	            if (actualRef != null) {
	                long actualPK = (new Long(actualRef)).longValue();
	                newValue.setActualCountry(getCountryBusManager().getCountryById(actualPK));
	            }
	            return newValue;
	        }
	        catch (Exception ex) {
