...
public class TatMasterReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public TatMasterReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_TAT_MASTER)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadTatMasterOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_TAT_MASTER_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadTatMasterIDOperation");
            }else{
