...
public class ReadTatMasterOperation extends AbstractTatMasterTrxOperation implements ITrxReadOperation{

	 
    public ReadTatMasterOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_READ_TAT_MASTER;
    }
    ...
    public ITrxValue getTransaction(ITrxValue anITrxValue) throws TransactionException {
    	try {
            ...
            if (null != stagingRef) {
                ...
                newValue.setStagingtatMaster(getStagingtatMasterBusManager().getTatMasterById(stagingPK));
            }else{
