 ...
 *Maker Edit Rejected operation to  update rejected record by maker
 */
public class MakerEditRejectedEnableDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedEnableDirectorMasterOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_ENABLE_DIRECTOR_MASTER;
        }
        ...
        */
        public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException
        {
            ...
            replicatedDirectorMaster.setVersionTime(stage.getVersionTime());
