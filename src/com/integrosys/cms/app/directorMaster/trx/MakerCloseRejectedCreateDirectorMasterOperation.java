...
public class MakerCloseRejectedCreateDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{

    private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_CREATE_DIRECTOR_MASTER;
    ...
    * Defaulc Constructor
    */
    public MakerCloseRejectedCreateDirectorMasterOperation()
    {
