...
public class CheckerEnableRejectDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{

    public CheckerEnableRejectDirectorMasterOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_ENABLE_DIRECTOR_MASTER;
    }
