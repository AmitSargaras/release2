 ...
 */
public class DirectorMasterReadController extends AbstractTrxController implements ITrxOperationFactory {
     ...
     * Default Constructor
     */
    public DirectorMasterReadController() {
    }
    ...
    public ITrxOperation getOperation(ITrxValue value, ITrxParameter param) throws TrxParameterException {
        ...
        if (action != null) {
            if (action.equals(ICMSConstant.ACTION_READ_DIRECTOR_MASTER)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadDirectorMasterOperation");
            } else if (action.equals(ICMSConstant.ACTION_READ_DIRECTOR_MASTER_ID)) {
                return (ITrxOperation) getNameTrxOperationMap().get("ReadDirectorMasterIDOperation");
            }else{
