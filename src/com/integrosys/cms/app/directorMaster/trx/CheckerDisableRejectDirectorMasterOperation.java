...
public class CheckerDisableRejectDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{

    public CheckerDisableRejectDirectorMasterOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_DISABLE_DIRECTOR_MASTER;
    }
