 ...
 */
public class MakerEditRejectedDisableDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{
    /**
        * Defaulc Constructor
        */
        public MakerEditRejectedDisableDirectorMasterOperation()
        {
            super();
        }
        ...
        */
        ...
        {
            return ICMSConstant.ACTION_MAKER_EDIT_REJECTED_DISABLE_DIRECTOR_MASTER;
        }
