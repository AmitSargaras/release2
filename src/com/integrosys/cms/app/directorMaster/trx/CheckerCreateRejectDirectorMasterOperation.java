...
public class CheckerCreateRejectDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{

    public CheckerCreateRejectDirectorMasterOperation()
    {
        super();
    }
    ...
    */
    ...
    {
        return ICMSConstant.ACTION_CHECKER_REJECT_CREATE_DIRECTOR_MASTER;
    }
