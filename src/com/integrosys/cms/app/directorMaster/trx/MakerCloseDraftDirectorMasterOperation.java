...
public class MakerCloseDraftDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{

    private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_CLOSE_DRAFT_DIRECTOR_MASTER;
    ...
    * Defaulc Constructor
    */
    public MakerCloseDraftDirectorMasterOperation()
    {
