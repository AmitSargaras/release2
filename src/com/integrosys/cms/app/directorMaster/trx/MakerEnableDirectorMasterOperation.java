 ...
 */
public class MakerEnableDirectorMasterOperation extends AbstractDirectorMasterTrxOperation {
    /**
     * Defaulc Constructor
     */
    public MakerEnableDirectorMasterOperation() {
        super();
    }
    ...
    public String getOperationName() {
        return ICMSConstant.ACTION_MAKER_ENABLE_DIRECTOR_MASTER;
    }
    ...
    public ITrxResult performProcess(ITrxValue anITrxValue) throws TrxOperationException {
        ...
        IDirectorMasterTrxValue trxValue = enableStagingDirectorMaster(idxTrxValue);
