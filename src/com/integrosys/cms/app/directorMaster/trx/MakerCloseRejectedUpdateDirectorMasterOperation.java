...
public class MakerCloseRejectedUpdateDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{

    private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_UPDATE_DIRECTOR_MASTER;
    ...
    * Defaulc Constructor
    */
    public MakerCloseRejectedUpdateDirectorMasterOperation()
    {
