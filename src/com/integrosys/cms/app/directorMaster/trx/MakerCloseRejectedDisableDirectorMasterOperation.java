...
public class MakerCloseRejectedDisableDirectorMasterOperation extends AbstractDirectorMasterTrxOperation{

    private static final String DEFAULT_OPERATION_NAME = ICMSConstant.ACTION_MAKER_CLOSE_REJECTED_DISABLE_DIRECTOR_MASTER;
    ...
    * Defaulc Constructor
    */
    public MakerCloseRejectedDisableDirectorMasterOperation()
    {
