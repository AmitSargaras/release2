 ...
 * Tag : $Name$
 */
public class MakerCreateDirectorMasterOperation extends AbstractDirectorMasterTrxOperation {

   /**
    * Default Constructor
    */
    public MakerCreateDirectorMasterOperation()
    {
        super();
    }
	...
	*/
	...
	{
		return ICMSConstant.ACTION_MAKER_CREATE_DIRECTOR_MASTER;
	}
	...
	*/
	private IDirectorMasterTrxValue createDirectorMasterTransaction(IDirectorMasterTrxValue anICCDirectorMasterTrxValue) throws TrxOperationException,DirectorMasterException
	{
		...
		{
			throw new DirectorMasterException("Error in Create Director Master Operation ");
		}
